...
# [bun] recent context, 2026-05-15 11:49pm GMT+9

Legend: 🎯session 🔴bugfix 🟣feature 🔄refactor ✅change 🔵discovery ⚖️decision 🚨security_alert 🔐security_note
Format: ID TIME TYPE TITLE
Fetch details: get_observations([IDs]) | Search: mem-search skill

Stats: 14 obs (5,311t read) | 165,493t work | 97% savings

### May 15, 2026
269 11:34p 🔵 Bun FFI dlopen() regression from Rust rewrite blocks embedded native libraries
270 " 🔵 Issue #30717 FFI dlopen regression already fixed in merged PR #30720
271 11:35p 🔵 Bun FFI has multiple active threading and memory leak issues with JSCallback
272 " 🔵 Windows ARM64 FFI support blocked on TinyCC backend implementation
S137 Systematic investigation of Bun FFI critical issues, focusing on JSCallback threading and memory management problems (May 15 at 11:36 PM)
273 11:45p 🔵 FFI threadsafe JSCallback test hanging indefinitely
274 11:46p 🔴 Fixed hanging threadsafe JSCallback test in FFI test suite
275 11:47p ✅ Increased threadsafe JSCallback test stress level
276 " 🔵 FFI JSCallback crashes with segfault under high-volume cross-thread invocation
277 " 🔵 FFI callback implementation uses ThreadSafeRefCounted for lifecycle management
278 " 🔴 Fixed use-after-free in threadsafe FFI callbacks
279 11:48p ✅ Improved thread safety and cleanup in FFI callback test
280 " 🔄 Refined FFI callback protection to guard all member access
281 " ✅ Standardized move syntax in FFI callback lambda capture
282 11:49p ✅ Documented threading safety constraints in FFI callback implementation

Access 165k tokens of past work via get_observations([IDs]) or mem-search skill.
</claude-mem-context>