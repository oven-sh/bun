...
- `src/runtime/bin_entry/` - process entry point (`main`); `bun_runtime` is the root of the crate graph and the final Rust crate; its objects and every other crate's rlib are inputs of the final link
