...
Also seen: `.img.zst` of the 213 MB CC image is 33 MB — the embedded single-file form should embed that and inflate into the image cache on first run (todo), instead of the raw 212 MB payload.
