...
fn addInternalImports(b: *Build, mod: *Module, opts: *BunBuildOptions) void {
    ...
    inline for (.{
        ...
        // node-fallbacks polyfills are embedded zstd-compressed and decompressed
        // lazily on first access (see src/resolver/node_fallbacks.zig).
        .{ .file = "node-fallbacks/assert.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/buffer.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/console.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/constants.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/crypto.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/domain.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/events.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/http.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/https.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/net.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/os.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/path.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/process.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/punycode.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/querystring.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/stream.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/string_decoder.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/sys.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/timers.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/tty.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/url.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/util.js.zst", .enable = opts.shouldEmbedCode() },
        .{ .file = "node-fallbacks/zlib.js.zst", .enable = opts.shouldEmbedCode() },
