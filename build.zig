...
fn addInternalImports(b: *Build, mod: *Module, opts: *BunBuildOptions) void {
    ...
    inline for (.{
        ...
        .{ .file = "bun-framework-react/client.tsx", .import = "bun-framework-react/client.tsx", .enable = opts.shouldEmbedCode() },
        .{ .file = "bun-framework-react/server.tsx", .import = "bun-framework-react/server.tsx", .enable = opts.shouldEmbedCode() },
        .{ .file = "bun-framework-react/ssr.tsx", .import = "bun-framework-react/ssr.tsx", .enable = opts.shouldEmbedCode() },
