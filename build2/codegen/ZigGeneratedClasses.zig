    ...
    comptime {
        ...
        if (@TypeOf(AttributeIterator.finalize) != (fn(*AttributeIterator) callconv(.C) void)) {
          ...
          if (@TypeOf(AttributeIterator.getThis) != CallbackType) 
            @compileLog(
              "Expected AttributeIterator.getThis to be a callback but received " ++ @typeName(@TypeOf(AttributeIterator.getThis))
            );
          if (@TypeOf(AttributeIterator.next) != CallbackType) 
            @compileLog(
              "Expected AttributeIterator.next to be a callback but received " ++ @typeName(@TypeOf(AttributeIterator.next))
            );
        if (!JSC.is_bindgen) {
        ...
        if (@TypeOf(BigIntStats.finalize) != (fn(*BigIntStats) callconv(.C) void)) {
           @compileLog("BigIntStats.finalize is not a finalizer");
            ...
            if (@TypeOf(BigIntStats.atime) != GetterType)
              @compileLog(
                "Expected BigIntStats.atime to be a getter"
                );

            if (@TypeOf(BigIntStats.atimeMs) != GetterType)
              @compileLog(
                "Expected BigIntStats.atimeMs to be a getter"
                );

            if (@TypeOf(BigIntStats.atimeNs) != GetterType)
              @compileLog(
                "Expected BigIntStats.atimeNs to be a getter"
                );

            if (@TypeOf(BigIntStats.birthtime) != GetterType)
              @compileLog(
                "Expected BigIntStats.birthtime to be a getter"
                );

            if (@TypeOf(BigIntStats.birthtimeMs) != GetterType)
              @compileLog(
                "Expected BigIntStats.birthtimeMs to be a getter"
                );

            if (@TypeOf(BigIntStats.birthtimeNs) != GetterType)
              @compileLog(
                "Expected BigIntStats.birthtimeNs to be a getter"
                );

            if (@TypeOf(BigIntStats.blksize) != GetterType)
              @compileLog(
                "Expected BigIntStats.blksize to be a getter"
                );

            if (@TypeOf(BigIntStats.blocks) != GetterType)
              @compileLog(
                "Expected BigIntStats.blocks to be a getter"
                );

            if (@TypeOf(BigIntStats.ctime) != GetterType)
              @compileLog(
                "Expected BigIntStats.ctime to be a getter"
                );

            if (@TypeOf(BigIntStats.ctimeMs) != GetterType)
              @compileLog(
                "Expected BigIntStats.ctimeMs to be a getter"
                );

            if (@TypeOf(BigIntStats.ctimeNs) != GetterType)
              @compileLog(
                "Expected BigIntStats.ctimeNs to be a getter"
                );

            if (@TypeOf(BigIntStats.dev) != GetterType)
              @compileLog(
                "Expected BigIntStats.dev to be a getter"
                );

            if (@TypeOf(BigIntStats.gid) != GetterType)
              @compileLog(
                "Expected BigIntStats.gid to be a getter"
                );

            if (@TypeOf(BigIntStats.ino) != GetterType)
              @compileLog(
                "Expected BigIntStats.ino to be a getter"
                );

          if (@TypeOf(BigIntStats.isBlockDevice_WithoutTypeChecks) != fn (*BigIntStats, *JSC.JSGlobalObject, ) callconv(.C) JSC.JSValue) 
            @compileLog(
              "Expected BigIntStats.isBlockDevice_WithoutTypeChecks to be a DOMJIT function"
            );
          if (@TypeOf(BigIntStats.isBlockDevice_) != CallbackType) 
            @compileLog(
              "Expected BigIntStats.isBlockDevice_ to be a callback but received " ++ @typeName(@TypeOf(BigIntStats.isBlockDevice_))
            );
          if (@TypeOf(BigIntStats.isCharacterDevice_WithoutTypeChecks) != fn (*BigIntStats, *JSC.JSGlobalObject, ) callconv(.C) JSC.JSValue) 
            @compileLog(
              "Expected BigIntStats.isCharacterDevice_WithoutTypeChecks to be a DOMJIT function"
            );
          if (@TypeOf(BigIntStats.isCharacterDevice_) != CallbackType) 
            @compileLog(
              "Expected BigIntStats.isCharacterDevice_ to be a callback but received " ++ @typeName(@TypeOf(BigIntStats.isCharacterDevice_))
            );
          if (@TypeOf(BigIntStats.isDirectory_WithoutTypeChecks) != fn (*BigIntStats, *JSC.JSGlobalObject, ) callconv(.C) JSC.JSValue) 
            @compileLog(
              "Expected BigIntStats.isDirectory_WithoutTypeChecks to be a DOMJIT function"
            );
          if (@TypeOf(BigIntStats.isDirectory_) != CallbackType) 
            @compileLog(
              "Expected BigIntStats.isDirectory_ to be a callback but received " ++ @typeName(@TypeOf(BigIntStats.isDirectory_))
            );
          if (@TypeOf(BigIntStats.isFIFO_WithoutTypeChecks) != fn (*BigIntStats, *JSC.JSGlobalObject, ) callconv(.C) JSC.JSValue) 
            @compileLog(
              "Expected BigIntStats.isFIFO_WithoutTypeChecks to be a DOMJIT function"
            );
          if (@TypeOf(BigIntStats.isFIFO_) != CallbackType) 
            @compileLog(
              "Expected BigIntStats.isFIFO_ to be a callback but received " ++ @typeName(@TypeOf(BigIntStats.isFIFO_))
            );
          if (@TypeOf(BigIntStats.isFile_WithoutTypeChecks) != fn (*BigIntStats, *JSC.JSGlobalObject, ) callconv(.C) JSC.JSValue) 
            @compileLog(
              "Expected BigIntStats.isFile_WithoutTypeChecks to be a DOMJIT function"
            );
          if (@TypeOf(BigIntStats.isFile_) != CallbackType) 
            @compileLog(
              "Expected BigIntStats.isFile_ to be a callback but received " ++ @typeName(@TypeOf(BigIntStats.isFile_))
            );
          if (@TypeOf(BigIntStats.isSocket_WithoutTypeChecks) != fn (*BigIntStats, *JSC.JSGlobalObject, ) callconv(.C) JSC.JSValue) 
            @compileLog(
              "Expected BigIntStats.isSocket_WithoutTypeChecks to be a DOMJIT function"
            );
          if (@TypeOf(BigIntStats.isSocket_) != CallbackType) 
            @compileLog(
              "Expected BigIntStats.isSocket_ to be a callback but received " ++ @typeName(@TypeOf(BigIntStats.isSocket_))
            );
          if (@TypeOf(BigIntStats.isSymbolicLink_WithoutTypeChecks) != fn (*BigIntStats, *JSC.JSGlobalObject, ) callconv(.C) JSC.JSValue) 
            @compileLog(
              "Expected BigIntStats.isSymbolicLink_WithoutTypeChecks to be a DOMJIT function"
            );
          if (@TypeOf(BigIntStats.isSymbolicLink_) != CallbackType) 
            @compileLog(
              "Expected BigIntStats.isSymbolicLink_ to be a callback but received " ++ @typeName(@TypeOf(BigIntStats.isSymbolicLink_))
            );
            if (@TypeOf(BigIntStats.mode) != GetterType)
              @compileLog(
                "Expected BigIntStats.mode to be a getter"
                );

            if (@TypeOf(BigIntStats.mtime) != GetterType)
              @compileLog(
                "Expected BigIntStats.mtime to be a getter"
                );

            if (@TypeOf(BigIntStats.mtimeMs) != GetterType)
              @compileLog(
                "Expected BigIntStats.mtimeMs to be a getter"
                );

            if (@TypeOf(BigIntStats.mtimeNs) != GetterType)
              @compileLog(
                "Expected BigIntStats.mtimeNs to be a getter"
                );

            if (@TypeOf(BigIntStats.nlink) != GetterType)
              @compileLog(
                "Expected BigIntStats.nlink to be a getter"
                );

            if (@TypeOf(BigIntStats.rdev) != GetterType)
              @compileLog(
                "Expected BigIntStats.rdev to be a getter"
                );

            if (@TypeOf(BigIntStats.size) != GetterType)
              @compileLog(
                "Expected BigIntStats.size to be a getter"
                );

            if (@TypeOf(BigIntStats.uid) != GetterType)
              @compileLog(
                "Expected BigIntStats.uid to be a getter"
                );
      ...
      if (@TypeOf(Blob.onStructuredCloneDeserialize) != (fn(globalThis: *JSC.JSGlobalObject, ptr: [*]u8, end: [*]u8) callconv(.C) JSC.JSValue)) {
        ...
        if (@TypeOf(Blob.finalize) != (fn(*Blob) callconv(.C) void)) {
          ...
          if (@TypeOf(Blob.getExists) != CallbackType) 
            @compileLog(
              "Expected Blob.getExists to be a callback but received " ++ @typeName(@TypeOf(Blob.getExists))
            );
          ...
          if (@TypeOf(Blob.getJSON) != CallbackType) 
            ...
            if (@TypeOf(Blob.getName) != GetterType)
              @compileLog(
                "Expected Blob.getName to be a getter"
                );
    ...
    comptime {
        ...
        if (@TypeOf(BuildArtifact.finalize) != (fn(*BuildArtifact) callconv(.C) void)) {
          ...
          if (@TypeOf(BuildArtifact.getArrayBuffer) != CallbackType) 
            @compileLog(
              "Expected BuildArtifact.getArrayBuffer to be a callback but received " ++ @typeName(@TypeOf(BuildArtifact.getArrayBuffer))
            );
            if (@TypeOf(BuildArtifact.getHash) != GetterType)
              @compileLog(
                "Expected BuildArtifact.getHash to be a getter"
                );

          if (@TypeOf(BuildArtifact.getJSON) != CallbackType) 
            @compileLog(
              "Expected BuildArtifact.getJSON to be a callback but received " ++ @typeName(@TypeOf(BuildArtifact.getJSON))
            );
            if (@TypeOf(BuildArtifact.getOutputKind) != GetterType)
              @compileLog(
                "Expected BuildArtifact.getOutputKind to be a getter"
                );

            if (@TypeOf(BuildArtifact.getLoader) != GetterType)
              @compileLog(
                "Expected BuildArtifact.getLoader to be a getter"
                );

            if (@TypeOf(BuildArtifact.getPath) != GetterType)
              @compileLog(
                "Expected BuildArtifact.getPath to be a getter"
                );

            if (@TypeOf(BuildArtifact.getSize) != GetterType)
              @compileLog(
                "Expected BuildArtifact.getSize to be a getter"
                );

          if (@TypeOf(BuildArtifact.getSlice) != CallbackType) 
            @compileLog(
              "Expected BuildArtifact.getSlice to be a callback but received " ++ @typeName(@TypeOf(BuildArtifact.getSlice))
            );
            if (@TypeOf(BuildArtifact.getSourceMap) != GetterType)
              @compileLog(
                "Expected BuildArtifact.getSourceMap to be a getter"
                );

          if (@TypeOf(BuildArtifact.getStream) != CallbackType) 
            @compileLog(
              "Expected BuildArtifact.getStream to be a callback but received " ++ @typeName(@TypeOf(BuildArtifact.getStream))
            );
          if (@TypeOf(BuildArtifact.getText) != CallbackType) 
            @compileLog(
              "Expected BuildArtifact.getText to be a callback but received " ++ @typeName(@TypeOf(BuildArtifact.getText))
            );
            if (@TypeOf(BuildArtifact.getMimeType) != GetterType)
              @compileLog(
                "Expected BuildArtifact.getMimeType to be a getter"
                );
    ...
    comptime {
        ...
        if (@TypeOf(BuildMessage.finalize) != (fn(*BuildMessage) callconv(.C) void)) {
          ...
          if (@TypeOf(BuildMessage.toPrimitive) != CallbackType) 
            @compileLog(
              "Expected BuildMessage.toPrimitive to be a callback but received " ++ @typeName(@TypeOf(BuildMessage.toPrimitive))
            );
            if (@TypeOf(BuildMessage.getLevel) != GetterType)
              @compileLog(
                "Expected BuildMessage.getLevel to be a getter"
                );

            if (@TypeOf(BuildMessage.getMessage) != GetterType)
              @compileLog(
                "Expected BuildMessage.getMessage to be a getter"
                );

            if (@TypeOf(BuildMessage.getPosition) != GetterType)
              @compileLog(
                "Expected BuildMessage.getPosition to be a getter"
                );

          if (@TypeOf(BuildMessage.toJSON) != CallbackType) 
            @compileLog(
              "Expected BuildMessage.toJSON to be a callback but received " ++ @typeName(@TypeOf(BuildMessage.toJSON))
            );
          if (@TypeOf(BuildMessage.toString) != CallbackType) 
            @compileLog(
              "Expected BuildMessage.toString to be a callback but received " ++ @typeName(@TypeOf(BuildMessage.toString))
            );
        if (!JSC.is_bindgen) {
    ...
    comptime {
        ...
        if (@TypeOf(Comment.finalize) != (fn(*Comment) callconv(.C) void)) {
          ...
          if (@TypeOf(Comment.after) != CallbackType) 
            @compileLog(
              "Expected Comment.after to be a callback but received " ++ @typeName(@TypeOf(Comment.after))
            );
          if (@TypeOf(Comment.before) != CallbackType) 
            @compileLog(
              "Expected Comment.before to be a callback but received " ++ @typeName(@TypeOf(Comment.before))
            );
          if (@TypeOf(Comment.remove) != CallbackType) 
            @compileLog(
              "Expected Comment.remove to be a callback but received " ++ @typeName(@TypeOf(Comment.remove))
            );
            if (@TypeOf(Comment.removed) != GetterType)
              @compileLog(
                "Expected Comment.removed to be a getter"
                );

          if (@TypeOf(Comment.replace) != CallbackType) 
            @compileLog(
              "Expected Comment.replace to be a callback but received " ++ @typeName(@TypeOf(Comment.replace))
            );
            if (@TypeOf(Comment.getText) != GetterType)
              @compileLog(
                "Expected Comment.getText to be a getter"
                );

            if (@TypeOf(Comment.setText) != SetterType)
              @compileLog(
                "Expected Comment.setText to be a setter"
              );
        if (!JSC.is_bindgen) {
    ...
    comptime {
        ...
        if (@TypeOf(Crypto.constructor) != (fn(*JSC.JSGlobalObject, *JSC.CallFrame) callconv(.C) ?*Crypto)) {
          ...
          if (@TypeOf(Crypto.getRandomValuesWithoutTypeChecks) != fn (*Crypto, *JSC.JSGlobalObject, *JSC.JSUint8Array) callconv(.C) JSC.JSValue) 
            @compileLog(
              "Expected Crypto.getRandomValuesWithoutTypeChecks to be a DOMJIT function"
            );
          if (@TypeOf(Crypto.getRandomValues) != CallbackType) 
            @compileLog(
              "Expected Crypto.getRandomValues to be a callback but received " ++ @typeName(@TypeOf(Crypto.getRandomValues))
            );
          if (@TypeOf(Crypto.randomInt) != CallbackType) 
            @compileLog(
              "Expected Crypto.randomInt to be a callback but received " ++ @typeName(@TypeOf(Crypto.randomInt))
            );
          if (@TypeOf(Crypto.randomUUIDWithoutTypeChecks) != fn (*Crypto, *JSC.JSGlobalObject, ) callconv(.C) JSC.JSValue) 
            @compileLog(
              "Expected Crypto.randomUUIDWithoutTypeChecks to be a DOMJIT function"
            );
          if (@TypeOf(Crypto.randomUUID) != CallbackType) 
            @compileLog(
              "Expected Crypto.randomUUID to be a callback but received " ++ @typeName(@TypeOf(Crypto.randomUUID))
            );
          if (@TypeOf(Crypto.doScryptSync) != CallbackType) 
            @compileLog(
              "Expected Crypto.doScryptSync to be a callback but received " ++ @typeName(@TypeOf(Crypto.doScryptSync))
            );
          if (@TypeOf(Crypto.timingSafeEqualWithoutTypeChecks) != fn (*Crypto, *JSC.JSGlobalObject, *JSC.JSUint8Array, *JSC.JSUint8Array) callconv(.C) JSC.JSValue) 
            @compileLog(
              "Expected Crypto.timingSafeEqualWithoutTypeChecks to be a DOMJIT function"
            );
          if (@TypeOf(Crypto.timingSafeEqual) != CallbackType) 
            @compileLog(
              "Expected Crypto.timingSafeEqual to be a callback but received " ++ @typeName(@TypeOf(Crypto.timingSafeEqual))
            );
        if (!JSC.is_bindgen) {
    ...
    comptime {
        ...
        if (@TypeOf(CryptoHasher.finalize) != (fn(*CryptoHasher) callconv(.C) void)) {
          ...
          if (@TypeOf(CryptoHasher.copy) != CallbackType) 
            @compileLog(
              "Expected CryptoHasher.copy to be a callback but received " ++ @typeName(@TypeOf(CryptoHasher.copy))
            );
        ...
        if (@TypeOf(DebugHTTPSServer.finalize) != (fn(*DebugHTTPSServer) callconv(.C) void)) {
           @compileLog("DebugHTTPSServer.finalize is not a finalizer");
            ...
            if (@TypeOf(DebugHTTPSServer.getAddress) != GetterType)
              @compileLog(
                "Expected DebugHTTPSServer.getAddress to be a getter"
                );

            if (@TypeOf(DebugHTTPSServer.getDevelopment) != GetterType)
              @compileLog(
                "Expected DebugHTTPSServer.getDevelopment to be a getter"
                );

          if (@TypeOf(DebugHTTPSServer.doFetch) != CallbackType) 
            @compileLog(
              "Expected DebugHTTPSServer.doFetch to be a callback but received " ++ @typeName(@TypeOf(DebugHTTPSServer.doFetch))
            );
            if (@TypeOf(DebugHTTPSServer.getHostname) != GetterType)
              @compileLog(
                "Expected DebugHTTPSServer.getHostname to be a getter"
                );

            if (@TypeOf(DebugHTTPSServer.getId) != GetterType)
              @compileLog(
                "Expected DebugHTTPSServer.getId to be a getter"
                );

            if (@TypeOf(DebugHTTPSServer.getPendingRequests) != GetterType)
              @compileLog(
                "Expected DebugHTTPSServer.getPendingRequests to be a getter"
                );

            if (@TypeOf(DebugHTTPSServer.getPendingWebSockets) != GetterType)
              @compileLog(
                "Expected DebugHTTPSServer.getPendingWebSockets to be a getter"
                );

            if (@TypeOf(DebugHTTPSServer.getPort) != GetterType)
              @compileLog(
                "Expected DebugHTTPSServer.getPort to be a getter"
                );

            if (@TypeOf(DebugHTTPSServer.getProtocol) != GetterType)
              @compileLog(
                "Expected DebugHTTPSServer.getProtocol to be a getter"
                );

          if (@TypeOf(DebugHTTPSServer.doPublish) != CallbackType) 
            @compileLog(
              "Expected DebugHTTPSServer.doPublish to be a callback but received " ++ @typeName(@TypeOf(DebugHTTPSServer.doPublish))
            );
          if (@TypeOf(DebugHTTPSServer.doReload) != CallbackType) 
            @compileLog(
              "Expected DebugHTTPSServer.doReload to be a callback but received " ++ @typeName(@TypeOf(DebugHTTPSServer.doReload))
            );
          if (@TypeOf(DebugHTTPSServer.doRequestIP) != CallbackType) 
            @compileLog(
              "Expected DebugHTTPSServer.doRequestIP to be a callback but received " ++ @typeName(@TypeOf(DebugHTTPSServer.doRequestIP))
            );
          if (@TypeOf(DebugHTTPSServer.doStop) != CallbackType) 
            @compileLog(
              "Expected DebugHTTPSServer.doStop to be a callback but received " ++ @typeName(@TypeOf(DebugHTTPSServer.doStop))
            );
          if (@TypeOf(DebugHTTPSServer.doUpgrade) != CallbackType) 
            @compileLog(
              "Expected DebugHTTPSServer.doUpgrade to be a callback but received " ++ @typeName(@TypeOf(DebugHTTPSServer.doUpgrade))
            );
        if (!JSC.is_bindgen) {
        ...
        if (@TypeOf(DebugHTTPServer.finalize) != (fn(*DebugHTTPServer) callconv(.C) void)) {
           @compileLog("DebugHTTPServer.finalize is not a finalizer");
            ...
            if (@TypeOf(DebugHTTPServer.getAddress) != GetterType)
              @compileLog(
                "Expected DebugHTTPServer.getAddress to be a getter"
                );

            if (@TypeOf(DebugHTTPServer.getDevelopment) != GetterType)
              @compileLog(
                "Expected DebugHTTPServer.getDevelopment to be a getter"
                );

          if (@TypeOf(DebugHTTPServer.doFetch) != CallbackType) 
            @compileLog(
              "Expected DebugHTTPServer.doFetch to be a callback but received " ++ @typeName(@TypeOf(DebugHTTPServer.doFetch))
            );
            if (@TypeOf(DebugHTTPServer.getHostname) != GetterType)
              @compileLog(
                "Expected DebugHTTPServer.getHostname to be a getter"
                );

            if (@TypeOf(DebugHTTPServer.getId) != GetterType)
              @compileLog(
                "Expected DebugHTTPServer.getId to be a getter"
                );

            if (@TypeOf(DebugHTTPServer.getPendingRequests) != GetterType)
              @compileLog(
                "Expected DebugHTTPServer.getPendingRequests to be a getter"
                );

            if (@TypeOf(DebugHTTPServer.getPendingWebSockets) != GetterType)
              @compileLog(
                "Expected DebugHTTPServer.getPendingWebSockets to be a getter"
                );

            if (@TypeOf(DebugHTTPServer.getPort) != GetterType)
              @compileLog(
                "Expected DebugHTTPServer.getPort to be a getter"
                );

            if (@TypeOf(DebugHTTPServer.getProtocol) != GetterType)
              @compileLog(
                "Expected DebugHTTPServer.getProtocol to be a getter"
                );

          if (@TypeOf(DebugHTTPServer.doPublish) != CallbackType) 
            @compileLog(
              "Expected DebugHTTPServer.doPublish to be a callback but received " ++ @typeName(@TypeOf(DebugHTTPServer.doPublish))
            );
          if (@TypeOf(DebugHTTPServer.doReload) != CallbackType) 
            @compileLog(
              "Expected DebugHTTPServer.doReload to be a callback but received " ++ @typeName(@TypeOf(DebugHTTPServer.doReload))
            );
          if (@TypeOf(DebugHTTPServer.doRequestIP) != CallbackType) 
            @compileLog(
              "Expected DebugHTTPServer.doRequestIP to be a callback but received " ++ @typeName(@TypeOf(DebugHTTPServer.doRequestIP))
            );
          if (@TypeOf(DebugHTTPServer.doStop) != CallbackType) 
            @compileLog(
              "Expected DebugHTTPServer.doStop to be a callback but received " ++ @typeName(@TypeOf(DebugHTTPServer.doStop))
            );
          if (@TypeOf(DebugHTTPServer.doUpgrade) != CallbackType) 
            @compileLog(
              "Expected DebugHTTPServer.doUpgrade to be a callback but received " ++ @typeName(@TypeOf(DebugHTTPServer.doUpgrade))
            );
        if (!JSC.is_bindgen) {
    ...
    comptime {
        ...
        if (@TypeOf(DocEnd.finalize) != (fn(*DocEnd) callconv(.C) void)) {
          ...
          if (@TypeOf(DocEnd.append) != CallbackType) 
            @compileLog(
              "Expected DocEnd.append to be a callback but received " ++ @typeName(@TypeOf(DocEnd.append))
            );
        if (!JSC.is_bindgen) {
        ...
        if (@TypeOf(DocType.finalize) != (fn(*DocType) callconv(.C) void)) {
           @compileLog("DocType.finalize is not a finalizer");
            ...
            if (@TypeOf(DocType.name) != GetterType)
              @compileLog(
                "Expected DocType.name to be a getter"
                );

            if (@TypeOf(DocType.publicId) != GetterType)
              @compileLog(
                "Expected DocType.publicId to be a getter"
                );

            if (@TypeOf(DocType.systemId) != GetterType)
              @compileLog(
                "Expected DocType.systemId to be a getter"
                );
    ...
    comptime {
        ...
        if (@TypeOf(Element.finalize) != (fn(*Element) callconv(.C) void)) {
          ...
          if (@TypeOf(Element.after) != CallbackType) 
            @compileLog(
              "Expected Element.after to be a callback but received " ++ @typeName(@TypeOf(Element.after))
            );
          if (@TypeOf(Element.append) != CallbackType) 
            @compileLog(
              "Expected Element.append to be a callback but received " ++ @typeName(@TypeOf(Element.append))
            );
            if (@TypeOf(Element.getAttributes) != GetterType)
              @compileLog(
                "Expected Element.getAttributes to be a getter"
                );

          if (@TypeOf(Element.before) != CallbackType) 
            @compileLog(
              "Expected Element.before to be a callback but received " ++ @typeName(@TypeOf(Element.before))
            );
            if (@TypeOf(Element.getCanHaveContent) != GetterType)
              @compileLog(
                "Expected Element.getCanHaveContent to be a getter"
                );

          if (@TypeOf(Element.getAttribute) != CallbackType) 
            @compileLog(
              "Expected Element.getAttribute to be a callback but received " ++ @typeName(@TypeOf(Element.getAttribute))
            );
          if (@TypeOf(Element.hasAttribute) != CallbackType) 
            @compileLog(
              "Expected Element.hasAttribute to be a callback but received " ++ @typeName(@TypeOf(Element.hasAttribute))
            );
            if (@TypeOf(Element.getNamespaceURI) != GetterType)
              @compileLog(
                "Expected Element.getNamespaceURI to be a getter"
                );

          if (@TypeOf(Element.onEndTag) != CallbackType) 
            @compileLog(
              "Expected Element.onEndTag to be a callback but received " ++ @typeName(@TypeOf(Element.onEndTag))
            );
          if (@TypeOf(Element.prepend) != CallbackType) 
            @compileLog(
              "Expected Element.prepend to be a callback but received " ++ @typeName(@TypeOf(Element.prepend))
            );
          if (@TypeOf(Element.remove) != CallbackType) 
            @compileLog(
              "Expected Element.remove to be a callback but received " ++ @typeName(@TypeOf(Element.remove))
            );
          if (@TypeOf(Element.removeAndKeepContent) != CallbackType) 
            @compileLog(
              "Expected Element.removeAndKeepContent to be a callback but received " ++ @typeName(@TypeOf(Element.removeAndKeepContent))
            );
          if (@TypeOf(Element.removeAttribute) != CallbackType) 
            @compileLog(
              "Expected Element.removeAttribute to be a callback but received " ++ @typeName(@TypeOf(Element.removeAttribute))
            );
            if (@TypeOf(Element.getRemoved) != GetterType)
              @compileLog(
                "Expected Element.getRemoved to be a getter"
                );

          if (@TypeOf(Element.replace) != CallbackType) 
            @compileLog(
              "Expected Element.replace to be a callback but received " ++ @typeName(@TypeOf(Element.replace))
            );
            if (@TypeOf(Element.getSelfClosing) != GetterType)
              @compileLog(
                "Expected Element.getSelfClosing to be a getter"
                );

          if (@TypeOf(Element.setAttribute) != CallbackType) 
            @compileLog(
              "Expected Element.setAttribute to be a callback but received " ++ @typeName(@TypeOf(Element.setAttribute))
            );
          if (@TypeOf(Element.setInnerContent) != CallbackType) 
            @compileLog(
              "Expected Element.setInnerContent to be a callback but received " ++ @typeName(@TypeOf(Element.setInnerContent))
            );
            if (@TypeOf(Element.getTagName) != GetterType)
              @compileLog(
                "Expected Element.getTagName to be a getter"
                );

            if (@TypeOf(Element.setTagName) != SetterType)
              @compileLog(
                "Expected Element.setTagName to be a setter"
              );
        if (!JSC.is_bindgen) {
    ...
    comptime {
        ...
        if (@TypeOf(EndTag.finalize) != (fn(*EndTag) callconv(.C) void)) {
          ...
          if (@TypeOf(EndTag.after) != CallbackType) 
            @compileLog(
              "Expected EndTag.after to be a callback but received " ++ @typeName(@TypeOf(EndTag.after))
            );
          if (@TypeOf(EndTag.before) != CallbackType) 
            @compileLog(
              "Expected EndTag.before to be a callback but received " ++ @typeName(@TypeOf(EndTag.before))
            );
            if (@TypeOf(EndTag.getName) != GetterType)
              @compileLog(
                "Expected EndTag.getName to be a getter"
                );

            if (@TypeOf(EndTag.setName) != SetterType)
              @compileLog(
                "Expected EndTag.setName to be a setter"
              );
          if (@TypeOf(EndTag.remove) != CallbackType) 
            @compileLog(
              "Expected EndTag.remove to be a callback but received " ++ @typeName(@TypeOf(EndTag.remove))
            );
        if (!JSC.is_bindgen) {
    ...
    comptime {
        ...
        if (@TypeOf(Expect.finalize) != (fn(*Expect) callconv(.C) void)) {
          ...
          if (@TypeOf(Expect.fail) != CallbackType) 
            @compileLog(
              "Expected Expect.fail to be a callback but received " ++ @typeName(@TypeOf(Expect.fail))
            );
          ...
          if (@TypeOf(Expect._pass) != CallbackType) 
            @compileLog(
              "Expected Expect._pass to be a callback but received " ++ @typeName(@TypeOf(Expect._pass))
            );
          ...
          if (@TypeOf(Expect.toBeArray) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeArray to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeArray))
            );
          if (@TypeOf(Expect.toBeArrayOfSize) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeArrayOfSize to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeArrayOfSize))
            );
          if (@TypeOf(Expect.toBeBoolean) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeBoolean to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeBoolean))
            );
          ...
          if (@TypeOf(Expect.toBeDate) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeDate to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeDate))
            );
          ...
          if (@TypeOf(Expect.toBeEmpty) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeEmpty to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeEmpty))
            );
          if (@TypeOf(Expect.toBeEven) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeEven to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeEven))
            );
          if (@TypeOf(Expect.toBeFalse) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeFalse to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeFalse))
            );
          ...
          if (@TypeOf(Expect.toBeFinite) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeFinite to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeFinite))
            );
          if (@TypeOf(Expect.toBeFunction) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeFunction to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeFunction))
            );
          ...
          if (@TypeOf(Expect.toBeInteger) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeInteger to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeInteger))
            );
          ...
          if (@TypeOf(Expect.toBeNegative) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeNegative to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeNegative))
            );
          if (@TypeOf(Expect.toBeNil) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeNil to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeNil))
            );
          ...
          if (@TypeOf(Expect.toBeNumber) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeNumber to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeNumber))
            );
          if (@TypeOf(Expect.toBeOdd) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeOdd to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeOdd))
            );
          if (@TypeOf(Expect.toBePositive) != CallbackType) 
            @compileLog(
              "Expected Expect.toBePositive to be a callback but received " ++ @typeName(@TypeOf(Expect.toBePositive))
            );
          if (@TypeOf(Expect.toBeString) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeString to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeString))
            );
          if (@TypeOf(Expect.toBeSymbol) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeSymbol to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeSymbol))
            );
          if (@TypeOf(Expect.toBeTrue) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeTrue to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeTrue))
            );
          ...
          if (@TypeOf(Expect.toBeTypeOf) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeTypeOf to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeTypeOf))
            );
          ...
          if (@TypeOf(Expect.toBeWithin) != CallbackType) 
            @compileLog(
              "Expected Expect.toBeWithin to be a callback but received " ++ @typeName(@TypeOf(Expect.toBeWithin))
            );
          ...
          if (@TypeOf(Expect.toEndWith) != CallbackType) 
            @compileLog(
              "Expected Expect.toEndWith to be a callback but received " ++ @typeName(@TypeOf(Expect.toEndWith))
            );
          ...
          if (@TypeOf(Expect.toEqualIgnoringWhitespace) != CallbackType) 
            @compileLog(
              "Expected Expect.toEqualIgnoringWhitespace to be a callback but received " ++ @typeName(@TypeOf(Expect.toEqualIgnoringWhitespace))
            );
          if (@TypeOf(Expect.toHaveBeenCalled) != CallbackType) 
            @compileLog(
              "Expected Expect.toHaveBeenCalled to be a callback but received " ++ @typeName(@TypeOf(Expect.toHaveBeenCalled))
            );
          ...
          if (@TypeOf(Expect.toInclude) != CallbackType) 
            @compileLog(
              "Expected Expect.toInclude to be a callback but received " ++ @typeName(@TypeOf(Expect.toInclude))
            );
          if (@TypeOf(Expect.toIncludeRepeated) != CallbackType) 
            @compileLog(
              "Expected Expect.toIncludeRepeated to be a callback but received " ++ @typeName(@TypeOf(Expect.toIncludeRepeated))
            );
          ...
          if (@TypeOf(Expect.toSatisfy) != CallbackType) 
            @compileLog(
              "Expected Expect.toSatisfy to be a callback but received " ++ @typeName(@TypeOf(Expect.toSatisfy))
            );
          if (@TypeOf(Expect.toStartWith) != CallbackType) 
            @compileLog(
              "Expected Expect.toStartWith to be a callback but received " ++ @typeName(@TypeOf(Expect.toStartWith))
            );
...
pub const JSExpectAnything = struct {
    ...
    comptime {
      ...
      @compileLog(
        "Expected ExpectAnything.call to be a static callback"
      );
        if (!JSC.is_bindgen) {
...
pub const JSExpectArrayContaining = struct {
    ...
    comptime {
      ...
      @compileLog(
        "Expected ExpectArrayContaining.call to be a static callback"
      );
        if (!JSC.is_bindgen) {
...
pub const JSExpectStringContaining = struct {
    ...
    comptime {
      ...
      @compileLog(
        "Expected ExpectStringContaining.call to be a static callback"
      );
        if (!JSC.is_bindgen) {
...
pub const JSExpectStringMatching = struct {
    ...
    comptime {
      ...
      @compileLog(
        "Expected ExpectStringMatching.call to be a static callback"
      );
        if (!JSC.is_bindgen) {
    ...
    comptime {
        ...
        if (@TypeOf(FFI.finalize) != (fn(*FFI) callconv(.C) void)) {
          ...
          if (@TypeOf(FFI.close) != CallbackType) 
            @compileLog(
              "Expected FFI.close to be a callback but received " ++ @typeName(@TypeOf(FFI.close))
            );
            if (@TypeOf(FFI.getSymbols) != GetterType)
              @compileLog(
                "Expected FFI.getSymbols to be a getter"
                );
    ...
    comptime {
        ...
        if (@TypeOf(FSWatcher.finalize) != (fn(*FSWatcher) callconv(.C) void)) {
          ...
          if (@TypeOf(FSWatcher.doClose) != CallbackType) 
            @compileLog(
              "Expected FSWatcher.doClose to be a callback but received " ++ @typeName(@TypeOf(FSWatcher.doClose))
            );
          if (@TypeOf(FSWatcher.hasRef) != CallbackType) 
            @compileLog(
              "Expected FSWatcher.hasRef to be a callback but received " ++ @typeName(@TypeOf(FSWatcher.hasRef))
            );
          if (@TypeOf(FSWatcher.doRef) != CallbackType) 
            @compileLog(
              "Expected FSWatcher.doRef to be a callback but received " ++ @typeName(@TypeOf(FSWatcher.doRef))
            );
          if (@TypeOf(FSWatcher.doUnref) != CallbackType) 
            @compileLog(
              "Expected FSWatcher.doUnref to be a callback but received " ++ @typeName(@TypeOf(FSWatcher.doUnref))
            );
        if (!JSC.is_bindgen) {
    ...
    comptime {
        ...
        if (@TypeOf(HTMLRewriter.finalize) != (fn(*HTMLRewriter) callconv(.C) void)) {
          ...
          if (@TypeOf(HTMLRewriter.on) != CallbackType) 
            @compileLog(
              "Expected HTMLRewriter.on to be a callback but received " ++ @typeName(@TypeOf(HTMLRewriter.on))
            );
          if (@TypeOf(HTMLRewriter.onDocument) != CallbackType) 
            @compileLog(
              "Expected HTMLRewriter.onDocument to be a callback but received " ++ @typeName(@TypeOf(HTMLRewriter.onDocument))
            );
          if (@TypeOf(HTMLRewriter.transform) != CallbackType) 
            @compileLog(
              "Expected HTMLRewriter.transform to be a callback but received " ++ @typeName(@TypeOf(HTMLRewriter.transform))
            );
        if (!JSC.is_bindgen) {
        ...
        if (@TypeOf(HTTPSServer.finalize) != (fn(*HTTPSServer) callconv(.C) void)) {
           @compileLog("HTTPSServer.finalize is not a finalizer");
            ...
            if (@TypeOf(HTTPSServer.getAddress) != GetterType)
              @compileLog(
                "Expected HTTPSServer.getAddress to be a getter"
                );

            if (@TypeOf(HTTPSServer.getDevelopment) != GetterType)
              @compileLog(
                "Expected HTTPSServer.getDevelopment to be a getter"
                );

          if (@TypeOf(HTTPSServer.doFetch) != CallbackType) 
            @compileLog(
              "Expected HTTPSServer.doFetch to be a callback but received " ++ @typeName(@TypeOf(HTTPSServer.doFetch))
            );
            if (@TypeOf(HTTPSServer.getHostname) != GetterType)
              @compileLog(
                "Expected HTTPSServer.getHostname to be a getter"
                );

            if (@TypeOf(HTTPSServer.getId) != GetterType)
              @compileLog(
                "Expected HTTPSServer.getId to be a getter"
                );

            if (@TypeOf(HTTPSServer.getPendingRequests) != GetterType)
              @compileLog(
                "Expected HTTPSServer.getPendingRequests to be a getter"
                );

            if (@TypeOf(HTTPSServer.getPendingWebSockets) != GetterType)
              @compileLog(
                "Expected HTTPSServer.getPendingWebSockets to be a getter"
                );

            if (@TypeOf(HTTPSServer.getPort) != GetterType)
              @compileLog(
                "Expected HTTPSServer.getPort to be a getter"
                );

            if (@TypeOf(HTTPSServer.getProtocol) != GetterType)
              @compileLog(
                "Expected HTTPSServer.getProtocol to be a getter"
                );

          if (@TypeOf(HTTPSServer.doPublish) != CallbackType) 
            @compileLog(
              "Expected HTTPSServer.doPublish to be a callback but received " ++ @typeName(@TypeOf(HTTPSServer.doPublish))
            );
          if (@TypeOf(HTTPSServer.doReload) != CallbackType) 
            @compileLog(
              "Expected HTTPSServer.doReload to be a callback but received " ++ @typeName(@TypeOf(HTTPSServer.doReload))
            );
          if (@TypeOf(HTTPSServer.doRequestIP) != CallbackType) 
            @compileLog(
              "Expected HTTPSServer.doRequestIP to be a callback but received " ++ @typeName(@TypeOf(HTTPSServer.doRequestIP))
            );
          if (@TypeOf(HTTPSServer.doStop) != CallbackType) 
            @compileLog(
              "Expected HTTPSServer.doStop to be a callback but received " ++ @typeName(@TypeOf(HTTPSServer.doStop))
            );
          if (@TypeOf(HTTPSServer.doUpgrade) != CallbackType) 
            @compileLog(
              "Expected HTTPSServer.doUpgrade to be a callback but received " ++ @typeName(@TypeOf(HTTPSServer.doUpgrade))
            );
        if (!JSC.is_bindgen) {
        ...
        if (@TypeOf(HTTPServer.finalize) != (fn(*HTTPServer) callconv(.C) void)) {
           @compileLog("HTTPServer.finalize is not a finalizer");
            ...
            if (@TypeOf(HTTPServer.getAddress) != GetterType)
              @compileLog(
                "Expected HTTPServer.getAddress to be a getter"
                );

            if (@TypeOf(HTTPServer.getDevelopment) != GetterType)
              @compileLog(
                "Expected HTTPServer.getDevelopment to be a getter"
                );

          if (@TypeOf(HTTPServer.doFetch) != CallbackType) 
            @compileLog(
              "Expected HTTPServer.doFetch to be a callback but received " ++ @typeName(@TypeOf(HTTPServer.doFetch))
            );
            if (@TypeOf(HTTPServer.getHostname) != GetterType)
              @compileLog(
                "Expected HTTPServer.getHostname to be a getter"
                );

            if (@TypeOf(HTTPServer.getId) != GetterType)
              @compileLog(
                "Expected HTTPServer.getId to be a getter"
                );

            if (@TypeOf(HTTPServer.getPendingRequests) != GetterType)
              @compileLog(
                "Expected HTTPServer.getPendingRequests to be a getter"
                );

            if (@TypeOf(HTTPServer.getPendingWebSockets) != GetterType)
              @compileLog(
                "Expected HTTPServer.getPendingWebSockets to be a getter"
                );

            if (@TypeOf(HTTPServer.getPort) != GetterType)
              @compileLog(
                "Expected HTTPServer.getPort to be a getter"
                );

            if (@TypeOf(HTTPServer.getProtocol) != GetterType)
              @compileLog(
                "Expected HTTPServer.getProtocol to be a getter"
                );

          if (@TypeOf(HTTPServer.doPublish) != CallbackType) 
            @compileLog(
              "Expected HTTPServer.doPublish to be a callback but received " ++ @typeName(@TypeOf(HTTPServer.doPublish))
            );
          if (@TypeOf(HTTPServer.doReload) != CallbackType) 
            @compileLog(
              "Expected HTTPServer.doReload to be a callback but received " ++ @typeName(@TypeOf(HTTPServer.doReload))
            );
          if (@TypeOf(HTTPServer.doRequestIP) != CallbackType) 
            @compileLog(
              "Expected HTTPServer.doRequestIP to be a callback but received " ++ @typeName(@TypeOf(HTTPServer.doRequestIP))
            );
          if (@TypeOf(HTTPServer.doStop) != CallbackType) 
            @compileLog(
              "Expected HTTPServer.doStop to be a callback but received " ++ @typeName(@TypeOf(HTTPServer.doStop))
            );
          if (@TypeOf(HTTPServer.doUpgrade) != CallbackType) 
            @compileLog(
              "Expected HTTPServer.doUpgrade to be a callback but received " ++ @typeName(@TypeOf(HTTPServer.doUpgrade))
            );
        if (!JSC.is_bindgen) {
    ...
    comptime {
        ...
        if (@TypeOf(NodeJSFS.constructor) != (fn(*JSC.JSGlobalObject, *JSC.CallFrame) callconv(.C) ?*NodeJSFS)) {
          ...
          if (@TypeOf(NodeJSFS.cp) != CallbackType) 
            @compileLog(
              "Expected NodeJSFS.cp to be a callback but received " ++ @typeName(@TypeOf(NodeJSFS.cp))
            );
          if (@TypeOf(NodeJSFS.cpSync) != CallbackType) 
            @compileLog(
              "Expected NodeJSFS.cpSync to be a callback but received " ++ @typeName(@TypeOf(NodeJSFS.cpSync))
            );
          ...
          if (@TypeOf(NodeJSFS.unwatchFile) != CallbackType) 
            @compileLog(
              "Expected NodeJSFS.unwatchFile to be a callback but received " ++ @typeName(@TypeOf(NodeJSFS.unwatchFile))
            );
          ...
          if (@TypeOf(NodeJSFS.watch) != CallbackType) 
            @compileLog(
              "Expected NodeJSFS.watch to be a callback but received " ++ @typeName(@TypeOf(NodeJSFS.watch))
            );
          if (@TypeOf(NodeJSFS.watchFile) != CallbackType) 
            @compileLog(
              "Expected NodeJSFS.watchFile to be a callback but received " ++ @typeName(@TypeOf(NodeJSFS.watchFile))
            );
    ...
    comptime {
        ...
        if (@TypeOf(ResolveMessage.finalize) != (fn(*ResolveMessage) callconv(.C) void)) {
          ...
          if (@TypeOf(ResolveMessage.toPrimitive) != CallbackType) 
            @compileLog(
              "Expected ResolveMessage.toPrimitive to be a callback but received " ++ @typeName(@TypeOf(ResolveMessage.toPrimitive))
            );
            if (@TypeOf(ResolveMessage.getCode) != GetterType)
              @compileLog(
                "Expected ResolveMessage.getCode to be a getter"
                );

            if (@TypeOf(ResolveMessage.getImportKind) != GetterType)
              @compileLog(
                "Expected ResolveMessage.getImportKind to be a getter"
                );

            if (@TypeOf(ResolveMessage.getLevel) != GetterType)
              @compileLog(
                "Expected ResolveMessage.getLevel to be a getter"
                );

            if (@TypeOf(ResolveMessage.getMessage) != GetterType)
              @compileLog(
                "Expected ResolveMessage.getMessage to be a getter"
                );

            if (@TypeOf(ResolveMessage.getPosition) != GetterType)
              @compileLog(
                "Expected ResolveMessage.getPosition to be a getter"
                );

            if (@TypeOf(ResolveMessage.getReferrer) != GetterType)
              @compileLog(
                "Expected ResolveMessage.getReferrer to be a getter"
                );

            if (@TypeOf(ResolveMessage.getSpecifier) != GetterType)
              @compileLog(
                "Expected ResolveMessage.getSpecifier to be a getter"
                );

          if (@TypeOf(ResolveMessage.toJSON) != CallbackType) 
            @compileLog(
              "Expected ResolveMessage.toJSON to be a callback but received " ++ @typeName(@TypeOf(ResolveMessage.toJSON))
            );
          if (@TypeOf(ResolveMessage.toString) != CallbackType) 
            @compileLog(
              "Expected ResolveMessage.toString to be a callback but received " ++ @typeName(@TypeOf(ResolveMessage.toString))
            );
        if (!JSC.is_bindgen) {
    ...
    comptime {
        ...
        if (@TypeOf(ServerWebSocket.finalize) != (fn(*ServerWebSocket) callconv(.C) void)) {
          ...
          if (@TypeOf(ServerWebSocket.ping) != CallbackType) 
            @compileLog(
              "Expected ServerWebSocket.ping to be a callback but received " ++ @typeName(@TypeOf(ServerWebSocket.ping))
            );
          if (@TypeOf(ServerWebSocket.pong) != CallbackType) 
            @compileLog(
              "Expected ServerWebSocket.pong to be a callback but received " ++ @typeName(@TypeOf(ServerWebSocket.pong))
            );
          ...
          if (@TypeOf(ServerWebSocket.terminate) != CallbackType) 
            @compileLog(
              "Expected ServerWebSocket.terminate to be a callback but received " ++ @typeName(@TypeOf(ServerWebSocket.terminate))
            );
    ...
    comptime {
        ...
        if (@TypeOf(StatWatcher.finalize) != (fn(*StatWatcher) callconv(.C) void)) {
          ...
          if (@TypeOf(StatWatcher.doClose) != CallbackType) 
            @compileLog(
              "Expected StatWatcher.doClose to be a callback but received " ++ @typeName(@TypeOf(StatWatcher.doClose))
            );
          if (@TypeOf(StatWatcher.doRef) != CallbackType) 
            @compileLog(
              "Expected StatWatcher.doRef to be a callback but received " ++ @typeName(@TypeOf(StatWatcher.doRef))
            );
          if (@TypeOf(StatWatcher.doUnref) != CallbackType) 
            @compileLog(
              "Expected StatWatcher.doUnref to be a callback but received " ++ @typeName(@TypeOf(StatWatcher.doUnref))
            );
        if (!JSC.is_bindgen) {
    ...
    comptime {
        ...
        if (@TypeOf(Subprocess.finalize) != (fn(*Subprocess) callconv(.C) void)) {
          ...
          if (@TypeOf(Subprocess.doSend) != CallbackType) 
            @compileLog(
              "Expected Subprocess.doSend to be a callback but received " ++ @typeName(@TypeOf(Subprocess.doSend))
            );
        ...
        if (@TypeOf(TCPSocket.finalize) != (fn(*TCPSocket) callconv(.C) void)) {
           @compileLog("TCPSocket.finalize is not a finalizer");
            ...
            if (@TypeOf(TCPSocket.getALPNProtocol) != GetterType)
              @compileLog(
                "Expected TCPSocket.getALPNProtocol to be a getter"
                );
          ...
          if (@TypeOf(TCPSocket.exportKeyingMaterial) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.exportKeyingMaterial to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.exportKeyingMaterial))
            );
          ...
          if (@TypeOf(TCPSocket.getCertificate) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.getCertificate to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.getCertificate))
            );
          if (@TypeOf(TCPSocket.getCipher) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.getCipher to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.getCipher))
            );
          if (@TypeOf(TCPSocket.getEphemeralKeyInfo) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.getEphemeralKeyInfo to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.getEphemeralKeyInfo))
            );
          if (@TypeOf(TCPSocket.getPeerCertificate) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.getPeerCertificate to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.getPeerCertificate))
            );
          if (@TypeOf(TCPSocket.getSession) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.getSession to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.getSession))
            );
          if (@TypeOf(TCPSocket.getSharedSigalgs) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.getSharedSigalgs to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.getSharedSigalgs))
            );
          if (@TypeOf(TCPSocket.getTLSFinishedMessage) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.getTLSFinishedMessage to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.getTLSFinishedMessage))
            );
          if (@TypeOf(TCPSocket.getTLSPeerFinishedMessage) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.getTLSPeerFinishedMessage to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.getTLSPeerFinishedMessage))
            );
          if (@TypeOf(TCPSocket.getTLSTicket) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.getTLSTicket to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.getTLSTicket))
            );
          if (@TypeOf(TCPSocket.getTLSVersion) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.getTLSVersion to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.getTLSVersion))
            );
          ...
          if (@TypeOf(TCPSocket.setMaxSendFragment) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.setMaxSendFragment to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.setMaxSendFragment))
            );
          if (@TypeOf(TCPSocket.setServername) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.setServername to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.setServername))
            );
          if (@TypeOf(TCPSocket.setSession) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.setSession to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.setSession))
            );
          ...
          if (@TypeOf(TCPSocket.upgradeTLS) != CallbackType) 
            @compileLog(
              "Expected TCPSocket.upgradeTLS to be a callback but received " ++ @typeName(@TypeOf(TCPSocket.upgradeTLS))
            );
        ...
        if (@TypeOf(TLSSocket.finalize) != (fn(*TLSSocket) callconv(.C) void)) {
           @compileLog("TLSSocket.finalize is not a finalizer");
            ...
            if (@TypeOf(TLSSocket.getALPNProtocol) != GetterType)
              @compileLog(
                "Expected TLSSocket.getALPNProtocol to be a getter"
                );
          ...
          if (@TypeOf(TLSSocket.exportKeyingMaterial) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.exportKeyingMaterial to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.exportKeyingMaterial))
            );
          ...
          if (@TypeOf(TLSSocket.getCertificate) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.getCertificate to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.getCertificate))
            );
          if (@TypeOf(TLSSocket.getCipher) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.getCipher to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.getCipher))
            );
          if (@TypeOf(TLSSocket.getEphemeralKeyInfo) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.getEphemeralKeyInfo to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.getEphemeralKeyInfo))
            );
          if (@TypeOf(TLSSocket.getPeerCertificate) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.getPeerCertificate to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.getPeerCertificate))
            );
          if (@TypeOf(TLSSocket.getSession) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.getSession to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.getSession))
            );
          if (@TypeOf(TLSSocket.getSharedSigalgs) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.getSharedSigalgs to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.getSharedSigalgs))
            );
          if (@TypeOf(TLSSocket.getTLSFinishedMessage) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.getTLSFinishedMessage to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.getTLSFinishedMessage))
            );
          if (@TypeOf(TLSSocket.getTLSPeerFinishedMessage) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.getTLSPeerFinishedMessage to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.getTLSPeerFinishedMessage))
            );
          if (@TypeOf(TLSSocket.getTLSTicket) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.getTLSTicket to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.getTLSTicket))
            );
          if (@TypeOf(TLSSocket.getTLSVersion) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.getTLSVersion to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.getTLSVersion))
            );
          ...
          if (@TypeOf(TLSSocket.setMaxSendFragment) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.setMaxSendFragment to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.setMaxSendFragment))
            );
          if (@TypeOf(TLSSocket.setServername) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.setServername to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.setServername))
            );
          if (@TypeOf(TLSSocket.setSession) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.setSession to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.setSession))
            );
          ...
          if (@TypeOf(TLSSocket.upgradeTLS) != CallbackType) 
            @compileLog(
              "Expected TLSSocket.upgradeTLS to be a callback but received " ++ @typeName(@TypeOf(TLSSocket.upgradeTLS))
            );
    ...
    comptime {
        ...
        if (@TypeOf(TextChunk.finalize) != (fn(*TextChunk) callconv(.C) void)) {
          ...
          if (@TypeOf(TextChunk.after) != CallbackType) 
            @compileLog(
              "Expected TextChunk.after to be a callback but received " ++ @typeName(@TypeOf(TextChunk.after))
            );
          if (@TypeOf(TextChunk.before) != CallbackType) 
            @compileLog(
              "Expected TextChunk.before to be a callback but received " ++ @typeName(@TypeOf(TextChunk.before))
            );
            if (@TypeOf(TextChunk.lastInTextNode) != GetterType)
              @compileLog(
                "Expected TextChunk.lastInTextNode to be a getter"
                );

          if (@TypeOf(TextChunk.remove) != CallbackType) 
            @compileLog(
              "Expected TextChunk.remove to be a callback but received " ++ @typeName(@TypeOf(TextChunk.remove))
            );
            if (@TypeOf(TextChunk.removed) != GetterType)
              @compileLog(
                "Expected TextChunk.removed to be a getter"
                );

          if (@TypeOf(TextChunk.replace) != CallbackType) 
            @compileLog(
              "Expected TextChunk.replace to be a callback but received " ++ @typeName(@TypeOf(TextChunk.replace))
            );
            if (@TypeOf(TextChunk.getText) != GetterType)
              @compileLog(
                "Expected TextChunk.getText to be a getter"
                );
        ...
        if (@TypeOf(TextDecoder.finalize) != (fn(*TextDecoder) callconv(.C) void)) {
          ...
          if (@TypeOf(TextDecoder.decode) != CallbackType) 
            ...
            if (@TypeOf(TextDecoder.getIgnoreBOM) != GetterType)
              @compileLog(
                "Expected TextDecoder.getIgnoreBOM to be a getter"
                );
    ...
    comptime {
        ...
        if (@TypeOf(Timeout.finalize) != (fn(*Timeout) callconv(.C) void)) {
          ...
          if (@TypeOf(Timeout.doRefresh) != CallbackType) 
            @compileLog(
              "Expected Timeout.doRefresh to be a callback but received " ++ @typeName(@TypeOf(Timeout.doRefresh))
            );
