(function (){"use strict";// build2/tmp/node/dns.ts
...
var resolveSrv = function(hostname, callback) {
  if (typeof callback != "function") {
    @throwTypeError("callback must be a function");
  }
...
var resolveTxt = function(hostname, callback) {
  if (typeof callback != "function") {
    @throwTypeError("callback must be a function");
  }
...
var resolveSoa = function(hostname, callback) {
  if (typeof callback != "function") {
    @throwTypeError("callback must be a function");
  }
...
var resolveNaptr = function(hostname, callback) {
  if (typeof callback != "function") {
    @throwTypeError("callback must be a function");
  }
...
var resolveMx = function(hostname, callback) {
  if (typeof callback != "function") {
    @throwTypeError("callback must be a function");
  }
...
var resolveCaa = function(hostname, callback) {
  if (typeof callback != "function") {
    @throwTypeError("callback must be a function");
  }
...
var resolveNs = function(hostname, callback) {
  if (typeof callback != "function") {
    @throwTypeError("callback must be a function");
  }
...
var resolvePtr = function(hostname, callback) {
  if (typeof callback != "function") {
    @throwTypeError("callback must be a function");
  }
...
var resolveCname = function(hostname, callback) {
  if (typeof callback != "function") {
    @throwTypeError("callback must be a function");
  }
...
var lookupService = function(address, port, callback) {
  if (typeof callback != "function") {
    @throwTypeError("callback must be a function");
  }
...
var resolve = function(hostname, rrtype, callback) {
...
var setDefaultResultOrder = function() {
};
var setServers = function() {
};
var $;
var dns = Bun.dns;
var InternalResolver = class Resolver2 {
  constructor(options) {
  }
  cancel() {
  }
...
var promisifyLookup = (res) => {
  res.sort((a, b) => a.family - b.family);
  const [{ address, family }] = res;
  return { address, family };
};
var mapLookupAll = (res) => {
  const { address, family } = res;
  return { address, family };
};
var promisifyLookupAll = (res) => {
  res.sort((a, b) => a.family - b.family);
  return res.map(mapLookupAll);
};
var mapResolveX = (a) => a.address;
var promisifyResolveX = (res) => {
