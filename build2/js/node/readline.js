(function (){"use strict";// build2/tmp/node/readline.ts
...
var { StringDecoder } = @requireNativeModule("string_decoder");
var isWritable;
var { inspect } = Bun;
...
var _Interface = class Interface2 extends InterfaceConstructor {
  ...
  [kTabCompleter](lastKeypressWasTab, { 0: completions, 1: completeOn }) {
    ...
    var width = MathMax.@apply(completionsWidth) + 2;
...
class Readline {
  ...
  constructor(stream, options = @undefined) {
    isWritable ??= (@getInternalField(@internalModuleRegistry, 39) || @createInternalModuleById(39)).isWritable;
