(function (){"use strict";// build2/tmp/node/wasi.ts
var nodeFsConstants = @processBindingConstants.fs;
...
var require_types = __commonJS({
  "node_modules/wasi-js/dist/types.js"(exports) {
    ...
    exports.WASIKillError = exports.WASIExitError = exports.WASIError = undefined;
...
var require_wasi = __commonJS({
  "node_modules/wasi-js/dist/wasi.js"(exports) {
    ...
    let fs;
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.SOCKET_DEFAULT_RIGHTS = undefined;
    var log = () => {
    };
    var logOpen = () => {
    };
    ...
    var WASI = class WASI2 {
      constructor(wasiConfig = {}) {
        ...
        this.lastStdin = 0;
        this.sleep = wasiConfig.sleep || defaultConfig2.sleep;
        ...
        this.view = undefined;
        this.bindings = wasiConfig.bindings || defaultConfig2.bindings;
        ...
        this.wasiImport = {
            ...
            outer:
              for (const iov of getiovs(iovs, iovsLen)) {
                ...
                while (r < iov.byteLength) {
                  ...
                  let position = IS_STDIN || stats.offset === undefined ? null : Number(stats.offset);
                  let rr = 0;
                  if (IS_STDIN) {
          ...
          path_open: wrap((dirfd, _dirflags, pathPtr, pathLen, oflags, fsRightsBase, fsRightsInheriting, fsFlags, fdPtr) => {
            try {
              ...
              const read = (fsRightsBase & (constants_1.WASI_RIGHT_FD_READ | constants_1.WASI_RIGHT_FD_READDIR)) !== BigInt(0);
              const write = (fsRightsBase & (constants_1.WASI_RIGHT_FD_DATASYNC | constants_1.WASI_RIGHT_FD_WRITE | constants_1.WASI_RIGHT_FD_ALLOCATE | constants_1.WASI_RIGHT_FD_FILESTAT_SET_SIZE)) !== BigInt(0);
              let noflags;
              if (write && read) {
          ...
          proc_raise: (sig) => {
            ...
            bindings2.kill(constants_1.SIGNAL_MAP[sig]);
            return constants_1.WASI_ESUCCESS;
          },
