...
$$capture_start$$(function(bytesWritten) {  if (!__intrinsic__isReadableStreamBYOBRequest(this)) throw __intrinsic__makeThisTypeError("ReadableStreamBYOBRequest", "respond");
