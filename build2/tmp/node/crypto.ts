...
// Sourced from src/js/node/crypto.js
...
const BufferModule = (__intrinsic__requireNativeModule("buffer"));
...
const { isAnyArrayBuffer, isArrayBufferView } = (__intrinsic__requireNativeModule("util/types"));
...
function getArrayBufferOrView(buffer, name, encoding) {
  if (buffer instanceof KeyObject) {
    if (buffer.type !== "secret") {
      const error = __intrinsic__makeTypeError(
  ...
  if (!isArrayBufferView(buffer)) {
    var error = __intrinsic__makeTypeError(
...
var require_safe_buffer = __commonJS({
  "node_modules/safe-buffer/index.js"(exports, module) {
    ...
    SafeBuffer.from = function (arg, encodingOrOffset, length) {
      if (typeof arg == "number") __intrinsic__throwTypeError("Argument must not be a number");
      return Buffer2(arg, encodingOrOffset, length);
    };
    SafeBuffer.alloc = function (size, fill, encoding) {
      if (typeof size != "number") __intrinsic__throwTypeError("Argument must be a number");
...
Use Chrome, Firefox or Internet Explorer 11`);
    ...
    function randomBytes(size, cb) {
      if (size > MAX_UINT32) __intrinsic__throwRangeError("requested too many random bytes");
  ...
  "node_modules/hash-base/index.js"(exports, module) {
    ...
    function throwIfNotStringOrBuffer(val, prefix) {
      if (!Buffer2.isBuffer(val) && typeof val != "string")
        __intrinsic__throwTypeError(prefix + " must be a string or a buffer");
    }
    function HashBase(blockSize) {
      StreamModule.Transform.__intrinsic__call(this),
...
var require_md5 = __commonJS({
  "node_modules/md5.js/index.js"(exports, module) {
    ...
    function MD5() {
      HashBase.__intrinsic__call(this, 64),
        (this._a = 1732584193),
        (this._b = 4023233417),
        (this._c = 2562383102),
        (this._d = 271733878);
...
var require_sha = __commonJS({
  "node_modules/sha.js/sha.js"(exports, module) {
    var inherits = require_inherits_browser(),
      ...
      W = new Array(80);
    function Sha() {
      this.init(), (this._w = W), Hash.__intrinsic__call(this, 64, 56);
    }
    inherits(Sha, Hash);
...
var require_sha512 = __commonJS({
  "node_modules/sha.js/sha512.js"(exports, module) {
    var inherits = require_inherits_browser(),
      ...
      W = new Array(160);
    function Sha512() {
      this.init(), (this._w = W), Hash.__intrinsic__call(this, 128, 112);
    }
    ...
    for (const method of triggerMethods) {
      Object.defineProperty(LazyHash.prototype, method, {
        get() {
          ...
          StreamModule.Transform.__intrinsic__call(this, this._options);
          return this[method];
        },
        enumerable: false,
        configurable: true,
...
var require_legacy = __commonJS({
  "node_modules/create-hmac/legacy.js"(exports, module) {
    ...
    function Hmac(alg, key) {
      ...
      Base.__intrinsic__call(this, "digest"),
...
var require_browser3 = __commonJS({
  "node_modules/create-hmac/browser.js"(exports, module) {
    ...
    function Hmac(alg, key) {
      ...
      Base.__intrinsic__call(this, "digest"), typeof key == "string" && (key = Buffer2.from(key));
...
var require_precondition = __commonJS({
  "node_modules/pbkdf2/lib/precondition.js"(exports, module) {
    ...
    module.exports = function (iterations, keylen) {
      if (typeof iterations != "number") __intrinsic__throwTypeError("Iterations not a number");
      if (iterations < 0) __intrinsic__throwTypeError("Bad iterations");
      if (typeof keylen != "number") __intrinsic__throwTypeError("Key length not a number");
      if (keylen < 0 || keylen > MAX_ALLOC || keylen !== keylen) __intrinsic__throwTypeError("Bad key length");
    };
  },
});
...
var require_to_buffer = __commonJS({
  "node_modules/pbkdf2/lib/to-buffer.js"(exports, module) {
    ...
    module.exports = function (thing, encoding, name) {
      ...
      __intrinsic__throwTypeError(name + " must be a string, a Buffer, a typed array or a DataView");
    };
  },
});
...
var require_des = __commonJS({
  "node_modules/des.js/lib/des/des.js"(exports, module) {
    ...
    function DES(options) {
      Cipher.__intrinsic__call(this, options);
  ...
  "node_modules/des.js/lib/des/cbc.js"(exports) {
    ...
    function instantiate(Base) {
      function CBC(options) {
        Base.__intrinsic__call(this, options), this._cbcInit();
      }
      inherits(CBC, Base);
    ...
    proto._update = function (inp, inOff, out, outOff) {
      ...
      if (this.type === "encrypt") {
        ...
        superProto._update.__intrinsic__call(this, iv, 0, out, outOff);
        for (var i = 0; i < this.blockSize; i++) iv[i] = out[outOff + i];
      } else {
        superProto._update.__intrinsic__call(this, inp, inOff, out, outOff);
...
var require_browserify_des = __commonJS({
  "node_modules/browserify-des/index.js"(exports, module) {
    ...
    function DES(opts) {
      CipherBase.__intrinsic__call(this);
...
var require_authCipher = __commonJS({
  "node_modules/browserify-aes/authCipher.js"(exports, module) {
    ...
    function StreamCipher(mode, key, iv, decrypt) {
      Transform.__intrinsic__call(this);
  ...
  "node_modules/evp_bytestokey/index.js"(exports, module) {
    ...
    function EVP_BytesToKey(password, salt, keyBits, ivLen) {
      if (
        ...
        __intrinsic__throwRangeError("salt should be Buffer with 8 byte length");
      for (
...
var require_encrypter = __commonJS({
  "node_modules/browserify-aes/encrypter.js"(exports) {
    ...
    function createCipheriv(suite, password, iv) {
      ...
      if (!config) __intrinsic__throwTypeError("invalid suite type");
...
var require_browser6 = __commonJS({
  "node_modules/browserify-cipher/browser.js"(exports) {
    ...
    function createCipher(suite, password) {
      ...
      else __intrinsic__throwTypeError("invalid suite type");
    ...
    function createCipheriv(suite, key, iv) {
      ...
      __intrinsic__throwTypeError("invalid suite type");
    }
...
var require_bn = __commonJS({
  "node_modules/diffie-hellman/node_modules/bn.js/lib/bn.js"(exports, module) {
    (function (module2, exports2) {
      ...
      function K256() {
        MPrime.__intrinsic__call(this, "k256", "ffffffff ffffffff ffffffff ffffffff ffffffff ffffffff fffffffe fffffc2f");
      }
      ...
      function P224() {
        MPrime.__intrinsic__call(this, "p224", "ffffffff ffffffff ffffffff ffffffff 00000000 00000000 00000001");
      }
      inherits(P224, MPrime);
      function P192() {
        MPrime.__intrinsic__call(this, "p192", "ffffffff ffffffff ffffffff fffffffe ffffffff ffffffff");
      }
      inherits(P192, MPrime);
      function P25519() {
        MPrime.__intrinsic__call(this, "25519", "7fffffffffffffff ffffffffffffffff ffffffffffffffff ffffffffffffffed");
      }
  ...
  "node_modules/elliptic/lib/elliptic/utils.js"(exports) {
    ...
    function cachedProperty(obj, name, computer) {
      ...
      obj.prototype[name] = function () {
        return this[key] !== void 0 ? this[key] : (this[key] = computer.__intrinsic__call(this));
      };
    }
...
var require_short = __commonJS({
  "node_modules/elliptic/lib/elliptic/curve/short.js"(exports, module) {
    ...
    function ShortCurve(conf) {
      Base.__intrinsic__call(this, "short", conf),
    ...
    function Point(curve, x, y, isRed) {
      Base.BasePoint.__intrinsic__call(this, curve, "affine"),
        x === null && y === null
    ...
    function JPoint(curve, x, y, z) {
      Base.BasePoint.__intrinsic__call(this, curve, "jacobian"),
...
var require_mont = __commonJS({
  "node_modules/elliptic/lib/elliptic/curve/mont.js"(exports, module) {
    ...
    function MontCurve(conf) {
      Base.__intrinsic__call(this, "mont", conf),
        (this.a = new BN(conf.a, 16).toRed(this.red)),
        (this.b = new BN(conf.b, 16).toRed(this.red)),
    ...
    function Point(curve, x, z) {
      Base.BasePoint.__intrinsic__call(this, curve, "projective"),
        x === null && z === null
  ...
  "node_modules/elliptic/lib/elliptic/curve/edwards.js"(exports, module) {
    ...
    function EdwardsCurve(conf) {
      (this.twisted = (conf.a | 0) !== 1),
        ...
        Base.__intrinsic__call(this, "edwards", conf),
...
var require__ = __commonJS({
  "node_modules/hash.js/lib/hash/sha/1.js"(exports, module) {
    ...
    function SHA1() {
      ...
      BlockHash.__intrinsic__call(this),
  ...
  "node_modules/elliptic/lib/elliptic/ec/index.js"(exports, module) {
    ...
    function EC(options) {
      ...
      typeof options == "string" &&
        (assert(Object.prototype.hasOwnProperty.__intrinsic__call(curves, options), "Unknown curve " + options),
    ...
    (!Safer.from || Safer.from === Uint8Array.from) &&
      (Safer.from = function (value, encodingOrOffset, length) {
        if (typeof value == "number")
          __intrinsic__throwTypeError('The "value" argument must not be of type number. Received type ' + typeof value);
    ...
    Safer.alloc ||
      (Safer.alloc = function (size, fill, encoding) {
        if (typeof size != "number")
          __intrinsic__throwTypeError('The "size" argument must be of type number. Received type ' + typeof size);
        if (size < 0 || size >= 2 * (1 << 30))
          __intrinsic__throwRangeError('The value "' + size + '" is invalid for option "size"');
        var buf = Buffer2(size);
        return (
          !fill || fill.length === 0
            ? buf.fill(0)
...
var require_buffer = __commonJS({
  "node_modules/asn1.js/lib/asn1/base/buffer.js"(exports) {
    ...
    function DecoderBuffer(base, options) {
      if ((Reporter.__intrinsic__call(this, options), !Buffer2.isBuffer(base))) {
    ...
    DecoderBuffer.prototype.save = function () {
      return {
        offset: this.offset,
        reporter: Reporter.prototype.save.__intrinsic__call(this),
      };
    };
    DecoderBuffer.prototype.restore = function (save) {
      ...
      return (
        ...
        Reporter.prototype.restore.__intrinsic__call(this, save.reporter),
        res
      );
    };
  ...
  "node_modules/asn1.js/lib/asn1/base/node.js"(exports, module) {
    ...
    Node.prototype._wrap = function () {
      ...
      methods.forEach(function (method) {
        this[method] = function () {
          ...
          return state.children.push(clone), clone[method].__intrinsic__apply(clone, arguments);
        };
      }, this);
    };
    ...
    tags.forEach(function (tag) {
      Node.prototype[tag] = function () {
        let state = this._baseState,
          args = Array.prototype.slice.__intrinsic__call(arguments);
...
var require_der2 = __commonJS({
  "node_modules/asn1.js/lib/asn1/encoders/der.js"(exports, module) {
    ...
    function DERNode(parent) {
      Node.__intrinsic__call(this, "der", parent);
    }
...
var require_pem = __commonJS({
  "node_modules/asn1.js/lib/asn1/encoders/pem.js"(exports, module) {
    ...
    function PEMEncoder(entity) {
      DEREncoder.__intrinsic__call(this, entity), (this.enc = "pem");
    }
    inherits(PEMEncoder, DEREncoder);
    module.exports = PEMEncoder;
    PEMEncoder.prototype.encode = function (data, options) {
      let p = DEREncoder.prototype.encode.__intrinsic__call(this, data).toString("base64"),
...
var require_pem2 = __commonJS({
  "node_modules/asn1.js/lib/asn1/decoders/pem.js"(exports, module) {
    ...
    function PEMDecoder(entity) {
      DERDecoder.__intrinsic__call(this, entity), (this.enc = "pem");
    }
    ...
    PEMDecoder.prototype.decode = function (data, options) {
      ...
      return DERDecoder.prototype.decode.__intrinsic__call(this, input, options);
    };
  },
});
    ...
    Entity.prototype._createNamed = function (Base) {
      ...
      return (
        ...
        (Generated.prototype._initNamed = function (entity, name2) {
          Base.__intrinsic__call(this, entity, name2);
        }),
        new Generated(this)
      );
    };
...
var require_browser8 = __commonJS({
  "node_modules/browserify-sign/browser/index.js"(exports, module) {
    ...
    function Sign(algorithm) {
      ...
      StreamModule.Writable.__intrinsic__call(this);
...
var require_browser11 = __commonJS({
  "node_modules/randomfill/browser.js"(exports) {
    ...
    function assertOffset(offset, length) {
      if (typeof offset != "number" || offset !== offset) __intrinsic__throwTypeError("offset must be a number");
      if (offset > kMaxUint32 || offset < 0) __intrinsic__throwTypeError("offset must be a uint32");
      if (offset > kBufferMaxLength || offset > length) __intrinsic__throwRangeError("offset out of range");
    }
    function assertSize(size, offset, length) {
      if (typeof size != "number" || size !== size) __intrinsic__throwTypeError("size must be a number");
      if (size > kMaxUint32 || size < 0) __intrinsic__throwTypeError("size must be a uint32");
      if (size + offset > length || size > kBufferMaxLength) __intrinsic__throwRangeError("buffer too small");
    }
    ...
    function randomFill(buf, offset, size, cb) {
      if (!Buffer2.isBuffer(buf) && !(buf instanceof global.Uint8Array))
        __intrinsic__throwTypeError('"buf" argument must be a Buffer or Uint8Array');
      if (typeof offset == "function") (cb = offset), (offset = 0), (size = buf.length);
      else if (typeof size == "function") (cb = size), (size = buf.length - offset);
      else if (typeof cb != "function") __intrinsic__throwTypeError('"cb" argument must be a function');
...
`),
    ...
    exports.constants = __intrinsic__processBindingConstants.crypto;
  },
});
    ...
    "timingSafeEqual" in crypto
      ? (a, b) => {
          ...
          if (typeof byteLengthA != "number" || typeof byteLengthB != "number")
            __intrinsic__throwTypeError("Input must be an array buffer view");
          if (byteLengthA !== byteLengthB) __intrinsic__throwRangeError("Input buffers must have the same length");
    ...
    "scryptSync" in crypto
      ? function (password, salt, keylen, options, callback) {
          if (
            ...
            var err = __intrinsic__makeTypeError("callback must be a function");
...
const {
  ...
  generateKeySync,
  generateKeyPairSync,
} = __intrinsic__lazy("internal/crypto");
...
class KeyObject {
  ...
  constructor(key) {
    ...
    if (typeof key !== "object") {
      __intrinsic__throwTypeError('The "key" argument must be an instance of CryptoKey.');
    }
    this[kCryptoKey] = key;
  }
  toString() {
  ...
  equals(otherKey) {
    if (!(otherKey instanceof KeyObject)) {
      __intrinsic__throwTypeError("otherKey must be a KeyObject");
    }
...
function _createPrivateKey(key) {
  if (typeof key === "string") {
    ...
    if (key instanceof KeyObject || key instanceof CryptoKey) {
      const error = __intrinsic__makeTypeError(`ERR_CRYPTO_INVALID_KEY_OBJECT_TYPE: Invalid key object type ${key.type}`);
      error.code = "ERR_CRYPTO_INVALID_KEY_OBJECT_TYPE";
      throw error;
    } else {
