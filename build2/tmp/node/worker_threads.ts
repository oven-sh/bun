...
// Sourced from src/js/node/worker_threads.ts
...
let [_workerData, _threadId, _receiveMessageOnPort] = __intrinsic__lazy("worker_threads");
...
class Worker extends EventEmitter {
  ...
  terminate() {
    ...
    if (onExitPromise) {
      return __intrinsic__isPromise(onExitPromise) ? onExitPromise : Promise.resolve(onExitPromise);
    }
