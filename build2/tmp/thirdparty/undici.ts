...
// Sourced from src/js/thirdparty/undici.js
...
const StreamModule = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 39/*node:stream*/) || __intrinsic__createInternalModuleById(39/*node:stream*/));
...
class BodyReadable extends ReadableFromWeb {
  ...
  #consume() {
    if (this.#bodyUsed) __intrinsic__throwTypeError("unusable");
    this.#bodyUsed = true;
  }
...
async function request(
  ...
  } else __intrinsic__throwTypeError("url must be a string, URL, or UrlObject");
