(function (){"use strict";// build3/tmp/node/crypto.ts
...
var getKeyFrom = function(key2, type) {
  if (key2 instanceof KeyObject) {
    key2 = key2.export();
  } else if (key2 instanceof CryptoKey) {
    key2 = KeyObject.from(key2).export();
...
var _generateKeyPairSync = function(algorithm, options) {
  ...
  if (result) {
    ...
    result.publicKey = publicKeyEncoding ? KeyObject.from(result.publicKey).export(publicKeyEncoding) : KeyObject.from(result.publicKey);
    result.privateKey = privateKeyEncoding ? KeyObject.from(result.privateKey).export(privateKeyEncoding) : KeyObject.from(result.privateKey);
  }
  return result;
};
var _createPrivateKey = function(key2) {
  if (typeof key2 === "string") {
    key2 = Buffer.from(key2, "utf8");
    ...
    if (key2 instanceof KeyObject || key2 instanceof CryptoKey) {
      ...
      if (typeof actual_key === "string") {
        actual_key = Buffer.from(actual_key, key2.encoding || "utf8");
        key2.key = actual_key;
...
var _createPublicKey = function(key2) {
  if (typeof key2 === "string") {
    key2 = Buffer.from(key2, "utf8");
...
var { isAnyArrayBuffer, isArrayBufferView } = @requireNativeModule("util/types");
...
var require_hash_base = __commonJS({
  "node_modules/hash-base/index.js"(exports, module) {
    ...
    function HashBase(blockSize) {
      StreamModule.Transform.@call(this), this._block = Buffer2.allocUnsafe(blockSize), this._blockSize = blockSize, this._blockOffset = 0, this._length = [0, 0, 0, 0], this._finalized = false;
    }
...
var require_legacy = __commonJS({
  "node_modules/create-hmac/legacy.js"(exports, module) {
    ...
    function Hmac(alg, key2) {
      ...
      Base.@call(this, "digest"), typeof key2 == "string" && (key2 = Buffer2.from(key2)), this._alg = alg, this._key = key2, key2.length > blocksize ? key2 = alg(key2) : key2.length < blocksize && (key2 = Buffer2.concat([key2, ZEROS], blocksize));
...
var require_browser3 = __commonJS({
  "node_modules/create-hmac/browser.js"(exports, module) {
    ...
    function Hmac(alg, key2) {
      key2 = exportIfKeyObject(key2);
      Base.@call(this, "digest"), typeof key2 == "string" && (key2 = Buffer2.from(key2));
    ...
    module.exports = function(alg, key2) {
      key2 = exportIfKeyObject(key2);
      return alg = alg.toLowerCase(), alg === "rmd160" || alg === "ripemd160" ? new Hmac("rmd160", key2) : alg === "md5" ? new Legacy(md5, key2) : new Hmac(alg, key2);
    };
  }
});
...
var require_encrypter = __commonJS({
  "node_modules/browserify-aes/encrypter.js"(exports) {
    ...
    function Cipher(mode, key2, iv) {
      Transform.@call(this), this._cache = new Splitter, this._cipher = new aes.AES(key2), this._prev = Buffer2.from(iv), this._mode = mode, this._autopadding = true;
    }
...
var require_decrypter = __commonJS({
  "node_modules/browserify-aes/decrypter.js"(exports) {
    ...
    function Decipher(mode, key2, iv) {
      Transform.@call(this), this._cache = new Splitter, this._last = undefined, this._cipher = new aes.AES(key2), this._prev = Buffer2.from(iv), this._mode = mode, this._autopadding = true;
    }
  ...
  "node_modules/elliptic/lib/elliptic/utils.js"(exports) {
    ...
    function cachedProperty(obj, name, computer) {
      ...
      obj.prototype[name] = function() {
        return this[key2] !== undefined ? this[key2] : this[key2] = computer.@call(this);
      };
    }
...
var require_hmac = __commonJS({
  "node_modules/hash.js/lib/hash/hmac.js"(exports, module) {
    ...
    Hmac.prototype = {};
    module.exports = Hmac;
    Hmac.prototype._init = function(key2) {
...
var require_ec = __commonJS({
  "node_modules/elliptic/lib/elliptic/ec/index.js"(exports, module) {
    ...
    EC.prototype.verify = function(msg, signature, key2, enc) {
      ...
      return this.curve._maxwellTrick ? (p = this.g.jmulAdd(u1, key2.getPublic(), u2), p.isInfinity() ? false : p.eqXToP(r)) : (p = this.g.mulAdd(u1, key2.getPublic(), u2), p.isInfinity() ? false : p.getX().umod(this.n).cmp(r) === 0);
    };
      ...
      return Object.keys(state.choice).some(function(key2) {
        ...
        try {
          ...
          if (input.isError(value))
            return false;
          result = { type: key2, value }, match = true;
        } catch {
...
var require_browser10 = __commonJS({
  "node_modules/public-encrypt/browser.js"(exports) {
    ...
    exports.privateEncrypt = function(key2, buf) {
      return publicEncrypt(getKeyFrom(key2, "private"), buf, true);
    };
    exports.publicDecrypt = function(key2, buf) {
      return privateDecrypt(getKeyFrom(key2, "public"), buf, true);
    };
  }
});
...
var randomInt = (...args) => crypto.randomInt(...args);
...
var kCryptoKey = Symbol.for("::bunKeyObjectCryptoKey::");
