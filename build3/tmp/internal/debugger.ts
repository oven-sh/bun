...
// Sourced from src/js/internal/debugger.ts
...
class Debugger {
  ...
  #listen(): void {
    ...
    __intrinsic__throwTypeError(`Unsupported protocol: '${protocol}' (expected 'ws:', 'ws+unix:', or 'unix:')`);
  }
...
function parseUrl(url: string): URL {
  try {
    ...
    __intrinsic__throwTypeError(`Invalid hostname or URL: '${url}'`);
  }
}
