...
// Sourced from src/js/internal/primordials.js
...
const FunctionPrototypeCall = __intrinsic__getByIdDirect(Function.prototype, "call");
    ...
    ArrayPrototypeForEach(Reflect.ownKeys(unsafe.prototype), key => {
      if (!Reflect.getOwnPropertyDescriptor(safe.prototype, key)) {
        ...
        if (
          ...
          desc.value.length === 0 &&
          Symbol.iterator in (desc.value.__intrinsic__call(dummy) || {})
        ) {
...
$ = {
  ...
  ArrayPrototypePushApply: (a, b) => arrayProtoPush.__intrinsic__apply(a, b),
