...
// Sourced from src/js/node/assert.js


// Hardcoded module "node:assert"
const util = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 48/*node:util*/) || __intrinsic__createInternalModuleById(48/*node:util*/));
...
var require_errors = __commonJS({
  "assert/build/internal/errors.js"(exports, module2) {
    ...
    function _classCallCheck(instance, Constructor) {
      if (!(instance instanceof Constructor)) __intrinsic__throwTypeError("Cannot call a class as a function");
    }
    ...
    function _inherits(subClass, superClass) {
      if (typeof superClass != "function" && superClass !== null)
        __intrinsic__throwTypeError("Super expression must either be null or a function");
        ...
        function NodeError2(arg1, arg2, arg3) {
          ...
          return (
            ...
            (_this = _possibleConstructorReturn(
              this,
              _getPrototypeOf(NodeError2).__intrinsic__call(this, getMessage(arg1, arg2, arg3)),
            )),
            (_this.code = code),
            _this
          );
...
var require_assertion_error = __commonJS({
  "assert/build/internal/assert/assertion_error.js"(exports, module2) {
    ...
    function _wrapNativeSuper(Class) {
      ...
      return (
        (_wrapNativeSuper = function (Class2) {
          ...
          if (typeof Class2 != "function") __intrinsic__throwTypeError("Super expression must either be null or a function");
    ...
    function isNativeReflectConstruct() {
      ...
      try {
        return Date.prototype.toString.__intrinsic__call(Reflect.construct(Date, [], function () {})), !0;
      } catch {
        return !1;
      }
    }
      ...
      return (
        isNativeReflectConstruct()
          ...
          : (_construct = function (Parent2, args2, Class2) {
              var a = [null];
              a.push.__intrinsic__apply(a, args2);
              var Constructor = Function.bind.__intrinsic__apply(Parent2, a),
                instance = new Constructor();
              return Class2 && _setPrototypeOf(instance, Class2.prototype), instance;
            }),
        _construct.__intrinsic__apply(null, arguments)
      );
    }
    function _isNativeFunction(fn) {
      return Function.toString.__intrinsic__call(fn).indexOf("[native code]") !== -1;
    }
    function _setPrototypeOf(o, p) {
      return (
        (_setPrototypeOf =
    ...
    var AssertionError = /* @__PURE__ */ (function (_Error) {
      function AssertionError2(options) {
        ...
        if (((Error.stackTraceLimit = 0), message != null))
          _this = _possibleConstructorReturn(this, _getPrototypeOf(AssertionError2).__intrinsic__call(this, String(message)));
        else if (
          (process.stderr &&
          ...
          _this = _possibleConstructorReturn(
            this,
            _getPrototypeOf(AssertionError2).__intrinsic__call(this, createErrDiff(actual, expected, operator)),
          );
...
`);
          ...
          res.length === 1
            ? (_this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(AssertionError2).__intrinsic__call(this, "".concat(base, " ").concat(res[0])),
              ))
            : (_this = _possibleConstructorReturn(
                this,
                _getPrototypeOf(AssertionError2).__intrinsic__call(
                  this,
                  ""
                    .concat(
                      base,
...
`,
            ...
            (_this = _possibleConstructorReturn(
              this,
              _getPrototypeOf(AssertionError2).__intrinsic__call(this, "".concat(_res).concat(other)),
            ));
        }
        return (
...
var require_assert = __commonJS({
  "assert/build/assert.js"(exports, module2) {
    ...
    function ok() {
      for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++)
        args[_key] = arguments[_key];
      innerOk.__intrinsic__apply(void 0, [ok, args.length].concat(args));
    }
    assert.ok = ok;
    ...
    function expectedException(actual, expected, msg, fn) {
      ...
      return expected.prototype !== void 0 && actual instanceof expected
        ...
        ? !1
        : expected.__intrinsic__call({}, actual) === !0;
    }
...
`,
    ...
    assert.throws = function throws(promiseFn) {
      ...
      expectsError.__intrinsic__apply(void 0, [throws, getActual(promiseFn)].concat(args));
    };
    assert.rejects = function rejects(promiseFn) {
      for (var _len3 = arguments.length, args = new Array(_len3 > 1 ? _len3 - 1 : 0), _key3 = 1; _key3 < _len3; _key3++)
        args[_key3 - 1] = arguments[_key3];
      return waitForActual(promiseFn).then(function (result) {
        return expectsError.__intrinsic__apply(void 0, [rejects, result].concat(args));
      });
    };
    assert.doesNotThrow = function doesNotThrow(fn) {
      for (var _len4 = arguments.length, args = new Array(_len4 > 1 ? _len4 - 1 : 0), _key4 = 1; _key4 < _len4; _key4++)
        args[_key4 - 1] = arguments[_key4];
      expectsNoError.__intrinsic__apply(void 0, [doesNotThrow, getActual(fn)].concat(args));
    };
    assert.doesNotReject = function doesNotReject(fn) {
      for (var _len5 = arguments.length, args = new Array(_len5 > 1 ? _len5 - 1 : 0), _key5 = 1; _key5 < _len5; _key5++)
        args[_key5 - 1] = arguments[_key5];
      return waitForActual(fn).then(function (result) {
        return expectsNoError.__intrinsic__apply(void 0, [doesNotReject, result].concat(args));
      });
    };
...
`),
    ...
    function strict() {
      ...
      innerOk.__intrinsic__apply(void 0, [strict, args.length].concat(args));
    }
...
$$EXPORT$$(assert_module).$$EXPORT_END$$;
