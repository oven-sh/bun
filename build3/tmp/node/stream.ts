...
// Sourced from src/js/node/stream.js
...
const EE = __intrinsic__lazy("events");
const StringDecoder = (__intrinsic__requireNativeModule("string_decoder")).StringDecoder;
...
(IS_BUN_DEVELOPMENT?$debug_log("node:stream loaded"):void 0);
  ...
  "node_modules/readable-stream/lib/ours/primordials.js"(exports, module) {
    ...
    module.exports = {
      ...
      FunctionPrototypeCall(fn, thisArgs, ...args) {
        return fn.__intrinsic__call(thisArgs, ...args);
      },
      FunctionPrototypeSymbolHasInstance(self, instance) {
        return Function.prototype[Symbol.hasInstance].__intrinsic__call(self, instance);
      },
      ...
      ReflectApply: __intrinsic__getByIdDirect(Reflect, "apply"),
    ...
    var AggregateError = class extends Error {
      constructor(errors) {
        if (!Array.isArray(errors)) {
          __intrinsic__throwTypeError(`Expected input to be an Array, got ${typeof errors}`);
        }
        let message = "";
    ...
    module.exports = {
      ...
      once(callback) {
        ...
        return function (...args) {
          ...
          called = true;
          callback.__intrinsic__apply(this, args);
        };
      },
    ...
    function eos(stream, options, callback) {
      ...
      const onclose = () => {
        ...
        if (readable && !readableFinished && isReadableNodeStream(stream, true)) {
          if (!isReadableFinished(stream, false)) return callback.__intrinsic__call(stream, new ERR_STREAM_PREMATURE_CLOSE());
        }
        if (writable && !writableFinished) {
          if (!isWritableFinished(stream, false)) return callback.__intrinsic__call(stream, new ERR_STREAM_PREMATURE_CLOSE());
        }
        callback.__intrinsic__call(stream);
      };
      const onrequest = () => {
...
var require_operators = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/operators.js"(exports, module) {
    ...
    async function every(fn, options = void 0) {
      ...
      return !(await some.__intrinsic__call(
        this,
        async (...args) => {
...
var require_legacy = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/legacy.js"(exports, module) {
    ...
    function Stream(options) {
      ...
      EE.__intrinsic__call(this, options);
    }
    Stream.prototype = {};
...
var require_readable = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/readable.js"(exports, module) {
    ...
    var ReadableState = __intrinsic__lazy("bun:stream").ReadableState;
    ...
    Readable.prototype.on = function (ev, fn) {
      const res = Stream.prototype.on.__intrinsic__call(this, ev, fn);
      const state = this._readableState;
      if (ev === "data") {
        state.readableListening = this.listenerCount("readable") > 0;
        if (state.flowing !== false) {
          (IS_BUN_DEVELOPMENT?$debug_log("in flowing mode!", this.__id):void 0);
          this.resume();
        } else {
          (IS_BUN_DEVELOPMENT?$debug_log("in readable mode!", this.__id):void 0);
        }
      } else if (ev === "readable") {
        (IS_BUN_DEVELOPMENT?$debug_log("readable listener added!", this.__id):void 0);
        if (!state.endEmitted && !state.readableListening) {
          ...
          (IS_BUN_DEVELOPMENT?$debug_log("end already emitted...", this.__id):void 0);
        }
      }
      return res;
    };
    ...
    var eos = require_end_of_stream();
    const { maybeReadMore: _maybeReadMore, resume, emitReadable: _emitReadable, onEofChunk } = __intrinsic__lazy("bun:stream");
    function maybeReadMore(stream, state) {
      process.nextTick(_maybeReadMore, stream, state);
    }
    // REVERT ME
    function emitReadable(stream, state) {
      (IS_BUN_DEVELOPMENT?$debug_log("NativeReadable - emitReadable", stream.__id):void 0);
    ...
    function readableAddChunk(stream, chunk, encoding, addToFront) {
      (IS_BUN_DEVELOPMENT?$debug_log("readableAddChunk", chunk, stream.__id):void 0);
    ...
    function addChunk(stream, state, chunk, addToFront) {
      (IS_BUN_DEVELOPMENT?$debug_log("adding chunk", stream.__id):void 0);
      (IS_BUN_DEVELOPMENT?$debug_log("chunk", chunk.toString(), stream.__id):void 0);
      if (state.flowing && state.length === 0 && !state.sync && stream.listenerCount("data") > 0) {
        ...
        (IS_BUN_DEVELOPMENT?$debug_log("needReadable @ addChunk", state.needReadable, stream.__id):void 0);
        if (state.needReadable) emitReadable(stream, state);
      }
      (IS_BUN_DEVELOPMENT?$debug_log("about to maybereadmore"):void 0);
      maybeReadMore(stream, state);
    }
    ...
    Readable.prototype.read = function (n) {
      (IS_BUN_DEVELOPMENT?$debug_log("read - n =", n, this.__id):void 0);
      ...
      if (
        ...
        (IS_BUN_DEVELOPMENT?$debug_log("read: emitReadable or endReadable", state.length, state.ended, this.__id):void 0);
      ...
      if (n === 0 && state.ended) {
        (IS_BUN_DEVELOPMENT?$debug_log("read: calling endReadable if length 0 -- length, state.ended", state.length, state.ended, this.__id):void 0);
      ...
      (IS_BUN_DEVELOPMENT?$debug_log("need readable", doRead, this.__id):void 0);

      // If we currently have less than the highWaterMark, then also read some.
      if (state.length === 0 || state.length - n < state.highWaterMark) {
        doRead = true;
        (IS_BUN_DEVELOPMENT?$debug_log("length less than watermark", doRead, this.__id):void 0);
      }
      ...
      if (state.ended || state.reading || state.destroyed || state.errored || !state.constructed) {
        (IS_BUN_DEVELOPMENT?$debug_log("state.constructed?", state.constructed, this.__id):void 0);
        doRead = false;
        (IS_BUN_DEVELOPMENT?$debug_log("reading, ended or constructing", doRead, this.__id):void 0);
      } else if (doRead) {
        (IS_BUN_DEVELOPMENT?$debug_log("do read", this.__id):void 0);
        state.reading = true;
        state.sync = true;
        ...
        try {
          ...
          if (__intrinsic__isPromise(result)) {
            (IS_BUN_DEVELOPMENT?$debug_log("async _read", this.__id):void 0);
            const peeked = Bun.peek(result);
            (IS_BUN_DEVELOPMENT?$debug_log("peeked promise", peeked, this.__id):void 0);
            if (peeked !== result) {
              result = peeked;
            }
          }

          if (__intrinsic__isPromise(result) && result?.then && __intrinsic__isCallable(result.then)) {
            (IS_BUN_DEVELOPMENT?$debug_log("async _read result.then setup", this.__id):void 0);
      ...
      (IS_BUN_DEVELOPMENT?$debug_log("n @ fromList", n, this.__id):void 0);
      let ret;
      if (n > 0) ret = fromList(n, state);
      else ret = null;

      (IS_BUN_DEVELOPMENT?$debug_log("ret @ read", ret, this.__id):void 0);

      if (ret === null) {
        state.needReadable = state.length <= state.highWaterMark;
        (IS_BUN_DEVELOPMENT?$debug_log("state.length while ret = null", state.length, this.__id):void 0);
        n = 0;
      } else {
        state.length -= n;
        if (state.multiAwaitDrain) {
    ...
    Readable.prototype.pipe = function (dest, pipeOpts) {
      ...
      (IS_BUN_DEVELOPMENT?$debug_log("pipe count=%d opts=%j", state.pipes.length, pipeOpts, src.__id):void 0);
      ...
      function onunpipe(readable, unpipeInfo) {
        (IS_BUN_DEVELOPMENT?$debug_log("onunpipe", src.__id):void 0);
        if (readable === src) {
      ...
      function onend() {
        (IS_BUN_DEVELOPMENT?$debug_log("onend", src.__id):void 0);
        dest.end();
      }
      let ondrain;
      let cleanedUp = false;
      function cleanup() {
        (IS_BUN_DEVELOPMENT?$debug_log("cleanup", src.__id):void 0);
      ...
      function pause() {
        if (!cleanedUp) {
          if (state.pipes.length === 1 && state.pipes[0] === dest) {
            (IS_BUN_DEVELOPMENT?$debug_log("false write response, pause", 0, src.__id):void 0);
            state.awaitDrainWriters = dest;
            state.multiAwaitDrain = false;
          } else if (state.pipes.length > 1 && state.pipes.includes(dest)) {
            (IS_BUN_DEVELOPMENT?$debug_log("false write response, pause", state.awaitDrainWriters.size, src.__id):void 0);
      ...
      src.on("data", ondata);
      function ondata(chunk) {
        (IS_BUN_DEVELOPMENT?$debug_log("ondata", src.__id):void 0);
        const ret = dest.write(chunk);
        (IS_BUN_DEVELOPMENT?$debug_log("dest.write", ret, src.__id):void 0);
        if (ret === false) {
          pause();
        }
      }
      function onerror(er) {
        (IS_BUN_DEVELOPMENT?$debug_log("onerror", er):void 0);
        unpipe();
        dest.removeListener("error", onerror);
      ...
      function onfinish() {
        (IS_BUN_DEVELOPMENT?$debug_log("onfinish"):void 0);
        dest.removeListener("close", onclose);
        unpipe();
      }
      dest.once("finish", onfinish);
      function unpipe() {
        (IS_BUN_DEVELOPMENT?$debug_log("unpipe"):void 0);
        src.unpipe(dest);
      }
      dest.emit("pipe", src);
      if (dest.writableNeedDrain === true) {
        ...
        (IS_BUN_DEVELOPMENT?$debug_log("pipe resume"):void 0);
        src.resume();
      }
      return dest;
    };
    function pipeOnDrain(src, dest) {
      return function pipeOnDrainFunctionResult() {
        ...
        if (state.awaitDrainWriters === dest) {
          (IS_BUN_DEVELOPMENT?$debug_log("pipeOnDrain", 1):void 0);
          state.awaitDrainWriters = null;
        } else if (state.multiAwaitDrain) {
          (IS_BUN_DEVELOPMENT?$debug_log("pipeOnDrain", state.awaitDrainWriters.size):void 0);
    ...
    Readable.prototype.removeListener = function (ev, fn) {
      const res = Stream.prototype.removeListener.__intrinsic__call(this, ev, fn);
      if (ev === "readable") {
    ...
    Readable.prototype.removeAllListeners = function (ev) {
      const res = Stream.prototype.removeAllListeners.__intrinsic__apply(this, arguments);
    ...
    function nReadingNextTick(self) {
      (IS_BUN_DEVELOPMENT?$debug_log("on readable nextTick, calling read(0)", self.__id):void 0);
      self.read(0);
    }
    Readable.prototype.resume = function () {
      const state = this._readableState;
      if (!state.flowing) {
        (IS_BUN_DEVELOPMENT?$debug_log("resume", this.__id):void 0);
    ...
    Readable.prototype.pause = function () {
      (IS_BUN_DEVELOPMENT?$debug_log("call pause flowing=%j", this._readableState.flowing, this.__id):void 0);
      if (this._readableState.flowing !== false) {
        (IS_BUN_DEVELOPMENT?$debug_log("pause", this.__id):void 0);
    ...
    function endReadable(stream) {
      const state = stream._readableState;
      (IS_BUN_DEVELOPMENT?$debug_log("endEmitted @ endReadable", state.endEmitted, stream.__id):void 0);
      if (!state.endEmitted) {
        state.ended = true;
    ...
    function endReadableNT(state, stream) {
      (IS_BUN_DEVELOPMENT?$debug_log("endReadableNT -- endEmitted, state.length", state.endEmitted, state.length, stream.__id):void 0);
      if (!state.errored && !state.closeEmitted && !state.endEmitted && state.length === 0) {
        state.endEmitted = true;
        stream.emit("end");
        (IS_BUN_DEVELOPMENT?$debug_log("end emitted @ endReadableNT", stream.__id):void 0);
...
var require_writable = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/writable.js"(exports, module) {
    ...
    Writable.prototype.end = function (chunk, encoding, cb, native = false) {
      const state = this._writableState;
      (IS_BUN_DEVELOPMENT?$debug_log("end", state, this.__id):void 0);
    ...
    function needFinish(state, tag) {
      var needFinish =
        ...
        !state.errorEmitted &&
        !state.closeEmitted;
      (IS_BUN_DEVELOPMENT?$debug_log("needFinish", needFinish, tag):void 0);
      return needFinish;
    }
    ...
    function finishMaybe(stream, state, sync) {
      (IS_BUN_DEVELOPMENT?$debug_log("finishMaybe -- state, sync", state, sync, stream.__id):void 0);
...
var require_transform = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/transform.js"(exports, module) {
    ...
    function Transform(options) {
      ...
      Duplex.__intrinsic__call(this, options);
...
var require_pipeline = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/pipeline.js"(exports, module) {
    ...
    async function* fromReadable(val) {
      ...
      yield* Readable.prototype[SymbolAsyncIterator].__intrinsic__call(val);
    }
...
function createNativeStreamReadable(nativeType, Readable) {
  var [pull, start, cancel, setClose, deinit, updateRef, drainFn] = __intrinsic__lazy(nativeType);
  ...
  var NativeReadable = class NativeReadable extends Readable {
    ...
    _read(maxToRead) {
      (IS_BUN_DEVELOPMENT?$debug_log("NativeReadable._read", this.__id):void 0);
      if (this.#pendingRead) {
        (IS_BUN_DEVELOPMENT?$debug_log("pendingRead is true", this.__id):void 0);
        return;
      }

      var ptr = this.#bunNativePtr;
      (IS_BUN_DEVELOPMENT?$debug_log("ptr @ NativeReadable._read", ptr, this.__id):void 0);
      if (ptr === 0) {
        this.push(null);
        return;
      }
      ...
      if (!this.#constructed) {
        (IS_BUN_DEVELOPMENT?$debug_log("NativeReadable not constructed yet", this.__id):void 0);
    ...
    #internalConstruct(ptr) {
      ...
      (IS_BUN_DEVELOPMENT?$debug_log("NativeReadable internal `start` result", result, this.__id):void 0);

      if (typeof result === "number" && result > 1) {
        this.#hasResized = true;
        (IS_BUN_DEVELOPMENT?$debug_log("NativeReadable resized", this.__id):void 0);
      ...
      if (drainFn) {
        ...
        (IS_BUN_DEVELOPMENT?$debug_log("NativeReadable drain result", drainResult, this.__id):void 0);
    ...
    #getRemainingChunk(maxToRead = this.#highWaterMark) {
      ...
      (IS_BUN_DEVELOPMENT?$debug_log("chunk @ #getRemainingChunk", chunk, this.__id):void 0);
    ...
    #handleResult(result, view, isClosed) {
      (IS_BUN_DEVELOPMENT?$debug_log("result, isClosed @ #handleResult", result, isClosed, this.__id):void 0);
      ...
      if (typeof result === "number") {
        ...
        if (result.byteLength >= this.#highWaterMark && !this.#hasResized && !isClosed) {
          this.#highWaterMark *= 2;
          this.#hasResized = true;
          (IS_BUN_DEVELOPMENT?$debug_log("Resized", this.__id):void 0);
        }

        return handleArrayBufferViewResult(this, result, view, isClosed);
      } else {
        (IS_BUN_DEVELOPMENT?$debug_log("Unknown result type", result, this.__id):void 0);
        throw new Error("Invalid result from pull");
      }
    }

    #internalRead(view, ptr) {
      (IS_BUN_DEVELOPMENT?$debug_log("#internalRead()", this.__id):void 0);
      closer[0] = false;
      ...
      if (__intrinsic__isPromise(result)) {
        ...
        return result.then(
          result => {
            this.#pendingRead = false;
            (IS_BUN_DEVELOPMENT?$debug_log("pending no longerrrrrrrr (result returned from pull)", this.__id):void 0);
            this.#remainingChunk = this.#handleResult(result, view, closer[0]);
          },
          reason => {
            (IS_BUN_DEVELOPMENT?$debug_log("error from pull", reason, this.__id):void 0);
    ...
    _destroy(error, callback) {
      ...
      (IS_BUN_DEVELOPMENT?$debug_log("NativeReadable destroyed", this.__id):void 0);
      cancel(ptr, error);
      callback(error);
    }
...
function getNativeReadableStream(Readable, stream, options) {
  ...
  const native = __intrinsic__direct(stream);
  if (!native) {
    (IS_BUN_DEVELOPMENT?$debug_log("no native readable stream"):void 0);
    return undefined;
  }
...
NativeWritable.prototype.write = function NativeWritablePrototypeWrite(chunk, encoding, cb, native) {
  if (!(native ?? this[_native])) {
    this[_native] = false;
    return WritablePrototypeWrite.__intrinsic__call(this, chunk, encoding, cb);
  }
...
NativeWritable.prototype.end = function end(chunk, encoding, cb, native) {
  return WritablePrototypeEnd.__intrinsic__call(this, chunk, encoding, cb, native ?? this[_native]);
};
