...
// Sourced from src/js/node/tty.js


const { ttySetMode, isatty, getWindowSize: _getWindowSize } = __intrinsic__lazy("tty");
...
function ReadStream(fd) {
  ...
  if (fd >> 0 !== fd || fd < 0) __intrinsic__throwRangeError("fd must be a positive integer");

  const stream = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 21/*node:fs*/) || __intrinsic__createInternalModuleById(21/*node:fs*/)).ReadStream.__intrinsic__call(this, "", {
    fd,
  });
  ...
  (IS_BUN_DEVELOPMENT?$assert(stream instanceof ReadStream,"stream instanceof ReadStream"):void 0);
...
Object.defineProperty(ReadStream, "prototype", {
  get() {
    const Prototype = Object.create((__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 21/*node:fs*/) || __intrinsic__createInternalModuleById(21/*node:fs*/)).ReadStream.prototype);
...
function WriteStream(fd) {
  ...
  const stream = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 21/*node:fs*/) || __intrinsic__createInternalModuleById(21/*node:fs*/)).WriteStream.__intrinsic__call(this, "", {
    fd,
  });
...
Object.defineProperty(WriteStream, "prototype", {
  get() {
    const Real = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 21/*node:fs*/) || __intrinsic__createInternalModuleById(21/*node:fs*/)).WriteStream.prototype;
    ...
    WriteStream.prototype.clearLine = function (dir, cb) {
      return (readline ??= (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 35/*node:readline*/) || __intrinsic__createInternalModuleById(35/*node:readline*/))).clearLine(this, dir, cb);
    };

    WriteStream.prototype.clearScreenDown = function (cb) {
      return (readline ??= (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 35/*node:readline*/) || __intrinsic__createInternalModuleById(35/*node:readline*/))).clearScreenDown(this, cb);
    };

    WriteStream.prototype.cursorTo = function (x, y, cb) {
      return (readline ??= (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 35/*node:readline*/) || __intrinsic__createInternalModuleById(35/*node:readline*/))).cursorTo(this, x, y, cb);
    };
    ...
    WriteStream.prototype.getColorDepth = function (env = process.env) {
      ...
      if (process.platform === "win32") {
        ...
        if (OSRelease === undefined) {
          const { release } = (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 28/*node:os*/) || __intrinsic__createInternalModuleById(28/*node:os*/));
    ...
    WriteStream.prototype.moveCursor = function (dx, dy, cb) {
      return (readline ??= (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 35/*node:readline*/) || __intrinsic__createInternalModuleById(35/*node:readline*/))).moveCursor(this, dx, dy, cb);
    };
...
$$EXPORT$$({ ReadStream, WriteStream, isatty }).$$EXPORT_END$$;
