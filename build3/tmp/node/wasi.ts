...
// Sourced from src/js/node/wasi.js
...
const nodeFsConstants = __intrinsic__processBindingConstants.fs;
  ...
  "node_modules/wasi-js/dist/wasi.js"(exports) {
    ...
    function getDefaults() {
      ...
      const defaultBindings = {
        ...
        isTTY: fd => (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 46/*node:tty*/) || __intrinsic__createInternalModuleById(46/*node:tty*/)).isatty(fd),
        fs: Bun.fs(),
        path: (__intrinsic__getInternalField(__intrinsic__internalModuleRegistry, 30/*node:path*/) || __intrinsic__createInternalModuleById(30/*node:path*/)),
      };
...
$$EXPORT$$({ WASI: require_wasi().default }).$$EXPORT_END$$;
