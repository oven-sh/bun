macro(add_custom_library)
  ...
  if(LIB_COMMAND)
    ...
    if(LIB_CMAKE_POSITION_INDEPENDENT_CODE)
    ...
    set(${LIB_ID}_CMAKE_ARGS
      ...
      "CMAKE_C_FLAGS=${CMAKE_C_FLAGS} ${LIB_CMAKE_C_FLAGS}"
      "CMAKE_CXX_FLAGS=${CMAKE_CXX_FLAGS} ${LIB_CMAKE_CXX_FLAGS}"
      "CMAKE_LINKER_FLAGS=${CMAKE_LINKER_FLAGS} ${LIB_CMAKE_LINKER_FLAGS}"
      ${CMAKE_ARGS}
      ${LIB_CMAKE_ARGS}
    )
