  ...
  foreach(artifact ${CMD_ARTIFACTS})
    ...
    if(BUILDKITE)
      ...
      if(filename STREQUAL "libbun-profile.a")
        ...
        list(APPEND CMD_COMMANDS COMMAND ${CMAKE_COMMAND} -E chdir ${BUILD_PATH} xz -9 ${filename})
        list(APPEND CMD_COMMANDS COMMAND ${CMAKE_COMMAND} -E chdir ${BUILD_PATH} buildkite-agent artifact upload ${filename}.xz)
      else()
