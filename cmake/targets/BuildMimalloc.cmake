...
if(CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64|arm64|ARM64|AARCH64" AND NOT APPLE)
  ...
  if(WIN32)
    # -moutline-atomics is not supported by clang-cl; suppress all warnings
    # from vendored mimalloc C code compiled as C++ (MI_USE_CXX=ON)
...
if(WIN32 AND NOT CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64|arm64|ARM64|AARCH64")
  list(APPEND MIMALLOC_CMAKE_ARGS "-DCMAKE_C_FLAGS=-w")
endif()
if(WIN32)
