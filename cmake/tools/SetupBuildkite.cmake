...
if(NOT BUILDKITE_BUILD_STATUS EQUAL 0)
  message(FATAL_ERROR "No build found: ${BUILDKITE_BUILD_STATUS}")
  return()
endif()
...
foreach(i RANGE ${BUILDKITE_JOBS_MAX_INDEX})
  ...
  if(BUILDKITE_GROUP_ID AND ENV{BUILDKITE_GROUP_ID} STREQUAL BUILDKITE_GROUP_ID AND NOT BUILDKITE_JOB_GROUP_ID STREQUAL BUILDKITE_GROUP_ID)
  ...
  if(NOT BUILDKITE_ARTIFACTS_STATUS EQUAL 0)
    message(FATAL_ERROR "Failed to download artifacts: ${BUILDKITE_ARTIFACTS_STATUS} ${BUILDKITE_ARTIFACTS_URL}")
    return()
  endif()
  ...
  foreach(i RANGE 0 ${BUILDKITE_ARTIFACTS_MAX_INDEX})
    ...
    if(BUILDKITE)
      set(BUILDKITE_DOWNLOAD_COMMAND buildkite-agent artifact download ${BUILDKITE_ARTIFACT_PATH} . --build ${BUILDKITE_BUILD_ID} --step ${BUILDKITE_JOB_ID})
    else()
