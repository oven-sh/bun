...
foreach(i RANGE ${BUILDKITE_JOBS_MAX_INDEX})
  ...
  message(STATUS "-> ${i} ${BUILDKITE_JOB_ID} ${BUILDKITE_JOB_GROUP_ID}")

  if(BUILDKITE_GROUP_ID)
    if(NOT BUILDKITE_GROUP_ID STREQUAL BUILDKITE_JOB_GROUP_ID)
  ...
  message(STATUS "-> ${i} ${BUILDKITE_JOB_NAME}")
  ...
  message(STATUS "-> ${i} ${BUILDKITE_ARTIFACTS_URL}")
...
if(BUILDKITE_JOBS_NOT_FOUND)
  ...
  message(FATAL_ERROR "The following jobs were not found: ${BUILDKITE_JOBS_NOT_FOUND}")
endif()
