...
foreach(i RANGE ${BUILDKITE_JOBS_MAX_INDEX})
  ...
  foreach(i RANGE 0 ${BUILDKITE_ARTIFACTS_MAX_INDEX})
    ...
    if(BUILDKITE_ARTIFACT_PATH MATCHES "\\.gz$")
      list(APPEND BUILDKITE_DOWNLOAD_COMMAND COMMAND gunzip -f ${BUILDKITE_ARTIFACT_PATH})
      string(REGEX REPLACE "\\.gz$" "" BUILDKITE_ARTIFACT_PATH ${BUILDKITE_ARTIFACT_PATH})
    endif()
