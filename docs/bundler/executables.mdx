...
<Frame caption="Startup time improvement with --bytecode — tsc starts ~2× faster">
  ![Bar chart comparing tsc startup time with and without bytecode compilation — bytecode enabled is about twice as fast](https://github.com/user-attachments/assets/dc8913db-01d2-48f8-a8ef-ac4e984f9763)
</Frame>
