...
Standalone executables can automatically load configuration files from the directory where they are run (unlike regular `bun` commands, they do not search parent directories). By default:
