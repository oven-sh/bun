...
| `.json5`                                              | JSON5 files are parsed and inlined into the bundle as a JavaScript object.<br/><br/>`js<br/>import config from "./config.json5";<br/>config.name; // => "my-app"<br/>`                                                                                                                                                      |
| `.xml`                                                | XML files are parsed into the compact object shape of [`Bun.XML.parse`](/runtime/xml) and inlined into the bundle.<br/><br/>`js<br/>import doc from "./config.xml";<br/>doc.config["@version"]; // => "2"<br/>`                                                                                                             |
| `.txt` `.text`                                        | The contents of the text file are read and inlined into the bundle as a string.<br/><br/>`js<br/>import contents from "./file.txt";<br/>console.log(contents); // => "Hello, world!"<br/>`                                                                                                                                  |
| `.md` `.markdown`                                     | Markdown files are rendered to HTML and inlined into the bundle as a string.<br/><br/>`js<br/>import html from "./README.md";<br/>console.log(html); // => "<h1>My project</h1>\n"<br/>`                                                                                                                                    |
