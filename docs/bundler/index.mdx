...
<Tabs>
  ...
  <Tab title="CLI">
    ...
    bun build ./index.tsx --outdir ./out --target bun --splitting --split-require
    ```
  </Tab>
</Tabs>
...
interface BuildConfig {
  ...
  splitRequire?: boolean; // default false, with splitting: require() of an ES module is a chunk too (target "bun")
