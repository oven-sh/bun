...
<ParamField path="--minify-whitespace" type="boolean">
  ...
  <br /> <em>Optional modifier:</em>{" "}
  <ul>
    {" "}
    <li>
      <code>--emit-dce-annotations</code> – Re-emit DCE annotations in the output. Disabled by default when <code>--minify-whitespace</code> is active, use this flag to re-enable them
    </li>{" "}
  </ul>{" "}
</ParamField>
...
<ParamField path="--minify-syntax" type="boolean">
  ...
  <ul>
    {" "}
    <li>
      <code>--keep-names</code> – Preserve original function and class names
    </li>{" "}
  </ul>{" "}
</ParamField>
