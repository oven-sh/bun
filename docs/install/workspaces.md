...
- **Run scripts in multiple pacakges.** You can use the [`--filter` flag](/docs/cli/run#filtering) to easily run `package.json` scripts in multiple packages in your workspace.
