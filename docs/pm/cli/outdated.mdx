...
An aliased dependency such as `"lodash3": "npm:lodash@^3.0.0"` is listed with both of its names, and a pattern selects it by either name:
...
| Package              | Current | Update | Latest  |
| -------------------- | ------- | ------ | ------- |
| lodash3@npm:lodash   | 3.10.1  | 3.10.1 | 4.17.21 |
```
