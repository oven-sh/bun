...
- Line tints follow the terminal: light or dark is taken from `COLORFGBG` or by asking the terminal for its background color (OSC 11), and exact colors are used when `COLORTERM=truecolor`.
