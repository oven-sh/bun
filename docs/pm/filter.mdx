...
<Frame caption="Parallel filter output — each package's logs are prefixed by package and script name">
  ![Terminal output showing bun --filter '*' dev running api and frontend dev scripts in parallel with prefixed log lines](https://github.com/oven-sh/bun/assets/48869301/2a103e42-9921-4c33-948f-a1ad6e6bac71)
</Frame>
