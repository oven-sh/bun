...
<Frame caption="Bun's web debugger at debug.bun.sh — Console tab showing program output and interactive prompt">
  ![Bun web debugger Console tab with interactive prompt and log output](https://github.com/oven-sh/bun/assets/3084745/e6a976a8-80cc-4394-8925-539025cc025d)
</Frame>
...
<Frame caption="Sources tab with server.ts open — click line 3 to set a breakpoint">
  ![Sources tab showing server.ts with a breakpoint set on line 3 at console.log(req.url)](https://github.com/oven-sh/bun/assets/3084745/3b69c7e9-25ff-4f9d-acc4-caa736862935)
</Frame>
...
<Frame caption="Debugger paused at breakpoint — call stack and scope highlighted">
  ![Debugger paused at breakpoint with highlighted call stack and scope panel](https://github.com/oven-sh/bun/assets/3084745/8b565e58-5445-4061-9bc4-f41090dfe769)
</Frame>
...
<Frame caption="Bottom console evaluated in paused context">
  ![Debugger bottom console evaluating an expression while paused at breakpoint](https://github.com/oven-sh/bun/assets/3084745/f4312b76-48ba-4a7d-b3b6-6205968ac681)
</Frame>
...
<Frame caption="Scope panel listing local variables — expand req to inspect properties">
  ![Scope panel showing local variables with req expanded to reveal its properties](https://github.com/oven-sh/bun/assets/3084745/63d7f843-5180-489c-aa94-87c486e68646)
</Frame>

The controls in the upper left of the Sources pane drive the program's execution.

<Frame caption="Execution controls in the Sources pane header">
  ![Execution controls — Continue, Step over, Step into, Step out buttons](https://github.com/oven-sh/bun/assets/3084745/41b76deb-7371-4461-9d5d-81b5a6d2f7a4)
</Frame>
...
<Frame caption="Full execution toolbar with labels">
  ![Full execution toolbar showing Continue, Step over, Step into and Step out controls](https://github-production-user-asset-6210df.s3.amazonaws.com/3084745/261510346-6a94441c-75d3-413a-99a7-efa62365f83d.png)
</Frame>
