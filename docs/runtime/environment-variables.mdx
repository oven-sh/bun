...
Environment variables are automatically _expanded_ when using \`backticks\`. This means you can reference previously-defined variables in your environment variables.
