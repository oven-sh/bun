...
| `BUN_CONFIG_ELIDE_LINES`                 | Control the number of lines elided when using `bun run --filter`. The `--elide-lines <n>` argument takes precedence over this environment variable. Set to `0` to show all lines.                                                                                                                                                                                                                                                                                                                                                                                         |
