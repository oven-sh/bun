...
| `BUN_OTEL`                               | If `BUN_OTEL=1`, Bun enables native [OpenTelemetry tracing](/runtime/opentelemetry) and reads the standard `OTEL_*` variables (`OTEL_EXPORTER_OTLP_ENDPOINT`, `OTEL_SERVICE_NAME`, …).                                                                                                                                                                                        |
