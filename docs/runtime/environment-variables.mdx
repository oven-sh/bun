...
| `BUN_CONFIG_ELIDE_LINES`                 | Maximum number of lines of script output shown when using `bun run --filter`. Defaults to `10`. The `--elide-lines <n>` argument takes precedence over this environment variable. Set to `0` to show all lines.                                                                                                                                                                                                                                                                                                                                                           |
