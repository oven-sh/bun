...
| `BUN_OPTIONS`                            | Prepends command-line flags to any Bun execution. For example, `BUN_OPTIONS="--hot"` makes `bun run dev` behave like `bun --hot run dev`. It supplies flags and their values, not the subcommand.                                                                                                                                                                             |
