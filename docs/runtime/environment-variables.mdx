...
Bun automatically _expands_ environment variables in unquoted and backtick-quoted values, so you can reference previously-defined variables. Single- and double-quoted values are not expanded.
