...
<Frame caption="Terminal output of bun cat — Bun.file piped to Bun.write streams a large file faster than GNU cat">
  ![Terminal screenshot showing bun cat completing quickly — Bun.file piped to Bun.stdout for large file streaming](/images/cat.jpg)
</Frame>
