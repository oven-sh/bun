...
Bun supports `.jsx` and `.tsx` files. Bun's internal transpiler can convert JSX syntax into vanilla JavaScript before execution, or preserve JSX syntax for another tool to transform later.
...
| `json<br/>{<br/>  "jsx": "solid"<br/>}<br/>`        | `tsx<br/>// JSX is preserved for the Solid compiler<br/><Box width={5}>Hello</Box><br/>`                                                                                                                                                                                                                                                                                                                              |
| `json<br/>{<br/>  "jsx": "preserve"<br/>}<br/>`     | `tsx<br/>// JSX is not transpiled<br/><Box width={5}>Hello</Box><br/>`                                                                                                                                                                                                                                                                                                                                                |
...
<Note>
  Only applicable when `jsx` is `react-jsx` or `react-jsxdev`; `jsx: "solid"` and `jsx: "preserve"` leave imports up to
  a later transform.
</Note>
