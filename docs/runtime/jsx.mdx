...
<Frame caption="Pretty-printed JSX component tree in the terminal — nested Stack and UserCard elements">
  ![Terminal output showing pretty-printed JSX tree for Stack with two UserCard children](https://github.com/oven-sh/bun/assets/3084745/d29db51d-6837-44e2-b8be-84fc1b9e9d97)
</Frame>
