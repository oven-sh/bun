...
In secure mode, operations like file I/O, network access, and subprocess spawning will throw a `PermissionDenied` error unless explicitly granted.
...
// Request permission (returns current state)
