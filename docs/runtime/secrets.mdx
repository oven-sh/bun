...
- `options.persist` (`"local"` or `"enterprise"`, optional) - Windows only. Which computers can see the credential. Defaults to `"enterprise"`. See [Windows (Credential Manager)](#windows-credential-manager)
