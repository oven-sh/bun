...
<Frame caption="Bun.semver vs node-semver — about 20× faster">
  ![Bar chart comparing Bun.semver and node-semver throughput — Bun is roughly 20 times faster](https://github.com/oven-sh/bun/assets/709451/94746adc-8aba-4baf-a143-3c355f8e0f78)
</Frame>
