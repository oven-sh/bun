...
Bun Shell is a small programming language implemented in Rust, with a handwritten lexer, parser, and interpreter. Unlike bash and zsh, Bun Shell runs operations concurrently.
