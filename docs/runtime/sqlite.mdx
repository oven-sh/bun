...
<Frame caption="SQLite read-query benchmark on M1 Max 64 GB — Bun bun:sqlite vs better-sqlite3 vs deno.land/x/sqlite (Northwind dataset)">
  ![Bar chart showing SQLite read-query throughput — Bun bun:sqlite is 3 to 6 times faster than better-sqlite3 and 8 to 9 times faster than deno.land/x/sqlite](https://user-images.githubusercontent.com/709451/168459263-8cd51ca3-a924-41e9-908d-cf3478a3b7f3.png)
</Frame>
