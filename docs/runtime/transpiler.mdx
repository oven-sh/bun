...
interface TranspilerOptions {
  ...
  // Whether to prepend the automatic JSX runtime import when JSX is used,
  // e.g. `import { jsx } from "react/jsx-runtime"` in production or
  // `import { jsxDEV } from "react/jsx-dev-runtime"` in development,
  // resolved against the configured jsxImportSource
  // Default: true
