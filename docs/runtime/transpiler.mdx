...
interface TranspilerOptions {
  ...
  // Experimental syntax minification (constant folding, dead code elimination)
  minifySyntax?: boolean,

  // Experimental identifier minification (rename to shorter names)
  minifyIdentifiers?: boolean,

  // Enable all minification (`true`) or a selective subset. Top-level
  // minifyWhitespace/minifySyntax/minifyIdentifiers override the nested fields.
