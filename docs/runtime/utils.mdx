...
CUID2 values are opaque: they do not expose their timestamp and are not monotonic or sortable by creation time. Store a separate timestamp when you need chronological ordering.
