...
| ----------------------------------- | --------------: | -----: | --------------: | -------------: | -----: |
| S3 `ListObjectsV2` response, 231 KB |      **1.2 ms** | 4.0 ms |           23 ms |          31 ms |  19 ms |
| Atom feed, 193 KB                   |      **1.0 ms** | 3.7 ms |           19 ms |          23 ms |  16 ms |
| libphonenumber metadata, 960 KB     |      **4.3 ms** | 9.6 ms |           56 ms |          53 ms |      — |
| Chromium `enums.xml`, 1.4 MB        |       **14 ms** |  41 ms |          150 ms |         103 ms |      — |
| freedesktop MIME database, 2.2 MB   |       **23 ms** |  56 ms |          299 ms |         280 ms |      — |
