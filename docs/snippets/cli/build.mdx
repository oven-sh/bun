...
<ParamField path="--mangle-props" type="string">
  Rename properties whose names match this regular expression to shorter names, e.g. <code>--mangle-props='_$'</code>
</ParamField>

<ParamField path="--reserve-props" type="string">
  Never rename properties whose names match this regular expression, even if they match <code>--mangle-props</code>
</ParamField>

<ParamField path="--mangle-quoted" type="boolean">
  Also rename matching properties written as string literals, e.g. <code>obj["foo_"]</code>
</ParamField>
