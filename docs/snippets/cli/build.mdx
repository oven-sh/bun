...
<ParamField path="--startup-jit-deferral" type="number" default="1500">
  With <code>--compile</code>: keep the JIT reluctant to compile until the program becomes interactive, for at most this
  many milliseconds (<code>--startup-jit-deferral=&lt;ms&gt;</code>). <code>--no-startup-jit-deferral</code> or{" "}
