...
<ParamField path="--compile-jit-policy" type="number" default="8">
  Scale JIT tier-up thresholds by this until the executable's first output, input or idle; <code>1</code> starts in the
  normal JIT policy
</ParamField>
