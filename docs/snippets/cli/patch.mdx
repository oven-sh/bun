...
<ParamField path="--minimum-release-age-excludes" type="string">
  Package names exempt from <code>--minimum-release-age</code> (comma-separated or repeated; replaces the bunfig.toml
  list)
</ParamField>
