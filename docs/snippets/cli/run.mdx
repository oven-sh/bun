...
<ParamField path="--trace-deprecation" type="boolean">
  Show stack traces on deprecations
</ParamField>

<ParamField path="--pending-deprecation" type="boolean">
  Emit pending deprecation warnings
</ParamField>

<ParamField path="--no-warnings" type="boolean">
  Silence all process warnings
</ParamField>

<ParamField path="--disable-warning" type="string">
  Silence specific process warnings by code or type
</ParamField>

<ParamField path="--trace-warnings" type="boolean">
  Show stack traces on process warnings
</ParamField>

<ParamField path="--redirect-warnings" type="string">
...
<ParamField path="--experimental-stream-iter" type="boolean">
  Enable the experimental stream/iter API (<code>node:stream/iter</code>, <code>node:zlib/iter</code>)
</ParamField>

<ParamField path="--cron-title" type="string">
  Title for cron execution mode. Requires <code>--cron-period</code>. With both flags, Bun imports the script and calls
  the <code>scheduled()</code> handler of its default export. The jobs that <code>Bun.cron()</code> registers with the
  operating system use these flags
</ParamField>

<ParamField path="--cron-period" type="string">
  Cron period for cron execution mode. Requires <code>--cron-title</code>
</ParamField>
...
<ParamField path="--cpu-prof" type="boolean">
  Start the CPU profiler and write a <code>.cpuprofile</code> file to disk on exit
</ParamField>

<ParamField path="--cpu-prof-md" type="boolean">
  Write the CPU profile in markdown format (grep-friendly, designed for LLM analysis). Combine it with{" "}
  <code>--cpu-prof</code> to write both formats
</ParamField>

<ParamField path="--cpu-prof-name" type="string">
  Specify the name of the CPU profile file
</ParamField>

<ParamField path="--cpu-prof-dir" type="string">
  Specify the directory where the CPU profile will be saved
</ParamField>

<ParamField path="--cpu-prof-interval" type="number" default="1000">
  Specify the sampling interval in microseconds for CPU profiling
</ParamField>

<ParamField path="--heap-prof" type="boolean">
  Write a heap profile to disk on exit (<code>.heapprofile</code>)
</ParamField>

<ParamField path="--heap-prof-md" type="boolean">
  Write a markdown heap profile on exit (for CLI analysis). If you also pass <code>--heap-prof</code>, Bun uses the
  markdown format
</ParamField>

<ParamField path="--heap-prof-name" type="string">
  Specify the name of the heap profile file
</ParamField>

<ParamField path="--heap-prof-dir" type="string">
  Specify the directory where the heap profile will be saved
</ParamField>

<ParamField path="--heap-prof-interval" type="number" default="524288">
  Accepted for Node.js compatibility. Bun takes the heap snapshot once at exit, so the interval has no effect
</ParamField>
...
<ParamField path="--feature" type="string">
  Enable a feature flag for dead-code elimination, e.g. <code>--feature=SUPER_SECRET</code>
</ParamField>
...
<ParamField path="--tls-min-v1.0" type="boolean">
  Set the default TLS minimum to TLSv1.0
</ParamField>

<ParamField path="--tls-min-v1.1" type="boolean">
  Set the default TLS minimum to TLSv1.1
</ParamField>

<ParamField path="--tls-min-v1.2" type="boolean">
  Set the default TLS minimum to TLSv1.2
</ParamField>

<ParamField path="--tls-min-v1.3" type="boolean">
  Set the default TLS minimum to TLSv1.3
</ParamField>

<ParamField path="--tls-max-v1.2" type="boolean">
  Set the default TLS maximum to TLSv1.2
</ParamField>

<ParamField path="--tls-max-v1.3" type="boolean">
  Set the default TLS maximum to TLSv1.3
</ParamField>

<ParamField path="--insecure-http-parser" type="boolean">
  Use an insecure HTTP parser that accepts invalid HTTP headers
</ParamField>

<ParamField path="--experimental-http2-fetch" type="boolean">
  Offer <code>h2</code> in the TLS ALPN of <code>fetch()</code>. Same as{" "}
  <code>BUN_FEATURE_FLAG_EXPERIMENTAL_HTTP2_CLIENT=1</code>
</ParamField>

<ParamField path="--experimental-http3-fetch" type="boolean">
  Honor <code>Alt-Svc: h3</code> in <code>fetch()</code> and upgrade to HTTP/3. Same as{" "}
  <code>BUN_FEATURE_FLAG_EXPERIMENTAL_HTTP3_CLIENT=1</code>
</ParamField>
...
<ParamField path="--no-env-file" type="boolean">
  Disable automatic loading of <code>.env</code> files
</ParamField>
