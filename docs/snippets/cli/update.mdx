...
<ParamField path="--exact" type="boolean">
  Write exact versions to <code>package.json</code> instead of <code>^</code> or <code>~</code> ranges. Alias:{" "}
  <code>-E</code>
</ParamField>
...
<ParamField path="--filter" type="string">
  Update packages for the matching workspaces. Alias: <code>-F</code>
</ParamField>
