		...
		categories: [
			{
				...
				icon: "binary",
				items: [
					{ title: "Convert an ArrayBuffer to an array of numbers", href: "/guides/binary/arraybuffer-to-array" },
					{ title: "Convert an ArrayBuffer to a Blob", href: "/guides/binary/arraybuffer-to-blob" },
					{ title: "Convert an ArrayBuffer to a Buffer", href: "/guides/binary/arraybuffer-to-buffer" },
					{ title: "Convert an ArrayBuffer to a string", href: "/guides/binary/arraybuffer-to-string" },
					{ title: "Convert an ArrayBuffer to a Uint8Array", href: "/guides/binary/arraybuffer-to-typedarray" },
					...
					{ title: "Convert a Buffer to an ArrayBuffer", href: "/guides/binary/buffer-to-arraybuffer" },
					{ title: "Convert a Buffer to a blob", href: "/guides/binary/buffer-to-blob" },
					{ title: "Convert a Buffer to a ReadableStream", href: "/guides/binary/buffer-to-readablestream" },
					{ title: "Convert a Buffer to a string", href: "/guides/binary/buffer-to-string" },
					{ title: "Convert a Buffer to a Uint8Array", href: "/guides/binary/buffer-to-typedarray" },
					{ title: "Convert a DataView to a string", href: "/guides/binary/dataview-to-string" },
					{ title: "Convert a Uint8Array to an ArrayBuffer", href: "/guides/binary/typedarray-to-arraybuffer" },
					{ title: "Convert a Uint8Array to a Blob", href: "/guides/binary/typedarray-to-blob" },
					{ title: "Convert a Uint8Array to a Buffer", href: "/guides/binary/typedarray-to-buffer" },
					{ title: "Convert a Uint8Array to a DataView", href: "/guides/binary/typedarray-to-dataview" },
					{ title: "Convert a Uint8Array to a ReadableStream", href: "/guides/binary/typedarray-to-readablestream" },
					{ title: "Convert a Uint8Array to a string", href: "/guides/binary/typedarray-to-string" },
				],
			},
			{
				key: "deployment",
				...
				icon: "server",
				items: [
					{ title: "Deploy a Bun application on Railway", href: "/guides/deployment/railway" },
				],
			},
			{
				key: "ecosystem",
				...
				items: [
					...
					{ title: "Use Neon Postgres through Drizzle ORM", href: "/guides/ecosystem/neon-drizzle" },
					{ title: "Build an HTTP server using Hono and Bun", href: "/guides/ecosystem/hono" },
					{ title: "Use Neon\'s Serverless Postgres with Bun", href: "/guides/ecosystem/neon-serverless-postgres" },
					...
					{ title: "Build an HTTP server using Express and Bun", href: "/guides/ecosystem/express" },
					{ title: "Server-side render (SSR) a React component", href: "/guides/ecosystem/ssr-react" },
					{ title: "Build an HTTP server using StricJS and Bun", href: "/guides/ecosystem/stric" },
					{ title: "Read and write data to MongoDB using Mongoose and Bun", href: "/guides/ecosystem/mongoose" },
				],
			},
			{
				key: "htmlrewriter",
				...
				icon: "file-code-2",
				items: [
					{ title: "Extract links from a webpage using HTMLRewriter", href: "/guides/html-rewriter/extract-links" },
					{ title: "Extract social share images and Open Graph tags", href: "/guides/html-rewriter/extract-social-meta" },
				],
			},
			{
				key: "http",
				...
				items: [
					...
					{ title: "Streaming HTTP Server with Async Iterators", href: "/guides/http/stream-iterator" },
			...
			},
			{
				...
				items: [
					...
					{ title: "Using bun install with Artifactory", href: "/guides/install/jfrog-artifactory" },
					{ title: "Generate a yarn-compatible lockfile", href: "/guides/install/yarnlock" },
					{ title: "Migrate from npm install to bun install", href: "/guides/install/from-npm-install-to-bun-install" },
					...
					{ title: "Configure git to diff Bun\'s lockb lockfile", href: "/guides/install/git-diff-bun-lockfile" },
					{ title: "Install dependencies with Bun in GitHub Actions", href: "/guides/install/cicd" },
					{ title: "Override the default npm registry for bun install", href: "/guides/install/custom-registry" },
					{ title: "Using bun install with an Azure Artifacts npm registry", href: "/guides/install/azure-artifacts" },
					{ title: "Configure a private registry for an organization scope with bun install", href: "/guides/install/registry-scope" },
				],
			},
			{
				key: "processes",
			...
			},
			{
				...
				items: [
					...
					{ title: "Build-time constants with --define", href: "/guides/runtime/build-time-constants" },
					...
					{ title: "Debugging Bun with the VS Code extension", href: "/guides/runtime/vscode-debugger" },
					{ title: "Inspect memory usage using V8 heap snapshots", href: "/guides/runtime/heap-snapshot" },
					{ title: "Define and replace static globals & constants", href: "/guides/runtime/define-constant" },
					{ title: "Codesign a single-file JavaScript executable on macOS", href: "/guides/runtime/codesign-macos-executable" },
				],
			},
			{
				key: "streams",
				...
				items: [
					...
					{ title: "Convert a Node.js Readable to JSON", href: "/guides/streams/node-readable-to-json" },
					{ title: "Convert a ReadableStream to a Blob", href: "/guides/streams/to-blob" },
					{ title: "Convert a Node.js Readable to a Blob", href: "/guides/streams/node-readable-to-blob" },
					...
					{ title: "Convert a Node.js Readable to a string", href: "/guides/streams/node-readable-to-string" },
					{ title: "Convert a ReadableStream to a Uint8Array", href: "/guides/streams/to-typedarray" },
					{ title: "Convert a ReadableStream to an ArrayBuffer", href: "/guides/streams/to-arraybuffer" },
					{ title: "Convert a Node.js Readable to an Uint8Array", href: "/guides/streams/node-readable-to-uint8array" },
					{ title: "Convert a Node.js Readable to an ArrayBuffer", href: "/guides/streams/node-readable-to-arraybuffer" },
					{ title: "Convert a ReadableStream to an array of chunks", href: "/guides/streams/to-array" },
				],
			},
			{
				key: "test",
				...
				items: [
					...
					{ title: "Migrate from Jest to Bun's test runner", href: "/guides/test/migrate-from-jest" },
					...
					{ title: "Write browser DOM tests with Bun and happy-dom", href: "/guides/test/happy-dom" },
					{ title: "Set a per-test timeout with the Bun test runner", href: "/guides/test/timeout" },
					{ title: "Mark a test as a \"todo\" with the Bun test runner", href: "/guides/test/todo-tests" },
					{ title: "Re-run tests multiple times with the Bun test runner", href: "/guides/test/rerun-each" },
					{ title: "Set a code coverage threshold with the Bun test runner", href: "/guides/test/coverage-threshold" },
					{ title: "Generate code coverage reports with the Bun test runner", href: "/guides/test/coverage" },
					{ title: "import, require, and test Svelte components with bun test", href: "/guides/test/svelte-test" },
				],
			},
			{
				key: "utilities",
				...
				items: [
					...
					{ title: "Convert a file URL to an absolute path", href: "/guides/util/file-url-to-path" },
					{ title: "Compress and decompress data with gzip", href: "/guides/util/gzip" },
					{ title: "Convert an absolute path to a file URL", href: "/guides/util/path-to-file-url" },
					{ title: "Get the path to an executable bin file", href: "/guides/util/which-path-to-executable-bin" },
					...
					{ title: "Get the absolute path of the current file", href: "/guides/util/import-meta-path" },
			...
			},
			{
				...
				items: [
					...
					{ title: "Enable compression for WebSocket messages", href: "/guides/websocket/compression" },
					{ title: "Build a publish-subscribe WebSocket server", href: "/guides/websocket/pubsub" },
					{ title: "Set per-socket contextual data on a WebSocket", href: "/guides/websocket/context" },
				],
			},
			{
				key: "write-file",
