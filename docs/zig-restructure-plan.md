...
| `cxx` (`:79-95`)                | `s                                                                                                                                                                  | src/bun.js/bindings | src/jsc/bindings | g`, `s | src/bun.js/modules | src/jsc/modules | g`, `s | src/bun.js/webview | src/runtime/webview | `, add `"src/highway*sys/*.cpp"`, `"src/simdutf*sys/*.cpp"`, drop `"src/vm/_.cpp"`(now under`jsc/bindings/vm/`), `"src/deps/_.cpp"`stays until`libuwsockets\*.cpp` relocates |
