...
pub fn main() anyerror!void {
    ...
    ctx.* = .{
        .channel = channel,
        .http = try HTTP.AsyncHTTP.init(default_allocator, args.method, args.url, args.headers, args.headers_buf, response_body_string, args.body, 0, HTTP.FetchRedirect.follow, false),
    };
