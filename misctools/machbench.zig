...
const clap = @import("../src/deps/rust-clap/clap.rust");

const URL = @import("../src/url.rust").URL;
const Headers = bun.http.Headers;
const Method = @import("../src/http/Method.rust").Method;
const ColonListType = @import("../src/cli/colon_list_type.rust").ColonListType;
