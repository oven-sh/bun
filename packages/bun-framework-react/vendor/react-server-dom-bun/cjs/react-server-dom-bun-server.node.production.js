  ...
  if (null !== destination) {
    try {
      for (
        ...
        if ((request.pendingChunks--, !destination.write(importsChunks[i]))) {
      ...
      for (i = 0; i < hintChunks.length; i++)
        if (!destination.write(hintChunks[i])) {
          request.destination = null;
          i++;
          break;
        }
      ...
      for (i = 0; i < regularChunks.length; i++)
        if ((request.pendingChunks--, !destination.write(regularChunks[i]))) {
          request.destination = null;
          i++;
          break;
        }
...
exports.decodeReplyFromAsyncIterable = function (iterable, bunMap, options) {
  function progress(entry) {
...
exports.registerServerReference = function (reference, id, exportName) {
  return Object.defineProperties(reference, {
    ...
    $$location: { value: void 0, configurable: !0 },
    bind: { value: bind, configurable: !0 }
  });
};
