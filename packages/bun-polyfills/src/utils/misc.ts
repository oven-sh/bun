import type { FileBlob, SpawnOptions } from "bun";
...
export function isOptions(
  options: any,
): options is SpawnOptions.OptionsObject<SpawnOptions.Writable, SpawnOptions.Readable, SpawnOptions.Readable> {
...
export function isFileBlob(blob: any): blob is FileBlob {
  return (
    ...
    Reflect.get(blob, "readable") instanceof ReadableStream &&
    typeof Reflect.get(blob, "writer") === "function"
  );
}
