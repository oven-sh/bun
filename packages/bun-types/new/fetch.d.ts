...
declare global {
   ...
   */
  function fetch(request: Request, init?: BunFetchRequestInit): Promise<Response>;
  /**
   * Send a HTTP(s) request
   *
   ...
   * @returns A promise that resolves to {@link Response} object.
   */
  function fetch(url: string | URL | Request, init?: BunFetchRequestInit): Promise<Response>;
   ...
   * @returns A promise that resolves to {@link Response} object.
   */
  function fetch(input: string | URL | Request, init?: BunFetchRequestInit): Promise<Response>;
