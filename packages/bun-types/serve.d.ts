declare module "bun" {
  ...
  namespace Serve {
     ...
     * Non-canonical paths (containing `.`, `..`, empty segments, `\`, `#`,
     * `%2F`, or a `%XX` sequence encoding a character that may appear
     ...
     * clamped by the kernel. Routing is case-sensitive but filesystems on
     * macOS and Windows are not by default: do not place access-controlled
     * content inside `dir` and rely on an overlapping route to gate it.
     *
