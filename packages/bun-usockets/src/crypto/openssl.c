...
#define CASE_X509_ERR(CODE) case X509_V_ERR_##CODE: code = #CODE; break;
  switch (err) {
    ...
    CASE_X509_ERR(SUBJECT_ISSUER_MISMATCH)
    CASE_X509_ERR(AKID_SKID_MISMATCH)
    CASE_X509_ERR(AKID_ISSUER_SERIAL_MISMATCH)
    CASE_X509_ERR(KEYUSAGE_NO_CERTSIGN)
    CASE_X509_ERR(UNABLE_TO_GET_CRL_ISSUER)
    CASE_X509_ERR(UNHANDLED_CRITICAL_EXTENSION)
    CASE_X509_ERR(KEYUSAGE_NO_CRL_SIGN)
    CASE_X509_ERR(UNHANDLED_CRITICAL_CRL_EXTENSION)
    CASE_X509_ERR(INVALID_NON_CA)
    CASE_X509_ERR(PROXY_PATH_LENGTH_EXCEEDED)
    CASE_X509_ERR(KEYUSAGE_NO_DIGITAL_SIGNATURE)
    CASE_X509_ERR(PROXY_CERTIFICATES_NOT_ALLOWED)
    CASE_X509_ERR(INVALID_EXTENSION)
    CASE_X509_ERR(INVALID_POLICY_EXTENSION)
    CASE_X509_ERR(NO_EXPLICIT_POLICY)
    CASE_X509_ERR(DIFFERENT_CRL_SCOPE)
    CASE_X509_ERR(UNSUPPORTED_EXTENSION_FEATURE)
    CASE_X509_ERR(UNNESTED_RESOURCE)
    CASE_X509_ERR(PERMITTED_VIOLATION)
    CASE_X509_ERR(EXCLUDED_VIOLATION)
    CASE_X509_ERR(SUBTREE_MINMAX)
    CASE_X509_ERR(APPLICATION_VERIFICATION)
    CASE_X509_ERR(UNSUPPORTED_CONSTRAINT_TYPE)
    CASE_X509_ERR(UNSUPPORTED_CONSTRAINT_SYNTAX)
    CASE_X509_ERR(UNSUPPORTED_NAME_SYNTAX)
    CASE_X509_ERR(CRL_PATH_VALIDATION_ERROR)
    CASE_X509_ERR(HOSTNAME_MISMATCH)
    CASE_X509_ERR(EMAIL_MISMATCH)
    CASE_X509_ERR(IP_ADDRESS_MISMATCH)
    CASE_X509_ERR(INVALID_CALL)
    CASE_X509_ERR(STORE_LOOKUP)
    CASE_X509_ERR(NAME_CONSTRAINTS_WITHOUT_SANS)
  }
#undef CASE_X509_ERR
  return code;
}
