...
struct us_poll_t *us_create_poll(struct us_loop_t *loop, int fallthrough, unsigned int ext_size) {
    struct us_poll_t *p = (struct us_poll_t *) us_malloc(sizeof(struct us_poll_t) + ext_size);
...
struct us_timer_t *us_create_timer(struct us_loop_t *loop, int fallthrough, unsigned int ext_size) {
    struct us_internal_callback_t *cb = us_malloc(sizeof(struct us_internal_callback_t) + sizeof(uv_timer_t) + ext_size);
...
struct us_internal_async *us_internal_create_async(struct us_loop_t *loop, int fallthrough, unsigned int ext_size) {
    struct us_internal_callback_t *cb = us_malloc(sizeof(struct us_internal_callback_t) + sizeof(uv_async_t) + ext_size);
