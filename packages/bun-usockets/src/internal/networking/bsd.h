...
/* See us_socket_send_progress_mark. A monotonic delivered-bytes counter: Linux
 * TCP_INFO tcpi_bytes_acked, macOS tcpi_txbytes, Windows SIO_TCP_INFO BytesOut.
 * Returns 0 and writes the mark, or -1 when the platform or socket kind cannot
 * answer. */
