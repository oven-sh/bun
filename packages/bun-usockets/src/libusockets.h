 ...
 * handlers must remain indirect (uWS C++); Bun-defined kinds compile to direct
 * calls and never read it.
 *
 ...
 * lazily on first socket add. Idempotent. vtable/ext may be NULL (Bun-defined
 * kinds use neither). */
