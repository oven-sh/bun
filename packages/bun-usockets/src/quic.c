...
extern void us_ssl_ctx_set_verify_signature_algorithms(SSL_CTX *ctx);
    ...
    unsigned int conn_ext_size, unsigned int stream_ext_size)
{
    ...
    /* Accept Ed25519 peer signatures, matching the H1/H2 client. */
    us_ssl_ctx_set_verify_signature_algorithms(ssl);
