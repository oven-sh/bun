 ...
 *
 * Call before anything shuts the send half: lsquic_stream_close sets
 * STREAM_U_WRITE_DONE, after which maybe_reset sends nothing. Its do_close
 * only shuts the read half in that case, hence the separate close. */
