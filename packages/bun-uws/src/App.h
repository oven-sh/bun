...
public:
    ...
    TemplatedApp &&setFlags(bool requireHostHeader, bool useStrictMethodValidation, bool validateHostHeaderValue) {
        ...
        httpContext->getSocketContextData()->flags.validateHostHeaderValue = validateHostHeaderValue;
        return std::move(*this);
    }
