...
| `timings-chart.ts`             | `timings.html`: the most recent runs as Gantt charts, a lane per sort of command; one self-contained page                                                               |
