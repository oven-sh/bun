...
export function freebsdSysroot(
  pin: { version: string; baseUrl: string },
  sysroot: { x64: string; aarch64: string },
): Tool {
  ...
  return {
    ...
    variables: {
      FREEBSD_AMD64_URL: url("amd64"),
      FREEBSD_ARM64_URL: url("arm64"),
      FREEBSD_SYSROOT_X64: sysroot.x64,
      FREEBSD_SYSROOT_AARCH64: sysroot.aarch64,
    },
  };
}
