 ...
 */
export function muslSysroot(
  image: LinuxImage,
  pin: { alpineRelease: string },
  ...
  return {
    ...
    variables: {
      ALPINE_REPOSITORY: repository,
      ALPINE_HOST_ARCH: host,
      MUSL_SYSROOT_X64: sysroot.x64,
      MUSL_SYSROOT_AARCH64: sysroot.aarch64,
    },
  };
}
