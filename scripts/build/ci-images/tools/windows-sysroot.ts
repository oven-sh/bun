...
export function windowsSysroot(
  image: LinuxImage,
  pin: { xwin: string; sdk: string; crt: string },
  sysroot: string,
): Tool {
  ...
  return {
    ...
    variables: { WINDOWS_SYSROOT: sysroot, XWIN_URL: url, WINDOWS_SDK_VERSION: pin.sdk, MSVC_CRT_VERSION: pin.crt },
  };
}
