...
import { download, log, run, scratchDir, sudo, warn } from "../bootstrap/runtime.ts";
...
export const crossBinutils: Component = {
  name: "cross-binutils",
  linux: {
    artifacts: () => ({}),
    steps: ctx => {
...
export const androidNdk: Component = {
  name: "android-ndk",
  linux: {
...
export const freebsdSysroot: Component = {
...
export const glibcSysroot: Component = {
  name: "glibc-sysroot",
  linux: {
    artifacts: image => {
      if (!image.buildHost) return {};
...
export const muslSysroot: Component = {
  name: "musl-sysroot",
  linux: {
...
export const windowsSysroot: Component = {
...
export const macosSdk: Component = {
  name: "macos-sdk",
  linux: {
