...
// download headers at test time. The windows half is nodejs.windows.ts.

import { join } from "node:path";
import { nodejsDownload, nodejsFolderName, nodejsHeadersDownload } from "../artifacts.ts";
import { copyIntoDirectory, ensureDirectory, extractArchive, setOwnerRecursive } from "../bootstrap/ops-posix.ts";
import { download, runOutput, scratchDir, verify, writeText } from "../bootstrap/runtime.ts";
