...
// against the image's root paths. The windows halves are runtimes.windows.ts.

import { join } from "node:path";
import { ageDownload, buildkiteAgentDownload, bunDownload, bunTriplet, curlH3Download } from "../artifacts.ts";
import { ensureSymlink, extractArchive, installFile } from "../bootstrap/ops-posix.ts";
import { download, log, run, runOutput, scratchDir, verify } from "../bootstrap/runtime.ts";
