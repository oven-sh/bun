...
export const powershell: WindowsComponent = {
  name: "powershell",
 ...
 * bun dev can ssh in.
 */
export const openssh: WindowsComponent = {
  name: "openssh",
...
export const ccache: WindowsComponent = {
  name: "ccache",
...
export const pdbAddr2line: WindowsComponent = {
  name: "pdb-addr2line",
  artifacts: () => ({}),
  steps: ctx => {
    const { image } = ctx;
...
export const visualStudio: WindowsComponent = {
  name: "visual-studio",
...
export const intelSde: WindowsComponent = {
  name: "intel-sde",
  artifacts: image => {
