...
//
// Pure: no bundler, no side effects. naming.ts (the hash), check.ts, and
// machine.ts (the consumer) read paths and the digest from here; the files
// themselves are produced by generate.ts.
