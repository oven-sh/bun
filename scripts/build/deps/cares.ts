...
const POSIX = def1([
  ...
  "HAVE_ARC4RANDOM_BUF", "HAVE_CLOCK_GETTIME_MONOTONIC", "HAVE_FCNTL_O_NONBLOCK",
  "HAVE_GETIFADDRS", "HAVE_GETTIMEOFDAY", "HAVE_IF_INDEXTONAME",
  "HAVE_IF_NAMETOINDEX", "HAVE_INET_NET_PTON", "HAVE_INET_NTOP", "HAVE_INET_PTON",
...
const DARWIN = def1([
  ...
  "HAVE_KQUEUE", "HAVE_GETRANDOM", "CARES_USE_LIBRESOLV",
]);
