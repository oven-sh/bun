 ...
 */
export const WEBKIT_VERSION = "autobuild-preview-pr-397-578ca7b9"; // oven-sh/WebKit#397 (snapshot support), on top of main's pin 171babe26c3b; swap for the merge sha before landing
