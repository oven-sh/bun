 ...
 */
export const WEBKIT_VERSION = "autobuild-preview-pr-397-e7a79223"; // oven-sh/WebKit#397 (snapshot support), based on ddea71318fec; rebase onto main's pin (171babe26c3b) and swap for the merge sha before landing
