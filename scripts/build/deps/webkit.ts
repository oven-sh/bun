 ...
 */
export const WEBKIT_VERSION = "autobuild-preview-pr-397-78136ea3"; // oven-sh/WebKit#397 (snapshot support); main is on 447082ab6897 — swap for the merge sha before landing
