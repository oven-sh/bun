 ...
 */
// Preview build of oven-sh/WebKit#302 (WebKit 0f966e81 + that change + a CI
// Dockerfile fix); bump to the merged commit once it lands.
export const WEBKIT_VERSION = "autobuild-preview-pr-302-672dd8f5";
