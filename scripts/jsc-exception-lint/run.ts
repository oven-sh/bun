...
async function main() {
  ...
  if (updateSummaries) {
    ...
    if (existsSync(wkSummaries)) {
      writeFileSync(
        committedWebKit,
        trimSummaries(wkSummaries, [
          `webkit ${wkVersion}`,
          "JavaScriptCore callee summaries that differ from the JSGlobalObject*/ThrowScope& convention.",
          "Generated by scripts/jsc-exception-lint/run.ts --update-summaries --webkit. Do not edit.",
  ...
  if (exportArgs.length) {
    ...
    writeFileSync(
      committedBun,
      trimSummaries(full, [
        "Bun callee summaries that differ from the JSGlobalObject*/ThrowScope& convention.",
        "Generated by scripts/jsc-exception-lint/run.ts --update-summaries. Do not edit.",
        "mangled name, qualified name/arity, kind, exit states, verifies at entry",
      ]),
    );
