...
pkgs.mkShell rec {
  ...
  shellHook = ''
    export CC="${pkgs.lib.getExe pkgs.clang_20}"
    export CXX="${pkgs.lib.getExe' pkgs.clang_20 "clang++"}"
    export AR="${pkgs.llvm_20}/bin/llvm-ar"
    export RANLIB="${pkgs.llvm_20}/bin/llvm-ranlib"
  ...
  '' + pkgs.lib.optionalString pkgs.stdenv.isLinux ''
    export LD="${pkgs.lib.getExe' pkgs.lld_20 "ld.lld"}"
