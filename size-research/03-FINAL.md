...
- **The ICU avenue is closed on all THREE axes** (data GT#1, UCONFIG, code modulo B3). w3-weird-ideas added a 4th: ICU's statically-compiled property tries (0.15 MB zstd-able) are HOT in `u_charType`/regex `\w`. PERF-LOCKED.
