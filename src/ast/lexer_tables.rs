...
bun_core::comptime_string_map! {
    pub static PROPERTY_MODIFIER_KEYWORDS: PropertyModifierKeyword = {
...
bun_core::comptime_string_map! {
    pub static JSX_ENTITY: CodePoint = {
        b"Aacute" => 0x00C1,
        b"aacute" => 0x00E1,
        b"Acirc" => 0x00C2,
        b"acirc" => 0x00E2,
...
/// UTF-16 overload of [`is_latin1_identifier`]. Walks code units directly
/// (no narrowing/alloc): any unit `> 0xFF` fails the predicate, otherwise
