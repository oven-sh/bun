...
impl Log {
    ...
    fn add_formatted_msg(
        ...
        self.add_msg(Msg {
            ...
            data,
            notes,
            redact_sensitive_information: redact == Redact::Yes,
            ..Default::default()
        })
    }
    ...
    pub fn add_range_error_fmt(
        ...
        let text = alloc_print(args);
        self.add_formatted_msg(Kind::Err, source, r, text, Box::default(), true, Redact::No)
    }
    ...
    pub fn add_range_error_fmt_with_notes(
        ...
        let text = alloc_print(args);
        self.add_formatted_msg(Kind::Err, source, r, text, notes, true, Redact::No)
    }
    ...
    pub fn add_range_warning_fmt_with_notes(
        ...
        let text = alloc_print(args);
        self.add_formatted_msg(Kind::Warn, source, r, text, notes, true, Redact::No)
    }
