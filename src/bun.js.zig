...
pub const Run = struct {
    ...
    pub fn start(this: *Run) void {
        ...
        if (this.ctx.runtime_options.cpu_prof.enabled or bun.env_var.BUN_CPU_PROFILE.get() or bun.env_var.BUN_CPU_PROFILE_MD.get()) {
            ...
            vm.cpu_profiler_config = CPUProfiler.CPUProfilerConfig{
                ...
                .md_format = cpu_prof_opts.md_format or bun.env_var.BUN_CPU_PROFILE_MD.get(),
