...
pub const BunObject = struct {
    ...
    pub const unstable_markdown = toJSLazyPropertyCallback(Bun.getMarkdownObject);
    ...
    pub fn exportAll() void {
        ...
        @export(&BunObject.unstable_markdown, .{ .name = lazyPropertyCallbackName("unstable_markdown") });
