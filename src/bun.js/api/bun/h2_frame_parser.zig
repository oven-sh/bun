...
const FullSettingsPayload = packed struct(u288) {
    ...
    pub fn toJS(this: *FullSettingsPayload, globalObject: *jsc.JSGlobalObject) jsc.JSValue {
        ...
        result.put(globalObject, bun.String.static("headerTableSize"), jsc.JSValue.jsNumber(this.headerTableSize));
        result.put(globalObject, bun.String.static("enablePush"), jsc.JSValue.jsBoolean(this.enablePush > 0));
        result.put(globalObject, bun.String.static("maxConcurrentStreams"), jsc.JSValue.jsNumber(this.maxConcurrentStreams));
        result.put(globalObject, bun.String.static("initialWindowSize"), jsc.JSValue.jsNumber(this.initialWindowSize));
        result.put(globalObject, bun.String.static("maxFrameSize"), jsc.JSValue.jsNumber(this.maxFrameSize));
        result.put(globalObject, bun.String.static("maxHeaderListSize"), jsc.JSValue.jsNumber(this.maxHeaderListSize));
        result.put(globalObject, bun.String.static("maxHeaderSize"), jsc.JSValue.jsNumber(this.maxHeaderListSize));
        ...
        result.put(globalObject, bun.String.static("enableConnectProtocol"), .false);
        return result;
    }
...
pub const H2FrameParser = struct {
    ...
    pub fn getCurrentState(this: *H2FrameParser, globalObject: *jsc.JSGlobalObject, _: *jsc.CallFrame) bun.JSError!JSValue {
        ...
        result.put(globalObject, bun.String.static("effectiveLocalWindowSize"), jsc.JSValue.jsNumber(this.windowSize));
        result.put(globalObject, bun.String.static("effectiveRecvDataLength"), jsc.JSValue.jsNumber(this.windowSize - this.usedWindowSize));
        result.put(globalObject, bun.String.static("nextStreamID"), jsc.JSValue.jsNumber(this.getNextStreamID()));
        result.put(globalObject, bun.String.static("lastProcStreamID"), jsc.JSValue.jsNumber(this.lastStreamID));

        const settings: FullSettingsPayload = this.remoteSettings orelse .{};
        result.put(globalObject, bun.String.static("remoteWindowSize"), jsc.JSValue.jsNumber(settings.initialWindowSize));
        result.put(globalObject, bun.String.static("localWindowSize"), jsc.JSValue.jsNumber(this.localSettings.initialWindowSize));
        result.put(globalObject, bun.String.static("deflateDynamicTableSize"), jsc.JSValue.jsNumber(this.localSettings.headerTableSize));
        result.put(globalObject, bun.String.static("inflateDynamicTableSize"), jsc.JSValue.jsNumber(this.localSettings.headerTableSize));
        result.put(globalObject, bun.String.static("outboundQueueSize"), jsc.JSValue.jsNumber(this.outboundQueueSize));
        return result;
    }
    ...
    pub fn getStreamState(this: *H2FrameParser, globalObject: *jsc.JSGlobalObject, callframe: *jsc.CallFrame) bun.JSError!JSValue {
        ...
        state.put(globalObject, bun.String.static("localWindowSize"), jsc.JSValue.jsNumber(stream.windowSize));
        state.put(globalObject, bun.String.static("state"), jsc.JSValue.jsNumber(@intFromEnum(stream.state)));
        state.put(globalObject, bun.String.static("localClose"), jsc.JSValue.jsNumber(@as(i32, if (stream.canSendData()) 0 else 1)));
        state.put(globalObject, bun.String.static("remoteClose"), jsc.JSValue.jsNumber(@as(i32, if (stream.canReceiveData()) 0 else 1)));
        // TODO: sumDependencyWeight
        state.put(globalObject, bun.String.static("sumDependencyWeight"), jsc.JSValue.jsNumber(0));
        state.put(globalObject, bun.String.static("weight"), jsc.JSValue.jsNumber(stream.weight));
