...
const errors: ErrorCodeMapping = [
  ...
  ["ERR_VALKEY_CONNECTION_CLOSED", Error],
  ["ERR_VALKEY_INVALID_RESPONSE", Error],
  ["ERR_VALKEY_INVALID_BULK_STRING", Error],
  ["ERR_VALKEY_INVALID_ARRAY", Error],
  ["ERR_VALKEY_INVALID_INTEGER", Error],
  ["ERR_VALKEY_INVALID_SIMPLE_STRING", Error],
  ["ERR_VALKEY_INVALID_ERROR_STRING", Error],
  ["ERR_VALKEY_TLS_NOT_AVAILABLE", Error],
  ["ERR_VALKEY_TLS_UPGRADE_FAILED", Error],
  ["ERR_VALKEY_AUTHENTICATION_FAILED", Error],
  ["ERR_VALKEY_INVALID_PASSWORD", Error],
  ["ERR_VALKEY_INVALID_USERNAME", Error],
  ["ERR_VALKEY_INVALID_DATABASE", Error],
  ["ERR_VALKEY_INVALID_COMMAND", Error],
  ["ERR_VALKEY_INVALID_ARGUMENT", Error],
];
