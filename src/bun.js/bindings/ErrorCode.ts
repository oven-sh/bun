...
const errors: ErrorCodeMapping = [
  ...
  ["ERR_VALKEY_CONNECTION_CLOSED", Error, "ValkeyError"],
  ["ERR_VALKEY_INVALID_RESPONSE", Error, "ValkeyError"],
  ["ERR_VALKEY_INVALID_BULK_STRING", Error, "ValkeyError"],
  ["ERR_VALKEY_INVALID_ARRAY", Error, "ValkeyError"],
  ["ERR_VALKEY_INVALID_INTEGER", Error, "ValkeyError"],
  ["ERR_VALKEY_INVALID_SIMPLE_STRING", Error, "ValkeyError"],
  ["ERR_VALKEY_INVALID_ERROR_STRING", Error, "ValkeyError"],
  ["ERR_VALKEY_TLS_NOT_AVAILABLE", Error, "ValkeyError"],
  ["ERR_VALKEY_TLS_UPGRADE_FAILED", Error, "ValkeyError"],
  ["ERR_VALKEY_AUTHENTICATION_FAILED", Error, "ValkeyError"],
  ["ERR_VALKEY_INVALID_PASSWORD", Error, "ValkeyError"],
  ["ERR_VALKEY_INVALID_USERNAME", Error, "ValkeyError"],
  ["ERR_VALKEY_INVALID_DATABASE", Error, "ValkeyError"],
  ["ERR_VALKEY_INVALID_COMMAND", Error, "ValkeyError"],
  ["ERR_VALKEY_INVALID_ARGUMENT", Error, "ValkeyError"],
  ["ERR_VALKEY_INVALID_RESPONSE_TYPE", Error, "ValkeyError"],
];
