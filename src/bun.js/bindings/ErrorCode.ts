...
const errors: ErrorCodeMapping = [
  ...
  ["ERR_REDIS_CONNECTION_CLOSED", Error],
  ["ERR_REDIS_INVALID_RESPONSE", Error],
  ["ERR_REDIS_INVALID_BULK_STRING", Error],
  ["ERR_REDIS_INVALID_ARRAY", Error],
  ["ERR_REDIS_INVALID_INTEGER", Error],
  ["ERR_REDIS_INVALID_SIMPLE_STRING", Error],
  ["ERR_REDIS_INVALID_ERROR_STRING", Error],
  ["ERR_REDIS_TLS_NOT_AVAILABLE", Error],
  ["ERR_REDIS_TLS_UPGRADE_FAILED", Error],
  ["ERR_REDIS_AUTHENTICATION_FAILED", Error],
  ["ERR_REDIS_INVALID_PASSWORD", Error],
  ["ERR_REDIS_INVALID_USERNAME", Error],
  ["ERR_REDIS_INVALID_DATABASE", Error],
  ["ERR_REDIS_INVALID_COMMAND", Error],
  ["ERR_REDIS_INVALID_ARGUMENT", Error],
];
