...
const errors: ErrorCodeMapping = [
  ...
  ["ERR_POSTGRES_COPY_BOTH_NOT_IMPLEMENTED", Error, "PostgresError"],
  ["ERR_POSTGRES_COPY_BUFFER_TOO_LARGE", RangeError, "PostgresError"],
  ["ERR_POSTGRES_COPY_CHUNK_TOO_LARGE", RangeError, "PostgresError"],
  ["ERR_POSTGRES_COPY_TIMEOUT", Error, "PostgresError"],
  ["ERR_POSTGRES_COPY_WRITE_FAILED", Error, "PostgresError"],
  ...
  ["ERR_POSTGRES_UNEXPECTED_COPY_DATA", Error, "PostgresError"],
