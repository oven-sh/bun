...
/// Generated for "src/bun.js/bindings/NodeModuleModule.zig"
...
/// Generated for "src/bun.js/node/node_os.zig"
...
const binding_internals = struct {
    ...
    const import_NodeModuleModule = @import("../../bun.js/bindings/NodeModuleModule.zig");
    ...
    const import_node_os = @import("../../bun.js/node/node_os.zig");
