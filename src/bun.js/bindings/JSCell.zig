...
pub const JSCell = extern struct {
    ...
    pub fn getType(this: *JSCell) JSValue.JSType {
        JSC.markMemberBinding(JSCell, @src());
    ...
    extern "c" fn JSC__JSCell__getObject(this: *JSCell) ?*JSC.JSObject;
    extern "c" fn JSC__JSCell__toObject(this: *JSCell, global: *JSGlobalObject) [*c]JSC.JSObject;
    ...
    extern "c" fn JSC__JSCell__getType(this: *JSCell) u8;
};
