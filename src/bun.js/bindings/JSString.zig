pub const JSString = opaque {
    ...
    extern fn JSC__JSString__isRope(this: *const JSString) bool;
    ...
    /// Does not resolve the rope.
    pub fn isRope(this: *const JSString) bool {
        return JSC__JSString__isRope(this);
    }
