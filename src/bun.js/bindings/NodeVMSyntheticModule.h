...
private:
    ...
    WTF::Vector<WTF::String> m_exportNames;

    NodeVMSyntheticModule(JSC::VM& vm, JSC::Structure* structure, WTF::String identifier, JSValue context, WTF::Vector<WTF::String> exportNames)
