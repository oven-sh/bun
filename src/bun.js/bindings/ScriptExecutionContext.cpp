...
ScriptExecutionContext::~ScriptExecutionContext()
{
    ...
    auto postMessageCompletionHandlers = std::move(m_processMessageWithMessagePortsSoonHandlers);
...
bool ScriptExecutionContext::postTaskTo(ScriptExecutionContextIdentifier identifier, Function<void(ScriptExecutionContext&)>&& task)
{
    ...
    context->postTaskConcurrently(std::move(task));
    return true;
}
...
void ScriptExecutionContext::processMessageWithMessagePortsSoon(CompletionHandler<void()>&& completionHandler)
{
    ...
    m_processMessageWithMessagePortsSoonHandlers.append(std::move(completionHandler));
...
{
    auto* task = new EventLoopTask(std::move(lambda));
