...
std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForBigIntStatsConstructor;
...
std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCryptoConstructor;
...
std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForDebugHTTPSServer;
...
std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForDocEnd;
...
std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForHTMLRewriter;
std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForHTMLRewriterConstructor;
std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForHTTPSServer;
...
std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForStatWatcher;
