...
std::unique_ptr<IsoSubspace> m_subspaceForCryptoHasherConstructor;std::unique_ptr<IsoSubspace> m_subspaceForDebugModeHTTPSServer;
std::unique_ptr<IsoSubspace> m_subspaceForDebugModeHTTPServer;
