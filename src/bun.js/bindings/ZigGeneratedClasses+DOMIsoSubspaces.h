...
std::unique_ptr<IsoSubspace> m_subspaceForFileSystemRouterConstructor;std::unique_ptr<IsoSubspace> m_subspaceForGlob;
std::unique_ptr<IsoSubspace> m_subspaceForGlobConstructor;std::unique_ptr<IsoSubspace> m_subspaceForHTMLRewriter;
...
std::unique_ptr<IsoSubspace> m_subspaceForServerWebSocketConstructor;std::unique_ptr<IsoSubspace> m_subspaceForStatWatcher;
