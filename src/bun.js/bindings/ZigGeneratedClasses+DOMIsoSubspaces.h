...
std::unique_ptr<IsoSubspace> m_subspaceForBigIntStatsConstructor;
...
std::unique_ptr<IsoSubspace> m_subspaceForDocEnd;
...
std::unique_ptr<IsoSubspace> m_subspaceForHTMLRewriter;
std::unique_ptr<IsoSubspace> m_subspaceForHTMLRewriterConstructor;
std::unique_ptr<IsoSubspace> m_subspaceForHTTPSServer;
...
std::unique_ptr<IsoSubspace> m_subspaceForStatWatcher;
