...
extern "C" JSC::EncodedJSValue Bun__initKeyPairGenJob(JSC::JSGlobalObject* lexicalGlobalObject, JSC::JSValue* obj);
    ...
    (JSC::JSGlobalObject * lexicalGlobalObject, JSC::CallFrame* callFrame))
{
    ...
    default: {
        ...
        if (string == "generateKeyPair"_s) {
            ...
            JSValue jsValueObj = obj;
            Bun__initKeyPairGenJob(globalObject, &jsValueObj);
            return JSValue::encode(obj);
        }
