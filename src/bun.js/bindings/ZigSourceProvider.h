...
public:
    ...
    // TODO: Add 'override' once oven-sh/WebKit bun-build-esm branch (4c8aa53fce5e)
    // is merged and a release is built. That branch adds virtual methods to
    // JSC::SourceProvider that these override.
