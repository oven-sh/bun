    ...
    napi_value value)
{
    ...
    auto name = JSC::PropertyName(JSC::Identifier::fromString(vm, std::move(nameStr)));
...

{
    ...
    auto* jsArrayBuffer = JSC::JSArrayBuffer::create(vm, globalObject->arrayBufferStructure(), std::move(arrayBuffer));
    NAPI_RETURN_IF_EXCEPTION(env);
    ...
    bool* copied)
{
    ...
    JSString* out = JSC::jsString(JSC::getVM(globalObject), WTF::String(std::move(impl)));
    ...
    napi_value* result)
{
    ...
    if (data == nullptr || length == 0) {
        ...
        auto* buffer = JSC::JSUint8Array::create(globalObject, subclassStructure, std::move(arrayBuffer), 0, 0);
        NAPI_RETURN_IF_EXCEPTION(env);
    ...
    auto* buffer = JSC::JSUint8Array::create(globalObject, subclassStructure, std::move(arrayBuffer), 0, length);
    NAPI_RETURN_IF_EXCEPTION(env);
    ...
    napi_finalize finalize_cb, void* finalize_hint, napi_value* result)
{
    ...
    auto* buffer = JSC::JSArrayBuffer::create(vm, globalObject->arrayBufferStructure(ArrayBufferSharingMode::Default), std::move(arrayBuffer));
