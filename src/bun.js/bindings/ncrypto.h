...
class BIOPointer final {
    WTF_MAKE_FAST_ALLOCATED(BIOPointer);
...
class CipherCtxPointer final {
    WTF_MAKE_FAST_ALLOCATED(CipherCtxPointer);
...
class EVPKeyPointer final {
    WTF_MAKE_FAST_ALLOCATED(EVPKeyPointer);
...
class DHPointer final {
    WTF_MAKE_FAST_ALLOCATED(DHPointer);
...
class SSLCtxPointer final {
    WTF_MAKE_FAST_ALLOCATED(SSLCtxPointer);
...
class SSLPointer final {
    WTF_MAKE_FAST_ALLOCATED(SSLPointer);
...
class X509Pointer final {
    WTF_MAKE_FAST_ALLOCATED(X509Pointer);
...
class ECDSASigPointer final {
    WTF_MAKE_FAST_ALLOCATED(ECDSASigPointer);
...
class ECGroupPointer final {
    WTF_MAKE_FAST_ALLOCATED(ECGroupPointer);
...
class ECPointPointer final {
    WTF_MAKE_FAST_ALLOCATED(ECPointPointer);
...
class ECKeyPointer final {
    WTF_MAKE_FAST_ALLOCATED(ECKeyPointer);
