...
static JSValue createSQLiteError(JSC::JSGlobalObject* globalObject, sqlite3* db)
{
    ...
    case SQLITE_INTERNAL:
        codeStr = "SQLITE_INTERNAL"_s;
        break;
    case SQLITE_PERM:
        codeStr = "SQLITE_PERM"_s;
        break;
    case SQLITE_ABORT:
        codeStr = "SQLITE_ABORT"_s;
        break;
    case SQLITE_BUSY:
        codeStr = "SQLITE_BUSY"_s;
        break;
    case SQLITE_LOCKED:
        codeStr = "SQLITE_LOCKED"_s;
        break;
    case SQLITE_NOMEM:
        codeStr = "SQLITE_NOMEM"_s;
        break;
    case SQLITE_READONLY:
        codeStr = "SQLITE_READONLY"_s;
        break;
    case SQLITE_INTERRUPT:
        codeStr = "SQLITE_INTERRUPT"_s;
        break;
    case SQLITE_IOERR:
        codeStr = "SQLITE_IOERR"_s;
        break;
    case SQLITE_CORRUPT:
        codeStr = "SQLITE_CORRUPT"_s;
        break;
    case SQLITE_NOTFOUND:
        codeStr = "SQLITE_NOTFOUND"_s;
        break;
    case SQLITE_FULL:
        codeStr = "SQLITE_FULL"_s;
        break;
    case SQLITE_CANTOPEN:
        codeStr = "SQLITE_CANTOPEN"_s;
        break;
    case SQLITE_PROTOCOL:
        codeStr = "SQLITE_PROTOCOL"_s;
        break;
    case SQLITE_EMPTY:
        codeStr = "SQLITE_EMPTY"_s;
        break;
    case SQLITE_SCHEMA:
        codeStr = "SQLITE_SCHEMA"_s;
        break;
    case SQLITE_TOOBIG:
        codeStr = "SQLITE_TOOBIG"_s;
        break;
    case SQLITE_CONSTRAINT:
        codeStr = "SQLITE_CONSTRAINT"_s;
        break;
    case SQLITE_MISMATCH:
        codeStr = "SQLITE_MISMATCH"_s;
        break;
    case SQLITE_MISUSE:
        codeStr = "SQLITE_MISUSE"_s;
        break;
    case SQLITE_NOLFS:
        codeStr = "SQLITE_NOLFS"_s;
        break;
    case SQLITE_AUTH:
        codeStr = "SQLITE_AUTH"_s;
        break;
    case SQLITE_FORMAT:
        codeStr = "SQLITE_FORMAT"_s;
        break;
    case SQLITE_RANGE:
        codeStr = "SQLITE_RANGE"_s;
        break;
    case SQLITE_NOTADB:
        codeStr = "SQLITE_NOTADB"_s;
        break;
    case SQLITE_NOTICE:
        codeStr = "SQLITE_NOTICE"_s;
        break;
    case SQLITE_WARNING:
        codeStr = "SQLITE_WARNING"_s;
        break;
    case SQLITE_ERROR_MISSING_COLLSEQ:
        codeStr = "SQLITE_ERROR_MISSING_COLLSEQ"_s;
        break;
    case SQLITE_ERROR_RETRY:
        codeStr = "SQLITE_ERROR_RETRY"_s;
        break;
    case SQLITE_ERROR_SNAPSHOT:
        codeStr = "SQLITE_ERROR_SNAPSHOT"_s;
        break;
    case SQLITE_IOERR_READ:
        codeStr = "SQLITE_IOERR_READ"_s;
        break;
    case SQLITE_IOERR_SHORT_READ:
        codeStr = "SQLITE_IOERR_SHORT_READ"_s;
        break;
    case SQLITE_IOERR_WRITE:
        codeStr = "SQLITE_IOERR_WRITE"_s;
        break;
    case SQLITE_IOERR_FSYNC:
        codeStr = "SQLITE_IOERR_FSYNC"_s;
        break;
    case SQLITE_IOERR_DIR_FSYNC:
        codeStr = "SQLITE_IOERR_DIR_FSYNC"_s;
        break;
    case SQLITE_IOERR_TRUNCATE:
        codeStr = "SQLITE_IOERR_TRUNCATE"_s;
        break;
    case SQLITE_IOERR_FSTAT:
        codeStr = "SQLITE_IOERR_FSTAT"_s;
        break;
    case SQLITE_IOERR_UNLOCK:
        codeStr = "SQLITE_IOERR_UNLOCK"_s;
        break;
    case SQLITE_IOERR_RDLOCK:
        codeStr = "SQLITE_IOERR_RDLOCK"_s;
        break;
    case SQLITE_IOERR_DELETE:
        codeStr = "SQLITE_IOERR_DELETE"_s;
        break;
    case SQLITE_IOERR_BLOCKED:
        codeStr = "SQLITE_IOERR_BLOCKED"_s;
        break;
    case SQLITE_IOERR_NOMEM:
        codeStr = "SQLITE_IOERR_NOMEM"_s;
        break;
    case SQLITE_IOERR_ACCESS:
        codeStr = "SQLITE_IOERR_ACCESS"_s;
        break;
    case SQLITE_IOERR_CHECKRESERVEDLOCK:
        codeStr = "SQLITE_IOERR_CHECKRESERVEDLOCK"_s;
        break;
    case SQLITE_IOERR_LOCK:
        codeStr = "SQLITE_IOERR_LOCK"_s;
        break;
    case SQLITE_IOERR_CLOSE:
        codeStr = "SQLITE_IOERR_CLOSE"_s;
        break;
    case SQLITE_IOERR_DIR_CLOSE:
        codeStr = "SQLITE_IOERR_DIR_CLOSE"_s;
        break;
    case SQLITE_IOERR_SHMOPEN:
        codeStr = "SQLITE_IOERR_SHMOPEN"_s;
        break;
    case SQLITE_IOERR_SHMSIZE:
        codeStr = "SQLITE_IOERR_SHMSIZE"_s;
        break;
    case SQLITE_IOERR_SHMLOCK:
        codeStr = "SQLITE_IOERR_SHMLOCK"_s;
        break;
    case SQLITE_IOERR_SHMMAP:
        codeStr = "SQLITE_IOERR_SHMMAP"_s;
        break;
    case SQLITE_IOERR_SEEK:
        codeStr = "SQLITE_IOERR_SEEK"_s;
        break;
    case SQLITE_IOERR_DELETE_NOENT:
        codeStr = "SQLITE_IOERR_DELETE_NOENT"_s;
        break;
    case SQLITE_IOERR_MMAP:
        codeStr = "SQLITE_IOERR_MMAP"_s;
        break;
    case SQLITE_IOERR_GETTEMPPATH:
        codeStr = "SQLITE_IOERR_GETTEMPPATH"_s;
        break;
    case SQLITE_IOERR_CONVPATH:
        codeStr = "SQLITE_IOERR_CONVPATH"_s;
        break;
    case SQLITE_IOERR_VNODE:
        codeStr = "SQLITE_IOERR_VNODE"_s;
        break;
    case SQLITE_IOERR_AUTH:
        codeStr = "SQLITE_IOERR_AUTH"_s;
        break;
    case SQLITE_IOERR_BEGIN_ATOMIC:
        codeStr = "SQLITE_IOERR_BEGIN_ATOMIC"_s;
        break;
    case SQLITE_IOERR_COMMIT_ATOMIC:
        codeStr = "SQLITE_IOERR_COMMIT_ATOMIC"_s;
        break;
    case SQLITE_IOERR_ROLLBACK_ATOMIC:
        codeStr = "SQLITE_IOERR_ROLLBACK_ATOMIC"_s;
        break;
    case SQLITE_IOERR_DATA:
        codeStr = "SQLITE_IOERR_DATA"_s;
        break;
    case SQLITE_IOERR_CORRUPTFS:
        codeStr = "SQLITE_IOERR_CORRUPTFS"_s;
        break;
    case SQLITE_IOERR_IN_PAGE:
        codeStr = "SQLITE_IOERR_IN_PAGE"_s;
        break;
    case SQLITE_LOCKED_SHAREDCACHE:
        codeStr = "SQLITE_LOCKED_SHAREDCACHE"_s;
        break;
    case SQLITE_LOCKED_VTAB:
        codeStr = "SQLITE_LOCKED_VTAB"_s;
        break;
    case SQLITE_BUSY_RECOVERY:
        codeStr = "SQLITE_BUSY_RECOVERY"_s;
        break;
    case SQLITE_BUSY_SNAPSHOT:
        codeStr = "SQLITE_BUSY_SNAPSHOT"_s;
        break;
    case SQLITE_BUSY_TIMEOUT:
        codeStr = "SQLITE_BUSY_TIMEOUT"_s;
        break;
    case SQLITE_CANTOPEN_NOTEMPDIR:
        codeStr = "SQLITE_CANTOPEN_NOTEMPDIR"_s;
        break;
    case SQLITE_CANTOPEN_ISDIR:
        codeStr = "SQLITE_CANTOPEN_ISDIR"_s;
        break;
    case SQLITE_CANTOPEN_FULLPATH:
        codeStr = "SQLITE_CANTOPEN_FULLPATH"_s;
        break;
    case SQLITE_CANTOPEN_CONVPATH:
        codeStr = "SQLITE_CANTOPEN_CONVPATH"_s;
        break;
    case SQLITE_CANTOPEN_DIRTYWAL:
        codeStr = "SQLITE_CANTOPEN_DIRTYWAL"_s;
        break;
    case SQLITE_CANTOPEN_SYMLINK:
        codeStr = "SQLITE_CANTOPEN_SYMLINK"_s;
        break;
    case SQLITE_CORRUPT_VTAB:
        codeStr = "SQLITE_CORRUPT_VTAB"_s;
        break;
    case SQLITE_CORRUPT_SEQUENCE:
        codeStr = "SQLITE_CORRUPT_SEQUENCE"_s;
        break;
    case SQLITE_CORRUPT_INDEX:
        codeStr = "SQLITE_CORRUPT_INDEX"_s;
        break;
    case SQLITE_READONLY_RECOVERY:
        codeStr = "SQLITE_READONLY_RECOVERY"_s;
        break;
    case SQLITE_READONLY_CANTLOCK:
        codeStr = "SQLITE_READONLY_CANTLOCK"_s;
        break;
    case SQLITE_READONLY_ROLLBACK:
        codeStr = "SQLITE_READONLY_ROLLBACK"_s;
        break;
    case SQLITE_READONLY_DBMOVED:
        codeStr = "SQLITE_READONLY_DBMOVED"_s;
        break;
    case SQLITE_READONLY_CANTINIT:
        codeStr = "SQLITE_READONLY_CANTINIT"_s;
        break;
    case SQLITE_READONLY_DIRECTORY:
        codeStr = "SQLITE_READONLY_DIRECTORY"_s;
        break;
    case SQLITE_ABORT_ROLLBACK:
        codeStr = "SQLITE_ABORT_ROLLBACK"_s;
        break;
    case SQLITE_CONSTRAINT_CHECK:
        codeStr = "SQLITE_CONSTRAINT_CHECK"_s;
        break;
    case SQLITE_CONSTRAINT_COMMITHOOK:
        codeStr = "SQLITE_CONSTRAINT_COMMITHOOK"_s;
        break;
    case SQLITE_CONSTRAINT_FOREIGNKEY:
        codeStr = "SQLITE_CONSTRAINT_FOREIGNKEY"_s;
        break;
    case SQLITE_CONSTRAINT_FUNCTION:
        codeStr = "SQLITE_CONSTRAINT_FUNCTION"_s;
        break;
    case SQLITE_CONSTRAINT_NOTNULL:
        codeStr = "SQLITE_CONSTRAINT_NOTNULL"_s;
        break;
    case SQLITE_CONSTRAINT_PRIMARYKEY:
        codeStr = "SQLITE_CONSTRAINT_PRIMARYKEY"_s;
        break;
    case SQLITE_CONSTRAINT_TRIGGER:
        codeStr = "SQLITE_CONSTRAINT_TRIGGER"_s;
        break;
    case SQLITE_CONSTRAINT_UNIQUE:
        codeStr = "SQLITE_CONSTRAINT_UNIQUE"_s;
        break;
    case SQLITE_CONSTRAINT_VTAB:
        codeStr = "SQLITE_CONSTRAINT_VTAB"_s;
        break;
    case SQLITE_CONSTRAINT_ROWID:
        codeStr = "SQLITE_CONSTRAINT_ROWID"_s;
        break;
    case SQLITE_CONSTRAINT_PINNED:
        codeStr = "SQLITE_CONSTRAINT_PINNED"_s;
        break;
    case SQLITE_CONSTRAINT_DATATYPE:
        codeStr = "SQLITE_CONSTRAINT_DATATYPE"_s;
        break;
    case SQLITE_NOTICE_RECOVER_WAL:
        codeStr = "SQLITE_NOTICE_RECOVER_WAL"_s;
        break;
    case SQLITE_NOTICE_RECOVER_ROLLBACK:
        codeStr = "SQLITE_NOTICE_RECOVER_ROLLBACK"_s;
        break;
    case SQLITE_NOTICE_RBU:
        codeStr = "SQLITE_NOTICE_RBU"_s;
        break;
    case SQLITE_WARNING_AUTOINDEX:
        codeStr = "SQLITE_WARNING_AUTOINDEX"_s;
        break;
    case SQLITE_AUTH_USER:
        codeStr = "SQLITE_AUTH_USER"_s;
        break;
    case SQLITE_OK_LOAD_PERMANENTLY:
        codeStr = "SQLITE_OK_LOAD_PERMANENTLY"_s;
        break;
    case SQLITE_OK_SYMLINK:
        codeStr = "SQLITE_OK_SYMLINK"_s;
        break;
    default: {
        break;
    }
