...
public:
    ...
    {
        JSPerformanceObserverEntryList* ptr = new (NotNull, JSC::allocateCell<JSPerformanceObserverEntryList>(globalObject->vm())) JSPerformanceObserverEntryList(structure, *globalObject, WTFMove(impl));
