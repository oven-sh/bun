...
template<> CryptoRsaHashedKeyAlgorithm convertDictionary<CryptoRsaHashedKeyAlgorithm>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (!nameValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "name"_s, "CryptoRsaHashedKeyAlgorithm"_s, "DOMString"_s);
        return {};
    }
    ...
    if (!modulusLengthValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "modulusLength"_s, "CryptoRsaHashedKeyAlgorithm"_s, "unsigned long"_s);
        return {};
    }
    ...
    if (!publicExponentValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "publicExponent"_s, "CryptoRsaHashedKeyAlgorithm"_s, "Uint8Array"_s);
        return {};
    }
    JSValue hashValue;
    if (isNullOrUndefined)
    ...
    if (!hashValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "hash"_s, "CryptoRsaHashedKeyAlgorithm"_s, "CryptoKeyAlgorithm"_s);
        return {};
    }
    return result;
}
