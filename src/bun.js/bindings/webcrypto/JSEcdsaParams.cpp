...
template<> CryptoAlgorithmEcdsaParams convertDictionary<CryptoAlgorithmEcdsaParams>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (!nameValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "name"_s, "EcdsaParams"_s, "DOMString"_s);
        return {};
    }
    JSValue hashValue;
    if (isNullOrUndefined)
    ...
    if (!hashValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "hash"_s, "EcdsaParams"_s, "(object or DOMString)"_s);
        return {};
    }
    return result;
}
