...
__asm__(".symver __libc_single_threaded,__libc_single_threaded@GLIBC_2.2.5");
...
int BUN_WRAP_GLIBC_SYMBOL(pthread_attr_getstack)(pthread_attr_t*, void**, size_t*);
...
extern "C" int __libc_start_main(int (*main)(int, char**, char**), int argc, char** argv, int (*init)(void), void (*fini)(void), void (*rtld_fini)(void), void* stack_end);
...
int __wrap_pthread_attr_getstack(pthread_attr_t* attr, void** stackaddr, size_t* stacksize)
{
...
int __wrap___libc_single_threaded()
{
    return 0;
}
