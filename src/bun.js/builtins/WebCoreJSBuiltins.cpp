...
const char* const s_byteLengthQueuingStrategySizeCode = "(function(chunk) {\n  return \"use strict\", chunk.byteLength;\n})";
...
const char* const s_importMetaObjectInternalRequireCode = "(function(resolved) {\n  \"use strict\";\n  var cached = @requireMap.@get(resolved);\n  const last5 = resolved.substring(resolved.length - 5);\n  if (cached) {\n    if (last5 === \".node\")\n      return cached.exports;\n    return cached;\n  }\n  if (last5 === \".json\") {\n    var fs = globalThis[Symbol.for(\"_fs\")] ||= @Bun.fs(), exports = JSON.parse(fs.readFileSync(resolved, \"utf8\"));\n    return @requireMap.@set(resolved, exports), exports;\n  } else if (last5 === \".node\") {\n    var module = { exports: {} };\n    return process.dlopen(module, resolved), @requireMap.@set(resolved, module), module.exports;\n  } else if (last5 === \".toml\") {\n    var fs = globalThis[Symbol.for(\"_fs\")] ||= @Bun.fs(), exports = @Bun.TOML.parse(fs.readFileSync(resolved, \"utf8\"));\n    return @requireMap.@set(resolved, exports), exports;\n  } else {\n    var exports = @requireESM(resolved);\n    return @requireMap.@set(resolved, exports), exports;\n  }\n})";
...
const char* const s_importMetaObjectMainCode = "(function() {\n  return \"use strict\", this.path === @Bun.main;\n})";
...
const char* const s_jsBufferPrototypeSetBigUint64Code = "(function(offset, value, le) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setBigUint64(offset, value, le);\n})";
...
const char* const s_jsBufferPrototypeReadInt8Code = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getInt8(offset);\n})";
...
const char* const s_jsBufferPrototypeReadUInt8Code = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getUint8(offset);\n})";
...
const char* const s_jsBufferPrototypeReadInt16LECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getInt16(offset, !0);\n})";
...
const char* const s_jsBufferPrototypeReadInt16BECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getInt16(offset, !1);\n})";
...
const char* const s_jsBufferPrototypeReadUInt16LECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getUint16(offset, !0);\n})";
...
const char* const s_jsBufferPrototypeReadUInt16BECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getUint16(offset, !1);\n})";
...
const char* const s_jsBufferPrototypeReadInt32LECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getInt32(offset, !0);\n})";
...
const char* const s_jsBufferPrototypeReadInt32BECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getInt32(offset, !1);\n})";
...
const char* const s_jsBufferPrototypeReadUInt32LECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getUint32(offset, !0);\n})";
...
const char* const s_jsBufferPrototypeReadUInt32BECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getUint32(offset, !1);\n})";
...
const char* const s_jsBufferPrototypeReadFloatLECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getFloat32(offset, !0);\n})";
...
const char* const s_jsBufferPrototypeReadFloatBECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getFloat32(offset, !1);\n})";
...
const char* const s_jsBufferPrototypeReadDoubleLECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getFloat64(offset, !0);\n})";
...
const char* const s_jsBufferPrototypeReadDoubleBECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getFloat64(offset, !1);\n})";
...
const char* const s_jsBufferPrototypeReadBigInt64LECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getBigInt64(offset, !0);\n})";
...
const char* const s_jsBufferPrototypeReadBigInt64BECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getBigInt64(offset, !1);\n})";
...
const char* const s_jsBufferPrototypeReadBigUInt64LECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getBigUint64(offset, !0);\n})";
...
const char* const s_jsBufferPrototypeReadBigUInt64BECode = "(function(offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).getBigUint64(offset, !1);\n})";
...
const char* const s_jsBufferPrototypeWriteInt8Code = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setInt8(offset, value), offset + 1;\n})";
...
const char* const s_jsBufferPrototypeWriteUInt8Code = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setUint8(offset, value), offset + 1;\n})";
...
const char* const s_jsBufferPrototypeWriteInt16LECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setInt16(offset, value, !0), offset + 2;\n})";
...
const char* const s_jsBufferPrototypeWriteInt16BECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setInt16(offset, value, !1), offset + 2;\n})";
...
const char* const s_jsBufferPrototypeWriteUInt16LECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setUint16(offset, value, !0), offset + 2;\n})";
...
const char* const s_jsBufferPrototypeWriteUInt16BECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setUint16(offset, value, !1), offset + 2;\n})";
...
const char* const s_jsBufferPrototypeWriteInt32LECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setInt32(offset, value, !0), offset + 4;\n})";
...
const char* const s_jsBufferPrototypeWriteInt32BECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setInt32(offset, value, !1), offset + 4;\n})";
...
const char* const s_jsBufferPrototypeWriteUInt32LECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setUint32(offset, value, !0), offset + 4;\n})";
...
const char* const s_jsBufferPrototypeWriteUInt32BECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setUint32(offset, value, !1), offset + 4;\n})";
...
const char* const s_jsBufferPrototypeWriteFloatLECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setFloat32(offset, value, !0), offset + 4;\n})";
...
const char* const s_jsBufferPrototypeWriteFloatBECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setFloat32(offset, value, !1), offset + 4;\n})";
...
const char* const s_jsBufferPrototypeWriteDoubleLECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setFloat64(offset, value, !0), offset + 8;\n})";
...
const char* const s_jsBufferPrototypeWriteDoubleBECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setFloat64(offset, value, !1), offset + 8;\n})";
...
const char* const s_jsBufferPrototypeWriteBigInt64LECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setBigInt64(offset, value, !0), offset + 8;\n})";
...
const char* const s_jsBufferPrototypeWriteBigInt64BECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setBigInt64(offset, value, !1), offset + 8;\n})";
...
const char* const s_jsBufferPrototypeWriteBigUInt64LECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setBigUint64(offset, value, !0), offset + 8;\n})";
...
const char* const s_jsBufferPrototypeWriteBigUInt64BECode = "(function(value, offset) {\n  return \"use strict\", (this.@dataView ||= new DataView(this.buffer, this.byteOffset, this.byteLength)).setBigUint64(offset, value, !1), offset + 8;\n})";
...
const char* const s_jsBufferPrototypeUtf8WriteCode = "(function(text, offset, length) {\n  return \"use strict\", this.write(text, offset, length, \"utf8\");\n})";
...
const char* const s_jsBufferPrototypeUcs2WriteCode = "(function(text, offset, length) {\n  return \"use strict\", this.write(text, offset, length, \"ucs2\");\n})";
...
const char* const s_jsBufferPrototypeUtf16leWriteCode = "(function(text, offset, length) {\n  return \"use strict\", this.write(text, offset, length, \"utf16le\");\n})";
...
const char* const s_jsBufferPrototypeLatin1WriteCode = "(function(text, offset, length) {\n  return \"use strict\", this.write(text, offset, length, \"latin1\");\n})";
...
const char* const s_jsBufferPrototypeAsciiWriteCode = "(function(text, offset, length) {\n  return \"use strict\", this.write(text, offset, length, \"ascii\");\n})";
...
const char* const s_jsBufferPrototypeBase64WriteCode = "(function(text, offset, length) {\n  return \"use strict\", this.write(text, offset, length, \"base64\");\n})";
...
const char* const s_jsBufferPrototypeBase64urlWriteCode = "(function(text, offset, length) {\n  return \"use strict\", this.write(text, offset, length, \"base64url\");\n})";
...
const char* const s_jsBufferPrototypeHexWriteCode = "(function(text, offset, length) {\n  return \"use strict\", this.write(text, offset, length, \"hex\");\n})";
...
const char* const s_jsBufferPrototypeUtf8SliceCode = "(function(offset, length) {\n  return \"use strict\", this.toString(offset, length, \"utf8\");\n})";
...
const char* const s_jsBufferPrototypeUcs2SliceCode = "(function(offset, length) {\n  return \"use strict\", this.toString(offset, length, \"ucs2\");\n})";
...
const char* const s_jsBufferPrototypeUtf16leSliceCode = "(function(offset, length) {\n  return \"use strict\", this.toString(offset, length, \"utf16le\");\n})";
...
const char* const s_jsBufferPrototypeLatin1SliceCode = "(function(offset, length) {\n  return \"use strict\", this.toString(offset, length, \"latin1\");\n})";
...
const char* const s_jsBufferPrototypeAsciiSliceCode = "(function(offset, length) {\n  return \"use strict\", this.toString(offset, length, \"ascii\");\n})";
...
const char* const s_jsBufferPrototypeBase64SliceCode = "(function(offset, length) {\n  return \"use strict\", this.toString(offset, length, \"base64\");\n})";
...
const char* const s_jsBufferPrototypeBase64urlSliceCode = "(function(offset, length) {\n  return \"use strict\", this.toString(offset, length, \"base64url\");\n})";
...
const char* const s_jsBufferPrototypeHexSliceCode = "(function(offset, length) {\n  return \"use strict\", this.toString(offset, length, \"hex\");\n})";
...
const char* const s_jsBufferPrototypeToJSONCode = "(function() {\n  \"use strict\";\n  const type = \"Buffer\", data = @Array.from(this);\n  return { type, data };\n})";
...
const char* const s_jsBufferPrototypeParentCode = "(function() {\n  return \"use strict\", @isObject(this) && this instanceof @Buffer \? this.buffer : @undefined;\n})";
...
const char* const s_jsBufferPrototypeOffsetCode = "(function() {\n  return \"use strict\", @isObject(this) && this instanceof @Buffer \? this.byteOffset : @undefined;\n})";
...
const char* const s_processObjectInternalsGetStdinStreamCode = "(function(fd_, rawRequire, Bun) {\n  \"use strict\";\n  var module = { path: \"node:process\", require: rawRequire }, require2 = (path) => module.require(path), { Duplex, eos, destroy } = require2(\"node:stream\"), StdinStream = class StdinStream2 extends Duplex {\n    #reader;\n    #readRef;\n    #writeStream;\n    #readable = !0;\n    #unrefOnRead = !1;\n    #writable = !0;\n    #onFinish;\n    #onClose;\n    #onDrain;\n    get isTTY() {\n      return require2(\"tty\").isatty(fd_);\n    }\n    get fd() {\n      return fd_;\n    }\n    constructor() {\n      super({ readable: !0, writable: !0 });\n    }\n    #onFinished(err) {\n      const cb = this.#onClose;\n      if (this.#onClose = null, cb)\n        cb(err);\n      else if (err)\n        this.destroy(err);\n      else if (!this.#readable && !this.#writable)\n        this.destroy();\n    }\n    _destroy(err, callback) {\n      if (!err && this.#onClose !== null) {\n        var AbortError = class AbortError2 extends Error {\n          constructor(message = \"The operation was aborted\", options = void 0) {\n            if (options !== void 0 && typeof options !== \"object\")\n              throw new Error(`Invalid AbortError options:\\n\\n${JSON.stringify(options, null, 2)}`);\n            super(message, options);\n            this.code = \"ABORT_ERR\", this.name = \"AbortError\";\n          }\n        };\n        err = new AbortError;\n      }\n      if (this.#onClose === null)\n        callback(err);\n      else if (this.#onClose = callback, this.#writeStream)\n        destroy(this.#writeStream, err);\n    }\n    setRawMode(mode) {\n    }\n    on(name, callback) {\n      if (name === \"readable\")\n        this.ref(), this.#unrefOnRead = !0;\n      return super.on(name, callback);\n    }\n    pause() {\n      return this.unref(), super.pause();\n    }\n    resume() {\n      return this.ref(), super.resume();\n    }\n    ref() {\n      this.#reader \?\?= Bun.stdin.stream().getReader(), this.#readRef \?\?= setInterval(() => {\n      }, 1 << 30);\n    }\n    unref() {\n      if (this.#readRef)\n        clearInterval(this.#readRef), this.#readRef = null;\n    }\n    async#readInternal() {\n      try {\n        var done, value;\n        const read = this.#reader.readMany();\n        if (!read\?.then)\n          ({ done, value } = read);\n        else\n          ({ done, value } = await read);\n        if (!done) {\n          this.push(value[0]);\n          const length = value.length;\n          for (let i = 1;i < length; i++)\n            this.push(value[i]);\n        } else\n          this.push(null), this.pause(), this.#readable = !1, this.#onFinished();\n      } catch (err) {\n        this.#readable = !1, this.#onFinished(err);\n      }\n    }\n    _read(size) {\n      if (this.#unrefOnRead)\n        this.unref(), this.#unrefOnRead = !1;\n      this.#readInternal();\n    }\n    #constructWriteStream() {\n      var { createWriteStream } = require2(\"node:fs\"), writeStream = this.#writeStream = createWriteStream(\"/dev/fd/0\");\n      return writeStream.on(\"finish\", () => {\n        if (this.#onFinish) {\n          const cb = this.#onFinish;\n          this.#onFinish = null, cb();\n        }\n      }), writeStream.on(\"drain\", () => {\n        if (this.#onDrain) {\n          const cb = this.#onDrain;\n          this.#onDrain = null, cb();\n        }\n      }), eos(writeStream, (err) => {\n        if (this.#writable = !1, err)\n          destroy(writeStream, err);\n        this.#onFinished(err);\n      }), writeStream;\n    }\n    _write(chunk, encoding, callback) {\n      var writeStream = this.#writeStream;\n      if (!writeStream)\n        writeStream = this.#constructWriteStream();\n      if (writeStream.write(chunk, encoding))\n        callback();\n      else\n        this.#onDrain = callback;\n    }\n    _final(callback) {\n      this.#writeStream.end(), this.#onFinish = (...args) => callback(...args);\n    }\n  };\n  return new StdinStream;\n})";
...
const int s_readableByteStreamControllerInitializeReadableByteStreamControllerCodeLength = 350;
...
const char* const s_readableByteStreamControllerInitializeReadableByteStreamControllerCode = "(function(stream, underlyingByteSource, highWaterMark) {\n  if (\"use strict\", arguments.length !== 4 && arguments[3] !== @isReadableStream)\n    @throwTypeError(\"ReadableByteStreamController constructor should not be called directly\");\n  return @privateInitializeReadableByteStreamController.@call(this, stream, underlyingByteSource, highWaterMark);\n})";
...
const char* const s_readableByteStreamControllerErrorCode = "(function(error) {\n  if (\"use strict\", !@isReadableByteStreamController(this))\n    throw @makeThisTypeError(\"ReadableByteStreamController\", \"error\");\n  if (@getByIdDirectPrivate(@getByIdDirectPrivate(this, \"controlledReadableStream\"), \"state\") !== @streamReadable)\n    @throwTypeError(\"ReadableStream is not readable\");\n  @readableByteStreamControllerError(this, error);\n})";
...
const int s_readableByteStreamInternalsPrivateInitializeReadableByteStreamControllerCodeLength = 2190;
...
const int s_readableByteStreamInternalsReadableStreamByteStreamControllerStartCodeLength = 98;
...
const char* const s_readableByteStreamInternalsReadableStreamByteStreamControllerStartCode = "(function(controller) {\n  \"use strict\", @putByIdDirectPrivate(controller, \"start\", @undefined);\n})";
...
const int s_readableByteStreamInternalsPrivateInitializeReadableStreamBYOBRequestCodeLength = 174;
...
const char* const s_readableByteStreamInternalsPrivateInitializeReadableStreamBYOBRequestCode = "(function(controller, view) {\n  \"use strict\", @putByIdDirectPrivate(this, \"associatedReadableByteStreamController\", controller), @putByIdDirectPrivate(this, \"view\", view);\n})";
...
const int s_readableByteStreamInternalsIsReadableByteStreamControllerCodeLength = 135;
static const JSC::Intrinsic s_readableByteStreamInternalsIsReadableByteStreamControllerCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableByteStreamInternalsIsReadableByteStreamControllerCode = "(function(controller) {\n  return \"use strict\", @isObject(controller) && !!@getByIdDirectPrivate(controller, \"underlyingByteSource\");\n})";
...
const int s_readableByteStreamInternalsIsReadableStreamBYOBRequestCodeLength = 156;
static const JSC::Intrinsic s_readableByteStreamInternalsIsReadableStreamBYOBRequestCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableByteStreamInternalsIsReadableStreamBYOBRequestCode = "(function(byobRequest) {\n  return \"use strict\", @isObject(byobRequest) && !!@getByIdDirectPrivate(byobRequest, \"associatedReadableByteStreamController\");\n})";
...
const int s_readableByteStreamInternalsIsReadableStreamBYOBReaderCodeLength = 119;
static const JSC::Intrinsic s_readableByteStreamInternalsIsReadableStreamBYOBReaderCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableByteStreamInternalsIsReadableStreamBYOBReaderCode = "(function(reader) {\n  return \"use strict\", @isObject(reader) && !!@getByIdDirectPrivate(reader, \"readIntoRequests\");\n})";
...
const int s_readableByteStreamInternalsReadableByteStreamControllerCloseCodeLength = 737;
static const JSC::Intrinsic s_readableByteStreamInternalsReadableByteStreamControllerCloseCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableByteStreamInternalsReadableByteStreamControllerCloseCode = "(function(controller) {\n  if (\"use strict\", @assert(!@getByIdDirectPrivate(controller, \"closeRequested\")), @assert(@getByIdDirectPrivate(@getByIdDirectPrivate(controller, \"controlledReadableStream\"), \"state\") === @streamReadable), @getByIdDirectPrivate(controller, \"queue\").size > 0) {\n    @putByIdDirectPrivate(controller, \"closeRequested\", !0);\n    return;\n  }\n  var first = @getByIdDirectPrivate(controller, \"pendingPullIntos\")\?.peek();\n  if (first) {\n    if (first.bytesFilled > 0) {\n      const e = @makeTypeError(\"Close requested while there remain pending bytes\");\n      throw @readableByteStreamControllerError(controller, e), e;\n    }\n  }\n  @readableStreamClose(@getByIdDirectPrivate(controller, \"controlledReadableStream\"));\n})";
...
const int s_readableByteStreamInternalsReadableByteStreamControllerClearPendingPullIntosCodeLength = 312;
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerClearPendingPullIntosCode = "(function(controller) {\n  \"use strict\", @readableByteStreamControllerInvalidateBYOBRequest(controller);\n  var existing = @getByIdDirectPrivate(controller, \"pendingPullIntos\");\n  if (existing !== @undefined)\n    existing.clear();\n  else\n    @putByIdDirectPrivate(controller, \"pendingPullIntos\", @createFIFO());\n})";
...
const int s_readableByteStreamInternalsReadableByteStreamControllerGetDesiredSizeCodeLength = 373;
...
const int s_readableByteStreamInternalsReadableStreamHasDefaultReaderCodeLength = 170;
static const JSC::Intrinsic s_readableByteStreamInternalsReadableStreamHasDefaultReaderCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableByteStreamInternalsReadableStreamHasDefaultReaderCode = "(function(stream) {\n  \"use strict\";\n  const reader = @getByIdDirectPrivate(stream, \"reader\");\n  return reader !== @undefined && @isReadableStreamDefaultReader(reader);\n})";
...
const int s_readableByteStreamInternalsReadableByteStreamControllerHandleQueueDrainCodeLength = 434;
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerHandleQueueDrainCode = "(function(controller) {\n  if (\"use strict\", @assert(@getByIdDirectPrivate(@getByIdDirectPrivate(controller, \"controlledReadableStream\"), \"state\") === @streamReadable), !@getByIdDirectPrivate(controller, \"queue\").size && @getByIdDirectPrivate(controller, \"closeRequested\"))\n    @readableStreamClose(@getByIdDirectPrivate(controller, \"controlledReadableStream\"));\n  else\n    @readableByteStreamControllerCallPullIfNeeded(controller);\n})";
...
const int s_readableByteStreamInternalsReadableByteStreamControllerShouldCallPullCodeLength = 808;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerCallPullIfNeededCodeLength = 899;
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerCallPullIfNeededCode = "(function(controller) {\n  if (\"use strict\", !@readableByteStreamControllerShouldCallPull(controller))\n    return;\n  if (@getByIdDirectPrivate(controller, \"pulling\")) {\n    @putByIdDirectPrivate(controller, \"pullAgain\", !0);\n    return;\n  }\n  @assert(!@getByIdDirectPrivate(controller, \"pullAgain\")), @putByIdDirectPrivate(controller, \"pulling\", !0), @promiseInvokeOrNoop(@getByIdDirectPrivate(controller, \"underlyingByteSource\"), \"pull\", [controller]).@then(() => {\n    if (@putByIdDirectPrivate(controller, \"pulling\", !1), @getByIdDirectPrivate(controller, \"pullAgain\"))\n      @putByIdDirectPrivate(controller, \"pullAgain\", !1), @readableByteStreamControllerCallPullIfNeeded(controller);\n  }, (error) => {\n    if (@getByIdDirectPrivate(@getByIdDirectPrivate(controller, \"controlledReadableStream\"), \"state\") === @streamReadable)\n      @readableByteStreamControllerError(controller, error);\n  });\n})";
...
const int s_readableByteStreamInternalsTransferBufferToCurrentRealmCodeLength = 53;
static const JSC::Intrinsic s_readableByteStreamInternalsTransferBufferToCurrentRealmCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableByteStreamInternalsTransferBufferToCurrentRealmCode = "(function(buffer) {\n  return \"use strict\", buffer;\n})";
...
const char* const s_readableByteStreamInternalsReadableStreamReaderKindCode = "(function(reader) {\n  if (\"use strict\", @getByIdDirectPrivate(reader, \"readRequests\"))\n    return @getByIdDirectPrivate(reader, \"bunNativePtr\") \? 3 : 1;\n  if (@getByIdDirectPrivate(reader, \"readIntoRequests\"))\n    return 2;\n  return 0;\n})";
...
const int s_readableByteStreamInternalsReadableByteStreamControllerEnqueueChunkCodeLength = 244;
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerEnqueueChunkCode = "(function(controller, buffer, byteOffset, byteLength) {\n  \"use strict\", @getByIdDirectPrivate(controller, \"queue\").content.push({\n    buffer,\n    byteOffset,\n    byteLength\n  }), @getByIdDirectPrivate(controller, \"queue\").size += byteLength;\n})";
...
const int s_readableByteStreamInternalsReadableByteStreamControllerRespondWithNewViewCodeLength = 582;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerRespondCodeLength = 384;
static const JSC::Intrinsic s_readableByteStreamInternalsReadableByteStreamControllerRespondCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableByteStreamInternalsReadableByteStreamControllerRespondCode = "(function(controller, bytesWritten) {\n  if (\"use strict\", bytesWritten = @toNumber(bytesWritten), @isNaN(bytesWritten) || bytesWritten === @Infinity || bytesWritten < 0)\n    @throwRangeError(\"bytesWritten has an incorrect value\");\n  @assert(@getByIdDirectPrivate(controller, \"pendingPullIntos\").isNotEmpty()), @readableByteStreamControllerRespondInternal(controller, bytesWritten);\n})";
...
const int s_readableByteStreamInternalsReadableByteStreamControllerRespondInternalCodeLength = 658;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerRespondInReadableStateCodeLength = 1360;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerRespondInClosedStateCodeLength = 684;
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerRespondInClosedStateCode = "(function(controller, firstDescriptor) {\n  if (\"use strict\", firstDescriptor.buffer = @transferBufferToCurrentRealm(firstDescriptor.buffer), @assert(firstDescriptor.bytesFilled === 0), @readableStreamHasBYOBReader(@getByIdDirectPrivate(controller, \"controlledReadableStream\")))\n    while (@getByIdDirectPrivate(@getByIdDirectPrivate(@getByIdDirectPrivate(controller, \"controlledReadableStream\"), \"reader\"), \"readIntoRequests\")\?.isNotEmpty()) {\n      let pullIntoDescriptor = @readableByteStreamControllerShiftPendingDescriptor(controller);\n      @readableByteStreamControllerCommitDescriptor(@getByIdDirectPrivate(controller, \"controlledReadableStream\"), pullIntoDescriptor);\n    }\n})";
...
const int s_readableByteStreamInternalsReadableByteStreamControllerProcessPullDescriptorsCodeLength = 651;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerFillDescriptorFromQueueCodeLength = 2058;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerShiftPendingDescriptorCodeLength = 209;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerInvalidateBYOBRequestCodeLength = 405;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerCommitDescriptorCodeLength = 594;
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerCommitDescriptorCode = "(function(stream, pullIntoDescriptor) {\n  \"use strict\", @assert(@getByIdDirectPrivate(stream, \"state\") !== @streamErrored);\n  let done = !1;\n  if (@getByIdDirectPrivate(stream, \"state\") === @streamClosed)\n    @assert(!pullIntoDescriptor.bytesFilled), done = !0;\n  let filledView = @readableByteStreamControllerConvertDescriptor(pullIntoDescriptor);\n  if (pullIntoDescriptor.readerType === \"default\")\n    @readableStreamFulfillReadRequest(stream, filledView, done);\n  else\n    @assert(pullIntoDescriptor.readerType === \"byob\"), @readableStreamFulfillReadIntoRequest(stream, filledView, done);\n})";
...
const int s_readableByteStreamInternalsReadableByteStreamControllerConvertDescriptorCodeLength = 363;
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerConvertDescriptorCode = "(function(pullIntoDescriptor) {\n  return \"use strict\", @assert(pullIntoDescriptor.bytesFilled <= pullIntoDescriptor.byteLength), @assert(pullIntoDescriptor.bytesFilled % pullIntoDescriptor.elementSize === 0), new pullIntoDescriptor.ctor(pullIntoDescriptor.buffer, pullIntoDescriptor.byteOffset, pullIntoDescriptor.bytesFilled / pullIntoDescriptor.elementSize);\n})";
...
const int s_readableByteStreamInternalsReadableStreamFulfillReadIntoRequestCodeLength = 229;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerPullIntoCodeLength = 1884;
...
const int s_readableByteStreamInternalsReadableStreamAddReadIntoRequestCodeLength = 407;
static const JSC::Intrinsic s_readableByteStreamInternalsReadableStreamAddReadIntoRequestCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableByteStreamInternalsReadableStreamAddReadIntoRequestCode = "(function(stream) {\n  \"use strict\", @assert(@isReadableStreamBYOBReader(@getByIdDirectPrivate(stream, \"reader\"))), @assert(@getByIdDirectPrivate(stream, \"state\") === @streamReadable || @getByIdDirectPrivate(stream, \"state\") === @streamClosed);\n  const readRequest = @newPromise();\n  return @getByIdDirectPrivate(@getByIdDirectPrivate(stream, \"reader\"), \"readIntoRequests\").push(readRequest), readRequest;\n})";
...
const char* const s_readableStreamReadableStreamToJSONCode = "(function(stream) {\n  return \"use strict\", @Bun.readableStreamToText(stream).@then(globalThis.JSON.parse);\n})";
...
const char* const s_readableStreamReadableStreamToBlobCode = "(function(stream) {\n  return \"use strict\", @Promise.resolve(@Bun.readableStreamToArray(stream)).@then((array) => new Blob(array));\n})";
...
const char* const s_readableStreamCreateEmptyReadableStreamCode = "(function() {\n  \"use strict\";\n  var stream = new @ReadableStream({\n    pull() {\n    }\n  });\n  return @readableStreamClose(stream), stream;\n})";
...
const char* const s_readableStreamCreateNativeReadableStreamCode = "(function(nativePtr, nativeType, autoAllocateChunkSize) {\n  return \"use strict\", new @ReadableStream({\n    @lazy: !0,\n    @bunNativeType: nativeType,\n    @bunNativePtr: nativePtr,\n    autoAllocateChunkSize\n  });\n})";
...
const int s_readableStreamDefaultControllerInitializeReadableStreamDefaultControllerCodeLength = 360;
...
const char* const s_readableStreamDefaultControllerInitializeReadableStreamDefaultControllerCode = "(function(stream, underlyingSource, size, highWaterMark) {\n  if (\"use strict\", arguments.length !== 5 && arguments[4] !== @isReadableStream)\n    @throwTypeError(\"ReadableStreamDefaultController constructor should not be called directly\");\n  return @privateInitializeReadableStreamDefaultController.@call(this, stream, underlyingSource, size, highWaterMark);\n})";
...
const int s_readableStreamDefaultReaderInitializeReadableStreamDefaultReaderCodeLength = 362;
...
const char* const s_readableStreamDefaultReaderCancelCode = "(function(reason) {\n  if (\"use strict\", !@isReadableStreamDefaultReader(this))\n    return @Promise.@reject(@makeThisTypeError(\"ReadableStreamDefaultReader\", \"cancel\"));\n  if (!@getByIdDirectPrivate(this, \"ownerReadableStream\"))\n    return @Promise.@reject(@makeTypeError(\"cancel() called on a reader owned by no readable stream\"));\n  return @readableStreamReaderGenericCancel(this, reason);\n})";
...
const int s_readableStreamInternalsReadableStreamReaderGenericInitializeCodeLength = 727;
static const JSC::Intrinsic s_readableStreamInternalsReadableStreamReaderGenericInitializeCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsReadableStreamReaderGenericInitializeCode = "(function(reader, stream) {\n  if (\"use strict\", @putByIdDirectPrivate(reader, \"ownerReadableStream\", stream), @putByIdDirectPrivate(stream, \"reader\", reader), @getByIdDirectPrivate(stream, \"state\") === @streamReadable)\n    @putByIdDirectPrivate(reader, \"closedPromiseCapability\", @newPromiseCapability(@Promise));\n  else if (@getByIdDirectPrivate(stream, \"state\") === @streamClosed)\n    @putByIdDirectPrivate(reader, \"closedPromiseCapability\", {\n      @promise: @Promise.@resolve()\n    });\n  else\n    @assert(@getByIdDirectPrivate(stream, \"state\") === @streamErrored), @putByIdDirectPrivate(reader, \"closedPromiseCapability\", {\n      @promise: @newHandledRejectedPromise(@getByIdDirectPrivate(stream, \"storedError\"))\n    });\n})";
...
const int s_readableStreamInternalsPrivateInitializeReadableStreamDefaultControllerCodeLength = 809;
...
const int s_readableStreamInternalsAcquireReadableStreamDefaultReaderCodeLength = 181;
static const JSC::Intrinsic s_readableStreamInternalsAcquireReadableStreamDefaultReaderCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsAcquireReadableStreamDefaultReaderCode = "(function(stream) {\n  \"use strict\";\n  var start = @getByIdDirectPrivate(stream, \"start\");\n  if (start)\n    start.@call(stream);\n  return new @ReadableStreamDefaultReader(stream);\n})";
...
const int s_readableStreamInternalsSetupReadableStreamDefaultControllerCodeLength = 863;
static const JSC::Intrinsic s_readableStreamInternalsSetupReadableStreamDefaultControllerCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsSetupReadableStreamDefaultControllerCode = "(function(stream, underlyingSource, size, highWaterMark, startMethod, pullMethod, cancelMethod) {\n  \"use strict\";\n  const controller = new @ReadableStreamDefaultController(stream, underlyingSource, size, highWaterMark, @isReadableStream), pullAlgorithm = () => @promiseInvokeOrNoopMethod(underlyingSource, pullMethod, [controller]), cancelAlgorithm = (reason) => @promiseInvokeOrNoopMethod(underlyingSource, cancelMethod, [reason]);\n  @putByIdDirectPrivate(controller, \"pullAlgorithm\", pullAlgorithm), @putByIdDirectPrivate(controller, \"cancelAlgorithm\", cancelAlgorithm), @putByIdDirectPrivate(controller, \"pull\", @readableStreamDefaultControllerPull), @putByIdDirectPrivate(controller, \"cancel\", @readableStreamDefaultControllerCancel), @putByIdDirectPrivate(stream, \"readableStreamController\", controller), @readableStreamDefaultControllerStart(controller);\n})";
...
const int s_readableStreamInternalsReadableStreamDefaultControllerStartCodeLength = 690;
static const JSC::Intrinsic s_readableStreamInternalsReadableStreamDefaultControllerStartCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsReadableStreamDefaultControllerStartCode = "(function(controller) {\n  if (\"use strict\", @getByIdDirectPrivate(controller, \"started\") !== -1)\n    return;\n  const underlyingSource = @getByIdDirectPrivate(controller, \"underlyingSource\"), startMethod = underlyingSource.start;\n  @putByIdDirectPrivate(controller, \"started\", 0), @promiseInvokeOrNoopMethodNoCatch(underlyingSource, startMethod, [controller]).@then(() => {\n    @putByIdDirectPrivate(controller, \"started\", 1), @assert(!@getByIdDirectPrivate(controller, \"pulling\")), @assert(!@getByIdDirectPrivate(controller, \"pullAgain\")), @readableStreamDefaultControllerCallPullIfNeeded(controller);\n  }, (error) => {\n    @readableStreamDefaultControllerError(controller, error);\n  });\n})";
...
const int s_readableStreamInternalsPipeToClosingMustBePropagatedBackwardCodeLength = 445;
static const JSC::Intrinsic s_readableStreamInternalsPipeToClosingMustBePropagatedBackwardCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsPipeToClosingMustBePropagatedBackwardCode = "(function(pipeState) {\n  if (\"use strict\", !@writableStreamCloseQueuedOrInFlight(pipeState.destination) && @getByIdDirectPrivate(pipeState.destination, \"state\") !== \"closed\")\n    return;\n  const error = @makeTypeError(\"closing is propagated backward\");\n  if (!pipeState.preventCancel) {\n    @pipeToShutdownWithAction(pipeState, () => @readableStreamCancel(pipeState.source, error), error);\n    return;\n  }\n  @pipeToShutdown(pipeState, error);\n})";
...
const char* const s_readableStreamInternalsPipeToShutdownCode = "(function(pipeState) {\n  if (\"use strict\", pipeState.shuttingDown)\n    return;\n  pipeState.shuttingDown = !0;\n  const hasError = arguments.length > 1, error = arguments[1], finalize = () => {\n    if (hasError)\n      @pipeToFinalize(pipeState, error);\n    else\n      @pipeToFinalize(pipeState);\n  };\n  if (@getByIdDirectPrivate(pipeState.destination, \"state\") === \"writable\" && !@writableStreamCloseQueuedOrInFlight(pipeState.destination)) {\n    pipeState.pendingReadPromiseCapability.@promise.@then(() => {\n      pipeState.pendingWritePromise.@then(finalize, finalize);\n    }, (e) => @pipeToFinalize(pipeState, e));\n    return;\n  }\n  finalize();\n})";
...
const char* const s_readableStreamInternalsPipeToFinalizeCode = "(function(pipeState) {\n  if (\"use strict\", @writableStreamDefaultWriterRelease(pipeState.writer), @readableStreamReaderGenericRelease(pipeState.reader), pipeState.finalized = !0, arguments.length > 1)\n    pipeState.promiseCapability.@reject.@call(@undefined, arguments[1]);\n  else\n    pipeState.promiseCapability.@resolve.@call();\n})";
...
const char* const s_readableStreamInternalsReadableStreamTeeBranch2CancelFunctionCode = "(function(teeState, stream) {\n  return \"use strict\", function(r) {\n    if (teeState.canceled2 = !0, teeState.reason2 = r, teeState.canceled1)\n      @readableStreamCancel(stream, [teeState.reason1, teeState.reason2]).@then(teeState.cancelPromiseCapability.@resolve, teeState.cancelPromiseCapability.@reject);\n    return teeState.cancelPromiseCapability.@promise;\n  };\n})";
...
const char* const s_readableStreamInternalsIsReadableStreamCode = "(function(stream) {\n  return \"use strict\", @isObject(stream) && @getByIdDirectPrivate(stream, \"readableStreamController\") !== @undefined;\n})";
...
const int s_readableStreamInternalsIsReadableStreamDefaultReaderCodeLength = 115;
static const JSC::Intrinsic s_readableStreamInternalsIsReadableStreamDefaultReaderCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsIsReadableStreamDefaultReaderCode = "(function(reader) {\n  return \"use strict\", @isObject(reader) && !!@getByIdDirectPrivate(reader, \"readRequests\");\n})";
...
const int s_readableStreamInternalsIsReadableStreamDefaultControllerCodeLength = 131;
static const JSC::Intrinsic s_readableStreamInternalsIsReadableStreamDefaultControllerCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsIsReadableStreamDefaultControllerCode = "(function(controller) {\n  return \"use strict\", @isObject(controller) && !!@getByIdDirectPrivate(controller, \"underlyingSource\");\n})";
...
const int s_readableStreamInternalsHandleDirectStreamErrorRejectCodeLength = 102;
static const JSC::Intrinsic s_readableStreamInternalsHandleDirectStreamErrorRejectCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsHandleDirectStreamErrorRejectCode = "(function(e) {\n  return \"use strict\", @handleDirectStreamError.@call(this, e), @Promise.@reject(e);\n})";
...
const char* const s_readableStreamInternalsNoopDoneFunctionCode = "(function() {\n  return \"use strict\", @Promise.@resolve({ value: @undefined, done: !0 });\n})";
...
const int s_readableStreamInternalsOnReadableStreamDirectControllerClosedCodeLength = 103;
static const JSC::Intrinsic s_readableStreamInternalsOnReadableStreamDirectControllerClosedCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsOnReadableStreamDirectControllerClosedCode = "(function(reason) {\n  \"use strict\", @throwTypeError(\"ReadableStreamDirectController is now closed\");\n})";
...
const int s_readableStreamInternalsReadableStreamDefaultControllerShouldCallPullCodeLength = 640;
...
const int s_readableStreamInternalsReadableStreamDefaultControllerCallPullIfNeededCodeLength = 1133;
...
const char* const s_readableStreamInternalsReadableStreamDefaultControllerCallPullIfNeededCode = "(function(controller) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(controller, \"controlledReadableStream\");\n  if (!@readableStreamDefaultControllerCanCloseOrEnqueue(controller))\n    return;\n  if (@getByIdDirectPrivate(controller, \"started\") !== 1)\n    return;\n  if ((!@isReadableStreamLocked(stream) || !@getByIdDirectPrivate(@getByIdDirectPrivate(stream, \"reader\"), \"readRequests\")\?.isNotEmpty()) && @readableStreamDefaultControllerGetDesiredSize(controller) <= 0)\n    return;\n  if (@getByIdDirectPrivate(controller, \"pulling\")) {\n    @putByIdDirectPrivate(controller, \"pullAgain\", !0);\n    return;\n  }\n  @assert(!@getByIdDirectPrivate(controller, \"pullAgain\")), @putByIdDirectPrivate(controller, \"pulling\", !0), @getByIdDirectPrivate(controller, \"pullAlgorithm\").@call(@undefined).@then(function() {\n    if (@putByIdDirectPrivate(controller, \"pulling\", !1), @getByIdDirectPrivate(controller, \"pullAgain\"))\n      @putByIdDirectPrivate(controller, \"pullAgain\", !1), @readableStreamDefaultControllerCallPullIfNeeded(controller);\n  }, function(error) {\n    @readableStreamDefaultControllerError(controller, error);\n  });\n})";
...
const char* const s_readableStreamInternalsIsReadableStreamLockedCode = "(function(stream) {\n  return \"use strict\", @assert(@isReadableStream(stream)), !!@getByIdDirectPrivate(stream, \"reader\");\n})";
...
const int s_readableStreamInternalsReadableStreamDefaultControllerGetDesiredSizeCodeLength = 384;
...
const char* const s_readableStreamInternalsReadableStreamDefaultControllerGetDesiredSizeCode = "(function(controller) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(controller, \"controlledReadableStream\"), state = @getByIdDirectPrivate(stream, \"state\");\n  if (state === @streamErrored)\n    return null;\n  if (state === @streamClosed)\n    return 0;\n  return @getByIdDirectPrivate(controller, \"strategy\").highWaterMark - @getByIdDirectPrivate(controller, \"queue\").size;\n})";
...
const int s_readableStreamInternalsReadableStreamReaderGenericCancelCodeLength = 184;
static const JSC::Intrinsic s_readableStreamInternalsReadableStreamReaderGenericCancelCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsReadableStreamReaderGenericCancelCode = "(function(reader, reason) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(reader, \"ownerReadableStream\");\n  return @assert(!!stream), @readableStreamCancel(stream, reason);\n})";
...
const int s_readableStreamInternalsReadableStreamDefaultControllerCancelCodeLength = 194;
static const JSC::Intrinsic s_readableStreamInternalsReadableStreamDefaultControllerCancelCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsReadableStreamDefaultControllerCancelCode = "(function(controller, reason) {\n  return \"use strict\", @putByIdDirectPrivate(controller, \"queue\", @newQueue()), @getByIdDirectPrivate(controller, \"cancelAlgorithm\").@call(@undefined, reason);\n})";
...
const int s_readableStreamInternalsReadableStreamDefaultControllerCloseCodeLength = 328;
static const JSC::Intrinsic s_readableStreamInternalsReadableStreamDefaultControllerCloseCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsReadableStreamDefaultControllerCloseCode = "(function(controller) {\n  if (\"use strict\", @assert(@readableStreamDefaultControllerCanCloseOrEnqueue(controller)), @putByIdDirectPrivate(controller, \"closeRequested\", !0), @getByIdDirectPrivate(controller, \"queue\")\?.content\?.isEmpty())\n    @readableStreamClose(@getByIdDirectPrivate(controller, \"controlledReadableStream\"));\n})";
...
const int s_readableStreamInternalsReadableStreamDefaultReaderReadCodeLength = 610;
static const JSC::Intrinsic s_readableStreamInternalsReadableStreamDefaultReaderReadCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsReadableStreamDefaultReaderReadCode = "(function(reader) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(reader, \"ownerReadableStream\");\n  @assert(!!stream);\n  const state = @getByIdDirectPrivate(stream, \"state\");\n  if (@putByIdDirectPrivate(stream, \"disturbed\", !0), state === @streamClosed)\n    return @createFulfilledPromise({ value: @undefined, done: !0 });\n  if (state === @streamErrored)\n    return @Promise.@reject(@getByIdDirectPrivate(stream, \"storedError\"));\n  return @assert(state === @streamReadable), @getByIdDirectPrivate(stream, \"readableStreamController\").@pull(@getByIdDirectPrivate(stream, \"readableStreamController\"));\n})";
...
const char* const s_readableStreamInternalsReadableStreamAddReadRequestCode = "(function(stream) {\n  \"use strict\", @assert(@isReadableStreamDefaultReader(@getByIdDirectPrivate(stream, \"reader\"))), @assert(@getByIdDirectPrivate(stream, \"state\") == @streamReadable);\n  const readRequest = @newPromise();\n  return @getByIdDirectPrivate(@getByIdDirectPrivate(stream, \"reader\"), \"readRequests\").push(readRequest), readRequest;\n})";
...
const char* const s_readableStreamInternalsIsReadableStreamDisturbedCode = "(function(stream) {\n  return \"use strict\", @assert(@isReadableStream(stream)), @getByIdDirectPrivate(stream, \"disturbed\");\n})";
...
const int s_readableStreamInternalsReadableStreamDefaultControllerCanCloseOrEnqueueCodeLength = 220;
...
const char* const s_readableStreamInternalsReadableStreamDefaultControllerCanCloseOrEnqueueCode = "(function(controller) {\n  return \"use strict\", !@getByIdDirectPrivate(controller, \"closeRequested\") && @getByIdDirectPrivate(@getByIdDirectPrivate(controller, \"controlledReadableStream\"), \"state\") === @streamReadable;\n})";
...
const char* const s_streamInternalsMarkPromiseAsHandledCode = "(function(promise) {\n  \"use strict\", @assert(@isPromise(promise)), @putPromiseInternalField(promise, @promiseFieldFlags, @getPromiseInternalField(promise, @promiseFieldFlags) | @promiseFlagsIsHandled);\n})";
...
const char* const s_streamInternalsShieldingPromiseResolveCode = "(function(result) {\n  \"use strict\";\n  const promise = @Promise.@resolve(result);\n  if (promise.@then === @undefined)\n    promise.@then = @Promise.prototype.@then;\n  return promise;\n})";
...
const char* const s_streamInternalsPromiseInvokeOrNoopMethodNoCatchCode = "(function(object, method, args) {\n  if (\"use strict\", method === @undefined)\n    return @Promise.@resolve();\n  return @shieldingPromiseResolve(method.@apply(object, args));\n})";
...
const char* const s_streamInternalsPromiseInvokeOrNoopNoCatchCode = "(function(object, key, args) {\n  return \"use strict\", @promiseInvokeOrNoopMethodNoCatch(object, object[key], args);\n})";
...
const char* const s_streamInternalsPromiseInvokeOrNoopMethodCode = "(function(object, method, args) {\n  \"use strict\";\n  try {\n    return @promiseInvokeOrNoopMethodNoCatch(object, method, args);\n  } catch (error) {\n    return @Promise.@reject(error);\n  }\n})";
...
const char* const s_streamInternalsPromiseInvokeOrNoopCode = "(function(object, key, args) {\n  \"use strict\";\n  try {\n    return @promiseInvokeOrNoopNoCatch(object, key, args);\n  } catch (error) {\n    return @Promise.@reject(error);\n  }\n})";
...
const char* const s_streamInternalsNewQueueCode = "(function() {\n  return \"use strict\", { content: @createFIFO(), size: 0 };\n})";
...
const char* const s_streamInternalsEnqueueValueWithSizeCode = "(function(queue, value, size) {\n  if (\"use strict\", size = @toNumber(size), !@isFinite(size) || size < 0)\n    @throwRangeError(\"size has an incorrect value\");\n  queue.content.push({ value, size }), queue.size += size;\n})";
...
const char* const s_streamInternalsPeekQueueValueCode = "(function(queue) {\n  return \"use strict\", queue.content.peek()\?.value;\n})";
...
const char* const s_streamInternalsResetQueueCode = "(function(queue) {\n  \"use strict\", @assert(\"content\" in queue), @assert(\"size\" in queue), queue.content.clear(), queue.size = 0;\n})";
...
const char* const s_streamInternalsExtractHighWaterMarkCode = "(function(strategy, defaultHWM) {\n  \"use strict\";\n  const highWaterMark = strategy.highWaterMark;\n  if (highWaterMark === @undefined)\n    return defaultHWM;\n  if (@isNaN(highWaterMark) || highWaterMark < 0)\n    @throwRangeError(\"highWaterMark value is negative or not a number\");\n  return @toNumber(highWaterMark);\n})";
...
const char* const s_streamInternalsCreateFulfilledPromiseCode = "(function(value) {\n  \"use strict\";\n  const promise = @newPromise();\n  return @fulfillPromise(promise, value), promise;\n})";
...
const char* const s_streamInternalsToDictionaryCode = "(function(value, defaultValue, errorMessage) {\n  if (\"use strict\", value === @undefined || value === null)\n    return defaultValue;\n  if (!@isObject(value))\n    @throwTypeError(errorMessage);\n  return value;\n})";
...
const int s_transformStreamDefaultControllerInitializeTransformStreamDefaultControllerCodeLength = 45;
...
const char* const s_transformStreamDefaultControllerInitializeTransformStreamDefaultControllerCode = "(function() {\n  return \"use strict\", this;\n})";
...
const char* const s_transformStreamDefaultControllerEnqueueCode = "(function(chunk) {\n  if (\"use strict\", !@isTransformStreamDefaultController(this))\n    throw @makeThisTypeError(\"TransformStreamDefaultController\", \"enqueue\");\n  @transformStreamDefaultControllerEnqueue(this, chunk);\n})";
...
const char* const s_transformStreamInternalsIsTransformStreamCode = "(function(stream) {\n  return \"use strict\", @isObject(stream) && !!@getByIdDirectPrivate(stream, \"readable\");\n})";
...
const int s_transformStreamInternalsIsTransformStreamDefaultControllerCodeLength = 133;
static const JSC::Intrinsic s_transformStreamInternalsIsTransformStreamDefaultControllerCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_transformStreamInternalsIsTransformStreamDefaultControllerCode = "(function(controller) {\n  return \"use strict\", @isObject(controller) && !!@getByIdDirectPrivate(controller, \"transformAlgorithm\");\n})";
...
const int s_transformStreamInternalsTransformStreamErrorWritableAndUnblockWriteCodeLength = 405;
...
const int s_transformStreamInternalsSetUpTransformStreamDefaultControllerFromTransformerCodeLength = 852;
...
const int s_transformStreamInternalsTransformStreamDefaultControllerClearAlgorithmsCodeLength = 168;
...
const char* const s_transformStreamInternalsTransformStreamDefaultControllerClearAlgorithmsCode = "(function(controller) {\n  \"use strict\", @putByIdDirectPrivate(controller, \"transformAlgorithm\", !0), @putByIdDirectPrivate(controller, \"flushAlgorithm\", @undefined);\n})";
...
const int s_transformStreamInternalsTransformStreamDefaultControllerEnqueueCodeLength = 891;
...
const int s_transformStreamInternalsTransformStreamDefaultControllerErrorCodeLength = 116;
static const JSC::Intrinsic s_transformStreamInternalsTransformStreamDefaultControllerErrorCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_transformStreamInternalsTransformStreamDefaultControllerErrorCode = "(function(controller, e) {\n  \"use strict\", @transformStreamError(@getByIdDirectPrivate(controller, \"stream\"), e);\n})";
...
const int s_transformStreamInternalsTransformStreamDefaultControllerPerformTransformCodeLength = 419;
...
const int s_transformStreamInternalsTransformStreamDefaultControllerTerminateCodeLength = 509;
...
const char* const s_transformStreamInternalsTransformStreamDefaultControllerTerminateCode = "(function(controller) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(controller, \"stream\"), readable = @getByIdDirectPrivate(stream, \"readable\"), readableController = @getByIdDirectPrivate(readable, \"readableStreamController\");\n  if (@readableStreamDefaultControllerCanCloseOrEnqueue(readableController))\n    @readableStreamDefaultControllerClose(readableController);\n  const error = @makeTypeError(\"the stream has been terminated\");\n  @transformStreamErrorWritableAndUnblockWrite(stream, error);\n})";
...
const int s_transformStreamInternalsTransformStreamDefaultSinkWriteAlgorithmCodeLength = 1218;
...
const char* const s_transformStreamInternalsTransformStreamDefaultSinkWriteAlgorithmCode = "(function(stream, chunk) {\n  \"use strict\";\n  const writable = @getByIdDirectPrivate(stream, \"internalWritable\");\n  @assert(@getByIdDirectPrivate(writable, \"state\") === \"writable\");\n  const controller = @getByIdDirectPrivate(stream, \"controller\");\n  if (@getByIdDirectPrivate(stream, \"backpressure\")) {\n    const promiseCapability = @newPromiseCapability(@Promise), backpressureChangePromise = @getByIdDirectPrivate(stream, \"backpressureChangePromise\");\n    return @assert(backpressureChangePromise !== @undefined), backpressureChangePromise.@promise.@then(() => {\n      const state = @getByIdDirectPrivate(writable, \"state\");\n      if (state === \"erroring\") {\n        promiseCapability.@reject.@call(@undefined, @getByIdDirectPrivate(writable, \"storedError\"));\n        return;\n      }\n      @assert(state === \"writable\"), @transformStreamDefaultControllerPerformTransform(controller, chunk).@then(() => {\n        promiseCapability.@resolve();\n      }, (e) => {\n        promiseCapability.@reject.@call(@undefined, e);\n      });\n    }, (e) => {\n      promiseCapability.@reject.@call(@undefined, e);\n    }), promiseCapability.@promise;\n  }\n  return @transformStreamDefaultControllerPerformTransform(controller, chunk);\n})";
...
const int s_transformStreamInternalsTransformStreamDefaultSinkAbortAlgorithmCodeLength = 113;
...
const char* const s_transformStreamInternalsTransformStreamDefaultSinkAbortAlgorithmCode = "(function(stream, reason) {\n  return \"use strict\", @transformStreamError(stream, reason), @Promise.@resolve();\n})";
...
const int s_transformStreamInternalsTransformStreamDefaultSinkCloseAlgorithmCodeLength = 1181;
...
const int s_transformStreamInternalsTransformStreamDefaultSourcePullAlgorithmCodeLength = 299;
...
const char* const s_transformStreamInternalsTransformStreamDefaultSourcePullAlgorithmCode = "(function(stream) {\n  return \"use strict\", @assert(@getByIdDirectPrivate(stream, \"backpressure\")), @assert(@getByIdDirectPrivate(stream, \"backpressureChangePromise\") !== @undefined), @transformStreamSetBackpressure(stream, !1), @getByIdDirectPrivate(stream, \"backpressureChangePromise\").@promise;\n})";
...
const int s_writableStreamDefaultControllerInitializeWritableStreamDefaultControllerCodeLength = 435;
...
const int s_writableStreamDefaultWriterInitializeWritableStreamDefaultWriterCodeLength = 335;
...
const char* const s_writableStreamDefaultWriterReleaseLockCode = "(function() {\n  if (\"use strict\", !@isWritableStreamDefaultWriter(this))\n    throw @makeThisTypeError(\"WritableStreamDefaultWriter\", \"releaseLock\");\n  const stream = @getByIdDirectPrivate(this, \"stream\");\n  if (stream === @undefined)\n    return;\n  @assert(@getByIdDirectPrivate(stream, \"writer\") !== @undefined), @writableStreamDefaultWriterRelease(this);\n})";
...
const char* const s_writableStreamInternalsIsWritableStreamCode = "(function(stream) {\n  return \"use strict\", @isObject(stream) && !!@getByIdDirectPrivate(stream, \"underlyingSink\");\n})";
...
const int s_writableStreamInternalsIsWritableStreamDefaultWriterCodeLength = 116;
static const JSC::Intrinsic s_writableStreamInternalsIsWritableStreamDefaultWriterCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_writableStreamInternalsIsWritableStreamDefaultWriterCode = "(function(writer) {\n  return \"use strict\", @isObject(writer) && !!@getByIdDirectPrivate(writer, \"closedPromise\");\n})";
...
const int s_writableStreamInternalsAcquireWritableStreamDefaultWriterCodeLength = 87;
static const JSC::Intrinsic s_writableStreamInternalsAcquireWritableStreamDefaultWriterCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_writableStreamInternalsAcquireWritableStreamDefaultWriterCode = "(function(stream) {\n  return \"use strict\", new @WritableStreamDefaultWriter(stream);\n})";
...
const int s_writableStreamInternalsCreateInternalWritableStreamFromUnderlyingSinkCodeLength = 1613;
...
const char* const s_writableStreamInternalsIsWritableStreamLockedCode = "(function(stream) {\n  return \"use strict\", @getByIdDirectPrivate(stream, \"writer\") !== @undefined;\n})";
...
const int s_writableStreamInternalsWritableStreamCloseQueuedOrInFlightCodeLength = 179;
static const JSC::Intrinsic s_writableStreamInternalsWritableStreamCloseQueuedOrInFlightCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_writableStreamInternalsWritableStreamCloseQueuedOrInFlightCode = "(function(stream) {\n  return \"use strict\", @getByIdDirectPrivate(stream, \"closeRequest\") !== @undefined || @getByIdDirectPrivate(stream, \"inFlightCloseRequest\") !== @undefined;\n})";
...
const int s_writableStreamInternalsWritableStreamDealWithRejectionCodeLength = 268;
static const JSC::Intrinsic s_writableStreamInternalsWritableStreamDealWithRejectionCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_writableStreamInternalsWritableStreamDealWithRejectionCode = "(function(stream, error) {\n  \"use strict\";\n  const state = @getByIdDirectPrivate(stream, \"state\");\n  if (state === \"writable\") {\n    @writableStreamStartErroring(stream, error);\n    return;\n  }\n  @assert(state === \"erroring\"), @writableStreamFinishErroring(stream);\n})";
...
const int s_writableStreamInternalsWritableStreamFinishInFlightCloseCodeLength = 969;
static const JSC::Intrinsic s_writableStreamInternalsWritableStreamFinishInFlightCloseCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_writableStreamInternalsWritableStreamFinishInFlightCloseCode = "(function(stream) {\n  \"use strict\", @getByIdDirectPrivate(stream, \"inFlightCloseRequest\").@resolve.@call(), @putByIdDirectPrivate(stream, \"inFlightCloseRequest\", @undefined);\n  const state = @getByIdDirectPrivate(stream, \"state\");\n  if (@assert(state === \"writable\" || state === \"erroring\"), state === \"erroring\") {\n    @putByIdDirectPrivate(stream, \"storedError\", @undefined);\n    const abortRequest = @getByIdDirectPrivate(stream, \"pendingAbortRequest\");\n    if (abortRequest !== @undefined)\n      abortRequest.promise.@resolve.@call(), @putByIdDirectPrivate(stream, \"pendingAbortRequest\", @undefined);\n  }\n  @putByIdDirectPrivate(stream, \"state\", \"closed\");\n  const writer = @getByIdDirectPrivate(stream, \"writer\");\n  if (writer !== @undefined)\n    @getByIdDirectPrivate(writer, \"closedPromise\").@resolve.@call();\n  @assert(@getByIdDirectPrivate(stream, \"pendingAbortRequest\") === @undefined), @assert(@getByIdDirectPrivate(stream, \"storedError\") === @undefined);\n})";
...
const int s_writableStreamInternalsWritableStreamFinishInFlightCloseWithErrorCodeLength = 702;
...
const char* const s_writableStreamInternalsWritableStreamFinishInFlightCloseWithErrorCode = "(function(stream, error) {\n  \"use strict\";\n  const inFlightCloseRequest = @getByIdDirectPrivate(stream, \"inFlightCloseRequest\");\n  @assert(inFlightCloseRequest !== @undefined), inFlightCloseRequest.@reject.@call(@undefined, error), @putByIdDirectPrivate(stream, \"inFlightCloseRequest\", @undefined);\n  const state = @getByIdDirectPrivate(stream, \"state\");\n  @assert(state === \"writable\" || state === \"erroring\");\n  const abortRequest = @getByIdDirectPrivate(stream, \"pendingAbortRequest\");\n  if (abortRequest !== @undefined)\n    abortRequest.promise.@reject.@call(@undefined, error), @putByIdDirectPrivate(stream, \"pendingAbortRequest\", @undefined);\n  @writableStreamDealWithRejection(stream, error);\n})";
...
const int s_writableStreamInternalsWritableStreamFinishInFlightWriteCodeLength = 278;
static const JSC::Intrinsic s_writableStreamInternalsWritableStreamFinishInFlightWriteCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_writableStreamInternalsWritableStreamFinishInFlightWriteCode = "(function(stream) {\n  \"use strict\";\n  const inFlightWriteRequest = @getByIdDirectPrivate(stream, \"inFlightWriteRequest\");\n  @assert(inFlightWriteRequest !== @undefined), inFlightWriteRequest.@resolve.@call(), @putByIdDirectPrivate(stream, \"inFlightWriteRequest\", @undefined);\n})";
...
const int s_writableStreamInternalsWritableStreamFinishInFlightWriteWithErrorCodeLength = 463;
...
const char* const s_writableStreamInternalsWritableStreamFinishInFlightWriteWithErrorCode = "(function(stream, error) {\n  \"use strict\";\n  const inFlightWriteRequest = @getByIdDirectPrivate(stream, \"inFlightWriteRequest\");\n  @assert(inFlightWriteRequest !== @undefined), inFlightWriteRequest.@reject.@call(@undefined, error), @putByIdDirectPrivate(stream, \"inFlightWriteRequest\", @undefined);\n  const state = @getByIdDirectPrivate(stream, \"state\");\n  @assert(state === \"writable\" || state === \"erroring\"), @writableStreamDealWithRejection(stream, error);\n})";
...
const int s_writableStreamInternalsWritableStreamHasOperationMarkedInFlightCodeLength = 187;
...
const char* const s_writableStreamInternalsWritableStreamHasOperationMarkedInFlightCode = "(function(stream) {\n  return \"use strict\", @getByIdDirectPrivate(stream, \"inFlightWriteRequest\") !== @undefined || @getByIdDirectPrivate(stream, \"inFlightCloseRequest\") !== @undefined;\n})";
...
const int s_writableStreamInternalsWritableStreamMarkCloseRequestInFlightCodeLength = 355;
static const JSC::Intrinsic s_writableStreamInternalsWritableStreamMarkCloseRequestInFlightCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_writableStreamInternalsWritableStreamMarkCloseRequestInFlightCode = "(function(stream) {\n  \"use strict\";\n  const closeRequest = @getByIdDirectPrivate(stream, \"closeRequest\");\n  @assert(@getByIdDirectPrivate(stream, \"inFlightCloseRequest\") === @undefined), @assert(closeRequest !== @undefined), @putByIdDirectPrivate(stream, \"inFlightCloseRequest\", closeRequest), @putByIdDirectPrivate(stream, \"closeRequest\", @undefined);\n})";
...
const int s_writableStreamInternalsWritableStreamMarkFirstWriteRequestInFlightCodeLength = 345;
...
const char* const s_writableStreamInternalsWritableStreamMarkFirstWriteRequestInFlightCode = "(function(stream) {\n  \"use strict\";\n  const writeRequests = @getByIdDirectPrivate(stream, \"writeRequests\");\n  @assert(@getByIdDirectPrivate(stream, \"inFlightWriteRequest\") === @undefined), @assert(writeRequests.isNotEmpty());\n  const writeRequest = writeRequests.shift();\n  @putByIdDirectPrivate(stream, \"inFlightWriteRequest\", writeRequest);\n})";
...
const int s_writableStreamInternalsWritableStreamRejectCloseAndClosedPromiseIfNeededCodeLength = 733;
...
const char* const s_writableStreamInternalsWritableStreamRejectCloseAndClosedPromiseIfNeededCode = "(function(stream) {\n  \"use strict\", @assert(@getByIdDirectPrivate(stream, \"state\") === \"errored\");\n  const storedError = @getByIdDirectPrivate(stream, \"storedError\"), closeRequest = @getByIdDirectPrivate(stream, \"closeRequest\");\n  if (closeRequest !== @undefined)\n    @assert(@getByIdDirectPrivate(stream, \"inFlightCloseRequest\") === @undefined), closeRequest.@reject.@call(@undefined, storedError), @putByIdDirectPrivate(stream, \"closeRequest\", @undefined);\n  const writer = @getByIdDirectPrivate(stream, \"writer\");\n  if (writer !== @undefined) {\n    const closedPromise = @getByIdDirectPrivate(writer, \"closedPromise\");\n    closedPromise.@reject.@call(@undefined, storedError), @markPromiseAsHandled(closedPromise.@promise);\n  }\n})";
...
const char* const s_writableStreamInternalsWritableStreamStartErroringCode = "(function(stream, reason) {\n  \"use strict\", @assert(@getByIdDirectPrivate(stream, \"storedError\") === @undefined), @assert(@getByIdDirectPrivate(stream, \"state\") === \"writable\");\n  const controller = @getByIdDirectPrivate(stream, \"controller\");\n  @assert(controller !== @undefined), @putByIdDirectPrivate(stream, \"state\", \"erroring\"), @putByIdDirectPrivate(stream, \"storedError\", reason);\n  const writer = @getByIdDirectPrivate(stream, \"writer\");\n  if (writer !== @undefined)\n    @writableStreamDefaultWriterEnsureReadyPromiseRejected(writer, reason);\n  if (!@writableStreamHasOperationMarkedInFlight(stream) && @getByIdDirectPrivate(controller, \"started\") === 1)\n    @writableStreamFinishErroring(stream);\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultWriterAbortCodeLength = 183;
static const JSC::Intrinsic s_writableStreamInternalsWritableStreamDefaultWriterAbortCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_writableStreamInternalsWritableStreamDefaultWriterAbortCode = "(function(writer, reason) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(writer, \"stream\");\n  return @assert(stream !== @undefined), @writableStreamAbort(stream, reason);\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultWriterCloseCodeLength = 167;
static const JSC::Intrinsic s_writableStreamInternalsWritableStreamDefaultWriterCloseCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_writableStreamInternalsWritableStreamDefaultWriterCloseCode = "(function(writer) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(writer, \"stream\");\n  return @assert(stream !== @undefined), @writableStreamClose(stream);\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultWriterCloseWithErrorPropagationCodeLength = 501;
...
const char* const s_writableStreamInternalsWritableStreamDefaultWriterCloseWithErrorPropagationCode = "(function(writer) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(writer, \"stream\");\n  @assert(stream !== @undefined);\n  const state = @getByIdDirectPrivate(stream, \"state\");\n  if (@writableStreamCloseQueuedOrInFlight(stream) || state === \"closed\")\n    return @Promise.@resolve();\n  if (state === \"errored\")\n    return @Promise.@reject(@getByIdDirectPrivate(stream, \"storedError\"));\n  return @assert(state === \"writable\" || state === \"erroring\"), @writableStreamDefaultWriterClose(writer);\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultWriterEnsureClosedPromiseRejectedCodeLength = 573;
...
const int s_writableStreamInternalsWritableStreamDefaultWriterEnsureReadyPromiseRejectedCodeLength = 561;
...
const int s_writableStreamInternalsWritableStreamDefaultWriterGetDesiredSizeCodeLength = 396;
...
const char* const s_writableStreamInternalsWritableStreamDefaultWriterGetDesiredSizeCode = "(function(writer) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(writer, \"stream\");\n  @assert(stream !== @undefined);\n  const state = @getByIdDirectPrivate(stream, \"state\");\n  if (state === \"errored\" || state === \"erroring\")\n    return null;\n  if (state === \"closed\")\n    return 0;\n  return @writableStreamDefaultControllerGetDesiredSize(@getByIdDirectPrivate(stream, \"controller\"));\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultControllerStartCodeLength = 905;
static const JSC::Intrinsic s_writableStreamInternalsWritableStreamDefaultControllerStartCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_writableStreamInternalsWritableStreamDefaultControllerStartCode = "(function(controller) {\n  if (\"use strict\", @getByIdDirectPrivate(controller, \"started\") !== -1)\n    return;\n  @putByIdDirectPrivate(controller, \"started\", 0);\n  const startAlgorithm = @getByIdDirectPrivate(controller, \"startAlgorithm\");\n  @putByIdDirectPrivate(controller, \"startAlgorithm\", @undefined);\n  const stream = @getByIdDirectPrivate(controller, \"stream\");\n  return @Promise.@resolve(startAlgorithm.@call()).@then(() => {\n    const state = @getByIdDirectPrivate(stream, \"state\");\n    @assert(state === \"writable\" || state === \"erroring\"), @putByIdDirectPrivate(controller, \"started\", 1), @writableStreamDefaultControllerAdvanceQueueIfNeeded(controller);\n  }, (error) => {\n    const state = @getByIdDirectPrivate(stream, \"state\");\n    @assert(state === \"writable\" || state === \"erroring\"), @putByIdDirectPrivate(controller, \"started\", 1), @writableStreamDealWithRejection(stream, error);\n  });\n})";
...
const int s_writableStreamInternalsSetUpWritableStreamDefaultControllerFromUnderlyingSinkCodeLength = 1327;
...
const int s_writableStreamInternalsWritableStreamDefaultControllerAdvanceQueueIfNeededCodeLength = 813;
...
const char* const s_writableStreamInternalsWritableStreamDefaultControllerAdvanceQueueIfNeededCode = "(function(controller) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(controller, \"stream\");\n  if (@getByIdDirectPrivate(controller, \"started\") !== 1)\n    return;\n  if (@assert(stream !== @undefined), @getByIdDirectPrivate(stream, \"inFlightWriteRequest\") !== @undefined)\n    return;\n  const state = @getByIdDirectPrivate(stream, \"state\");\n  if (@assert(state !== \"closed\" || state !== \"errored\"), state === \"erroring\") {\n    @writableStreamFinishErroring(stream);\n    return;\n  }\n  const queue = @getByIdDirectPrivate(controller, \"queue\");\n  if (queue.content\?.isEmpty() \?\? !1)\n    return;\n  const value = @peekQueueValue(queue);\n  if (value === @isCloseSentinel)\n    @writableStreamDefaultControllerProcessClose(controller);\n  else\n    @writableStreamDefaultControllerProcessWrite(controller, value);\n})";
...
const char* const s_writableStreamInternalsIsCloseSentinelCode = "(function() {\n  \"use strict\";\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultControllerClearAlgorithmsCodeLength = 309;
...
const char* const s_writableStreamInternalsWritableStreamDefaultControllerClearAlgorithmsCode = "(function(controller) {\n  \"use strict\", @putByIdDirectPrivate(controller, \"writeAlgorithm\", @undefined), @putByIdDirectPrivate(controller, \"closeAlgorithm\", @undefined), @putByIdDirectPrivate(controller, \"abortAlgorithm\", @undefined), @putByIdDirectPrivate(controller, \"strategySizeAlgorithm\", @undefined);\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultControllerCloseCodeLength = 196;
static const JSC::Intrinsic s_writableStreamInternalsWritableStreamDefaultControllerCloseCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_writableStreamInternalsWritableStreamDefaultControllerCloseCode = "(function(controller) {\n  \"use strict\", @enqueueValueWithSize(@getByIdDirectPrivate(controller, \"queue\"), @isCloseSentinel, 0), @writableStreamDefaultControllerAdvanceQueueIfNeeded(controller);\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultControllerErrorCodeLength = 315;
static const JSC::Intrinsic s_writableStreamInternalsWritableStreamDefaultControllerErrorCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_writableStreamInternalsWritableStreamDefaultControllerErrorCode = "(function(controller, error) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(controller, \"stream\");\n  @assert(stream !== @undefined), @assert(@getByIdDirectPrivate(stream, \"state\") === \"writable\"), @writableStreamDefaultControllerClearAlgorithms(controller), @writableStreamStartErroring(stream, error);\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultControllerErrorIfNeededCodeLength = 234;
...
const char* const s_writableStreamInternalsWritableStreamDefaultControllerErrorIfNeededCode = "(function(controller, error) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(controller, \"stream\");\n  if (@getByIdDirectPrivate(stream, \"state\") === \"writable\")\n    @writableStreamDefaultControllerError(controller, error);\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultControllerGetBackpressureCodeLength = 114;
...
const char* const s_writableStreamInternalsWritableStreamDefaultControllerGetBackpressureCode = "(function(controller) {\n  return \"use strict\", @writableStreamDefaultControllerGetDesiredSize(controller) <= 0;\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultControllerGetChunkSizeCodeLength = 249;
...
const int s_writableStreamInternalsWritableStreamDefaultControllerGetDesiredSizeCodeLength = 149;
...
const char* const s_writableStreamInternalsWritableStreamDefaultControllerGetDesiredSizeCode = "(function(controller) {\n  return \"use strict\", @getByIdDirectPrivate(controller, \"strategyHWM\") - @getByIdDirectPrivate(controller, \"queue\").size;\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultControllerProcessCloseCodeLength = 606;
...
const char* const s_writableStreamInternalsWritableStreamDefaultControllerProcessCloseCode = "(function(controller) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(controller, \"stream\");\n  @writableStreamMarkCloseRequestInFlight(stream), @dequeueValue(@getByIdDirectPrivate(controller, \"queue\")), @assert(@getByIdDirectPrivate(controller, \"queue\").content\?.isEmpty());\n  const sinkClosePromise = @getByIdDirectPrivate(controller, \"closeAlgorithm\").@call();\n  @writableStreamDefaultControllerClearAlgorithms(controller), sinkClosePromise.@then(() => {\n    @writableStreamFinishInFlightClose(stream);\n  }, (reason) => {\n    @writableStreamFinishInFlightCloseWithError(stream, reason);\n  });\n})";
...
const int s_writableStreamInternalsWritableStreamDefaultControllerProcessWriteCodeLength = 1006;
...
const char* const s_writableStreamInternalsWritableStreamDefaultControllerProcessWriteCode = "(function(controller, chunk) {\n  \"use strict\";\n  const stream = @getByIdDirectPrivate(controller, \"stream\");\n  @writableStreamMarkFirstWriteRequestInFlight(stream), @getByIdDirectPrivate(controller, \"writeAlgorithm\").@call(@undefined, chunk).@then(() => {\n    @writableStreamFinishInFlightWrite(stream);\n    const state = @getByIdDirectPrivate(stream, \"state\");\n    if (@assert(state === \"writable\" || state === \"erroring\"), @dequeueValue(@getByIdDirectPrivate(controller, \"queue\")), !@writableStreamCloseQueuedOrInFlight(stream) && state === \"writable\") {\n      const backpressure = @writableStreamDefaultControllerGetBackpressure(controller);\n      @writableStreamUpdateBackpressure(stream, backpressure);\n    }\n    @writableStreamDefaultControllerAdvanceQueueIfNeeded(controller);\n  }, (reason) => {\n    if (@getByIdDirectPrivate(stream, \"state\") === \"writable\")\n      @writableStreamDefaultControllerClearAlgorithms(controller);\n    @writableStreamFinishInFlightWriteWithError(stream, reason);\n  });\n})";
