...
pub fn getActiveTasks(globalObject: *jsc.JSGlobalObject, _: *jsc.CallFrame) bun.JSError!jsc.JSValue {
    ...
    result.put(globalObject, bun.String.static("activeTasks"), jsc.JSValue.jsNumber(vm.active_tasks));
    result.put(globalObject, bun.String.static("concurrentRef"), jsc.JSValue.jsNumber(event_loop.concurrent_ref.load(.seq_cst)));
    ...
    result.put(globalObject, bun.String.static("numPolls"), jsc.JSValue.jsNumber(num_polls));
