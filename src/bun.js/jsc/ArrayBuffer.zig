...
pub const Marked = struct {
    ...
    pub inline fn stream(this: *Marked) Stream {
        return this.buffer.stream();
    }

    pub fn fromTypedArray(ctx: *JSC.JSGlobalObject, value: JSC.JSValue) Marked {
        return Marked{
            .allocator = null,
    ...
    pub fn fromArrayBuffer(ctx: *JSC.JSGlobalObject, value: JSC.JSValue) Marked {
        return Marked{
            .allocator = null,
    ...
    pub fn fromString(str: []const u8, allocator: std.mem.Allocator) !Marked {
        const buf = try allocator.dupe(u8, str);
        return Marked.fromBytes(buf, allocator, JSC.JSValue.JSType.Uint8Array);
    }

    pub fn fromJS(global: *JSC.JSGlobalObject, value: JSC.JSValue) ?Marked {
        const array_buffer = value.asArrayBuffer(global) orelse return null;
        return Marked{ .buffer = array_buffer, .allocator = null };
    }

    pub fn fromBytes(bytes: []u8, allocator: std.mem.Allocator, typed_array_type: JSC.JSValue.JSType) Marked {
        return Marked{
    ...
    pub fn destroy(this: *Marked) void {
        const content = this.*;
    ...
    pub fn init(allocator: std.mem.Allocator, size: u32, typed_array_type: JSC.JSValue.JSType) !*Marked {
        const bytes = try allocator.alloc(u8, size);
        const container = try allocator.create(Marked);
        container.* = Marked.fromBytes(bytes, allocator, typed_array_type);
        return container;
    }

    pub fn toNodeBuffer(this: *const Marked, ctx: *JSC.JSGlobalObject) JSC.JSValue {
        return JSC.JSValue.createBufferWithCtx(ctx, this.buffer.byteSlice(), this.buffer.ptr, MarkedArrayBuffer_deallocator);
    }

    pub fn toJSObjectRef(this: *const Marked, ctx: *JSC.JSGlobalObject, exception: JSC.C.ExceptionRef) bun.JSC.C.JSObjectRef {
    ...
    // TODO: refactor this
    pub fn toJS(this: *const Marked, globalObject: *JSC.JSGlobalObject) JSC.JSValue {
