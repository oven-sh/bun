...
export default [
  ...
  define({
    ...
    JSType: "0b11101110",
    proto: {
      min: { getter: "min", setter: "setMin" },
      max: { getter: "max", setter: "setMax" },
      mean: { getter: "mean", setter: "setMean" },
      exceeds: { getter: "exceeds", setter: "setExceeds" },
      stddev: { getter: "stddev", setter: "setStddev" },
      count: { getter: "count", setter: "setCount" },
