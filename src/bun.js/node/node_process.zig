...
pub fn setTitle(globalObject: *JSGlobalObject, newvalue: *ZigString) callconv(.C) JSValue {
    ...
    bun.cli.Bun__Node__ProcessTitle = newvalue.dupe(bun.default_allocator) catch |oe| bun.outOfMemory(oe);
...
pub fn Bun__Process__editWindowsEnvVar(k: bun.String, v: bun.String) callconv(.C) void {
    ...
    var buf1 = allocator.alloc(u16, k.utf16ByteLength() + 1) catch |oe| bun.outOfMemory(oe);
    defer allocator.free(buf1);
    var buf2 = allocator.alloc(u16, v.utf16ByteLength() + 1) catch |oe| bun.outOfMemory(oe);
