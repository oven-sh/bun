...
const ZstdContext = struct {
    ...
    pub fn init(this: *ZstdContext, pledged_src_size: u64) Error {
        switch (this.mode_) {
            .ZSTD_COMPRESS => {
    ...
    pub fn setParams(this: *ZstdContext, key: c_uint, value: u32) Error {
        switch (this.mode_) {
            .ZSTD_COMPRESS => {
    ...
    pub fn reset(this: *ZstdContext) Error {
        return this.init(this.pledged_src_size);
    }

    pub fn setBuffers(this: *ZstdContext, in: ?[]const u8, out: ?[]u8) void {
    ...
    pub fn setFlush(this: *ZstdContext, flush: c_int) void {
        this.flush = flush;
    }
    ...
    pub fn updateWriteResult(this: *ZstdContext, avail_in: *u32, avail_out: *u32) void {
        avail_in.* = @intCast(this.input.size - this.input.pos);
        avail_out.* = @intCast(this.output.size - this.output.pos);
    }

    pub fn getErrorInfo(this: *ZstdContext) Error {
    ...
    pub fn close(this: *ZstdContext) void {
        _ = switch (this.mode_) {
