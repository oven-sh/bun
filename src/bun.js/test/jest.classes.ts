...
export default [
  ...
  define({
    ...
    finalize: true,
    JSType: "0b11101110",
    values: ["flags", "numberValue", "digitsValue"],
    configurable: false,
    klass: {},
    proto: {},
  }),
  ...
  define({
    ...
    finalize: true,
    JSType: "0b11101110",
    values: ["flags", "arrayValue"],
    configurable: false,
    klass: {},
    proto: {},
  }),
  define({
    name: "ExpectCustomMatcher",
    construct: false,
    noConstructor: true,
    call: false,
    apply: true,
    finalize: true,
    JSType: "0b11101110",
    values: ["matcherFn", "capturedValue"],
    configurable: false,
    klass: {},
    proto: {},
  }),
  define({
    ...
    finalize: true,
    JSType: "0b11101110",
    values: ["flags", "matcherFn", "capturedArgs"],
    configurable: false,
    klass: {},
    proto: {
      asymmetricMatch: {
  ...
  define({
    ...
    call: true,
    getOwnPropertySlot: "first",
    getOwnPropertySlotStatic: "first",
    finalize: true,
    JSType: "0b11101110",
    values: ["capturedValue", "resultValue"],
    valuesAccessorsFromJsObject: true,
    configurable: false,
    klass: {
      extend: {
        fn: "extend",
