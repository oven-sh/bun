...
pub const Jest = struct {
    ...
    pub fn createTestModule(globalObject: *JSGlobalObject) JSValue {
        ...
        const test_scope_functions = describe2.ScopeFunctions.create(globalObject, .@"test", .zero, .{}, null);
        ...
        const xtest_scope_functions = describe2.ScopeFunctions.create(globalObject, .@"test", .zero, .{ .self_mode = .skip }, null);
        ...
        const describe_scope_functions = describe2.ScopeFunctions.create(globalObject, .describe, .zero, .{}, null);
        module.put(globalObject, ZigString.static("describe"), describe_scope_functions);

        const xdescribe_scope_functions = describe2.ScopeFunctions.create(globalObject, .describe, .zero, .{ .self_mode = .skip }, null);
