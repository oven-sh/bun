...
pub const CompressionStreamEncoder = @import("./webcore/CompressionStreamEncoder.zig");
pub const DecompressionStreamDecoder = @import("./webcore/DecompressionStreamDecoder.zig");
