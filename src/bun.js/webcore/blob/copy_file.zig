...
pub const CopyFile = struct {
    ...
    pub fn create(
        ...
        store.ref();
        source_store.ref();
        return CopyFilePromiseTask.createOnJSThread(allocator, globalThis, read_file) catch |oe| bun.outOfMemory(oe);
    }
...
pub const CopyFileWindows = struct {
    ...
    pub const ReadWriteLoop = struct {
        ...
        pub fn start(read_write_loop: *ReadWriteLoop, this: *CopyFileWindows) bun.sys.Maybe(void) {
            read_write_loop.read_buf.ensureTotalCapacityPrecise(64 * 1024) catch |oe| bun.outOfMemory(oe);
