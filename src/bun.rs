...
// ─── assertions ───────────────────────────────────────────────────────────────
// Use Rust's builtin `assert!` / `debug_assert!` / `assert_eq!`. The Zig-port
// helpers (`bun.assert`, `bun.assertf`, `bun.assert_eql`, …) were redundant
// translations and have been removed.
