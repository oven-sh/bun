...
pub const StaticString = struct {
    #ptr: *const u8,
    #len: usize,
    pub inline fn init(comptime slice: []const u8) @This() {
        return .{
            .#ptr = slice.ptr,
            .#len = slice.len,
        };
    }
    pub inline fn slice(this: @This()) []const u8 {
...
pub const String = struct {
    #ptr: StringPtr,
    #len: usize,
    const StringPtr = bun.ptr.TaggedPointerUnion(.{
        .StaticString = *u8,
        .HeapString = *u8,
        .DeadString = void,
    });
    pub inline fn init(comptime slice: []const u8) @This() {
        return .{
            .#ptr = StringPtr.init(slice.ptr),
            .#len = slice.len,
        };
    }
    pub inline fn slice(this: @This()) []const u8 {
        switch (this.#ptr) {
            inline .StaticString, .HeapString => |*str| str.slice(),
        }
    }
    pub inline fn deinit(this: *@This()) void {
        switch (this.#ptr) {
             .HeapString => |*str_ptr| mimalloc.mi_free(str_ptr),
             .StaticString => {
                // Do nothing
             }
        };
...
pub const String = union(enum) {
    ...
    pub inline fn init(comptime slice: []const u8) @This() {
        return .{
            .static = StaticString.init(slice),
        };
    }
    pub inline fn initFromHeap(comptime slice: []const u8) @This() {
        return .{
            .heap = HeapString.init(slice),
        };
    }
    pub inline fn slice(this: @This()) []const u8 {
        return switch (this) {
            inline .static, .heap => |*str| str.slice(),
        };
    }
    pub inline fn deinit(this: @This()) void {
        switch (this) {
            inline .static, .heap => |*str| str.deinit(),
        }
    }
};
