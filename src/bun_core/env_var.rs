...
pub mod feature_flag {
    ...
    // run a full GC inside `Bun.spawnSync` while its isolated event loop is installed.
    new_feature_flag!(pub BUN_INTERNAL_SPAWN_SYNC_GC, "BUN_INTERNAL_SPAWN_SYNC_GC", {});
