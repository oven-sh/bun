...
new!(pub BUN_PPROF_HEAP_MAX_JS_LOCATIONS: unsigned, "BUN_PPROF_HEAP_MAX_JS_LOCATIONS", {});
new!(pub BUN_PPROF_HEAP_MAX_STACKS: unsigned, "BUN_PPROF_HEAP_MAX_STACKS", {});
new!(pub BUN_PPROF_HEAP_MAX_STRINGS: unsigned, "BUN_PPROF_HEAP_MAX_STRINGS", {});
