...
pub fn escape_html_for_latin1_input(latin1: &[u8]) -> Result<Escaped<u8>, AllocError> {
    match latin1.len() {
        ...
        3 => return Ok(scalar_push::<3>(latin1[0..3].try_into().expect("infallible: size matches"))),
        4 => return Ok(scalar_push::<4>(latin1[0..4].try_into().expect("infallible: size matches"))),
        5 => return Ok(scalar_push::<5>(latin1[0..5].try_into().expect("infallible: size matches"))),
        6 => return Ok(scalar_push::<6>(latin1[0..6].try_into().expect("infallible: size matches"))),
        7 => return Ok(scalar_push::<7>(latin1[0..7].try_into().expect("infallible: size matches"))),
        8 => return Ok(scalar_push::<8>(latin1[0..8].try_into().expect("infallible: size matches"))),
        9 => return Ok(scalar_push::<9>(latin1[0..9].try_into().expect("infallible: size matches"))),
        10 => return Ok(scalar_push::<10>(latin1[0..10].try_into().expect("infallible: size matches"))),
        11 => return Ok(scalar_push::<11>(latin1[0..11].try_into().expect("infallible: size matches"))),
        12 => return Ok(scalar_push::<12>(latin1[0..12].try_into().expect("infallible: size matches"))),
        13 => return Ok(scalar_push::<13>(latin1[0..13].try_into().expect("infallible: size matches"))),
        14 => return Ok(scalar_push::<14>(latin1[0..14].try_into().expect("infallible: size matches"))),
        15 => return Ok(scalar_push::<15>(latin1[0..15].try_into().expect("infallible: size matches"))),
        16 => return Ok(scalar_push::<16>(latin1[0..16].try_into().expect("infallible: size matches"))),
        17 => return Ok(scalar_push::<17>(latin1[0..17].try_into().expect("infallible: size matches"))),
        18 => return Ok(scalar_push::<18>(latin1[0..18].try_into().expect("infallible: size matches"))),
        19 => return Ok(scalar_push::<19>(latin1[0..19].try_into().expect("infallible: size matches"))),
        20 => return Ok(scalar_push::<20>(latin1[0..20].try_into().expect("infallible: size matches"))),
        21 => return Ok(scalar_push::<21>(latin1[0..21].try_into().expect("infallible: size matches"))),
        22 => return Ok(scalar_push::<22>(latin1[0..22].try_into().expect("infallible: size matches"))),
        23 => return Ok(scalar_push::<23>(latin1[0..23].try_into().expect("infallible: size matches"))),
        24 => return Ok(scalar_push::<24>(latin1[0..24].try_into().expect("infallible: size matches"))),
        25 => return Ok(scalar_push::<25>(latin1[0..25].try_into().expect("infallible: size matches"))),
        26 => return Ok(scalar_push::<26>(latin1[0..26].try_into().expect("infallible: size matches"))),
        27 => return Ok(scalar_push::<27>(latin1[0..27].try_into().expect("infallible: size matches"))),
        28 => return Ok(scalar_push::<28>(latin1[0..28].try_into().expect("infallible: size matches"))),
        29 => return Ok(scalar_push::<29>(latin1[0..29].try_into().expect("infallible: size matches"))),
        30 => return Ok(scalar_push::<30>(latin1[0..30].try_into().expect("infallible: size matches"))),
        31 => return Ok(scalar_push::<31>(latin1[0..31].try_into().expect("infallible: size matches"))),
        32 => return Ok(scalar_push::<32>(latin1[0..32].try_into().expect("infallible: size matches"))),
