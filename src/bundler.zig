        ...
        switch (loader) {
            ...
            .css => {
                if (bundler.options.experimental_css) {
                    ...
                    _ = source; //
                    var v = switch (bun.css.StyleSheet(bun.css.DefaultAtRule).parse(alloc, entry.contents, bun.css.ParserOptions.default(alloc, bundler.log), null)) {
                        .result => |v| v,
                        .err => |e| {
                    ...
                    if (v.minify(alloc, bun.css.MinifyOptions.default()).asErr()) |e| {
