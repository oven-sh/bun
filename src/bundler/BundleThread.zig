    ...
    return struct {
        ...
        pub const singleton = struct {
            ...
            fn loadOnceImpl() void {
                const bundle_thread = bun.default_allocator.create(Self) catch |oe| bun.outOfMemory(oe);
        ...
        fn generateInNewThread(completion: *CompletionStruct, generation: bun.Generation) !void {
            ...
            errdefer {
                ...
                this.transpiler.log.appendToWithRecycled(&out_log, true) catch |oe| bun.outOfMemory(oe);
