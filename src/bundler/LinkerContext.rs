...
pub struct LinkerContext<'a> {
    ...
    /// Files that `merge_small_chunks` moved out of the chunk of a pinned entry point.
    pub(crate) left_entry_chunk: Option<AutoBitSet>,
