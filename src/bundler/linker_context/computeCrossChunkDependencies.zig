    ...
    pub fn walk(deps: *@This(), chunk: *Chunk, chunk_index: usize) void {
        ...
        if (chunk.content == .javascript) {
            if (chunk.entry_point.is_entry_point) {
                ...
                // https://github.com/evanw/esbuild/blob/v0.24.2/internal/linker/linker.go#L1049-L1051
                ...
                // https://github.com/evanw/esbuild/blob/v0.24.2/internal/linker/linker.go#L1053-L1056
                if (flags.wrap != .none) {
