                        ...
                        already_bundled: match already_bundled {
                            ...
                            | js_ast::AlreadyBundled::Bytecode => 'brk: {
                                    ...
                                    && this_parse.allow_bytecode_cache
                                {
                                    ...
                                    // `ZStr::from_buf` asserts `buf[total] == 0`.
                                    // `PathBuffer::uninit()` hands back MaybeUninit
                                    // bytes — write the terminator explicitly so the
                                    // assertion holds regardless of what leaked
                                    // through from the stack allocation.
                                    path_buf2[total] = 0;
