                        ...
                        const plugins: ?[]const []const u8 = plugins: {
                            if (config_plugins.data == .e_array) {
                                ...
                                for (raw_plugins, 0..) |p, i| {
                                    ...
                                    plugins[i] = try p.data.e_string.toWtf8MayAlloc(allocator);
                                }
                                break :plugins plugins;
                            } else {
                                const p = try config_plugins.data.e_string.toWtf8MayAlloc(allocator);
                        ...
                        switch (env.data) {
                            ...
                            .e_string => |str| {
                                if (str.eqlComptime("inline")) {
                                    ...
                                    const slice = try str.toWtf8MayAlloc(allocator);
