...
__BUN_CC_INTRIN __m128d _mm_add_sd(__m128d __a, __m128d __b)
{
    __a[0] = __a[0] + __b[0];
    return __a;
}
__BUN_CC_INTRIN __m128d _mm_sub_sd(__m128d __a, __m128d __b)
{
    __a[0] = __a[0] - __b[0];
    return __a;
}
__BUN_CC_INTRIN __m128d _mm_mul_sd(__m128d __a, __m128d __b)
{
    __a[0] = __a[0] * __b[0];
    return __a;
}
__BUN_CC_INTRIN __m128d _mm_div_sd(__m128d __a, __m128d __b)
{
    __a[0] = __a[0] / __b[0];
    return __a;
}
__BUN_CC_INTRIN __m128d _mm_sqrt_sd(__m128d __a, __m128d __b)
{
    __a[0] = __builtin_elementwise_sqrt(__b)[0];
    return __a;
}
__BUN_CC_INTRIN __m128d _mm_min_sd(__m128d __a, __m128d __b)
{
    __a[0] = __builtin_elementwise_min(__a, __b)[0];
    return __a;
}
__BUN_CC_INTRIN __m128d _mm_max_sd(__m128d __a, __m128d __b)
{
    __a[0] = __builtin_elementwise_max(__a, __b)[0];
    return __a;
}
__BUN_CC_INTRIN __m128d _mm_move_sd(__m128d __a, __m128d __b)
{
    __a[0] = __b[0];
    return __a;
}
...
__BUN_CC_CMP_SD(eq)
__BUN_CC_CMP_SD(lt) __BUN_CC_CMP_SD(le) __BUN_CC_CMP_SD(gt) __BUN_CC_CMP_SD(ge) __BUN_CC_CMP_SD(neq)
...
#undef __BUN_CC_CMP_SD
        ...
        __BUN_CC_INTRIN int _mm_comieq_sd(__m128d __a, __m128d __b)
{
    return __a[0] == __b[0];
}
...
__BUN_CC_INTRIN __m128 _mm_cvtsd_ss(__m128 __a, __m128d __b)
{
    __a[0] = (float)__b[0];
    return __a;
}
__BUN_CC_INTRIN __m128d _mm_cvtss_sd(__m128d __a, __m128 __b)
{
    __a[0] = (double)__b[0];
    return __a;
}
__BUN_CC_INTRIN __m128d _mm_cvtsi32_sd(__m128d __a, int __b)
{
    __a[0] = (double)__b;
    return __a;
}
__BUN_CC_INTRIN __m128d _mm_cvtsi64_sd(__m128d __a, long long __b)
{
    __a[0] = (double)__b;
    return __a;
}
...
__BUN_CC_INTRIN __m128d _mm_loadh_pd(__m128d __a, const double* __p)
{
    __a[1] = *__p;
    return __a;
}
__BUN_CC_INTRIN __m128d _mm_loadl_pd(__m128d __a, const double* __p)
{
    __a[0] = *__p;
    return __a;
}
...
/* Unaligned partial loads and stores; they go through a packed struct so that no alignment
   is assumed. */
struct __bun_cc_loadu_si16 {
    short __v;
} __attribute__((__packed__));
struct __bun_cc_loadu_si32 {
    int __v;
} __attribute__((__packed__));
struct __bun_cc_loadu_si64 {
    long long __v;
} __attribute__((__packed__));
