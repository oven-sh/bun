...
typedef struct __attribute__((__aligned__(32))) __m256i {
    __m128i __lo, __hi;
} __m256i;
...
__BUN_CC_INTRIN void _mm256_storeu_si256(__m256i* __p, __m256i __a)
{
    _mm_storeu_si128((__m128i*)__p, __a.__lo);
    _mm_storeu_si128((__m128i*)__p + 1, __a.__hi);
}
