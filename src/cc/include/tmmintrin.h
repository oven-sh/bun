...
{
    return (__m128i)((__v8hu)__builtin_shufflevector((__v8hi)__a, (__v8hi)__b, 0, 2, 4, 6, 8, 10, 12, 14) + (__v8hu)__builtin_shufflevector((__v8hi)__a, (__v8hi)__b, 1, 3, 5, 7, 9, 11, 13, 15));
}
__BUN_CC_INTRIN __m128i _mm_hadd_epi32(__m128i __a, __m128i __b)
{
    return (__m128i)((__v4su)__builtin_shufflevector((__v4si)__a, (__v4si)__b, 0, 2, 4, 6) + (__v4su)__builtin_shufflevector((__v4si)__a, (__v4si)__b, 1, 3, 5, 7));
}
