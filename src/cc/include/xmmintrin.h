...
__BUN_CC_INTRIN __m128 _mm_min_ps(__m128 __a, __m128 __b) { return __builtin_bir_second_if_less(__b, __a); }
__BUN_CC_INTRIN __m128 _mm_max_ps(__m128 __a, __m128 __b) { return __builtin_bir_second_if_greater(__b, __a); }
...
__BUN_CC_INTRIN __m128 _mm_add_ss(__m128 __a, __m128 __b) { __a[0] = __a[0] + __b[0]; return __a; }
__BUN_CC_INTRIN __m128 _mm_sub_ss(__m128 __a, __m128 __b) { __a[0] = __a[0] - __b[0]; return __a; }
...
__BUN_CC_INTRIN __m128 _mm_min_ss(__m128 __a, __m128 __b) { __a[0] = __builtin_bir_second_if_less(__b, __a)[0]; return __a; }
__BUN_CC_INTRIN __m128 _mm_max_ss(__m128 __a, __m128 __b) { __a[0] = __builtin_bir_second_if_greater(__b, __a)[0]; return __a; }
...
__BUN_CC_INTRIN __m128 _mm_rcp_ss(__m128 __a) { __a[0] = 1.0f / __a[0]; return __a; }
__BUN_CC_INTRIN __m128 _mm_rsqrt_ss(__m128 __a) { __a[0] = 1.0f / __builtin_elementwise_sqrt(__a)[0]; return __a; }
...
__BUN_CC_CMP_SS(eq) __BUN_CC_CMP_SS(lt) __BUN_CC_CMP_SS(le) __BUN_CC_CMP_SS(gt) __BUN_CC_CMP_SS(ge) __BUN_CC_CMP_SS(neq)
...
__BUN_CC_INTRIN int _mm_comieq_ss(__m128 __a, __m128 __b) { return __a[0] == __b[0]; }
