 ...
 * Import it by a path relative to the `.bind.ts` file, for example `import { fn, t } from "../codegen/bindgen-lib.ts"`.
...
export const t = {
   ...
   */
  virtualMachine: builtinType<never>()("virtualMachine"),
...
} satisfies Record<TypeKind, unknown>;
...
interface FuncOptionsWithVariant {
   ...
   * ```ts
   * // foo.bind.ts
   * import { fn } from "../codegen/bindgen-lib.ts";
   *
   * export const foo = fn({
   *   variants: [
   *     {
