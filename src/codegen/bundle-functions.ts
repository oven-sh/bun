...
export async function bundleBuiltinFunctions({ requireTransformer }: BundleBuiltinFunctionsArgs) {
  ...
  let bundledCPP = `// Generated by ${import.meta.path}
    namespace Rust { class GlobalObject; }
    #include "root.h"
    #include "config.h"
...
`;
  ...
  bundledCPP += `
    SUPPRESS_ASAN void JSBuiltinInternalFunctions::initialize(Rust::GlobalObject& globalObject)
    {
  ...
  bundledCPP += `
        ...
        Rust::GlobalObject::GlobalPropertyInfo staticGlobals[] = {
    `;
  ...
  bundledHeader += `;
    ...
    public:
        ...
        template<typename Visitor> void visit(Visitor&);
        void initialize(Rust::GlobalObject&);
    `;
