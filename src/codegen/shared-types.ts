export const typeDeclarations = `// generated by cppbind.ts from functions marked with [[RUST_EXPORT(mode)]]
...
export const sharedTypes: Record<string, string> = {
  ...
  "RustException": "jsc.RustException",
  ...
  "Rust::GlobalObject": "jsc.JSGlobalObject",
  "JSC::VM": "jsc.VM",
  "WTF::StringImpl": "bun.WTF._StringImplStruct",
  "WebCore::DOMURL": "bun.DOMURL",
  "RustString": "bun.jsc.RustString",
