...
//
// PORT NOTE: this module is `#[cfg(any())]`-gated in `properties/mod.rs`
// until the leaf property modules + values/ calc lattice un-gate. The
// type paths below resolve against `super::*` (the gated leaf modules)
// and `crate::css_values`, matching the Zig prelude in
// properties_generated.zig.
...
// Leaf property modules (gated in mod.rs).
use super::align;
...
type BabyList<T> = bun_baby_list::BabyList<T>;
