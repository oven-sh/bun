...
impl Property {
    ...
    pub fn value_to_css(&self, dest: &mut css::Printer) -> Result<(), css::PrintErr> {
        match self {
            Property::BackgroundColor(v) => v.to_css(dest),
            Property::BackgroundImage(v) => v.to_css(dest),
            Property::BackgroundPositionX(v) => v.to_css(dest),
            Property::BackgroundPositionY(v) => v.to_css(dest),
            Property::BackgroundPosition(v) => v.to_css(dest),
            Property::BackgroundSize(v) => v.to_css(dest),
            Property::BackgroundRepeat(v) => v.to_css(dest),
            Property::BackgroundAttachment(v) => v.to_css(dest),
            Property::BackgroundClip(v) => v.0.to_css(dest),
            Property::BackgroundOrigin(v) => v.to_css(dest),
            Property::Background(v) => v.to_css(dest),
            Property::BoxShadow(v) => v.0.to_css(dest),
            Property::Opacity(v) => v.to_css(dest),
            Property::Color(v) => v.to_css(dest),
            Property::Display(v) => v.to_css(dest),
            Property::Visibility(v) => v.to_css(dest),
            Property::Width(v) => v.to_css(dest),
            Property::Height(v) => v.to_css(dest),
            Property::MinWidth(v) => v.to_css(dest),
            Property::MinHeight(v) => v.to_css(dest),
            Property::MaxWidth(v) => v.to_css(dest),
            Property::MaxHeight(v) => v.to_css(dest),
            Property::BlockSize(v) => v.to_css(dest),
            Property::InlineSize(v) => v.to_css(dest),
            Property::MinBlockSize(v) => v.to_css(dest),
            Property::MinInlineSize(v) => v.to_css(dest),
            Property::MaxBlockSize(v) => v.to_css(dest),
            Property::MaxInlineSize(v) => v.to_css(dest),
            Property::BoxSizing(v) => v.0.to_css(dest),
            Property::AspectRatio(v) => v.to_css(dest),
            Property::Overflow(v) => v.to_css(dest),
            Property::OverflowX(v) => v.to_css(dest),
            Property::OverflowY(v) => v.to_css(dest),
            Property::TextOverflow(v) => v.0.to_css(dest),
            Property::Position(v) => v.to_css(dest),
            Property::Top(v) => v.to_css(dest),
            Property::Bottom(v) => v.to_css(dest),
            Property::Left(v) => v.to_css(dest),
            Property::Right(v) => v.to_css(dest),
            Property::InsetBlockStart(v) => v.to_css(dest),
            Property::InsetBlockEnd(v) => v.to_css(dest),
            Property::InsetInlineStart(v) => v.to_css(dest),
            Property::InsetInlineEnd(v) => v.to_css(dest),
            Property::InsetBlock(v) => v.to_css(dest),
            Property::InsetInline(v) => v.to_css(dest),
            Property::Inset(v) => v.to_css(dest),
            Property::BorderSpacing(v) => v.to_css(dest),
            Property::BorderTopColor(v) => v.to_css(dest),
            Property::BorderBottomColor(v) => v.to_css(dest),
            Property::BorderLeftColor(v) => v.to_css(dest),
            Property::BorderRightColor(v) => v.to_css(dest),
            Property::BorderBlockStartColor(v) => v.to_css(dest),
            Property::BorderBlockEndColor(v) => v.to_css(dest),
            Property::BorderInlineStartColor(v) => v.to_css(dest),
            Property::BorderInlineEndColor(v) => v.to_css(dest),
            Property::BorderTopStyle(v) => v.to_css(dest),
            Property::BorderBottomStyle(v) => v.to_css(dest),
            Property::BorderLeftStyle(v) => v.to_css(dest),
            Property::BorderRightStyle(v) => v.to_css(dest),
            Property::BorderBlockStartStyle(v) => v.to_css(dest),
            Property::BorderBlockEndStyle(v) => v.to_css(dest),
            Property::BorderInlineStartStyle(v) => v.to_css(dest),
            Property::BorderInlineEndStyle(v) => v.to_css(dest),
            Property::BorderTopWidth(v) => v.to_css(dest),
            Property::BorderBottomWidth(v) => v.to_css(dest),
            Property::BorderLeftWidth(v) => v.to_css(dest),
            Property::BorderRightWidth(v) => v.to_css(dest),
            Property::BorderBlockStartWidth(v) => v.to_css(dest),
            Property::BorderBlockEndWidth(v) => v.to_css(dest),
            Property::BorderInlineStartWidth(v) => v.to_css(dest),
            Property::BorderInlineEndWidth(v) => v.to_css(dest),
            Property::BorderTopLeftRadius(v) => v.0.to_css(dest),
            Property::BorderTopRightRadius(v) => v.0.to_css(dest),
            Property::BorderBottomLeftRadius(v) => v.0.to_css(dest),
            Property::BorderBottomRightRadius(v) => v.0.to_css(dest),
            Property::BorderStartStartRadius(v) => v.to_css(dest),
            Property::BorderStartEndRadius(v) => v.to_css(dest),
            Property::BorderEndStartRadius(v) => v.to_css(dest),
            Property::BorderEndEndRadius(v) => v.to_css(dest),
            Property::BorderRadius(v) => v.0.to_css(dest),
            Property::BorderImageSource(v) => v.to_css(dest),
            Property::BorderImageOutset(v) => v.to_css(dest),
            Property::BorderImageRepeat(v) => v.to_css(dest),
            Property::BorderImageWidth(v) => v.to_css(dest),
            Property::BorderImageSlice(v) => v.to_css(dest),
            Property::BorderImage(v) => v.0.to_css(dest),
            Property::BorderColor(v) => v.to_css(dest),
            Property::BorderStyle(v) => v.to_css(dest),
            Property::BorderWidth(v) => v.to_css(dest),
            Property::BorderBlockColor(v) => v.to_css(dest),
            Property::BorderBlockStyle(v) => v.to_css(dest),
            Property::BorderBlockWidth(v) => v.to_css(dest),
            Property::BorderInlineColor(v) => v.to_css(dest),
            Property::BorderInlineStyle(v) => v.to_css(dest),
            Property::BorderInlineWidth(v) => v.to_css(dest),
            Property::Border(v) => v.to_css(dest),
            Property::BorderTop(v) => v.to_css(dest),
            Property::BorderBottom(v) => v.to_css(dest),
            Property::BorderLeft(v) => v.to_css(dest),
            Property::BorderRight(v) => v.to_css(dest),
            Property::BorderBlock(v) => v.to_css(dest),
            Property::BorderBlockStart(v) => v.to_css(dest),
            Property::BorderBlockEnd(v) => v.to_css(dest),
            Property::BorderInline(v) => v.to_css(dest),
            Property::BorderInlineStart(v) => v.to_css(dest),
            Property::BorderInlineEnd(v) => v.to_css(dest),
            Property::Outline(v) => v.to_css(dest),
            Property::OutlineColor(v) => v.to_css(dest),
            Property::OutlineStyle(v) => v.to_css(dest),
            Property::OutlineWidth(v) => v.to_css(dest),
            Property::FlexDirection(v) => v.0.to_css(dest),
            Property::FlexWrap(v) => v.0.to_css(dest),
            Property::FlexFlow(v) => v.0.to_css(dest),
            Property::FlexGrow(v) => v.0.to_css(dest),
            Property::FlexShrink(v) => v.0.to_css(dest),
            Property::FlexBasis(v) => v.0.to_css(dest),
            Property::Flex(v) => v.0.to_css(dest),
            Property::Order(v) => v.0.to_css(dest),
            Property::AlignContent(v) => v.0.to_css(dest),
            Property::JustifyContent(v) => v.0.to_css(dest),
            Property::PlaceContent(v) => v.to_css(dest),
            Property::AlignSelf(v) => v.0.to_css(dest),
            Property::JustifySelf(v) => v.to_css(dest),
            Property::PlaceSelf(v) => v.to_css(dest),
            Property::AlignItems(v) => v.0.to_css(dest),
            Property::JustifyItems(v) => v.to_css(dest),
            Property::PlaceItems(v) => v.to_css(dest),
            Property::RowGap(v) => v.to_css(dest),
            Property::ColumnGap(v) => v.to_css(dest),
            Property::Gap(v) => v.to_css(dest),
            Property::BoxOrient(v) => v.0.to_css(dest),
            Property::BoxDirection(v) => v.0.to_css(dest),
            Property::BoxOrdinalGroup(v) => v.0.to_css(dest),
            Property::BoxAlign(v) => v.0.to_css(dest),
            Property::BoxFlex(v) => v.0.to_css(dest),
            Property::BoxFlexGroup(v) => v.0.to_css(dest),
            Property::BoxPack(v) => v.0.to_css(dest),
            Property::BoxLines(v) => v.0.to_css(dest),
            Property::FlexPack(v) => v.0.to_css(dest),
            Property::FlexOrder(v) => v.0.to_css(dest),
            Property::FlexAlign(v) => v.0.to_css(dest),
            Property::FlexItemAlign(v) => v.0.to_css(dest),
            Property::FlexLinePack(v) => v.0.to_css(dest),
            Property::FlexPositive(v) => v.0.to_css(dest),
            Property::FlexNegative(v) => v.0.to_css(dest),
            Property::FlexPreferredSize(v) => v.0.to_css(dest),
            Property::MarginTop(v) => v.to_css(dest),
            Property::MarginBottom(v) => v.to_css(dest),
            Property::MarginLeft(v) => v.to_css(dest),
            Property::MarginRight(v) => v.to_css(dest),
            Property::MarginBlockStart(v) => v.to_css(dest),
            Property::MarginBlockEnd(v) => v.to_css(dest),
            Property::MarginInlineStart(v) => v.to_css(dest),
            Property::MarginInlineEnd(v) => v.to_css(dest),
            Property::MarginBlock(v) => v.to_css(dest),
            Property::MarginInline(v) => v.to_css(dest),
            Property::Margin(v) => v.to_css(dest),
            Property::PaddingTop(v) => v.to_css(dest),
            Property::PaddingBottom(v) => v.to_css(dest),
            Property::PaddingLeft(v) => v.to_css(dest),
            Property::PaddingRight(v) => v.to_css(dest),
            Property::PaddingBlockStart(v) => v.to_css(dest),
            Property::PaddingBlockEnd(v) => v.to_css(dest),
            Property::PaddingInlineStart(v) => v.to_css(dest),
            Property::PaddingInlineEnd(v) => v.to_css(dest),
            Property::PaddingBlock(v) => v.to_css(dest),
            Property::PaddingInline(v) => v.to_css(dest),
            Property::Padding(v) => v.to_css(dest),
            Property::ScrollMarginTop(v) => v.to_css(dest),
            Property::ScrollMarginBottom(v) => v.to_css(dest),
            Property::ScrollMarginLeft(v) => v.to_css(dest),
            Property::ScrollMarginRight(v) => v.to_css(dest),
            Property::ScrollMarginBlockStart(v) => v.to_css(dest),
            Property::ScrollMarginBlockEnd(v) => v.to_css(dest),
            Property::ScrollMarginInlineStart(v) => v.to_css(dest),
            Property::ScrollMarginInlineEnd(v) => v.to_css(dest),
            Property::ScrollMarginBlock(v) => v.to_css(dest),
            Property::ScrollMarginInline(v) => v.to_css(dest),
            Property::ScrollMargin(v) => v.to_css(dest),
            Property::ScrollPaddingTop(v) => v.to_css(dest),
            Property::ScrollPaddingBottom(v) => v.to_css(dest),
            Property::ScrollPaddingLeft(v) => v.to_css(dest),
            Property::ScrollPaddingRight(v) => v.to_css(dest),
            Property::ScrollPaddingBlockStart(v) => v.to_css(dest),
            Property::ScrollPaddingBlockEnd(v) => v.to_css(dest),
            Property::ScrollPaddingInlineStart(v) => v.to_css(dest),
            Property::ScrollPaddingInlineEnd(v) => v.to_css(dest),
            Property::ScrollPaddingBlock(v) => v.to_css(dest),
            Property::ScrollPaddingInline(v) => v.to_css(dest),
            Property::ScrollPadding(v) => v.to_css(dest),
            Property::FontWeight(v) => v.to_css(dest),
            Property::FontSize(v) => v.to_css(dest),
            Property::FontStretch(v) => v.to_css(dest),
            Property::FontFamily(v) => v.to_css(dest),
            Property::FontStyle(v) => v.to_css(dest),
            Property::FontVariantCaps(v) => v.to_css(dest),
            Property::LineHeight(v) => v.to_css(dest),
            Property::Font(v) => v.to_css(dest),
            Property::TransitionProperty(v) => v.0.to_css(dest),
            Property::TransitionDuration(v) => v.0.to_css(dest),
            Property::TransitionDelay(v) => v.0.to_css(dest),
            Property::TransitionTimingFunction(v) => v.0.to_css(dest),
            Property::Transition(v) => v.0.to_css(dest),
            Property::Transform(v) => v.0.to_css(dest),
            Property::TransformOrigin(v) => v.0.to_css(dest),
            Property::TransformStyle(v) => v.0.to_css(dest),
            Property::TransformBox(v) => v.to_css(dest),
            Property::BackfaceVisibility(v) => v.0.to_css(dest),
            Property::Perspective(v) => v.0.to_css(dest),
            Property::PerspectiveOrigin(v) => v.0.to_css(dest),
            Property::Translate(v) => v.to_css(dest),
            Property::Rotate(v) => v.to_css(dest),
            Property::Scale(v) => v.to_css(dest),
            Property::TextDecorationColor(v) => v.0.to_css(dest),
            Property::TextEmphasisColor(v) => v.0.to_css(dest),
            Property::TextShadow(v) => v.to_css(dest),
            Property::Direction(v) => v.to_css(dest),
            Property::Composes(v) => v.to_css(dest),
            Property::MaskImage(v) => v.0.to_css(dest),
            Property::MaskMode(v) => v.to_css(dest),
            Property::MaskRepeat(v) => v.0.to_css(dest),
            Property::MaskPositionX(v) => v.to_css(dest),
            Property::MaskPositionY(v) => v.to_css(dest),
            Property::MaskPosition(v) => v.0.to_css(dest),
            Property::MaskClip(v) => v.0.to_css(dest),
            Property::MaskOrigin(v) => v.0.to_css(dest),
            Property::MaskSize(v) => v.0.to_css(dest),
            Property::MaskComposite(v) => v.to_css(dest),
            Property::MaskType(v) => v.to_css(dest),
            Property::Mask(v) => v.0.to_css(dest),
            Property::MaskBorderSource(v) => v.to_css(dest),
            Property::MaskBorderMode(v) => v.to_css(dest),
            Property::MaskBorderSlice(v) => v.to_css(dest),
            Property::MaskBorderWidth(v) => v.to_css(dest),
            Property::MaskBorderOutset(v) => v.to_css(dest),
            Property::MaskBorderRepeat(v) => v.to_css(dest),
            Property::MaskBorder(v) => v.to_css(dest),
            Property::WebKitMaskComposite(v) => v.to_css(dest),
            Property::MaskSourceType(v) => v.0.to_css(dest),
            Property::MaskBoxImage(v) => v.0.to_css(dest),
            Property::MaskBoxImageSource(v) => v.0.to_css(dest),
            Property::MaskBoxImageSlice(v) => v.0.to_css(dest),
            Property::MaskBoxImageWidth(v) => v.0.to_css(dest),
            Property::MaskBoxImageOutset(v) => v.0.to_css(dest),
            Property::MaskBoxImageRepeat(v) => v.0.to_css(dest),
            Property::ColorScheme(v) => v.to_css(dest),
            Property::All(v) => v.to_css(dest),
