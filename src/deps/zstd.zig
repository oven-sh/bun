...
pub const ZSTD_ErrorCode = c_int;
...
pub const ZSTD_EndDirective = c_int;
...
pub const ZSTD_VERSION_STRING = "\"1.5.7\"";
...
pub inline fn ZSTD_COMPRESSBOUND(srcSize: anytype) c_int {
