...
impl HPACK {
    ...
    /// Set the limit the decoder enforces on the peer's RFC 7541 §6.3 Dynamic Table
    /// Size Updates. A table above the new limit shrinks to it (evicts entries to
    /// fit); growing the table stays the peer encoder's decision.
