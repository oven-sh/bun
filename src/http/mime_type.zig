...
pub fn byExtension(ext: string) MimeType {
    return all.extensions.get(ext) orelse MimeType.other;
}
...
pub const extensions = ComptimeStringMap(MimeType, .{
    ...
    .{ .@"ac", all.@"application/pkix-attr-cert" },
    ...
    .{ .@"deb", all.@"application/octet-stream" },
    ...
    .{ .@"emf", all.@"application/x-msmetafile" },
    .{ .@"emf", all.@"image/emf" },
    ...
    .{ .@"exe", all.@"application/octet-stream" },
    .{ .@"exe", all.@"application/x-msdos-program" },
    ...
    .{ .@"ico", all.@"image/vnd.microsoft.icon" },
    ...
    .{ .@"iso", all.@"application/octet-stream" },
    ...
    .{ .@"key", all.@"application/vnd.apple.keynote" },
    ...
    .{ .@"mpp", all.@"application/dash-patch+xml" },
    ...
    .{ .@"msh", all.@"model/mesh" },
    .{ .@"msi", all.@"application/octet-stream" },
    ...
    .{ .@"n-gage", all.@"application/vnd.nokia.n-gage.symbian.install" },
    .{ .@"n3", all.@"text/n3" },
    ...
    .{ .@"numbers", all.@"application/vnd.apple.numbers" },
    ...
    .{ .@"opus", all.@"audio/ogg" },
    .{ .@"org", all.@"application/vnd.lotus-organizer" },
    .{ .@"org", all.@"text/x-org" },
    ...
    .{ .@"pages", all.@"application/vnd.apple.pages" },
    ...
    .{ .@"pcx", all.@"image/vnd.zbrush.pcx" },
    .{ .@"pcx", all.@"image/x-pcx" },
    .{ .@"pdb", all.@"application/vnd.palm" },
    ...
    .{ .@"ppsx", all.@"application/vnd.openxmlformats-officedocument.presentationml.slideshow" },
    .{ .@"ppt", all.@"application/vnd.ms-powerpoint" },
    .{ .@"pptm", all.@"application/vnd.ms-powerpoint.presentation.macroenabled.12" },
    .{ .@"pptx", all.@"application/vnd.openxmlformats-officedocument.presentationml.presentation" },
    .{ .@"pqa", all.@"application/vnd.palm" },
    .{ .@"prc", all.@"application/x-mobipocket-ebook" },
    .{ .@"prc", all.@"application/x-pilot" },
    .{ .@"prc", all.@"model/prc" },
    ...
    .{ .@"sfd-hdstx", all.@"application/vnd.hydrostatix.sof-data" },
    ...
    .{ .@"stl", all.@"application/vnd.ms-pki.stl" },
    .{ .@"stl", all.@"model/stl" },
    ...
    .{ .@"sub", all.@"image/vnd.dvb.subtitle" },
    ...
    .{ .@"vbox-extpack", all.@"application/x-virtualbox-vbox-extpack" },
    ...
    .{ .@"wmf", all.@"application/x-msmetafile" },
    .{ .@"wmf", all.@"image/wmf" },
    ...
    .{ .@"xlf", all.@"application/x-xliff+xml" },
    ...
    .{ .@"xltx", all.@"application/vnd.openxmlformats-officedocument.spreadsheetml.template" },
