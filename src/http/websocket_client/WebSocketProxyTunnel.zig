...
ref_count: RefCount,
/// Reference to the upgrade client (WebSocketUpgradeClient)
...
/// Initialize a new proxy tunnel
pub fn init() *WebSocketProxyTunnel {
