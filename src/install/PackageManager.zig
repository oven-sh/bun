...
const installWithManager = @import("PackageManager/install_with_manager.zig").installWithManager;
...
const PatchCommitResult = @import("PackageManager/patch.zig").PatchCommitResult;
const doPatchCommit = @import("PackageManager/patch.zig").doPatchCommit;
