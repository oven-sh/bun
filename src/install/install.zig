    ...
    pub fn verify(
        ...
        return switch (resolution.tag) {
            ...
            .folder => {
                ...
                return this.verifyPackageJSONNameAndVersion(root_node_modules_dir, resolution.tag);
            },
            else => return this.verifyPackageJSONNameAndVersion(root_node_modules_dir, resolution.tag),
        };
    }
