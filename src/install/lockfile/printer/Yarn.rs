...
pub fn print(this: &mut Printer, writer: &mut impl bun_loop::Write) -> Result<(), crate::Error> {
...
fn packages(this: &mut Printer, writer: &mut impl bun_loop::Write) -> Result<(), crate::Error> {
