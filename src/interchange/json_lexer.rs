    ...
    'bump: 'a,
{
    ...
    #[cold]
    fn add_range_error(&mut self, r: logger::Range, args: core::fmt::Arguments<'_>) -> LexResult {
        if self.is_log_disabled {
            return Ok(());
        }
            ...
            match self.code_point {
                    ...
                    || cp == 0x2029 =>
                {
                        ...
                        && self.code_point == '\n' as CodePoint
                    {
                        ...
                        {
                            bun_logger::js_printer::options::IndentationCharacter::Space
                        } else {
                            bun_logger::js_printer::options::IndentationCharacter::Tab
                        };
