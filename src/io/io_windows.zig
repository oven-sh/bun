...
const errno_map: [bun.C.SystemErrno.max + 1]Errno = brk: {
    var entries: [bun.C.SystemErrno.max + 1]Errno = [_]Errno{error.EOTHER} ** (bun.C.SystemErrno.max + 1);
    entries[@intFromEnum(bun.C.SystemErrno.E2BIG)] = error.E2BIG;
    entries[@intFromEnum(bun.C.SystemErrno.EACCES)] = error.EACCES;
    entries[@intFromEnum(bun.C.SystemErrno.EADDRINUSE)] = error.EADDRINUSE;
    entries[@intFromEnum(bun.C.SystemErrno.EADDRNOTAVAIL)] = error.EADDRNOTAVAIL;
    entries[@intFromEnum(bun.C.SystemErrno.EAFNOSUPPORT)] = error.EAFNOSUPPORT;
    entries[@intFromEnum(bun.C.SystemErrno.EAGAIN)] = error.EAGAIN;
    entries[@intFromEnum(bun.C.SystemErrno.EALREADY)] = error.EALREADY;
    entries[@intFromEnum(bun.C.SystemErrno.EBADF)] = error.EBADF;
    entries[@intFromEnum(bun.C.SystemErrno.EBADMSG)] = error.EBADMSG;
    entries[@intFromEnum(bun.C.SystemErrno.EBUSY)] = error.EBUSY;
    entries[@intFromEnum(bun.C.SystemErrno.ECANCELED)] = error.ECANCELED;
    entries[@intFromEnum(bun.C.SystemErrno.ECHILD)] = error.ECHILD;
    entries[@intFromEnum(bun.C.SystemErrno.ECONNABORTED)] = error.ECONNABORTED;
    entries[@intFromEnum(bun.C.SystemErrno.ECONNREFUSED)] = error.ECONNREFUSED;
    entries[@intFromEnum(bun.C.SystemErrno.ECONNRESET)] = error.ECONNRESET;
    entries[@intFromEnum(bun.C.SystemErrno.EDEADLOCK)] = error.EDEADLOCK;
    entries[@intFromEnum(bun.C.SystemErrno.EDESTADDRREQ)] = error.EDESTADDRREQ;
    entries[@intFromEnum(bun.C.SystemErrno.EDOM)] = error.EDOM;
    entries[@intFromEnum(bun.C.SystemErrno.EEXIST)] = error.EEXIST;
    entries[@intFromEnum(bun.C.SystemErrno.EFAULT)] = error.EFAULT;
    entries[@intFromEnum(bun.C.SystemErrno.EFBIG)] = error.EFBIG;
    entries[@intFromEnum(bun.C.SystemErrno.EHOSTUNREACH)] = error.EHOSTUNREACH;
    entries[@intFromEnum(bun.C.SystemErrno.EIDRM)] = error.EIDRM;
    entries[@intFromEnum(bun.C.SystemErrno.EILSEQ)] = error.EILSEQ;
    entries[@intFromEnum(bun.C.SystemErrno.EINPROGRESS)] = error.EINPROGRESS;
    entries[@intFromEnum(bun.C.SystemErrno.EINTR)] = error.EINTR;
    entries[@intFromEnum(bun.C.SystemErrno.EINVAL)] = error.EINVAL;
    entries[@intFromEnum(bun.C.SystemErrno.EIO)] = error.EIO;
    entries[@intFromEnum(bun.C.SystemErrno.EISCONN)] = error.EISCONN;
    entries[@intFromEnum(bun.C.SystemErrno.EISDIR)] = error.EISDIR;
    entries[@intFromEnum(bun.C.SystemErrno.ELOOP)] = error.ELOOP;
    entries[@intFromEnum(bun.C.SystemErrno.EMFILE)] = error.EMFILE;
    entries[@intFromEnum(bun.C.SystemErrno.EMLINK)] = error.EMLINK;
    entries[@intFromEnum(bun.C.SystemErrno.EMSGSIZE)] = error.EMSGSIZE;
    entries[@intFromEnum(bun.C.SystemErrno.ENAMETOOLONG)] = error.ENAMETOOLONG;
    entries[@intFromEnum(bun.C.SystemErrno.ENETDOWN)] = error.ENETDOWN;
    entries[@intFromEnum(bun.C.SystemErrno.ENETRESET)] = error.ENETRESET;
    entries[@intFromEnum(bun.C.SystemErrno.ENETUNREACH)] = error.ENETUNREACH;
    entries[@intFromEnum(bun.C.SystemErrno.ENFILE)] = error.ENFILE;
    entries[@intFromEnum(bun.C.SystemErrno.ENOBUFS)] = error.ENOBUFS;
    entries[@intFromEnum(bun.C.SystemErrno.ENODATA)] = error.ENODATA;
    entries[@intFromEnum(bun.C.SystemErrno.ENODEV)] = error.ENODEV;
    entries[@intFromEnum(bun.C.SystemErrno.ENOENT)] = error.ENOENT;
    entries[@intFromEnum(bun.C.SystemErrno.ENOEXEC)] = error.ENOEXEC;
    entries[@intFromEnum(bun.C.SystemErrno.ENOLCK)] = error.ENOLCK;
    entries[@intFromEnum(bun.C.SystemErrno.ENOLINK)] = error.ENOLINK;
    entries[@intFromEnum(bun.C.SystemErrno.ENOMEM)] = error.ENOMEM;
    entries[@intFromEnum(bun.C.SystemErrno.ENOMSG)] = error.ENOMSG;
    entries[@intFromEnum(bun.C.SystemErrno.ENOPROTOOPT)] = error.ENOPROTOOPT;
    entries[@intFromEnum(bun.C.SystemErrno.ENOSPC)] = error.ENOSPC;
    entries[@intFromEnum(bun.C.SystemErrno.ENOSR)] = error.ENOSR;
    entries[@intFromEnum(bun.C.SystemErrno.ENOSTR)] = error.ENOSTR;
    entries[@intFromEnum(bun.C.SystemErrno.ENOSYS)] = error.ENOSYS;
    entries[@intFromEnum(bun.C.SystemErrno.ENOTCONN)] = error.ENOTCONN;
    entries[@intFromEnum(bun.C.SystemErrno.ENOTDIR)] = error.ENOTDIR;
    entries[@intFromEnum(bun.C.SystemErrno.ENOTEMPTY)] = error.ENOTEMPTY;
    entries[@intFromEnum(bun.C.SystemErrno.ENOTRECOVERABLE)] = error.ENOTRECOVERABLE;
    entries[@intFromEnum(bun.C.SystemErrno.ENOTSOCK)] = error.ENOTSOCK;
    entries[@intFromEnum(bun.C.SystemErrno.ENOTSUP)] = error.ENOTSUP;
    entries[@intFromEnum(bun.C.SystemErrno.ENOTTY)] = error.ENOTTY;
    entries[@intFromEnum(bun.C.SystemErrno.ENXIO)] = error.ENXIO;
    entries[@intFromEnum(bun.C.SystemErrno.EOPNOTSUPP)] = error.EOPNOTSUPP;
    entries[@intFromEnum(bun.C.SystemErrno.EOTHER)] = error.EOTHER;
    entries[@intFromEnum(bun.C.SystemErrno.EOVERFLOW)] = error.EOVERFLOW;
    entries[@intFromEnum(bun.C.SystemErrno.EOWNERDEAD)] = error.EOWNERDEAD;
    entries[@intFromEnum(bun.C.SystemErrno.EPERM)] = error.EPERM;
    entries[@intFromEnum(bun.C.SystemErrno.EPIPE)] = error.EPIPE;
    entries[@intFromEnum(bun.C.SystemErrno.EPROTO)] = error.EPROTO;
    entries[@intFromEnum(bun.C.SystemErrno.EPROTONOSUPPORT)] = error.EPROTONOSUPPORT;
    entries[@intFromEnum(bun.C.SystemErrno.EPROTOTYPE)] = error.EPROTOTYPE;
    entries[@intFromEnum(bun.C.SystemErrno.ERANGE)] = error.ERANGE;
    entries[@intFromEnum(bun.C.SystemErrno.EROFS)] = error.EROFS;
    entries[@intFromEnum(bun.C.SystemErrno.ESPIPE)] = error.ESPIPE;
    entries[@intFromEnum(bun.C.SystemErrno.ESRCH)] = error.ESRCH;
    entries[@intFromEnum(bun.C.SystemErrno.ETIME)] = error.ETIME;
    entries[@intFromEnum(bun.C.SystemErrno.ETIMEDOUT)] = error.ETIMEDOUT;
    entries[@intFromEnum(bun.C.SystemErrno.ETXTBSY)] = error.ETXTBSY;
    entries[@intFromEnum(bun.C.SystemErrno.EWOULDBLOCK)] = error.EWOULDBLOCK;
    entries[@intFromEnum(bun.C.SystemErrno.EXDEV)] = error.EXDEV;
    entries[@intFromEnum(bun.C.SystemErrno.STRUNCATE)] = error.STRUNCATE;
...
pub const Waker = struct {
    ...
    pub fn wait(this: Waker) !u64 {
        ...
        var removed: usize = 0;
        if (!kernel32.GetQueuedCompletionStatusEx(this.iocp, &overlapped, 1, &removed, 0, 1)) {
            return 0;
        }
        return 0;
    }
