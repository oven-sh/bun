...
CPP_DECL JSC__JSValue Bun__Readable__create(JSC__JSGlobalObject* arg0, Bun__Readable* arg1);
...
CPP_DECL JSC__JSValue Bun__Writable__create(JSC__JSGlobalObject* arg0, Bun__Writable* arg1);
