...
To actually wire up one of these modules to the resolver, that is done separately in `src/jsc/ModuleLoader.rs`. Maybe in the future we can do codegen for it.
