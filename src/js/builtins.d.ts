...
declare function $moduleGraphOf(
  requireOrModule: unknown,
):
  | { mainModule: string; requireMap: Map<string, JSCommonJSModule>; requireCache: Record<string, JSCommonJSModule> }
  | undefined;
