...
declare function $ERR_INVALID_URL_SCHEME(message: string): TypeError;
declare function $ERR_INVALID_FILE_URL_HOST(message: string): TypeError;
declare function $ERR_INVALID_FILE_URL_PATH(message: string): TypeError;
