...
/** How many times `--hot` reloaded this global. `GlobalObject::reload()` sets it, so it is absent before the first reload. */
declare var $hotReloadGeneration: number | undefined;
