...
const onInternalMessage = $newRustFunction("node_cluster_binding.rust", "onInternalMessageChild", 2);
...
cluster._setupWorker = function () {
  ...
  $newRustFunction("node_cluster_binding.rust", "channelIgnoreOneDisconnectEventListener", 0)();
