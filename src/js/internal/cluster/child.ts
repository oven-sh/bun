...
const onInternalMessage = $newNativeFunction("node_cluster_binding.rs", "onInternalMessageChild", 2);
...
cluster._setupWorker = function () {
  ...
  $newNativeFunction("node_cluster_binding.rs", "channelIgnoreOneDisconnectEventListener", 0)();
