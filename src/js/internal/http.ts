...
const setMaxHTTPHeaderSize = $newNativeFunction("node_http_binding.zig", "setMaxHTTPHeaderSize", 1);
const getMaxHTTPHeaderSize = $newNativeFunction("node_http_binding.zig", "getMaxHTTPHeaderSize", 0);
