...
const defineProps = (object, thruples) => {
  for (let i = 0, { length } = thruples; i < length; i += 3) {
...
const MapGetSymbolSpeciesRaw = $Map.__lookupGetter__(SymbolSpecies);
...
const PromiseWithResolversRaw = function () {
  return $newPromiseCapability(this);
};
const PromiseGetSymbolSpeciesRaw = $Promise.__lookupGetter__(SymbolSpecies);
...
const SetGetSymbolSpeciesRaw = $Set.__lookupGetter__(SymbolSpecies);
...
// The @isArray private method is the original Array.isArray.
primordials.ArrayIsArray = $isArray;
...
// The @arraySort private method is the original Array.prototype.sort.
primordials.ArrayPrototypeSort = uncurry1Args($arraySort);
...
const MapIteratorPrototype = new $Map()[SymbolIterator]().__proto__;
...
const SetIteratorPrototype = new $Set()[SymbolIterator]().__proto__;
...
primordials.StringPrototypeSubstring = uncurry2Args($stringSubstring);
...
primordials.TypedArrayPrototypeGetSymbolToStringTag = uncurry0Args(
  TypedArrayPrototype.__lookupGetter__(SymbolToStringTag),
);
...
primordials.SafeFinalizationRegistry = defineSafeCtor(
  class SafeFinalizationRegistry extends FinalizationRegistry {
    ...
    proto: [
      "register", "value", FinalizationRegistryPrototypeRegisterRaw,
      "unregister", "value", FinalizationRegistryPrototypeUnregisterRaw,
      SymbolToStringTag, "value", FinalizationRegistryPrototypeSymbolToStringTag,
    ],
  },
);
...
primordials.SafeMap = defineSafeCtor(
  class SafeMap extends $Map {
    ...
    proto: [
      "clear", "value", MapPrototypeClearRaw,
      "delete", "value", MapPrototypeDeleteRaw,
      "entries", "value", SafeMapPrototypeEntriesRaw,
      "forEach", "value", MapPrototypeForEachRaw,
      "get", "value", MapPrototypeGetRaw,
      "has", "value", MapPrototypeHasRaw,
      "keys", "value", MapPrototypeKeysRaw,
      "set", "value", MapPrototypeSetRaw,
      "size", "get", MapPrototypeGetSizeRaw,
      "values", "value", SafeMapPrototypeValuesRaw,
      SymbolIterator, "value", SafeMapPrototypeEntriesRaw,
      SymbolToStringTag, "value", MapPrototypeSymbolToStringTag,
    ],
  },
);
...
primordials.SafePromise = defineSafeCtor(
  class SafePromise extends $Promise {
    ...
    ctor: [
      "all", "value", PromiseAllRaw,
      "allSettled", "value", PromiseAllSettledRaw,
      "any", "value", PromiseAnyRaw,
      "race", "value", PromiseRaceRaw,
      "reject", "value", PromiseRejectRaw,
      "resolve", "value", PromiseResolveRaw,
      "withResolvers", "value", PromiseWithResolversRaw,
      SymbolSpecies, "get", PromiseGetSymbolSpeciesRaw
    ],
    proto: [
      "catch", "value", PromisePrototypeCatchRaw,
      "finally", "value", PromisePrototypeFinallyRaw,
      "then", "value", PromisePrototypeThenRaw,
    ],
  },
);
...
primordials.SafeSet = defineSafeCtor(
  class SafeSet extends $Set {
    ...
    proto: [
      "add", "value", SetPrototypeAddRaw,
      "clear", "value", SetPrototypeClearRaw,
      "delete", "value", SetPrototypeDeleteRaw,
      "entries", "value", SafeSetPrototypeEntriesRaw,
      "forEach", "value", SetPrototypeForEachRaw,
      "has", "value", SetPrototypeHasRaw,
      "keys", "value", SetPrototypeKeysRaw,
      "size", "get", SetPrototypeGetSizeRaw,
      "values", "value", SafeSetPrototypeValuesRaw,
      SymbolIterator, "value", SafeSetPrototypeValuesRaw,
      SymbolToStringTag, "value", SetPrototypeSymbolToStringTag,
    ],
  },
);
...
primordials.SafeWeakMap = defineSafeCtor(
  class SafeWeakMap extends WeakMap {
    ...
    proto: [
      "delete", "value", WeakMapPrototypeDeleteRaw,
      "get", "value", WeakMapPrototypeGetRaw,
      "has", "value", WeakMapPrototypeHasRaw,
      "set", "value", WeakMapPrototypeSetRaw,
      SymbolToStringTag, "value", WeakMapPrototypeSymbolToStringTag,
    ],
  },
);
...
primordials.SafeWeakRef = defineSafeCtor(
  class SafeWeakRef extends WeakRef {
    ...
    proto: [
      "deref", "value", WeakRefPrototypeDerefRaw,
      SymbolToStringTag, "value", WeakRefPrototypeSymbolToStringTag,
    ],
  },
);
...
primordials.SafeWeakSet = defineSafeCtor(
  class SafeWeakSet extends WeakSet {
    ...
    proto: [
      "add", "value", WeakSetPrototypeAddRaw,
      "delete", "value", WeakSetPrototypeDeleteRaw,
      "has", "value", WeakSetPrototypeHasRaw,
      SymbolToStringTag, "value", WeakSetPrototypeSymbolToStringTag,
    ],
  },
);
