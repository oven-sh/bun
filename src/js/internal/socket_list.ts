...
const ERR_CHILD_CLOSED_BEFORE_REPLY = $zig("node_error_binding.zig", "ERR_CHILD_CLOSED_BEFORE_REPLY");

// This object keeps track of the sockets that are sent
export class SocketListSend extends EventEmitter {
...
export class SocketListReceive extends EventEmitter {
  constructor(child, key) {
    super();
