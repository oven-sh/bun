...
// ---------------------------------------------------------------------------
// Socket callbacks — called by native code with `this` = native handle (not useful).
...
function upgradeRawSocketToH2(
  ...
  // socket: callbacks — bind to tlsSocket since native code calls them with native handle as `this`
