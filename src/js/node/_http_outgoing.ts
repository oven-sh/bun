...
$toClass(OutgoingMessage, "Stream", Stream);
...
Object.defineProperty(OutgoingMessage.prototype, "connection", {
  __proto__: null,
  get: function () {
    if (this[kBunServer]) return this.socket;
    return this[kSocket];
  },
  set: function (val) {
    this.socket = val;
...
Object.defineProperty(OutgoingMessage.prototype, "socket", {
  __proto__: null,
  get: function () {
    if (this[kBunServer]) return (this[fakeSocketSymbol] ??= new FakeSocket(this));
    return this[kSocket];
  },
  set: function (val) {
    if (this[kBunServer]) {
