...
const getBunServerAllClosedPromise = $newRustFunction("node_http_binding.rust", "getBunServerAllClosedPromise", 1);
const sendHelper = $newRustFunction("node_cluster_binding.rust", "sendHelperChild", 3);
