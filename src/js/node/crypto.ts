...
// The values are the argon2 reference implementation's `argon2_type` ids, which
// the native side maps back to a variant.
const kArgon2Types = { __proto__: null, argon2d: 0, argon2i: 1, argon2id: 2 };

// Mirrors `check()` in node's lib/internal/crypto/argon2.js.
function checkArgon2(algorithm, parameters) {
  ...
  if (secret === undefined) {
    ...
    secret = getArrayBufferOrView(secret, "parameters.secret");
