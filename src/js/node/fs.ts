...
// Private exports
// `fs` points to the return value of `node_fs_binding.rust`'s `createBinding` function.
...
/** Implemented in `node_fs_stat_watcher.rust` */
  ...
  process.platform !== "win32"
    ...
    : function realpathSync(p, options) {
        ...
        if (options) {
          ...
          if (encoding) {
            (assertEncodingForWindows ?? $newRustFunction("runtime/node/types.rust", "jsAssertEncodingValid", 1))(
              encoding,
            );
          }
        }
