...
var { isPromise, isCallable, direct, Object } = Bun.lazy("primordials");
...
var require_readable = __commonJS({
  "node_modules/readable-stream/lib/internal/streams/readable.js"(exports, module) {
    ...
    var ReadableState = Bun.lazy("bun:stream").ReadableState;
    ...
    var eos = require_end_of_stream();
    const { maybeReadMore: _maybeReadMore, resume, emitReadable: _emitReadable, onEofChunk } = Bun.lazy("bun:stream");
...
function createNativeStreamReadable(nativeType, Readable) {
  var [pull, start, cancel, setClose, deinit, updateRef, drainFn] = Bun.lazy(nativeType);
