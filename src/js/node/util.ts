...
const internalErrorName = $newRustFunction("node_util_binding.rust", "internalErrorName", 1);
const parseEnv = $newRustFunction("node_util_binding.rust", "parseEnv", 1);
...
const parseArgs = $newRustFunction("parse_args.rust", "parseArgs", 1);
