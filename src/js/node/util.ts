...
const internalErrorName = $newNativeFunction("node_util_binding.zig", "internalErrorName", 1);
const parseEnv = $newNativeFunction("node_util_binding.zig", "parseEnv", 1);
...
const parseArgs = $newNativeFunction("parse_args.zig", "parseArgs", 1);
