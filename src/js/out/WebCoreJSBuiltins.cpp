...
const int s_readableStreamReadableStreamToFormDataCodeLength = 140;
static const JSC::Intrinsic s_readableStreamReadableStreamToFormDataCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamReadableStreamToFormDataCode = "(function (r,u){\"use strict\";return @Bun.readableStreamToBlob(r).then((d)=>{if(d.size===0)return new FormData;return FormData.from(d,u)})})\n";
