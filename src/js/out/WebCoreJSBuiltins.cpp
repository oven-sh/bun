...
const char* const s_transformStreamInternalsInitializeTransformStreamCode = "(function (T,q,x,v,E,F){\"use strict\";const G=()=>{return q},I=(j)=>{return @transformStreamDefaultSinkWriteAlgorithm(T,j)},J=(j)=>{return @transformStreamDefaultSinkAbortAlgorithm(T,j)},K=()=>{return @transformStreamDefaultSinkCloseAlgorithm(T)},f=@createWritableStream(G,I,K,J,x,v),B=()=>{return @transformStreamDefaultSourcePullAlgorithm(T)},C=(j)=>{return @transformStreamErrorWritableAndUnblockWrite(T,j),@Promise.@resolve()},D={};@putByIdDirectPrivate(D,\"start\",G),@putByIdDirectPrivate(D,\"pull\",B),@putByIdDirectPrivate(D,\"cancel\",C);const L={};@putByIdDirectPrivate(L,\"size\",F),@putByIdDirectPrivate(L,\"highWaterMark\",E);const N=new @ReadableStream(D,L);@putByIdDirectPrivate(T,\"writable\",f),@putByIdDirectPrivate(T,\"internalWritable\",@getInternalWritableStream(f)),@putByIdDirectPrivate(T,\"readable\",N),@putByIdDirectPrivate(T,\"backpressure\",@undefined),@putByIdDirectPrivate(T,\"backpressureChangePromise\",@undefined),@transformStreamSetBackpressure(T,!0),@putByIdDirectPrivate(T,\"controller\",@undefined)})\n";
...
const char* const s_processObjectInternalsBindingCode = "(function (l){\"use strict\";if(l!==\"constants\")@throwTypeError(\"process.binding() is not supported in Bun. If that breaks something, please file an issue and include a reproducible code sample.\");var I=globalThis.Symbol.for(\"process.bindings.constants\"),r=globalThis[I];if(!r){const{constants:d}=globalThis[globalThis.Symbol.for(\"Bun.lazy\")](\"createImportMeta\",\"node:process\").require(\"node:fs\");r={fs:d,zlib:{},crypto:{},os:@Bun._Os().constants},globalThis[I]=r}return r})\n";
...
const char* const s_processObjectInternalsGetStdioWriteStreamCode = "(function (M,z){\"use strict\";var K={path:\"node:process\",require:z},G=(J)=>K.require(J);function H(J){var{Duplex:L,eos:U,destroy:V}=G(\"node:stream\"),X=class Z extends L{#$;#B;#j=!0;#z=!0;#G;#H;#J;#K;#L;#M;get isTTY(){return this.#M\?\?=G(\"node:tty\").isatty(J)}get fd(){return J}constructor(Y){super({readable:!0,writable:!0});this.#G=`/dev/fd/${Y}`}#N(Y){const j=this.#H;if(this.#H=null,j)j(Y);else if(Y)this.destroy(Y);else if(!this.#j&&!this.#z)this.destroy()}_destroy(Y,j){if(!Y&&this.#H!==null){var P=class A extends Error{code;name;constructor(T=\"The operation was aborted\",x=void 0){if(x!==void 0&&typeof x!==\"object\")throw new Error(`Invalid AbortError options:\\n\\n${JSON.stringify(x,null,2)}`);super(T,x);this.code=\"ABORT_ERR\",this.name=\"AbortError\"}};Y=new P}if(this.#J=null,this.#K=null,this.#H===null)j(Y);else{if(this.#H=j,this.#$)V(this.#$,Y);if(this.#B)V(this.#B,Y)}}_write(Y,j,P){if(!this.#$){var{createWriteStream:A}=G(\"node:fs\"),T=this.#$=A(this.#G);T.on(\"finish\",()=>{if(this.#K){const x=this.#K;this.#K=null,x()}}),T.on(\"drain\",()=>{if(this.#J){const x=this.#J;this.#J=null,x()}}),U(T,(x)=>{if(this.#z=!1,x)V(T,x);this.#N(x)})}if(T.write(Y,j))P();else this.#J=P}_final(Y){this.#$&&this.#$.end(),this.#K=Y}#O(){var{createReadStream:Y}=G(\"node:fs\"),j=this.#B=Y(this.#G);return j.on(\"readable\",()=>{if(this.#L){const P=this.#L;this.#L=null,P()}else this.read()}),j.on(\"end\",()=>{this.push(null)}),U(j,(P)=>{if(this.#j=!1,P)V(j,P);this.#N(P)}),j}_read(){var Y=this.#B;if(!Y)Y=this.#O();while(!0){const j=Y.read();if(j===null||!this.push(j))return}}};return new X(J)}var{EventEmitter:N}=G(\"node:events\");function O(J){if(!J)return!0;var L=J.toLowerCase();return L===\"utf8\"||L===\"utf-8\"||L===\"buffer\"||L===\"binary\"}var Q,B=class J extends N{#$;#B;#j;#z;bytesWritten=0;setDefaultEncoding(L){if(this.#B||!O(L))return this.#J(),this.#B.setDefaultEncoding(L)}#G(){switch(this.#$){case 1:{var L=@Bun.stdout.writer({highWaterMark:0});return L.unref(),L}case 2:{var L=@Bun.stderr.writer({highWaterMark:0});return L.unref(),L}default:throw new Error(\"Unsupported writer\")}}#H(){return this.#j\?\?=this.#G()}constructor(L){super();this.#$=L}get fd(){return this.#$}get isTTY(){return this.#z\?\?=G(\"node:tty\").isatty(this.#$)}cursorTo(L,U,V){return(Q\?\?=G(\"readline\")).cursorTo(this,L,U,V)}moveCursor(L,U,V){return(Q\?\?=G(\"readline\")).moveCursor(this,L,U,V)}clearLine(L,U){return(Q\?\?=G(\"readline\")).clearLine(this,L,U)}clearScreenDown(L){return(Q\?\?=G(\"readline\")).clearScreenDown(this,L)}ref(){this.#H().ref()}unref(){this.#H().unref()}on(L,U){if(L===\"close\"||L===\"finish\")return this.#J(),this.#B.on(L,U);if(L===\"drain\")return super.on(\"drain\",U);if(L===\"error\")return super.on(\"error\",U);return super.on(L,U)}get _writableState(){return this.#J(),this.#B._writableState}get _readableState(){return this.#J(),this.#B._readableState}pipe(L){return this.#J(),this.#B.pipe(L)}unpipe(L){return this.#J(),this.#B.unpipe(L)}#J(){if(this.#B)return;this.#B=H(this.#$);const L=this.eventNames();for(let U of L)this.#B.on(U,(...V)=>{this.emit(U,...V)})}#K(L){var U=this.#H();const V=U.write(L);this.bytesWritten+=V;const X=U.flush(!1);return!!(V||X)}#L(L,U){if(!O(U))return this.#J(),this.#B.write(L,U);return this.#K(L)}#M(L,U){if(U)this.emit(\"error\",U);try{L(U\?U:null)}catch(V){this.emit(\"error\",V)}}#N(L,U,V){if(!O(U))return this.#J(),this.#B.write(L,U,V);var X=this.#H();const Z=X.write(L),Y=X.flush(!0);if(Y\?.then)return Y.then(()=>{this.#M(V),this.emit(\"drain\")},(j)=>this.#M(V,j)),!1;return queueMicrotask(()=>{this.#M(V)}),!!(Z||Y)}write(L,U,V){const X=this._write(L,U,V);if(X)this.emit(\"drain\");return X}get hasColors(){return @Bun.tty[this.#$].hasColors}_write(L,U,V){var X=this.#B;if(X)return X.write(L,U,V);switch(arguments.length){case 0:{var Z=new Error(\"Invalid arguments\");throw Z.code=\"ERR_INVALID_ARG_TYPE\",Z}case 1:return this.#K(L);case 2:if(typeof U===\"function\")return this.#N(L,\"\",U);else if(typeof U===\"string\")return this.#L(L,U);default:{if(typeof U!==\"undefined\"&&typeof U!==\"string\"||typeof V!==\"undefined\"&&typeof V!==\"function\"){var Z=new Error(\"Invalid arguments\");throw Z.code=\"ERR_INVALID_ARG_TYPE\",Z}if(typeof V===\"undefined\")return this.#L(L,U);return this.#N(L,U,V)}}}destroy(){return this}end(){return this}};return new B(M)})\n";
...
const char* const s_processObjectInternalsGetStdinStreamCode = "(function (G,K,M){\"use strict\";var N={path:\"node:process\",require:K},j=(U)=>N.require(U),{Duplex:P,eos:z,destroy:Q}=j(\"node:stream\"),T=class U extends P{#Y;#$;#j;#z=!0;#G=!1;#H=!0;#I;#J;#K;get isTTY(){return j(\"tty\").isatty(G)}get fd(){return G}constructor(){super({readable:!0,writable:!0})}#L(L){const Y=this.#J;if(this.#J=null,Y)Y(L);else if(L)this.destroy(L);else if(!this.#z&&!this.#H)this.destroy()}_destroy(L,Y){if(!L&&this.#J!==null){var H=class I extends Error{constructor(J=\"The operation was aborted\",V=void 0){if(V!==void 0&&typeof V!==\"object\")throw new Error(`Invalid AbortError options:\\n\\n${JSON.stringify(V,null,2)}`);super(J,V);this.code=\"ABORT_ERR\",this.name=\"AbortError\"}};L=new H}if(this.#J===null)Y(L);else if(this.#J=Y,this.#j)Q(this.#j,L)}setRawMode(L){}on(L,Y){if(L===\"readable\")this.ref(),this.#G=!0;return super.on(L,Y)}pause(){return this.unref(),super.pause()}resume(){return this.ref(),super.resume()}ref(){this.#Y\?\?=M.stdin.stream().getReader(),this.#$\?\?=setInterval(()=>{},1<<30)}unref(){if(this.#$)clearInterval(this.#$),this.#$=null}async#M(){try{var L,Y;const H=this.#Y.readMany();if(!H\?.then)({done:L,value:Y}=H);else({done:L,value:Y}=await H);if(!L){this.push(Y[0]);const I=Y.length;for(let J=1;J<I;J++)this.push(Y[J])}else this.push(null),this.pause(),this.#z=!1,this.#L()}catch(H){this.#z=!1,this.#L(H)}}_read(L){if(this.#G)this.unref(),this.#G=!1;this.#M()}#N(){var{createWriteStream:L}=j(\"node:fs\"),Y=this.#j=L(\"/dev/fd/0\");return Y.on(\"finish\",()=>{if(this.#I){const H=this.#I;this.#I=null,H()}}),Y.on(\"drain\",()=>{if(this.#K){const H=this.#K;this.#K=null,H()}}),z(Y,(H)=>{if(this.#H=!1,H)Q(Y,H);this.#L(H)}),Y}_write(L,Y,H){var I=this.#j;if(!I)I=this.#N();if(I.write(L,Y))H();else this.#K=H}_final(L){this.#j.end(),this.#I=(...Y)=>L(...Y)}};return new T})\n";
...
const char* const s_transformStreamInitializeTransformStreamCode = "(function (){\"use strict\";let q=arguments[0];if(@isObject(q)&&@getByIdDirectPrivate(q,\"TransformStream\"))return this;let v=arguments[1],B=arguments[2];if(q===@undefined)q=null;if(B===@undefined)B={};if(v===@undefined)v={};let E={};if(q!==null){if(\"start\"in q){if(E[\"start\"]=q[\"start\"],typeof E[\"start\"]!==\"function\")@throwTypeError(\"transformer.start should be a function\")}if(\"transform\"in q){if(E[\"transform\"]=q[\"transform\"],typeof E[\"transform\"]!==\"function\")@throwTypeError(\"transformer.transform should be a function\")}if(\"flush\"in q){if(E[\"flush\"]=q[\"flush\"],typeof E[\"flush\"]!==\"function\")@throwTypeError(\"transformer.flush should be a function\")}if(\"readableType\"in q)@throwRangeError(\"TransformStream transformer has a readableType\");if(\"writableType\"in q)@throwRangeError(\"TransformStream transformer has a writableType\")}const _=@extractHighWaterMark(B,0),F=@extractSizeAlgorithm(B),j=@extractHighWaterMark(v,1),G=@extractSizeAlgorithm(v),I=@newPromiseCapability(@Promise);if(@initializeTransformStream(this,I.@promise,j,G,_,F),@setUpTransformStreamDefaultControllerFromTransformer(this,q,E),(\"start\"in E)){const J=@getByIdDirectPrivate(this,\"controller\");(()=>@promiseInvokeOrNoopMethodNoCatch(q,E[\"start\"],[J]))().@then(()=>{I.@resolve.@call()},(u)=>{I.@reject.@call(@undefined,u)})}else I.@resolve.@call();return this})\n";
...
const char* const s_moduleRequireCode = "(function (_){\"use strict\";const l=@requireMap.@get(_)||@requireMap.@get(_=@resolveSync(_,this.path,!1));if(l)return @evaluateCommonJSModule(l),l.exports;if(_.endsWith(\".json\")||_.endsWith(\".toml\")||_.endsWith(\".node\"))return @internalRequire(_);let w=@Loader.registry.@get(_);if(w\?.evaluated){const v=w.module,f=@Loader.getModuleNamespaceObject(v),h=f\?.[@commonJSSymbol]===0||f\?.default\?.[@commonJSSymbol]===0\?f.default:f;return @requireMap.@set(_,@createCommonJSModule(_,h,!0)),h}let y=this.@require(_);if(y===-1){const v=@createCommonJSModule(_,{},!1);@requireMap.@set(_,v);try{y=@requireESM(_)}catch(f){throw @requireMap.@delete(_),f}if(w=@Loader.registry.@get(_),w\?.evaluated){const f=@Loader.getModuleNamespaceObject(w.module);return v.exports=f\?.[@commonJSSymbol]===0||f\?.default\?.[@commonJSSymbol]===0\?f.default:f}}const r=@requireMap.@get(_);if(r)return @evaluateCommonJSModule(r),r.exports;return y})\n";
...
const char* const s_jsBufferPrototypeReadIntBECode = "(function (r,d){\"use strict\";const c=this.@dataView||=new DataView(this.buffer,this.byteOffset,this.byteLength);switch(d){case 1:return c.getInt8(r);case 2:return c.getInt16(r,!1);case 3:{const u=c.getUint16(r+1,!1)+c.getUint8(r)*65536;return u|(u&8388608)*510}case 4:return c.getInt32(r,!1);case 5:{const u=c.getUint8(r);return(u|(u&128)*33554430)*4294967296+c.getUint32(r+1,!1)}case 6:{const u=c.getUint16(r,!1);return(u|(u&32768)*131070)*4294967296+c.getUint32(r+2,!1)}}@throwRangeError(\"byteLength must be >= 1 and <= 6\")})\n";
...
const char* const s_consoleObjectWriteCode = "(function (a){\"use strict\";var _=@getByIdDirectPrivate(this,\"writer\");if(!_){var b=@toLength(a\?.length\?\?0);_=@Bun.stdout.writer({highWaterMark:b>65536\?b:65536}),@putByIdDirectPrivate(this,\"writer\",_)}var d=_.write(a);const f=@argumentCount();for(var c=1;c<f;c++)d+=_.write(@argument(c));return _.flush(!0),d})\n";
...
const char* const s_readableStreamInternalsCreateReadableStreamControllerCode = "(function (w,A,C){\"use strict\";const b=A.type,f=@toString(b);if(f===\"bytes\"){if(C.highWaterMark===@undefined)C.highWaterMark=0;if(C.size!==@undefined)@throwRangeError(\"Strategy for a ReadableByteStreamController cannot have a size\");@putByIdDirectPrivate(w,\"readableStreamController\",new @ReadableByteStreamController(w,A,C.highWaterMark,@isReadableStream))}else if(f===\"direct\"){var v=C\?.highWaterMark;@initializeArrayBufferStream.@call(w,A,v)}else if(b===@undefined){if(C.highWaterMark===@undefined)C.highWaterMark=1;@setupReadableStreamDefaultController(w,A,C.size,C.highWaterMark,A.start,A.pull,A.cancel)}else @throwRangeError(\"Invalid type for underlying source\")})\n";
...
const char* const s_readableStreamInternalsPipeToShutdownCode = "(function (_){\"use strict\";if(_.shuttingDown)return;_.shuttingDown=!0;const d=arguments.length>1,u=arguments[1],m=()=>{if(d)@pipeToFinalize(_,u);else @pipeToFinalize(_)};if(@getByIdDirectPrivate(_.destination,\"state\")===\"writable\"&&!@writableStreamCloseQueuedOrInFlight(_.destination)){_.pendingReadPromiseCapability.@promise.@then(()=>{_.pendingWritePromise.@then(m,m)},(I)=>@pipeToFinalize(_,I));return}m()})\n";
...
const char* const s_readableStreamInternalsReadDirectStreamCode = "(function (_,x,z){\"use strict\";@putByIdDirectPrivate(_,\"underlyingSource\",@undefined),@putByIdDirectPrivate(_,\"start\",@undefined);function A(w,j){if(j&&z\?.cancel){try{var q=z.cancel(j);@markPromiseAsHandled(q)}catch(v){}z=@undefined}if(w){if(@putByIdDirectPrivate(w,\"readableStreamController\",@undefined),@putByIdDirectPrivate(w,\"reader\",@undefined),j)@putByIdDirectPrivate(w,\"state\",@streamErrored),@putByIdDirectPrivate(w,\"storedError\",j);else @putByIdDirectPrivate(w,\"state\",@streamClosed);w=@undefined}}if(!z.pull){A();return}if(!@isCallable(z.pull)){A(),@throwTypeError(\"pull is not a function\");return}@putByIdDirectPrivate(_,\"readableStreamController\",x);const f=@getByIdDirectPrivate(_,\"highWaterMark\");x.start({highWaterMark:!f||f<64\?64:f}),@startDirectStream.@call(x,_,z.pull,A),@putByIdDirectPrivate(_,\"reader\",{});var B=z.pull(x);if(x=@undefined,B&&@isPromise(B))return B.@then(()=>{})})\n";
...
const char* const s_readableStreamInternalsReadStreamIntoSinkCode = "(async function (P,A,D){\"use strict\";var E=!1,c=!1;try{var F=P.getReader(),f=F.readMany();if(f&&@isPromise(f))f=await f;if(f.done)return E=!0,A.end();var G=f.value.length;const K=@getByIdDirectPrivate(P,\"highWaterMark\");if(D)@startDirectStream.@call(A,P,@undefined,()=>!c&&@markPromiseAsHandled(P.cancel()));A.start({highWaterMark:K||0});for(var H=0,J=f.value,B=f.value.length;H<B;H++)A.write(J[H]);var _=@getByIdDirectPrivate(P,\"state\");if(_===@streamClosed)return E=!0,A.end();while(!0){var{value:q,done:x}=await F.read();if(x)return E=!0,A.end();A.write(q)}}catch(K){c=!0;try{F=@undefined;const I=P.cancel(K);@markPromiseAsHandled(I)}catch(I){}if(A&&!E){E=!0;try{A.close(K)}catch(I){throw new globalThis.AggregateError([K,I])}}throw K}finally{if(F){try{F.releaseLock()}catch(I){}F=@undefined}A=@undefined;var _=@getByIdDirectPrivate(P,\"state\");if(P){var z=@getByIdDirectPrivate(P,\"readableStreamController\");if(z){if(@getByIdDirectPrivate(z,\"underlyingSource\"))@putByIdDirectPrivate(z,\"underlyingSource\",@undefined);if(@getByIdDirectPrivate(z,\"controlledReadableStream\"))@putByIdDirectPrivate(z,\"controlledReadableStream\",@undefined);if(@putByIdDirectPrivate(P,\"readableStreamController\",null),@getByIdDirectPrivate(P,\"underlyingSource\"))@putByIdDirectPrivate(P,\"underlyingSource\",@undefined);z=@undefined}if(!c&&_!==@streamClosed&&_!==@streamErrored)@readableStreamClose(P);P=@undefined}}})\n";
...
const char* const s_readableStreamInternalsOnCloseDirectStreamCode = "(function (c){\"use strict\";var y=this.@controlledReadableStream;if(!y||@getByIdDirectPrivate(y,\"state\")!==@streamReadable)return;if(this._deferClose!==0){this._deferClose=1,this._deferCloseReason=c;return}if(@putByIdDirectPrivate(y,\"state\",@streamClosing),typeof this.@underlyingSource.close===\"function\")try{this.@underlyingSource.close.@call(this.@underlyingSource,c)}catch(j){}var B;try{B=this.@sink.end(),@putByIdDirectPrivate(this,\"sink\",@undefined)}catch(j){if(this._pendingRead){var C=this._pendingRead;this._pendingRead=@undefined,@rejectPromise(C,j)}@readableStreamError(y,j);return}this.error=this.flush=this.write=this.close=this.end=@onReadableStreamDirectControllerClosed;var v=@getByIdDirectPrivate(y,\"reader\");if(v&&@isReadableStreamDefaultReader(v)){var S=this._pendingRead;if(S&&@isPromise(S)&&B\?.byteLength){this._pendingRead=@undefined,@fulfillPromise(S,{value:B,done:!1}),@readableStreamClose(y);return}}if(B\?.byteLength){var b=@getByIdDirectPrivate(v,\"readRequests\");if(b\?.isNotEmpty()){@readableStreamFulfillReadRequest(y,B,!1),@readableStreamClose(y);return}@putByIdDirectPrivate(y,\"state\",@streamReadable),this.@pull=()=>{var j=@createFulfilledPromise({value:B,done:!1});return B=@undefined,@readableStreamClose(y),y=@undefined,j}}else if(this._pendingRead){var C=this._pendingRead;this._pendingRead=@undefined,@putByIdDirectPrivate(this,\"pull\",@noopDoneFunction),@fulfillPromise(C,{value:@undefined,done:!0})}@readableStreamClose(y)})\n";
...
const char* const s_readableStreamInternalsCreateTextStreamCode = "(function (q){\"use strict\";var v,x=[],C=!1,E=!1,_=\"\",z=@toLength(0),A=@newPromiseCapability(@Promise),G=!1;return v={start(){},write(w){if(typeof w===\"string\"){var F=@toLength(w.length);if(F>0)_+=w,C=!0,z+=F;return F}if(!w||!(@ArrayBuffer.@isView(w)||w instanceof @ArrayBuffer))@throwTypeError(\"Expected text, ArrayBuffer or ArrayBufferView\");const j=@toLength(w.byteLength);if(j>0)if(E=!0,_.length>0)@arrayPush(x,_,w),_=\"\";else @arrayPush(x,w);return z+=j,j},flush(){return 0},end(){if(G)return\"\";return v.fulfill()},fulfill(){G=!0;const w=v.finishInternal();return @fulfillPromise(A.@promise,w),w},finishInternal(){if(!C&&!E)return\"\";if(C&&!E)return _;if(E&&!C)return new globalThis.TextDecoder().decode(@Bun.concatArrayBuffers(x));var w=new @Bun.ArrayBufferSink;w.start({highWaterMark:z,asUint8Array:!0});for(let F of x)w.write(F);if(x.length=0,_.length>0)w.write(_),_=\"\";return new globalThis.TextDecoder().decode(w.end())},close(){try{if(!G)G=!0,v.fulfill()}catch(w){}}},[v,A]})\n";
...
const char* const s_readableStreamInternalsInitializeTextStreamCode = "(function (_,p){\"use strict\";var[b,f]=@createTextStream(p),m={@underlyingSource:_,@pull:@onPullDirectStream,@controlledReadableStream:this,@sink:b,close:@onCloseDirectStream,write:b.write,error:@handleDirectStreamError,end:@onCloseDirectStream,@close:@onCloseDirectStream,flush:@onFlushDirectStream,_pendingRead:@undefined,_deferClose:0,_deferFlush:0,_deferCloseReason:@undefined,_handleError:@undefined};return @putByIdDirectPrivate(this,\"readableStreamController\",m),@putByIdDirectPrivate(this,\"underlyingSource\",@undefined),@putByIdDirectPrivate(this,\"start\",@undefined),f})\n";
...
const char* const s_readableStreamInternalsInitializeArrayStreamCode = "(function (_,t){\"use strict\";var p=[],j=@newPromiseCapability(@Promise),b=!1;function q(){return b=!0,j.@resolve.@call(@undefined,p),p}var v={start(){},write(m){return @arrayPush(p,m),m.byteLength||m.length},flush(){return 0},end(){if(b)return[];return q()},close(){if(!b)q()}},d={@underlyingSource:_,@pull:@onPullDirectStream,@controlledReadableStream:this,@sink:v,close:@onCloseDirectStream,write:v.write,error:@handleDirectStreamError,end:@onCloseDirectStream,@close:@onCloseDirectStream,flush:@onFlushDirectStream,_pendingRead:@undefined,_deferClose:0,_deferFlush:0,_deferCloseReason:@undefined,_handleError:@undefined};return @putByIdDirectPrivate(this,\"readableStreamController\",d),@putByIdDirectPrivate(this,\"underlyingSource\",@undefined),@putByIdDirectPrivate(this,\"start\",@undefined),j})\n";
...
const char* const s_readableStreamInternalsReadableStreamFulfillReadRequestCode = "(function (p,i,_){\"use strict\";const y=@getByIdDirectPrivate(@getByIdDirectPrivate(p,\"reader\"),\"readRequests\").shift();@fulfillPromise(y,{value:i,done:_})})\n";
...
const char* const s_readableStreamInternalsLazyLoadStreamCode = "(function (B,f){\"use strict\";var j=@getByIdDirectPrivate(B,\"bunNativeType\"),m=@getByIdDirectPrivate(B,\"bunNativePtr\"),q=@lazyStreamPrototypeMap.@get(j);if(q===@undefined){let Q=function(Y){var{c:Z,v:_}=this;this.c=@undefined,this.v=@undefined,I(Y,Z,_)},U=function(Y){try{Y.close()}catch(Z){globalThis.reportError(Z)}},W=function(Y,Z,_,p){p[0]=!1;var z;try{z=D(Y,_,p)}catch(A){return Z.error(A)}return I(z,Z,_)};var O=Q,P=U,N=W,[D,E,F,b,x,y,G]=@lazyLoad(j),H=[!1],I;I=function Y(Z,_,p){if(Z&&@isPromise(Z))return Z.then(Q.bind({c:_,v:p}),(z)=>_.error(z));else if(typeof Z===\"number\")if(p&&p.byteLength===Z&&p.buffer===_.byobRequest\?.view\?.buffer)_.byobRequest.respondWithNewView(p);else _.byobRequest.respond(Z);else if(Z.constructor===@Uint8Array)_.enqueue(Z);if(H[0]||Z===!1)@enqueueJob(U,_),H[0]=!1};const X=x\?new FinalizationRegistry(x):null;q=class Y{constructor(Z,_,p){if(this.#f=Z,this.#b={},this.pull=this.#j.bind(this),this.cancel=this.#m.bind(this),this.autoAllocateChunkSize=_,p!==@undefined)this.start=(z)=>{z.enqueue(p)};if(X)X.register(this,Z,this.#b)}#b;pull;cancel;start;#f;type=\"bytes\";autoAllocateChunkSize=0;static startSync=E;#j(Z){var _=this.#f;if(!_){Z.close();return}W(_,Z,Z.byobRequest.view,H)}#m(Z){var _=this.#f;X&&X.unregister(this.#b),y&&y(_,!1),F(_,Z)}static deinit=x;static drain=G},@lazyStreamPrototypeMap.@set(j,q)}const J=q.startSync(m,f);var K;const{drain:L,deinit:M}=q;if(L)K=L(m);if(J===0){if(x&&m&&@enqueueJob(x,m),(K\?.byteLength\?\?0)>0)return{start(Q){Q.enqueue(K),Q.close()},type:\"bytes\"};return{start(Q){Q.close()},type:\"bytes\"}}return new q(m,J,K)})\n";
...
const char* const s_readableStreamInternalsReadableStreamIntoArrayCode = "(function (_){\"use strict\";var g=_.getReader(),p=g.readMany();async function q(b){if(b.done)return[];var j=b.value||[];while(!0){var f=await g.read();if(f.done)break;j=j.concat(f.value)}return j}if(p&&@isPromise(p))return p.@then(q);return q(p)})\n";
...
const char* const s_readableStreamInternalsReadableStreamToArrayBufferDirectCode = "(function (j,A){\"use strict\";var x=new @Bun.ArrayBufferSink;@putByIdDirectPrivate(j,\"underlyingSource\",@undefined);var C=@getByIdDirectPrivate(j,\"highWaterMark\");x.start(C\?{highWaterMark:C}:{});var q=@newPromiseCapability(@Promise),D=!1,O=A.pull,F=A.close,v={start(){},close(B){if(!D){if(D=!0,F)F();@fulfillPromise(q.@promise,x.end())}},end(){if(!D){if(D=!0,F)F();@fulfillPromise(q.@promise,x.end())}},flush(){return 0},write:x.write.bind(x)},G=!1;try{const B=O(v);if(B&&@isObject(B)&&@isPromise(B))return async function(_,w,z){while(!D)await z(_);return await w}(v,promise,O);return q.@promise}catch(B){return G=!0,@readableStreamError(j,B),@Promise.@reject(B)}finally{if(!G&&j)@readableStreamClose(j);v=F=x=O=j=@undefined}})\n";
...
const char* const s_readableStreamInternalsReadableStreamDefineLazyIteratorsCode = "(function (g){\"use strict\";var j=globalThis.Symbol.asyncIterator,q=async function*z(B,D){var F=B.getReader(),G;try{while(!0){var h,k;const i=F.readMany();if(@isPromise(i))({done:h,value:k}=await i);else({done:h,value:k}=i);if(h)return;yield*k}}catch(i){G=i}finally{if(F.releaseLock(),!D)B.cancel(G);if(G)throw G}},w=function z(){return q(this,!1)},x=function z({preventCancel:B=!1}={preventCancel:!1}){return q(this,B)};return @Object.@defineProperty(g,j,{value:w}),@Object.@defineProperty(g,\"values\",{value:x}),g})\n";
...
const char* const s_readableStreamDefaultReaderReadManyCode = "(function (){\"use strict\";if(!@isReadableStreamDefaultReader(this))@throwTypeError(\"ReadableStreamDefaultReader.readMany() should not be called directly\");const _=@getByIdDirectPrivate(this,\"ownerReadableStream\");if(!_)@throwTypeError(\"readMany() called on a reader owned by no readable stream\");const d=@getByIdDirectPrivate(_,\"state\");if(@putByIdDirectPrivate(_,\"disturbed\",!0),d===@streamClosed)return{value:[],size:0,done:!0};else if(d===@streamErrored)throw @getByIdDirectPrivate(_,\"storedError\");var F=@getByIdDirectPrivate(_,\"readableStreamController\"),k=@getByIdDirectPrivate(F,\"queue\");if(!k)return F.@pull(F).@then(function({done:C,value:N}){return C\?{done:!0,value:[],size:0}:{value:[N],size:1,done:!1}});const B=k.content;var G=k.size,x=B.toArray(!1),H=x.length;if(H>0){var w=@newArrayWithSize(H);if(@isReadableByteStreamController(F)){{const C=x[0];if(!(@ArrayBuffer.@isView(C)||C instanceof @ArrayBuffer))@putByValDirect(w,0,new @Uint8Array(C.buffer,C.byteOffset,C.byteLength));else @putByValDirect(w,0,C)}for(var I=1;I<H;I++){const C=x[I];if(!(@ArrayBuffer.@isView(C)||C instanceof @ArrayBuffer))@putByValDirect(w,I,new @Uint8Array(C.buffer,C.byteOffset,C.byteLength));else @putByValDirect(w,I,C)}}else{@putByValDirect(w,0,x[0].value);for(var I=1;I<H;I++)@putByValDirect(w,I,x[I].value)}if(@resetQueue(@getByIdDirectPrivate(F,\"queue\")),@getByIdDirectPrivate(F,\"closeRequested\"))@readableStreamClose(@getByIdDirectPrivate(F,\"controlledReadableStream\"));else if(@isReadableStreamDefaultController(F))@readableStreamDefaultControllerCallPullIfNeeded(F);else if(@isReadableByteStreamController(F))@readableByteStreamControllerCallPullIfNeeded(F);return{value:w,size:G,done:!1}}var J=(C)=>{if(C.done)return{value:[],size:0,done:!0};var N=@getByIdDirectPrivate(_,\"readableStreamController\"),A=@getByIdDirectPrivate(N,\"queue\"),Q=[C.value].concat(A.content.toArray(!1)),D=Q.length;if(@isReadableByteStreamController(N))for(var S=0;S<D;S++){const U=Q[S];if(!(@ArrayBuffer.@isView(U)||U instanceof @ArrayBuffer)){const{buffer:j,byteOffset:W,byteLength:E}=U;@putByValDirect(Q,S,new @Uint8Array(j,W,E))}}else for(var S=1;S<D;S++)@putByValDirect(Q,S,Q[S].value);var T=A.size;if(@resetQueue(A),@getByIdDirectPrivate(N,\"closeRequested\"))@readableStreamClose(@getByIdDirectPrivate(N,\"controlledReadableStream\"));else if(@isReadableStreamDefaultController(N))@readableStreamDefaultControllerCallPullIfNeeded(N);else if(@isReadableByteStreamController(N))@readableByteStreamControllerCallPullIfNeeded(N);return{value:Q,size:T,done:!1}},K=F.@pull(F);if(K&&@isPromise(K))return K.@then(J);return J(K)})\n";
...
const char* const s_streamInternalsPromiseInvokeOrNoopMethodCode = "(function (l,d,i){\"use strict\";try{return @promiseInvokeOrNoopMethodNoCatch(l,d,i)}catch(f){return @Promise.@reject(f)}})\n";
...
const char* const s_streamInternalsPromiseInvokeOrFallbackOrNoopCode = "(function (n,v,p,u,_){\"use strict\";try{const l=n[v];if(l===@undefined)return @promiseInvokeOrNoopNoCatch(n,u,_);return @shieldingPromiseResolve(l.@apply(n,p))}catch(l){return @Promise.@reject(l)}})\n";
...
const char* const s_streamInternalsCreateFIFOCode = "(function (){\"use strict\";var v=@Array.prototype.slice;class b{constructor(){this._head=0,this._tail=0,this._capacityMask=3,this._list=@newArrayWithSize(4)}_head;_tail;_capacityMask;_list;size(){if(this._head===this._tail)return 0;if(this._head<this._tail)return this._tail-this._head;else return this._capacityMask+1-(this._head-this._tail)}isEmpty(){return this.size()==0}isNotEmpty(){return this.size()>0}shift(){var{_head:g,_tail:z,_list:k,_capacityMask:x}=this;if(g===z)return @undefined;var w=k[g];if(@putByValDirect(k,g,@undefined),g=this._head=g+1&x,g<2&&z>1e4&&z<=k.length>>>2)this._shrinkArray();return w}peek(){if(this._head===this._tail)return @undefined;return this._list[this._head]}push(g){var z=this._tail;if(@putByValDirect(this._list,z,g),this._tail=z+1&this._capacityMask,this._tail===this._head)this._growArray()}toArray(g){var z=this._list,k=@toLength(z.length);if(g||this._head>this._tail){var x=@toLength(this._head),w=@toLength(this._tail),A=@toLength(k-x+w),B=@newArrayWithSize(A),E=0;for(var F=x;F<k;F++)@putByValDirect(B,E++,z[F]);for(var F=0;F<w;F++)@putByValDirect(B,E++,z[F]);return B}else return v.@call(z,this._head,this._tail)}clear(){this._head=0,this._tail=0,this._list.fill(@undefined)}_growArray(){if(this._head)this._list=this.toArray(!0),this._head=0;this._tail=@toLength(this._list.length),this._list.length<<=1,this._capacityMask=this._capacityMask<<1|1}shrinkArray(){this._list.length>>>=1,this._capacityMask>>>=1}}return new b})\n";
...
const char* const s_importMetaObjectLoadCJS2ESMCode = "(function (J){\"use strict\";var L=@Loader,T=@createFIFO(),U=J;while(U){var w=L.registry.@get(U);if((w\?.state\?\?0)<=@ModuleFetch)@fulfillModuleSync(U),w=L.registry.@get(U);var V=@getPromiseInternalField(w.fetch,@promiseFieldReactionsOrResult),D=L.parseModule(U,V),W=w.module;if(D&&@isPromise(D)){var X=@getPromiseInternalField(D,@promiseFieldReactionsOrResult),Y=@getPromiseInternalField(D,@promiseFieldFlags),Q=Y&@promiseStateMask;if(Q===@promiseStatePending||X&&@isPromise(X))@throwTypeError(`require() async module \"${U}\" is unsupported. use \"await import()\" instead.`);else if(Q===@promiseStateRejected){if(!X\?.message)@throwTypeError(`${X+\"\"\?X:\"An error occurred\"} occurred while parsing module \\\"${U}\\\"`);throw X}w.module=W=X}else if(D&&!W)w.module=W=D;@setStateToMax(w,@ModuleLink);var _=W.dependenciesMap,B=L.requestedModules(W),F=@newArrayWithSize(B.length);for(var G=0,Z=B.length;G<Z;++G){var x=B[G],H=x[0]===\"/\"\?x:L.resolve(x,U),I=L.ensureRegistered(H);if(I.state<@ModuleLink)T.push(H);@putByValDirect(F,G,I),_.@set(x,I)}w.dependencies=F,w.instantiate=@Promise.resolve(w),w.satisfy=@Promise.resolve(w),U=T.shift();while(U&&(L.registry.@get(U)\?.state\?\?@ModuleFetch)>=@ModuleLink)U=T.shift()}var z=L.linkAndEvaluateModule(J,@undefined);if(z&&@isPromise(z))@throwTypeError(`require() async module \\\"${J}\\\" is unsupported. use \"await import()\" instead.`);return L.registry.@get(J)})\n";
...
const char* const s_importMetaObjectCreateRequireCacheCode = "(function (){\"use strict\";var f=new Map,L={};return new Proxy(L,{get(u,b){const h=@requireMap.@get(b);if(h)return h;const c=@Loader.registry.@get(b);if(c\?.evaluated){const _=@Loader.getModuleNamespaceObject(c.module),g=_[@commonJSSymbol]===0||_.default\?.[@commonJSSymbol]\?_.default:_,t=@createCommonJSModule(b,g,!0);return @requireMap.@set(b,t),t}return L[b]},set(u,b,h){return @requireMap.@set(b,h),!0},has(u,b){return @requireMap.@has(b)||@Loader.registry.@has(b)},deleteProperty(u,b){return f.@delete(b),@requireMap.@delete(b),@Loader.registry.@delete(b),!0},ownKeys(u){var b=[...@requireMap.@keys()];const h=[...@Loader.registry.@keys()];for(let c of h)if(!b.includes(c))@arrayPush(b,c);return b},getPrototypeOf(u){return null},getOwnPropertyDescriptor(u,b){if(@requireMap.@has(b)||@Loader.registry.@has(b))return{configurable:!0,enumerable:!0}}})})\n";
...
const char* const s_readableStreamConsumeReadableStreamCode = "(function (_,L,F){\"use strict\";const N=globalThis.Symbol.for(\"Bun.consumeReadableStreamPrototype\");var j=globalThis[N];if(!j)j=globalThis[N]=[];var H=j[L];if(H===@undefined){var[k,J,q,I,w,D]=globalThis[globalThis.Symbol.for(\"Bun.lazy\")](L);H=class G{handleError;handleClosed;processResult;constructor(A,K){this.#_=K,this.#F=A,this.#$=!1,this.handleError=this._handleError.bind(this),this.handleClosed=this._handleClosed.bind(this),this.processResult=this._processResult.bind(this),A.closed.then(this.handleClosed,this.handleError)}_handleClosed(){if(this.#$)return;this.#$=!0;var A=this.#_;this.#_=0,I(A),D(A)}_handleError(A){if(this.#$)return;this.#$=!0;var K=this.#_;this.#_=0,J(K,A),D(K)}#_;#$=!1;#F;_handleReadMany({value:A,done:K,size:B}){if(K){this.handleClosed();return}if(this.#$)return;q(this.#_,A,K,B)}read(){if(!this.#_)return @throwTypeError(\"ReadableStreamSink is already closed\");return this.processResult(this.#F.read())}_processResult(A){if(A&&@isPromise(A)){if(@getPromiseInternalField(A,@promiseFieldFlags)&@promiseStateFulfilled){const B=@getPromiseInternalField(A,@promiseFieldReactionsOrResult);if(B)A=B}}if(A&&@isPromise(A))return A.then(this.processResult,this.handleError),null;if(A.done)return this.handleClosed(),0;else if(A.value)return A.value;else return-1}readMany(){if(!this.#_)return @throwTypeError(\"ReadableStreamSink is already closed\");return this.processResult(this.#F.readMany())}};const x=L+1;if(j.length<x)j.length=x;@putByValDirect(j,L,H)}if(@isReadableStreamLocked(F))@throwTypeError(\"Cannot start reading from a locked stream\");return new H(F.getReader(),_)})\n";
...
const char* const s_readableStreamPipeThroughCode = "(function (_,c){\"use strict\";const h=_,d=h[\"readable\"];if(!@isReadableStream(d))throw @makeTypeError(\"readable should be ReadableStream\");const y=h[\"writable\"],j=@getInternalWritableStream(y);if(!@isWritableStream(j))throw @makeTypeError(\"writable should be WritableStream\");let k=!1,q=!1,x=!1,u;if(!@isUndefinedOrNull(c)){if(!@isObject(c))throw @makeTypeError(\"options must be an object\");if(q=!!c[\"preventAbort\"],x=!!c[\"preventCancel\"],k=!!c[\"preventClose\"],u=c[\"signal\"],u!==@undefined&&!@isAbortSignal(u))throw @makeTypeError(\"options.signal must be AbortSignal\")}if(!@isReadableStream(this))throw @makeThisTypeError(\"ReadableStream\",\"pipeThrough\");if(@isReadableStreamLocked(this))throw @makeTypeError(\"ReadableStream is locked\");if(@isWritableStreamLocked(j))throw @makeTypeError(\"WritableStream is locked\");return @readableStreamPipeToWritableStream(this,j,k,q,x,u),d})\n";
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerRespondWithNewViewCode = "(function (d,a){\"use strict\";@assert(@getByIdDirectPrivate(d,\"pendingPullIntos\").isNotEmpty());let u=@getByIdDirectPrivate(d,\"pendingPullIntos\").peek();if(u.byteOffset+u.bytesFilled!==a.byteOffset)@throwRangeError(\"Invalid value for view.byteOffset\");if(u.byteLength!==a.byteLength)@throwRangeError(\"Invalid value for view.byteLength\");u.buffer=a.buffer,@readableByteStreamControllerRespondInternal(d,a.byteLength)})\n";
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerRespondInReadableStateCode = "(function (g,h,R){\"use strict\";if(R.bytesFilled+h>R.byteLength)@throwRangeError(\"bytesWritten value is too great\");if(@assert(@getByIdDirectPrivate(g,\"pendingPullIntos\").isEmpty()||@getByIdDirectPrivate(g,\"pendingPullIntos\").peek()===R),@readableByteStreamControllerInvalidateBYOBRequest(g),R.bytesFilled+=h,R.bytesFilled<R.elementSize)return;@readableByteStreamControllerShiftPendingDescriptor(g);const f=R.bytesFilled%R.elementSize;if(f>0){const w=R.byteOffset+R.bytesFilled,_=@cloneArrayBuffer(R.buffer,w-f,f);@readableByteStreamControllerEnqueueChunk(g,_,0,_.byteLength)}R.buffer=@transferBufferToCurrentRealm(R.buffer),R.bytesFilled-=f,@readableByteStreamControllerCommitDescriptor(@getByIdDirectPrivate(g,\"controlledReadableStream\"),R),@readableByteStreamControllerProcessPullDescriptors(g)})\n";
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerCommitDescriptorCode = "(function (b,_){\"use strict\";@assert(@getByIdDirectPrivate(b,\"state\")!==@streamErrored);let g=!1;if(@getByIdDirectPrivate(b,\"state\")===@streamClosed)@assert(!_.bytesFilled),g=!0;let h=@readableByteStreamControllerConvertDescriptor(_);if(_.readerType===\"default\")@readableStreamFulfillReadRequest(b,h,g);else @assert(_.readerType===\"byob\"),@readableStreamFulfillReadIntoRequest(b,h,g)})\n";
...
const char* const s_readableByteStreamInternalsReadableStreamFulfillReadIntoRequestCode = "(function (_,l,p){\"use strict\";const i=@getByIdDirectPrivate(@getByIdDirectPrivate(_,\"reader\"),\"readIntoRequests\").shift();@fulfillPromise(i,{value:l,done:p})})\n";
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerPullIntoCode = "(function (_,b){\"use strict\";const N=@getByIdDirectPrivate(_,\"controlledReadableStream\");let d=1;if(b.BYTES_PER_ELEMENT!==@undefined)d=b.BYTES_PER_ELEMENT;const L=b.constructor,k={buffer:b.buffer,byteOffset:b.byteOffset,byteLength:b.byteLength,bytesFilled:0,elementSize:d,ctor:L,readerType:\"byob\"};var A=@getByIdDirectPrivate(_,\"pendingPullIntos\");if(A\?.isNotEmpty())return k.buffer=@transferBufferToCurrentRealm(k.buffer),A.push(k),@readableStreamAddReadIntoRequest(N);if(@getByIdDirectPrivate(N,\"state\")===@streamClosed){const E=new L(k.buffer,k.byteOffset,0);return @createFulfilledPromise({value:E,done:!0})}if(@getByIdDirectPrivate(_,\"queue\").size>0){if(@readableByteStreamControllerFillDescriptorFromQueue(_,k)){const E=@readableByteStreamControllerConvertDescriptor(k);return @readableByteStreamControllerHandleQueueDrain(_),@createFulfilledPromise({value:E,done:!1})}if(@getByIdDirectPrivate(_,\"closeRequested\")){const E=@makeTypeError(\"Closing stream has been requested\");return @readableByteStreamControllerError(_,E),@Promise.@reject(E)}}k.buffer=@transferBufferToCurrentRealm(k.buffer),@getByIdDirectPrivate(_,\"pendingPullIntos\").push(k);const R=@readableStreamAddReadIntoRequest(N);return @readableByteStreamControllerCallPullIfNeeded(_),R})\n";
...
const char* const s_eventSourceGetEventSourceCode = "(function (){\"use strict\";class F extends EventTarget{#$;#j;#w;#A;#B;#F=!1;#G=null;#J=\"\";#K=\"\";#L=\"\";#M=!0;#O=0;#Q=0;#U=0;#V=null;static#W(L){L.#H()}static#X(L,j){const A=L.data,G=A.#L\?`Last-Event-ID: ${A.#L}\\r\\n`:\"\",M=`GET ${j.pathname}${j.search} HTTP/1.1\\r\\nHost: bun\\r\\nContent-type: text/event-stream\\r\\nContent-length: 0\\r\\n${G}\\r\\n`,O=L.write(M);if(O!==M.length)A.#K=M.substring(O)}static#Y(L,j,A){for(;;){if(A>=j.length)return;let G=-1,M=j.indexOf(\"\\r\\n\",A);const O=M+2;if(M>0)if(L.#O===0){const W=parseInt(j.substring(A,M),16);if(W===0){L.#j=2,L.#G\?.end();return}G=O+W}else G=j.length;else{if(L.#J.length===0){L.#J+=j.substring(A);return}G=j.length}let Q=j.substring(O,G);A=G+2;let U=0,V=Q.indexOf(\"\\n\\n\");if(V==-1){L.#J+=j.substring(O);return}if(L.#J.length)L.#J+=Q,Q=L.#J,L.#J=\"\";let w=!0;while(w){const W=Q.substring(U,V);let J,X=\"\",B,Y=0,K=-1;for(;;){let z=W.indexOf(\"\\n\",Y);if(z===-1){if(Y>=W.length)break;z=W.length}const H=W.substring(Y,z);if(H.startsWith(\"data:\"))if(X.length)X+=`\\n${H.substring(5).trim()}`;else X=H.substring(5).trim();else if(H.startsWith(\"event:\"))J=H.substring(6).trim();else if(H.startsWith(\"id:\"))B=H.substring(3).trim();else if(H.startsWith(\"retry:\")){if(K=parseInt(H.substring(6).trim(),10),@isNaN(K))K=-1}Y=z+1}if(L.#L=B||\"\",K>=0)L.#U=K;if(X||B||J)L.dispatchEvent(new MessageEvent(J||\"message\",{data:X||\"\",origin:L.#$.origin,source:L,lastEventId:B}));if(Q.length===V+2){w=!1;break}const Z=Q.indexOf(\"\\n\\n\",V+1);if(Z===-1)break;U=V,V=Z}}}static#Z={open(L){const j=L.data;if(j.#G=L,!j.#F)F.#X(L,j.#$)},handshake(L,j,A){const G=L.data;if(j)F.#X(L,G.#$);else G.#j=2,G.dispatchEvent(new ErrorEvent(\"error\",{error:A})),L.end()},data(L,j){const A=L.data;switch(A.#j){case 0:{let G=j.toString();const M=G.indexOf(\"\\r\\n\\r\\n\");if(M===-1){A.#J+=G;return}if(A.#J.length)A.#J+=G,G=A.#J,A.#J=\"\";const O=G.substring(0,M),Q=O.indexOf(\"\\r\\n\");if(Q===-1){A.#j=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Invalid HTTP request\")})),L.end();return}const U=O.substring(0,Q);if(U!==\"HTTP/1.1 200 OK\"){A.#j=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(U)})),L.end();return}let V=Q+1,w=!1,W=-1;for(;;){let X=O.indexOf(\"\\r\\n\",V);if(X===-1){if(V>=O.length){if(!w)A.#j=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's response has no MIME type and \"text/event-stream\" is required. Aborting the connection.`)})),L.end();return}X=O.length}const B=O.substring(V+1,X),Y=B.indexOf(\":\"),K=B.substring(0,Y),Z=K.localeCompare(\"content-type\",@undefined,{sensitivity:\"accent\"})===0;if(V=X+1,Z)if(B.endsWith(\" text/event-stream\"))w=!0;else{A.#j=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's response has a MIME type that is not \"text/event-stream\". Aborting the connection.`)})),L.end();return}else if(K.localeCompare(\"content-length\",@undefined,{sensitivity:\"accent\"})===0){if(W=parseInt(B.substring(Y+1).trim(),10),@isNaN(W)||W<=0){A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's Content-Length is invalid. Aborting the connection.`)})),L.end();return}if(w)break}else if(K.localeCompare(\"transfer-encoding\",@undefined,{sensitivity:\"accent\"})===0){if(B.substring(Y+1).trim()!==\"chunked\"){A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's Transfer-Encoding is invalid. Aborting the connection.`)})),L.end();return}if(W=0,w)break}}A.#O=W,A.#j=1,A.dispatchEvent(new Event(\"open\"));const J=G.substring(M+4);if(F.#Y(A,J,0),A.#O>0){if(A.#Q+=J.length,A.#Q>=A.#O)A.#j=2,L.end()}return}case 1:if(F.#Y(A,j.toString(),2),A.#O>0){if(A.#Q+=j.byteLength,A.#Q>=A.#O)A.#j=2,L.end()}return;default:break}},drain(L){const j=L.data;if(j.#j===0){const A=j.#J;if(A.length){const G=L.write(A);if(G!==A.length)L.data.#K=A.substring(G);else L.data.#K=\"\"}}},close:F.#z,end(L){F.#z(L).dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Connection closed by server\")}))},timeout(L){F.#z(L).dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Timeout\")}))},binaryType:\"buffer\"};static#z(L){const j=L.data;if(j.#G=null,j.#Q=0,j.#j=2,j.#M){if(j.#V)clearTimeout(j.#V);j.#V=setTimeout(F.#W,j.#U,j)}return j}constructor(L,j=@undefined){super();const A=new URL(L);this.#F=A.protocol===\"https:\",this.#$=A,this.#j=2,process.nextTick(F.#W,this)}ref(){this.#V\?.ref(),this.#G\?.ref()}unref(){this.#V\?.unref(),this.#G\?.unref()}#H(){if(this.#j!==2)return;const L=this.#$,j=this.#F;this.#j=0,@Bun.connect({data:this,socket:F.#Z,hostname:L.hostname,port:parseInt(L.port||(j\?\"443\":\"80\"),10),tls:j\?{requestCert:!0,rejectUnauthorized:!1}:!1}).catch((A)=>{if(super.dispatchEvent(new ErrorEvent(\"error\",{error:A})),this.#M){if(this.#V)this.#V.unref\?.();this.#V=setTimeout(F.#W,1000,this)}})}get url(){return this.#$.href}get readyState(){return this.#j}close(){this.#M=!1,this.#j=2,this.#G\?.unref(),this.#G\?.end()}get onopen(){return this.#B}get onerror(){return this.#w}get onmessage(){return this.#A}set onopen(L){if(this.#B)super.removeEventListener(\"close\",this.#B);super.addEventListener(\"open\",L),this.#B=L}set onerror(L){if(this.#w)super.removeEventListener(\"error\",this.#w);super.addEventListener(\"error\",L),this.#w=L}set onmessage(L){if(this.#A)super.removeEventListener(\"message\",this.#A);super.addEventListener(\"message\",L),this.#A=L}}return Object.defineProperty(F.prototype,\"CONNECTING\",{enumerable:!0,value:0}),Object.defineProperty(F.prototype,\"OPEN\",{enumerable:!0,value:1}),Object.defineProperty(F.prototype,\"CLOSED\",{enumerable:!0,value:2}),F[Symbol.for(\"CommonJS\")]=0,F})\n";
