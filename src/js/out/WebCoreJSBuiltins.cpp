...
const char* const s_transformStreamInternalsTransformStreamDefaultSinkCloseAlgorithmCode = "(function (_){\"use strict\";const I=@getByIdDirectPrivate(_,\"readable\"),f=@getByIdDirectPrivate(_,\"controller\"),j=@getByIdDirectPrivate(I,\"readableStreamController\"),u=@getByIdDirectPrivate(f,\"flushAlgorithm\");@assert(u!==@undefined);const v=@getByIdDirectPrivate(f,\"flushAlgorithm\").@call();@transformStreamDefaultControllerClearAlgorithms(f);const q=@newPromiseCapability(@Promise);return v.@then(()=>{if(@getByIdDirectPrivate(I,\"state\")===@streamErrored){q.@reject.@call(@undefined,@getByIdDirectPrivate(I,\"storedError\"));return}if(@readableStreamDefaultControllerCanCloseOrEnqueue(j))@readableStreamDefaultControllerClose(j);q.@resolve()},(k)=>{@transformStreamError(@getByIdDirectPrivate(f,\"stream\"),k),q.@reject.@call(@undefined,@getByIdDirectPrivate(I,\"storedError\"))}),q.@promise})\n";
...
const char* const s_processObjectInternalsGetStdioWriteStreamCode = "(function (Y,M){\"use strict\";var N={path:\"node:process\",require:M},O=(V)=>N.require(V);function Q(V){var{Duplex:A,eos:T,destroy:X}=O(\"node:stream\"),j=class K extends A{#$;#B;#j=!0;#z=!0;#G;#H;#J;#K;#L;#M;get isTTY(){return this.#M\?\?=O(\"node:tty\").isatty(V)}get fd(){return V}constructor(x){super({readable:!0,writable:!0});this.#G=`/dev/fd/${x}`}#N(x){const L=this.#H;if(this.#H=null,L)L(x);else if(x)this.destroy(x);else if(!this.#j&&!this.#z)this.destroy()}_destroy(x,L){if(!x&&this.#H!==null){var U=class G extends Error{code;name;constructor(z=\"The operation was aborted\",Z=void 0){if(Z!==void 0&&typeof Z!==\"object\")throw new Error(`Invalid AbortError options:\\n\\n${JSON.stringify(Z,null,2)}`);super(z,Z);this.code=\"ABORT_ERR\",this.name=\"AbortError\"}};x=new U}if(this.#J=null,this.#K=null,this.#H===null)L(x);else{if(this.#H=L,this.#$)X(this.#$,x);if(this.#B)X(this.#B,x)}}_write(x,L,U){if(!this.#$){var{createWriteStream:G}=O(\"node:fs\"),z=this.#$=G(this.#G);z.on(\"finish\",()=>{if(this.#K){const Z=this.#K;this.#K=null,Z()}}),z.on(\"drain\",()=>{if(this.#J){const Z=this.#J;this.#J=null,Z()}}),T(z,(Z)=>{if(this.#z=!1,Z)X(z,Z);this.#N(Z)})}if(z.write(x,L))U();else this.#J=U}_final(x){this.#$&&this.#$.end(),this.#K=x}#O(){var{createReadStream:x}=O(\"node:fs\"),L=this.#B=x(this.#G);return L.on(\"readable\",()=>{if(this.#L){const U=this.#L;this.#L=null,U()}else this.read()}),L.on(\"end\",()=>{this.push(null)}),T(L,(U)=>{if(this.#j=!1,U)X(L,U);this.#N(U)}),L}_read(){var x=this.#B;if(!x)x=this.#O();while(!0){const L=x.read();if(L===null||!this.push(L))return}}};return new j(V)}var{EventEmitter:B}=O(\"node:events\");function H(V){if(!V)return!0;var A=V.toLowerCase();return A===\"utf8\"||A===\"utf-8\"||A===\"buffer\"||A===\"binary\"}var P,J=class V extends B{#$;#B;#j;#z;bytesWritten=0;setDefaultEncoding(A){if(this.#B||!H(A))return this.#J(),this.#B.setDefaultEncoding(A)}#G(){switch(this.#$){case 1:{var A=@Bun.stdout.writer({highWaterMark:0});return A.unref(),A}case 2:{var A=@Bun.stderr.writer({highWaterMark:0});return A.unref(),A}default:throw new Error(\"Unsupported writer\")}}#H(){return this.#j\?\?=this.#G()}constructor(A){super();this.#$=A}get fd(){return this.#$}get isTTY(){return this.#z\?\?=O(\"node:tty\").isatty(this.#$)}cursorTo(A,T,X){return(P\?\?=O(\"readline\")).cursorTo(this,A,T,X)}moveCursor(A,T,X){return(P\?\?=O(\"readline\")).moveCursor(this,A,T,X)}clearLine(A,T){return(P\?\?=O(\"readline\")).clearLine(this,A,T)}clearScreenDown(A){return(P\?\?=O(\"readline\")).clearScreenDown(this,A)}ref(){this.#H().ref()}unref(){this.#H().unref()}on(A,T){if(A===\"close\"||A===\"finish\")return this.#J(),this.#B.on(A,T);if(A===\"drain\")return super.on(\"drain\",T);if(A===\"error\")return super.on(\"error\",T);return super.on(A,T)}get _writableState(){return this.#J(),this.#B._writableState}get _readableState(){return this.#J(),this.#B._readableState}pipe(A){return this.#J(),this.#B.pipe(A)}unpipe(A){return this.#J(),this.#B.unpipe(A)}#J(){if(this.#B)return;this.#B=Q(this.#$);const A=this.eventNames();for(let T of A)this.#B.on(T,(...X)=>{this.emit(T,...X)})}#K(A){var T=this.#H();const X=T.write(A);this.bytesWritten+=X;const j=T.flush(!1);return!!(X||j)}#L(A,T){if(!H(T))return this.#J(),this.#B.write(A,T);return this.#K(A)}#M(A,T){if(T)this.emit(\"error\",T);try{A(T\?T:null)}catch(X){this.emit(\"error\",X)}}#N(A,T,X){if(!H(T))return this.#J(),this.#B.write(A,T,X);var j=this.#H();const K=j.write(A),x=j.flush(!0);if(x\?.then)return x.then(()=>{this.#M(X),this.emit(\"drain\")},(L)=>this.#M(X,L)),!1;return queueMicrotask(()=>{this.#M(X)}),!!(K||x)}write(A,T,X){const j=this._write(A,T,X);if(j)this.emit(\"drain\");return j}get hasColors(){return @Bun.tty[this.#$].hasColors}_write(A,T,X){var j=this.#B;if(j)return j.write(A,T,X);switch(arguments.length){case 0:{var K=new Error(\"Invalid arguments\");throw K.code=\"ERR_INVALID_ARG_TYPE\",K}case 1:return this.#K(A);case 2:if(typeof T===\"function\")return this.#N(A,\"\",T);else if(typeof T===\"string\")return this.#L(A,T);default:{if(typeof T!==\"undefined\"&&typeof T!==\"string\"||typeof X!==\"undefined\"&&typeof X!==\"function\"){var K=new Error(\"Invalid arguments\");throw K.code=\"ERR_INVALID_ARG_TYPE\",K}if(typeof X===\"undefined\")return this.#L(A,T);return this.#N(A,T,X)}}}destroy(){return this}end(){return this}};return new J(Y)})\n";
...
const char* const s_jsBufferPrototypeUtf16leSliceCode = "(function (r,d){\"use strict\";return this.toString(r,d,\"utf16le\")})\n";
...
const char* const s_readableStreamInternalsReadStreamIntoSinkCode = "(async function (_,E,c){\"use strict\";var f=!1,x=!1;try{var B=_.getReader(),F=B.readMany();if(F&&@isPromise(F))F=await F;if(F.done)return f=!0,E.end();var G=F.value.length;const q=@getByIdDirectPrivate(_,\"highWaterMark\");if(c)@startDirectStream.@call(E,_,@undefined,()=>!x&&@markPromiseAsHandled(_.cancel()));E.start({highWaterMark:q||0});for(var H=0,I=F.value,J=F.value.length;H<J;H++)E.write(I[H]);var K=@getByIdDirectPrivate(_,\"state\");if(K===@streamClosed)return f=!0,E.end();while(!0){var{value:P,done:z}=await B.read();if(z)return f=!0,E.end();E.write(P)}}catch(q){x=!0;try{B=@undefined;const D=_.cancel(q);@markPromiseAsHandled(D)}catch(D){}if(E&&!f){f=!0;try{E.close(q)}catch(D){throw new globalThis.AggregateError([q,D])}}throw q}finally{if(B){try{B.releaseLock()}catch(D){}B=@undefined}E=@undefined;var K=@getByIdDirectPrivate(_,\"state\");if(_){var A=@getByIdDirectPrivate(_,\"readableStreamController\");if(A){if(@getByIdDirectPrivate(A,\"underlyingSource\"))@putByIdDirectPrivate(A,\"underlyingSource\",@undefined);if(@getByIdDirectPrivate(A,\"controlledReadableStream\"))@putByIdDirectPrivate(A,\"controlledReadableStream\",@undefined);if(@putByIdDirectPrivate(_,\"readableStreamController\",null),@getByIdDirectPrivate(_,\"underlyingSource\"))@putByIdDirectPrivate(_,\"underlyingSource\",@undefined);A=@undefined}if(!x&&K!==@streamClosed&&K!==@streamErrored)@readableStreamClose(_);_=@undefined}}})\n";
...
const char* const s_readableStreamInternalsOnPullDirectStreamCode = "(function (g){\"use strict\";var i=g.@controlledReadableStream;if(!i||@getByIdDirectPrivate(i,\"state\")!==@streamReadable)return;if(g._deferClose===-1)return;g._deferClose=-1,g._deferFlush=-1;var b,y;try{var j=g.@underlyingSource.pull(g);if(j&&@isPromise(j)){if(g._handleError===@undefined)g._handleError=@handleDirectStreamErrorReject.bind(g);@Promise.prototype.catch.@call(j,g._handleError)}}catch(_){return @handleDirectStreamErrorReject.@call(g,_)}finally{b=g._deferClose,y=g._deferFlush,g._deferFlush=g._deferClose=0}var k;if(g._pendingRead===@undefined)g._pendingRead=k=@newPromise();else k=@readableStreamAddReadRequest(i);if(b===1){var h=g._deferCloseReason;return g._deferCloseReason=@undefined,@onCloseDirectStream.@call(g,h),k}if(y===1)@onFlushDirectStream.@call(g);return k})\n";
...
const char* const s_readableStreamInternalsOnCloseDirectStreamCode = "(function (c){\"use strict\";var C=this.@controlledReadableStream;if(!C||@getByIdDirectPrivate(C,\"state\")!==@streamReadable)return;if(this._deferClose!==0){this._deferClose=1,this._deferCloseReason=c;return}if(@putByIdDirectPrivate(C,\"state\",@streamClosing),typeof this.@underlyingSource.close===\"function\")try{this.@underlyingSource.close.@call(this.@underlyingSource,c)}catch(B){}var v;try{v=this.@sink.end(),@putByIdDirectPrivate(this,\"sink\",@undefined)}catch(B){if(this._pendingRead){var S=this._pendingRead;this._pendingRead=@undefined,@rejectPromise(S,B)}@readableStreamError(C,B);return}this.error=this.flush=this.write=this.close=this.end=@onReadableStreamDirectControllerClosed;var j=@getByIdDirectPrivate(C,\"reader\");if(j&&@isReadableStreamDefaultReader(j)){var b=this._pendingRead;if(b&&@isPromise(b)&&v\?.byteLength){this._pendingRead=@undefined,@fulfillPromise(b,{value:v,done:!1}),@readableStreamClose(C);return}}if(v\?.byteLength){var y=@getByIdDirectPrivate(j,\"readRequests\");if(y\?.isNotEmpty()){@readableStreamFulfillReadRequest(C,v,!1),@readableStreamClose(C);return}@putByIdDirectPrivate(C,\"state\",@streamReadable),this.@pull=()=>{var B=@createFulfilledPromise({value:v,done:!1});return v=@undefined,@readableStreamClose(C),C=@undefined,B}}else if(this._pendingRead){var S=this._pendingRead;this._pendingRead=@undefined,@putByIdDirectPrivate(this,\"pull\",@noopDoneFunction),@fulfillPromise(S,{value:@undefined,done:!0})}@readableStreamClose(C)})\n";
...
const char* const s_readableStreamInternalsLazyLoadStreamCode = "(function (Q,G){\"use strict\";var H=@getByIdDirectPrivate(Q,\"bunNativeType\"),I=@getByIdDirectPrivate(Q,\"bunNativePtr\"),J=@lazyStreamPrototypeMap.@get(H);if(J===@undefined){let j=function(D){var{c:p,v:z}=this;this.c=@undefined,this.v=@undefined,Y(D,p,z)},P=function(D){try{D.close()}catch(p){globalThis.reportError(p)}},M=function(D,p,z,A){A[0]=!1;var E;try{E=b(D,z,A)}catch(F){return p.error(F)}return Y(E,p,z)};var f=j,O=P,m=M,[b,q,U,x,K,N,W]=@lazyLoad(H),X=[!1],Y;Y=function D(p,z,A){if(p&&@isPromise(p))return p.then(j.bind({c:z,v:A}),(E)=>z.error(E));else if(typeof p===\"number\")if(A&&A.byteLength===p&&A.buffer===z.byobRequest\?.view\?.buffer)z.byobRequest.respondWithNewView(A);else z.byobRequest.respond(p);else if(p.constructor===@Uint8Array)z.enqueue(p);if(X[0]||p===!1)@enqueueJob(P,z),X[0]=!1};const B=K\?new FinalizationRegistry(K):null;J=class D{constructor(p,z,A){if(this.#f=p,this.#b={},this.pull=this.#j.bind(this),this.cancel=this.#m.bind(this),this.autoAllocateChunkSize=z,A!==@undefined)this.start=(E)=>{E.enqueue(A)};if(B)B.register(this,p,this.#b)}#b;pull;cancel;start;#f;type=\"bytes\";autoAllocateChunkSize=0;static startSync=q;#j(p){var z=this.#f;if(!z){p.close();return}M(z,p,p.byobRequest.view,X)}#m(p){var z=this.#f;B&&B.unregister(this.#b),N&&N(z,!1),U(z,p)}static deinit=K;static drain=W},@lazyStreamPrototypeMap.@set(H,J)}const Z=J.startSync(I,G);var _;const{drain:y,deinit:L}=J;if(y)_=y(I);if(Z===0){if(K&&I&&@enqueueJob(K,I),(_\?.byteLength\?\?0)>0)return{start(j){j.enqueue(_),j.close()},type:\"bytes\"};return{start(j){j.close()},type:\"bytes\"}}return new J(I,Z,_)})\n";
...
const char* const s_readableStreamInternalsReadableStreamToArrayDirectCode = "(async function (_,k){\"use strict\";const j=@initializeArrayStream.@call(_,k,@undefined);k=@undefined;var p=_.getReader();try{while(@getByIdDirectPrivate(_,\"state\")===@streamReadable){var q=await p.read();if(q.done)break}try{p.releaseLock()}catch(f){}return p=@undefined,@Promise.@resolve(j.@promise)}catch(f){throw f}finally{_=@undefined,p=@undefined}})\n";
...
const char* const s_readableStreamDefaultReaderReadManyCode = "(function (){\"use strict\";if(!@isReadableStreamDefaultReader(this))@throwTypeError(\"ReadableStreamDefaultReader.readMany() should not be called directly\");const K=@getByIdDirectPrivate(this,\"ownerReadableStream\");if(!K)@throwTypeError(\"readMany() called on a reader owned by no readable stream\");const k=@getByIdDirectPrivate(K,\"state\");if(@putByIdDirectPrivate(K,\"disturbed\",!0),k===@streamClosed)return{value:[],size:0,done:!0};else if(k===@streamErrored)throw @getByIdDirectPrivate(K,\"storedError\");var x=@getByIdDirectPrivate(K,\"readableStreamController\"),C=@getByIdDirectPrivate(x,\"queue\");if(!C)return x.@pull(x).@then(function({done:S,value:T}){return S\?{done:!0,value:[],size:0}:{value:[T],size:1,done:!1}});const E=C.content;var _=C.size,A=E.toArray(!1),N=A.length;if(N>0){var D=@newArrayWithSize(N);if(@isReadableByteStreamController(x)){{const S=A[0];if(!(@ArrayBuffer.@isView(S)||S instanceof @ArrayBuffer))@putByValDirect(D,0,new @Uint8Array(S.buffer,S.byteOffset,S.byteLength));else @putByValDirect(D,0,S)}for(var F=1;F<N;F++){const S=A[F];if(!(@ArrayBuffer.@isView(S)||S instanceof @ArrayBuffer))@putByValDirect(D,F,new @Uint8Array(S.buffer,S.byteOffset,S.byteLength));else @putByValDirect(D,F,S)}}else{@putByValDirect(D,0,A[0].value);for(var F=1;F<N;F++)@putByValDirect(D,F,A[F].value)}if(@resetQueue(@getByIdDirectPrivate(x,\"queue\")),@getByIdDirectPrivate(x,\"closeRequested\"))@readableStreamClose(@getByIdDirectPrivate(x,\"controlledReadableStream\"));else if(@isReadableStreamDefaultController(x))@readableStreamDefaultControllerCallPullIfNeeded(x);else if(@isReadableByteStreamController(x))@readableByteStreamControllerCallPullIfNeeded(x);return{value:D,size:_,done:!1}}var H=(S)=>{if(S.done)return{value:[],size:0,done:!0};var T=@getByIdDirectPrivate(K,\"readableStreamController\"),U=@getByIdDirectPrivate(T,\"queue\"),W=[S.value].concat(U.content.toArray(!1)),j=W.length;if(@isReadableByteStreamController(T))for(var G=0;G<j;G++){const d=W[G];if(!(@ArrayBuffer.@isView(d)||d instanceof @ArrayBuffer)){const{buffer:I,byteOffset:B,byteLength:J}=d;@putByValDirect(W,G,new @Uint8Array(I,B,J))}}else for(var G=1;G<j;G++)@putByValDirect(W,G,W[G].value);var w=U.size;if(@resetQueue(U),@getByIdDirectPrivate(T,\"closeRequested\"))@readableStreamClose(@getByIdDirectPrivate(T,\"controlledReadableStream\"));else if(@isReadableStreamDefaultController(T))@readableStreamDefaultControllerCallPullIfNeeded(T);else if(@isReadableByteStreamController(T))@readableByteStreamControllerCallPullIfNeeded(T);return{value:W,size:w,done:!1}},Q=x.@pull(x);if(Q&&@isPromise(Q))return Q.@then(H);return H(Q)})\n";
...
const char* const s_streamInternalsCreateFIFOCode = "(function (){\"use strict\";var v=@Array.prototype.slice;class w{constructor(){this._head=0,this._tail=0,this._capacityMask=3,this._list=@newArrayWithSize(4)}_head;_tail;_capacityMask;_list;size(){if(this._head===this._tail)return 0;if(this._head<this._tail)return this._tail-this._head;else return this._capacityMask+1-(this._head-this._tail)}isEmpty(){return this.size()==0}isNotEmpty(){return this.size()>0}shift(){var{_head:b,_tail:x,_list:k,_capacityMask:z}=this;if(b===x)return @undefined;var A=k[b];if(@putByValDirect(k,b,@undefined),b=this._head=b+1&z,b<2&&x>1e4&&x<=k.length>>>2)this._shrinkArray();return A}peek(){if(this._head===this._tail)return @undefined;return this._list[this._head]}push(b){var x=this._tail;if(@putByValDirect(this._list,x,b),this._tail=x+1&this._capacityMask,this._tail===this._head)this._growArray()}toArray(b){var x=this._list,k=@toLength(x.length);if(b||this._head>this._tail){var z=@toLength(this._head),A=@toLength(this._tail),B=@toLength(k-z+A),E=@newArrayWithSize(B),g=0;for(var F=z;F<k;F++)@putByValDirect(E,g++,x[F]);for(var F=0;F<A;F++)@putByValDirect(E,g++,x[F]);return E}else return v.@call(x,this._head,this._tail)}clear(){this._head=0,this._tail=0,this._list.fill(@undefined)}_growArray(){if(this._head)this._list=this.toArray(!0),this._head=0;this._tail=@toLength(this._list.length),this._list.length<<=1,this._capacityMask=this._capacityMask<<1|1}shrinkArray(){this._list.length>>>=1,this._capacityMask>>>=1}}return new w})\n";
...
const char* const s_importMetaObjectLoadCJS2ESMCode = "(function (h){\"use strict\";var H=@Loader,_=@createFIFO(),I=h;while(I){var w=H.registry.@get(I);if(!w||!w.state||w.state<=@ModuleFetch)@fulfillModuleSync(I),w=H.registry.@get(I);var J=@getPromiseInternalField(w.fetch,@promiseFieldReactionsOrResult),x=H.parseModule(I,J),L=w.module;if(x&&@isPromise(x)){var Q=@getPromiseInternalField(x,@promiseFieldReactionsOrResult),z=@getPromiseInternalField(x,@promiseFieldFlags),T=z&@promiseStateMask;if(T===@promiseStatePending||Q&&@isPromise(Q))@throwTypeError(`require() async module \"${I}\" is unsupported`);else if(T===@promiseStateRejected){if(!Q\?.message)@throwTypeError(`${Q+\"\"\?Q:\"An error occurred\"} occurred while parsing module \\\"${I}\\\"`);throw Q}w.module=L=Q}else if(x&&!L)w.module=L=x;@setStateToMax(w,@ModuleLink);var U=L.dependenciesMap,V=H.requestedModules(L),W=@newArrayWithSize(V.length);for(var X=0,Y=V.length;X<Y;++X){var B=V[X],D=B[0]===\"/\"\?B:H.resolve(B,I),F=H.ensureRegistered(D);if(F.state<@ModuleLink)_.push(D);@putByValDirect(W,X,F),U.@set(B,F)}w.dependencies=W,w.instantiate=@Promise.resolve(w),w.satisfy=@Promise.resolve(w),I=_.shift();while(I&&(H.registry.@get(I)\?.state\?\?@ModuleFetch)>=@ModuleLink)I=_.shift()}var G=H.linkAndEvaluateModule(h,@undefined);if(G&&@isPromise(G))@throwTypeError(`require() async module \\\"${h}\\\" is unsupported`);return H.registry.@get(h)})\n";
...
const char* const s_importMetaObjectInternalRequireCode = "(function (n){\"use strict\";var F=@requireMap.@get(n);const M=n.substring(n.length-5);if(F)return F.exports;if(M===\".json\"){var _=globalThis[Symbol.for(\"_fs\")]||=@Bun.fs(),b=JSON.parse(_.readFileSync(n,\"utf8\"));return @requireMap.@set(n,@createCommonJSModule(n,b)),b}else if(M===\".node\"){const g=@createCommonJSModule(n,{});return process.dlopen(g,n),@requireMap.@set(n,g),g.exports}else if(M===\".toml\"){var _=globalThis[Symbol.for(\"_fs\")]||=@Bun.fs(),b=@Bun.TOML.parse(_.readFileSync(n,\"utf8\"));return @requireMap.@set(n,@createCommonJSModule(n,b)),b}else{var b=@requireESM(n);const j=@requireMap.@get(n);if(j)return j.exports;return @requireMap.@set(n,@createCommonJSModule(n,b)),b}})\n";
...
const char* const s_importMetaObjectCreateRequireCacheCode = "(function (){\"use strict\";class _{id;parent;filename;children=[];paths=[];constructor(d){this.id=d;const b=d.lastIndexOf(\"/\");if(b!==-1&&d.length>b+1)this.filename=d.substring(b+1);else this.filename=d}get loaded(){return!0}require(d){return @internalRequire(@resolveSync(d,this.id))}get exports(){return @requireMap.@get(this.id)\?\?{}}set exports(d){@requireMap.@set(this.id,d)}}var g=new Map,O={};return new Proxy(O,{get(d,b){const j=@requireMap.@get(b);if(j)return j;const q=@Loader.registry.@get(b);if(q&&q.evaluated){const w=@Loader.getModuleNamespaceObject(q.module),z=w[@commonJSSymbol]===0||w.default\?.[@commonJSSymbol]\?w.default:w,L=@createCommonJSModule(b,z);return @requireMap.@set(b,L),L}return O[b]},set(d,b,j){return @requireMap.@set(b,j),!0},has(d,b){return @requireMap.@has(b)||@Loader.registry.@has(b)},deleteProperty(d,b){return g.@delete(b),@requireMap.@delete(b),@Loader.registry.@delete(b),!0},ownKeys(d){var b=[...@requireMap.@keys()];const j=[...@Loader.registry.@keys()];for(let q of j)if(!b.includes(q))@arrayPush(b,q);return b},getPrototypeOf(d){return null},getOwnPropertyDescriptor(d,b){if(@requireMap.@has(b)||@Loader.registry.@has(b))return{configurable:!0,enumerable:!0}}})})\n";
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerPullCode = "(function (_){\"use strict\";const d=@getByIdDirectPrivate(_,\"controlledReadableStream\");if(@assert(@readableStreamHasDefaultReader(d)),@getByIdDirectPrivate(_,\"queue\").content\?.isNotEmpty()){const h=@getByIdDirectPrivate(_,\"queue\").content.shift();@getByIdDirectPrivate(_,\"queue\").size-=h.byteLength,@readableByteStreamControllerHandleQueueDrain(_);let P;try{P=new @Uint8Array(h.buffer,h.byteOffset,h.byteLength)}catch(R){return @Promise.@reject(R)}return @createFulfilledPromise({value:P,done:!1})}if(@getByIdDirectPrivate(_,\"autoAllocateChunkSize\")!==@undefined){let h;try{h=@createUninitializedArrayBuffer(@getByIdDirectPrivate(_,\"autoAllocateChunkSize\"))}catch(R){return @Promise.@reject(R)}const P={buffer:h,byteOffset:0,byteLength:@getByIdDirectPrivate(_,\"autoAllocateChunkSize\"),bytesFilled:0,elementSize:1,ctor:@Uint8Array,readerType:\"default\"};@getByIdDirectPrivate(_,\"pendingPullIntos\").push(P)}const F=@readableStreamAddReadRequest(d);return @readableByteStreamControllerCallPullIfNeeded(_),F})\n";
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerRespondInReadableStateCode = "(function (f,w,_){\"use strict\";if(_.bytesFilled+w>_.byteLength)@throwRangeError(\"bytesWritten value is too great\");if(@assert(@getByIdDirectPrivate(f,\"pendingPullIntos\").isEmpty()||@getByIdDirectPrivate(f,\"pendingPullIntos\").peek()===_),@readableByteStreamControllerInvalidateBYOBRequest(f),_.bytesFilled+=w,_.bytesFilled<_.elementSize)return;@readableByteStreamControllerShiftPendingDescriptor(f);const R=_.bytesFilled%_.elementSize;if(R>0){const h=_.byteOffset+_.bytesFilled,g=@cloneArrayBuffer(_.buffer,h-R,R);@readableByteStreamControllerEnqueueChunk(f,g,0,g.byteLength)}_.buffer=@transferBufferToCurrentRealm(_.buffer),_.bytesFilled-=R,@readableByteStreamControllerCommitDescriptor(@getByIdDirectPrivate(f,\"controlledReadableStream\"),_),@readableByteStreamControllerProcessPullDescriptors(f)})\n";
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerFillDescriptorFromQueueCode = "(function (q,_){\"use strict\";const j=_.bytesFilled-_.bytesFilled%_.elementSize,w=@getByIdDirectPrivate(q,\"queue\").size<_.byteLength-_.bytesFilled\?@getByIdDirectPrivate(q,\"queue\").size:_.byteLength-_.bytesFilled,k=_.bytesFilled+w,z=k-k%_.elementSize;let v=w,E=!1;if(z>j)v=z-_.bytesFilled,E=!0;while(v>0){let G=@getByIdDirectPrivate(q,\"queue\").content.peek();const H=v<G.byteLength\?v:G.byteLength,J=_.byteOffset+_.bytesFilled;if(new @Uint8Array(_.buffer).set(new @Uint8Array(G.buffer,G.byteOffset,H),J),G.byteLength===H)@getByIdDirectPrivate(q,\"queue\").content.shift();else G.byteOffset+=H,G.byteLength-=H;@getByIdDirectPrivate(q,\"queue\").size-=H,@assert(@getByIdDirectPrivate(q,\"pendingPullIntos\").isEmpty()||@getByIdDirectPrivate(q,\"pendingPullIntos\").peek()===_),@readableByteStreamControllerInvalidateBYOBRequest(q),_.bytesFilled+=H,v-=H}if(!E)@assert(@getByIdDirectPrivate(q,\"queue\").size===0),@assert(_.bytesFilled>0),@assert(_.bytesFilled<_.elementSize);return E})\n";
...
const char* const s_eventSourceGetEventSourceCode = "(function (){\"use strict\";class F extends EventTarget{#$;#j;#w;#A;#B;#F=!1;#G=null;#J=\"\";#K=\"\";#L=\"\";#M=!0;#O=0;#Q=0;#U=0;#V=null;static#W(L){L.#H()}static#X(L,j){const A=L.data,M=A.#L\?`Last-Event-ID: ${A.#L}\\r\\n`:\"\",K=`GET ${j.pathname}${j.search} HTTP/1.1\\r\\nHost: bun\\r\\nContent-type: text/event-stream\\r\\nContent-length: 0\\r\\n${M}\\r\\n`,O=L.write(K);if(O!==K.length)A.#K=K.substring(O)}static#Y(L,j,A){for(;;){if(A>=j.length)return;let M=-1,K=j.indexOf(\"\\r\\n\",A);const O=K+2;if(K>0)if(L.#O===0){const W=parseInt(j.substring(A,K),16);if(W===0){L.#j=2,L.#G\?.end();return}M=O+W}else M=j.length;else{if(L.#J.length===0){L.#J+=j.substring(A);return}M=j.length}let Q=j.substring(O,M);A=M+2;let U=0,V=Q.indexOf(\"\\n\\n\");if(V==-1){L.#J+=j.substring(O);return}if(L.#J.length)L.#J+=Q,Q=L.#J,L.#J=\"\";let G=!0;while(G){const W=Q.substring(U,V);let X,w=\"\",B,Y=0,J=-1;for(;;){let z=W.indexOf(\"\\n\",Y);if(z===-1){if(Y>=W.length)break;z=W.length}const H=W.substring(Y,z);if(H.startsWith(\"data:\"))if(w.length)w+=`\\n${H.substring(5).trim()}`;else w=H.substring(5).trim();else if(H.startsWith(\"event:\"))X=H.substring(6).trim();else if(H.startsWith(\"id:\"))B=H.substring(3).trim();else if(H.startsWith(\"retry:\")){if(J=parseInt(H.substring(6).trim(),10),@isNaN(J))J=-1}Y=z+1}if(L.#L=B||\"\",J>=0)L.#U=J;if(w||B||X)L.dispatchEvent(new MessageEvent(X||\"message\",{data:w||\"\",origin:L.#$.origin,source:L,lastEventId:B}));if(Q.length===V+2){G=!1;break}const Z=Q.indexOf(\"\\n\\n\",V+1);if(Z===-1)break;U=V,V=Z}}}static#Z={open(L){const j=L.data;if(j.#G=L,!j.#F)F.#X(L,j.#$)},handshake(L,j,A){const M=L.data;if(j)F.#X(L,M.#$);else M.#j=2,M.dispatchEvent(new ErrorEvent(\"error\",{error:A})),L.end()},data(L,j){const A=L.data;switch(A.#j){case 0:{let M=j.toString();const K=M.indexOf(\"\\r\\n\\r\\n\");if(K===-1){A.#J+=M;return}if(A.#J.length)A.#J+=M,M=A.#J,A.#J=\"\";const O=M.substring(0,K),Q=O.indexOf(\"\\r\\n\");if(Q===-1){A.#j=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Invalid HTTP request\")})),L.end();return}const U=O.substring(0,Q);if(U!==\"HTTP/1.1 200 OK\"){A.#j=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(U)})),L.end();return}let V=Q+1,G=!1,W=-1;for(;;){let w=O.indexOf(\"\\r\\n\",V);if(w===-1){if(V>=O.length){if(!G)A.#j=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's response has no MIME type and \"text/event-stream\" is required. Aborting the connection.`)})),L.end();return}w=O.length}const B=O.substring(V+1,w),Y=B.indexOf(\":\"),J=B.substring(0,Y),Z=J.localeCompare(\"content-type\",@undefined,{sensitivity:\"accent\"})===0;if(V=w+1,Z)if(B.endsWith(\" text/event-stream\"))G=!0;else{A.#j=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's response has a MIME type that is not \"text/event-stream\". Aborting the connection.`)})),L.end();return}else if(J.localeCompare(\"content-length\",@undefined,{sensitivity:\"accent\"})===0){if(W=parseInt(B.substring(Y+1).trim(),10),@isNaN(W)||W<=0){A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's Content-Length is invalid. Aborting the connection.`)})),L.end();return}if(G)break}else if(J.localeCompare(\"transfer-encoding\",@undefined,{sensitivity:\"accent\"})===0){if(B.substring(Y+1).trim()!==\"chunked\"){A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's Transfer-Encoding is invalid. Aborting the connection.`)})),L.end();return}if(W=0,G)break}}A.#O=W,A.#j=1,A.dispatchEvent(new Event(\"open\"));const X=M.substring(K+4);if(F.#Y(A,X,0),A.#O>0){if(A.#Q+=X.length,A.#Q>=A.#O)A.#j=2,L.end()}return}case 1:if(F.#Y(A,j.toString(),2),A.#O>0){if(A.#Q+=j.byteLength,A.#Q>=A.#O)A.#j=2,L.end()}return;default:break}},drain(L){const j=L.data;if(j.#j===0){const A=j.#J;if(A.length){const M=L.write(A);if(M!==A.length)L.data.#K=A.substring(M);else L.data.#K=\"\"}}},close:F.#z,end(L){F.#z(L).dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Connection closed by server\")}))},timeout(L){F.#z(L).dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Timeout\")}))},binaryType:\"buffer\"};static#z(L){const j=L.data;if(j.#G=null,j.#Q=0,j.#j=2,j.#M){if(j.#V)clearTimeout(j.#V);j.#V=setTimeout(F.#W,j.#U,j)}return j}constructor(L,j=@undefined){super();const A=new URL(L);this.#F=A.protocol===\"https:\",this.#$=A,this.#j=2,process.nextTick(F.#W,this)}ref(){this.#V\?.ref(),this.#G\?.ref()}unref(){this.#V\?.unref(),this.#G\?.unref()}#H(){if(this.#j!==2)return;const L=this.#$,j=this.#F;this.#j=0,@Bun.connect({data:this,socket:F.#Z,hostname:L.hostname,port:parseInt(L.port||(j\?\"443\":\"80\"),10),tls:j\?{requestCert:!0,rejectUnauthorized:!1}:!1}).catch((A)=>{if(super.dispatchEvent(new ErrorEvent(\"error\",{error:A})),this.#M){if(this.#V)this.#V.unref\?.();this.#V=setTimeout(F.#W,1000,this)}})}get url(){return this.#$.href}get readyState(){return this.#j}close(){this.#M=!1,this.#j=2,this.#G\?.unref(),this.#G\?.end()}get onopen(){return this.#B}get onerror(){return this.#w}get onmessage(){return this.#A}set onopen(L){if(this.#B)super.removeEventListener(\"close\",this.#B);super.addEventListener(\"open\",L),this.#B=L}set onerror(L){if(this.#w)super.removeEventListener(\"error\",this.#w);super.addEventListener(\"error\",L),this.#w=L}set onmessage(L){if(this.#A)super.removeEventListener(\"message\",this.#A);super.addEventListener(\"message\",L),this.#A=L}}return Object.defineProperty(F.prototype,\"CONNECTING\",{enumerable:!0,value:0}),Object.defineProperty(F.prototype,\"OPEN\",{enumerable:!0,value:1}),Object.defineProperty(F.prototype,\"CLOSED\",{enumerable:!0,value:2}),F[Symbol.for(\"CommonJS\")]=0,F})\n";
