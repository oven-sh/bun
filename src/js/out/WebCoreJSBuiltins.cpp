...
const char* const s_processObjectInternalsGetStdinStreamCode = "(function (Y,N,j){\"use strict\";var z={path:\"node:process\",require:N},L=(G)=>z.require(G),{Duplex:M,eos:P,destroy:Q}=L(\"node:stream\"),T=class G extends M{#Y;#$;#j;#z=!0;#G=!1;#H=!0;#I;#J;#K;get isTTY(){return L(\"tty\").isatty(Y)}get fd(){return Y}constructor(){super({readable:!0,writable:!0})}#L(U){const V=this.#J;if(this.#J=null,V)V(U);else if(U)this.destroy(U);else if(!this.#z&&!this.#H)this.destroy()}_destroy(U,V){if(!U&&this.#J!==null){var H=class J extends Error{constructor(K=\"The operation was aborted\",I=void 0){if(I!==void 0&&typeof I!==\"object\")throw new Error(`Invalid AbortError options:\\n\\n${JSON.stringify(I,null,2)}`);super(K,I);this.code=\"ABORT_ERR\",this.name=\"AbortError\"}};U=new H}if(this.#J===null)V(U);else if(this.#J=V,this.#j)Q(this.#j,U)}setRawMode(U){}on(U,V){if(U===\"readable\")this.ref(),this.#G=!0;return super.on(U,V)}pause(){return this.unref(),super.pause()}resume(){return this.ref(),super.resume()}ref(){this.#Y\?\?=j.stdin.stream().getReader(),this.#$\?\?=setInterval(()=>{},1<<30)}unref(){if(this.#$)clearInterval(this.#$),this.#$=null}async#M(){try{var U,V;const H=this.#Y.readMany();if(!H\?.then)({done:U,value:V}=H);else({done:U,value:V}=await H);if(!U){this.push(V[0]);const J=V.length;for(let K=1;K<J;K++)this.push(V[K])}else this.push(null),this.pause(),this.#z=!1,this.#L()}catch(H){this.#z=!1,this.#L(H)}}_read(U){if(this.#G)this.unref(),this.#G=!1;this.#M()}#N(){var{createWriteStream:U}=L(\"node:fs\"),V=this.#j=U(\"/dev/fd/0\");return V.on(\"finish\",()=>{if(this.#I){const H=this.#I;this.#I=null,H()}}),V.on(\"drain\",()=>{if(this.#K){const H=this.#K;this.#K=null,H()}}),P(V,(H)=>{if(this.#H=!1,H)Q(V,H);this.#L(H)}),V}_write(U,V,H){var J=this.#j;if(!J)J=this.#N();if(J.write(U,V))H();else this.#K=H}_final(U){this.#j.end(),this.#I=(...V)=>U(...V)}};return new T})\n";
...
const char* const s_moduleRequireCode = "(function (_){\"use strict\";const h=@requireMap.@get(_)||@requireMap.@get(_=@resolveSync(_,this.path,!1));if(h)return h.exports;if(_.endsWith(\".json\")||_.endsWith(\".toml\")||_.endsWith(\".node\"))return @internalRequire(_);let M=@Loader.registry.@get(_);if(M\?.evaluated){const q=M.module,r=@Loader.getModuleNamespaceObject(q),y=r\?.[@commonJSSymbol]===0||r\?.default\?.[@commonJSSymbol]===0\?r.default:r;return @requireMap.@set(_,@createCommonJSModule(_,y)),y}let l=this.@require(_);if(l===-1){const q=@createCommonJSModule(_,{});@requireMap.@set(_,q);try{l=@requireESM(_)}catch(r){throw @requireMap.@delete(_),r}if(M=@Loader.registry.@get(_),M\?.evaluated){const r=@Loader.getModuleNamespaceObject(M.module);return q.exports=r\?.[@commonJSSymbol]===0||r\?.default\?.[@commonJSSymbol]===0\?r.default:r}}const f=@requireMap.@get(_);if(f)return f.exports;return l})\n";
...
const char* const s_jsBufferPrototypeWriteIntLECode = "(function (d,c,r){\"use strict\";const j=this.@dataView||=new DataView(this.buffer,this.byteOffset,this.byteLength);switch(r){case 1:{j.setInt8(c,d);break}case 2:{j.setInt16(c,d,!0);break}case 3:{j.setUint16(c,d&65535,!0),j.setInt8(c+2,Math.floor(d*0.0000152587890625));break}case 4:{j.setInt32(c,d,!0);break}case 5:{j.setUint32(c,d|0,!0),j.setInt8(c+4,Math.floor(d*0.00000000023283064365386964));break}case 6:{j.setUint32(c,d|0,!0),j.setInt16(c+4,Math.floor(d*0.00000000023283064365386964),!0);break}default:@throwRangeError(\"byteLength must be >= 1 and <= 6\")}return c+r})\n";
...
const char* const s_jsBufferPrototypeBase64urlSliceCode = "(function (r,d){\"use strict\";return this.toString(r,d,\"base64url\")})\n";
...
const char* const s_readableStreamInternalsReadableStreamPipeToWritableStreamCode = "(function (D,I,E,T,x,G){\"use strict\";if(@assert(@isReadableStream(D)),@assert(@isWritableStream(I)),@assert(!@isReadableStreamLocked(D)),@assert(!@isWritableStreamLocked(I)),@assert(G===@undefined||@isAbortSignal(G)),@getByIdDirectPrivate(D,\"underlyingByteSource\")!==@undefined)return @Promise.@reject(\"Piping to a readable bytestream is not supported\");let J={source:D,destination:I,preventAbort:T,preventCancel:x,preventClose:E,signal:G};if(J.reader=@acquireReadableStreamDefaultReader(D),J.writer=@acquireWritableStreamDefaultWriter(I),@putByIdDirectPrivate(D,\"disturbed\",!0),J.finalized=!1,J.shuttingDown=!1,J.promiseCapability=@newPromiseCapability(@Promise),J.pendingReadPromiseCapability=@newPromiseCapability(@Promise),J.pendingReadPromiseCapability.@resolve.@call(),J.pendingWritePromise=@Promise.@resolve(),G!==@undefined){const K=(L)=>{if(J.finalized)return;@pipeToShutdownWithAction(J,()=>{const z=!J.preventAbort&&@getByIdDirectPrivate(J.destination,\"state\")===\"writable\"\?@writableStreamAbort(J.destination,L):@Promise.@resolve(),q=!J.preventCancel&&@getByIdDirectPrivate(J.source,\"state\")===@streamReadable\?@readableStreamCancel(J.source,L):@Promise.@resolve();let B=@newPromiseCapability(@Promise),F=!0,w=()=>{if(F){F=!1;return}B.@resolve.@call()},H=(f)=>{B.@reject.@call(@undefined,f)};return z.@then(w,H),q.@then(w,H),B.@promise},L)};if(@whenSignalAborted(G,K))return J.promiseCapability.@promise}return @pipeToErrorsMustBePropagatedForward(J),@pipeToErrorsMustBePropagatedBackward(J),@pipeToClosingMustBePropagatedForward(J),@pipeToClosingMustBePropagatedBackward(J),@pipeToLoop(J),J.promiseCapability.@promise})\n";
...
const char* const s_readableStreamInternalsReadDirectStreamCode = "(function (_,x,f){\"use strict\";@putByIdDirectPrivate(_,\"underlyingSource\",@undefined),@putByIdDirectPrivate(_,\"start\",@undefined);function j(z,A){if(A&&f\?.cancel){try{var B=f.cancel(A);@markPromiseAsHandled(B)}catch(q){}f=@undefined}if(z){if(@putByIdDirectPrivate(z,\"readableStreamController\",@undefined),@putByIdDirectPrivate(z,\"reader\",@undefined),A)@putByIdDirectPrivate(z,\"state\",@streamErrored),@putByIdDirectPrivate(z,\"storedError\",A);else @putByIdDirectPrivate(z,\"state\",@streamClosed);z=@undefined}}if(!f.pull){j();return}if(!@isCallable(f.pull)){j(),@throwTypeError(\"pull is not a function\");return}@putByIdDirectPrivate(_,\"readableStreamController\",x);const v=@getByIdDirectPrivate(_,\"highWaterMark\");x.start({highWaterMark:!v||v<64\?64:v}),@startDirectStream.@call(x,_,f.pull,j),@putByIdDirectPrivate(_,\"reader\",{});var w=f.pull(x);if(x=@undefined,w&&@isPromise(w))return w.@then(()=>{})})\n";
...
const char* const s_readableStreamInternalsReadStreamIntoSinkCode = "(async function (c,E,x){\"use strict\";var f=!1,z=!1;try{var F=c.getReader(),H=F.readMany();if(H&&@isPromise(H))H=await H;if(H.done)return f=!0,E.end();var J=H.value.length;const q=@getByIdDirectPrivate(c,\"highWaterMark\");if(x)@startDirectStream.@call(E,c,@undefined,()=>!z&&@markPromiseAsHandled(c.cancel()));E.start({highWaterMark:q||0});for(var K=0,I=H.value,A=H.value.length;K<A;K++)E.write(I[K]);var _=@getByIdDirectPrivate(c,\"state\");if(_===@streamClosed)return f=!0,E.end();while(!0){var{value:P,done:B}=await F.read();if(B)return f=!0,E.end();E.write(P)}}catch(q){z=!0;try{F=@undefined;const G=c.cancel(q);@markPromiseAsHandled(G)}catch(G){}if(E&&!f){f=!0;try{E.close(q)}catch(G){throw new globalThis.AggregateError([q,G])}}throw q}finally{if(F){try{F.releaseLock()}catch(G){}F=@undefined}E=@undefined;var _=@getByIdDirectPrivate(c,\"state\");if(c){var D=@getByIdDirectPrivate(c,\"readableStreamController\");if(D){if(@getByIdDirectPrivate(D,\"underlyingSource\"))@putByIdDirectPrivate(D,\"underlyingSource\",@undefined);if(@getByIdDirectPrivate(D,\"controlledReadableStream\"))@putByIdDirectPrivate(D,\"controlledReadableStream\",@undefined);if(@putByIdDirectPrivate(c,\"readableStreamController\",null),@getByIdDirectPrivate(c,\"underlyingSource\"))@putByIdDirectPrivate(c,\"underlyingSource\",@undefined);D=@undefined}if(!z&&_!==@streamClosed&&_!==@streamErrored)@readableStreamClose(c);c=@undefined}}})\n";
...
const char* const s_readableStreamInternalsOnCloseDirectStreamCode = "(function (c){\"use strict\";var y=this.@controlledReadableStream;if(!y||@getByIdDirectPrivate(y,\"state\")!==@streamReadable)return;if(this._deferClose!==0){this._deferClose=1,this._deferCloseReason=c;return}if(@putByIdDirectPrivate(y,\"state\",@streamClosing),typeof this.@underlyingSource.close===\"function\")try{this.@underlyingSource.close.@call(this.@underlyingSource,c)}catch(j){}var v;try{v=this.@sink.end(),@putByIdDirectPrivate(this,\"sink\",@undefined)}catch(j){if(this._pendingRead){var B=this._pendingRead;this._pendingRead=@undefined,@rejectPromise(B,j)}@readableStreamError(y,j);return}this.error=this.flush=this.write=this.close=this.end=@onReadableStreamDirectControllerClosed;var C=@getByIdDirectPrivate(y,\"reader\");if(C&&@isReadableStreamDefaultReader(C)){var b=this._pendingRead;if(b&&@isPromise(b)&&v\?.byteLength){this._pendingRead=@undefined,@fulfillPromise(b,{value:v,done:!1}),@readableStreamClose(y);return}}if(v\?.byteLength){var S=@getByIdDirectPrivate(C,\"readRequests\");if(S\?.isNotEmpty()){@readableStreamFulfillReadRequest(y,v,!1),@readableStreamClose(y);return}@putByIdDirectPrivate(y,\"state\",@streamReadable),this.@pull=()=>{var j=@createFulfilledPromise({value:v,done:!1});return v=@undefined,@readableStreamClose(y),y=@undefined,j}}else if(this._pendingRead){var B=this._pendingRead;this._pendingRead=@undefined,@putByIdDirectPrivate(this,\"pull\",@noopDoneFunction),@fulfillPromise(B,{value:@undefined,done:!0})}@readableStreamClose(y)})\n";
...
const char* const s_readableStreamInternalsCreateTextStreamCode = "(function (_){\"use strict\";var q,w=[],x=!1,j=!1,z=\"\",v=@toLength(0),A=@newPromiseCapability(@Promise),C=!1;return q={start(){},write(E){if(typeof E===\"string\"){var F=@toLength(E.length);if(F>0)z+=E,x=!0,v+=F;return F}if(!E||!(@ArrayBuffer.@isView(E)||E instanceof @ArrayBuffer))@throwTypeError(\"Expected text, ArrayBuffer or ArrayBufferView\");const G=@toLength(E.byteLength);if(G>0)if(j=!0,z.length>0)@arrayPush(w,z,E),z=\"\";else @arrayPush(w,E);return v+=G,G},flush(){return 0},end(){if(C)return\"\";return q.fulfill()},fulfill(){C=!0;const E=q.finishInternal();return @fulfillPromise(A.@promise,E),E},finishInternal(){if(!x&&!j)return\"\";if(x&&!j)return z;if(j&&!x)return new globalThis.TextDecoder().decode(@Bun.concatArrayBuffers(w));var E=new @Bun.ArrayBufferSink;E.start({highWaterMark:v,asUint8Array:!0});for(let F of w)E.write(F);if(w.length=0,z.length>0)E.write(z),z=\"\";return new globalThis.TextDecoder().decode(E.end())},close(){try{if(!C)C=!0,q.fulfill()}catch(E){}}},[q,A]})\n";
...
const char* const s_readableStreamInternalsInitializeTextStreamCode = "(function (_,p){\"use strict\";var[b,m]=@createTextStream(p),f={@underlyingSource:_,@pull:@onPullDirectStream,@controlledReadableStream:this,@sink:b,close:@onCloseDirectStream,write:b.write,error:@handleDirectStreamError,end:@onCloseDirectStream,@close:@onCloseDirectStream,flush:@onFlushDirectStream,_pendingRead:@undefined,_deferClose:0,_deferFlush:0,_deferCloseReason:@undefined,_handleError:@undefined};return @putByIdDirectPrivate(this,\"readableStreamController\",f),@putByIdDirectPrivate(this,\"underlyingSource\",@undefined),@putByIdDirectPrivate(this,\"start\",@undefined),m})\n";
...
const char* const s_readableStreamInternalsInitializeArrayBufferStreamCode = "(function (m,w){\"use strict\";var b=w&&typeof w===\"number\"\?{highWaterMark:w,stream:!0,asUint8Array:!0}:{stream:!0,asUint8Array:!0},_=new @Bun.ArrayBufferSink;_.start(b);var D={@underlyingSource:m,@pull:@onPullDirectStream,@controlledReadableStream:this,@sink:_,close:@onCloseDirectStream,write:_.write.bind(_),error:@handleDirectStreamError,end:@onCloseDirectStream,@close:@onCloseDirectStream,flush:@onFlushDirectStream,_pendingRead:@undefined,_deferClose:0,_deferFlush:0,_deferCloseReason:@undefined,_handleError:@undefined};@putByIdDirectPrivate(this,\"readableStreamController\",D),@putByIdDirectPrivate(this,\"underlyingSource\",@undefined),@putByIdDirectPrivate(this,\"start\",@undefined)})\n";
...
const char* const s_readableStreamInternalsReadableStreamDefaultControllerEnqueueCode = "(function (_,E){\"use strict\";const d=@getByIdDirectPrivate(_,\"controlledReadableStream\");if(@assert(@readableStreamDefaultControllerCanCloseOrEnqueue(_)),@isReadableStreamLocked(d)&&@getByIdDirectPrivate(@getByIdDirectPrivate(d,\"reader\"),\"readRequests\")\?.isNotEmpty()){@readableStreamFulfillReadRequest(d,E,!1),@readableStreamDefaultControllerCallPullIfNeeded(_);return}try{let D=1;if(@getByIdDirectPrivate(_,\"strategy\").size!==@undefined)D=@getByIdDirectPrivate(_,\"strategy\").size(E);@enqueueValueWithSize(@getByIdDirectPrivate(_,\"queue\"),E,D)}catch(D){throw @readableStreamDefaultControllerError(_,D),D}@readableStreamDefaultControllerCallPullIfNeeded(_)})\n";
...
const char* const s_readableStreamInternalsLazyLoadStreamCode = "(function (Q,G){\"use strict\";var K=@getByIdDirectPrivate(Q,\"bunNativeType\"),H=@getByIdDirectPrivate(Q,\"bunNativePtr\"),I=@lazyStreamPrototypeMap.@get(K);if(I===@undefined){let j=function(D){var{c:p,v:z}=this;this.c=@undefined,this.v=@undefined,Y(D,p,z)},P=function(D){try{D.close()}catch(p){globalThis.reportError(p)}},J=function(D,p,z,A){A[0]=!1;var E;try{E=b(D,z,A)}catch(F){return p.error(F)}return Y(E,p,z)};var f=j,O=P,m=J,[b,q,U,x,L,N,W]=@lazyLoad(K),X=[!1],Y;Y=function D(p,z,A){if(p&&@isPromise(p))return p.then(j.bind({c:z,v:A}),(E)=>z.error(E));else if(typeof p===\"number\")if(A&&A.byteLength===p&&A.buffer===z.byobRequest\?.view\?.buffer)z.byobRequest.respondWithNewView(A);else z.byobRequest.respond(p);else if(p.constructor===@Uint8Array)z.enqueue(p);if(X[0]||p===!1)@enqueueJob(P,z),X[0]=!1};const B=L\?new FinalizationRegistry(L):null;I=class D{constructor(p,z,A){if(this.#f=p,this.#b={},this.pull=this.#j.bind(this),this.cancel=this.#m.bind(this),this.autoAllocateChunkSize=z,A!==@undefined)this.start=(E)=>{E.enqueue(A)};if(B)B.register(this,p,this.#b)}#b;pull;cancel;start;#f;type=\"bytes\";autoAllocateChunkSize=0;static startSync=q;#j(p){var z=this.#f;if(!z){p.close();return}J(z,p,p.byobRequest.view,X)}#m(p){var z=this.#f;B&&B.unregister(this.#b),N&&N(z,!1),U(z,p)}static deinit=L;static drain=W},@lazyStreamPrototypeMap.@set(K,I)}const Z=I.startSync(H,G);var _;const{drain:y,deinit:M}=I;if(y)_=y(H);if(Z===0){if(L&&H&&@enqueueJob(L,H),(_\?.byteLength\?\?0)>0)return{start(j){j.enqueue(_),j.close()},type:\"bytes\"};return{start(j){j.close()},type:\"bytes\"}}return new I(H,Z,_)})\n";
...
const char* const s_readableStreamInternalsReadableStreamIntoArrayCode = "(function (f){\"use strict\";var b=f.getReader(),g=b.readMany();async function j(q){if(q.done)return[];var p=q.value||[];while(!0){var _=await b.read();if(_.done)break;p=p.concat(_.value)}return p}if(g&&@isPromise(g))return g.@then(j);return j(g)})\n";
...
const char* const s_readableStreamInternalsReadableStreamToArrayBufferDirectCode = "(function (_,j){\"use strict\";var v=new @Bun.ArrayBufferSink;@putByIdDirectPrivate(_,\"underlyingSource\",@undefined);var w=@getByIdDirectPrivate(_,\"highWaterMark\");v.start(w\?{highWaterMark:w}:{});var x=@newPromiseCapability(@Promise),z=!1,A=j.pull,B=j.close,C={start(){},close(F){if(!z){if(z=!0,B)B();@fulfillPromise(x.@promise,v.end())}},end(){if(!z){if(z=!0,B)B();@fulfillPromise(x.@promise,v.end())}},flush(){return 0},write:v.write.bind(v)},D=!1;try{const F=A(C);if(F&&@isObject(F)&&@isPromise(F))return async function(G,O,q){while(!z)await q(G);return await O}(C,promise,A);return x.@promise}catch(F){return D=!0,@readableStreamError(_,F),@Promise.@reject(F)}finally{if(!D&&_)@readableStreamClose(_);C=B=v=A=_=@undefined}})\n";
...
const char* const s_readableStreamDefaultReaderReadManyCode = "(function (){\"use strict\";if(!@isReadableStreamDefaultReader(this))@throwTypeError(\"ReadableStreamDefaultReader.readMany() should not be called directly\");const H=@getByIdDirectPrivate(this,\"ownerReadableStream\");if(!H)@throwTypeError(\"readMany() called on a reader owned by no readable stream\");const k=@getByIdDirectPrivate(H,\"state\");if(@putByIdDirectPrivate(H,\"disturbed\",!0),k===@streamClosed)return{value:[],size:0,done:!0};else if(k===@streamErrored)throw @getByIdDirectPrivate(H,\"storedError\");var x=@getByIdDirectPrivate(H,\"readableStreamController\"),C=@getByIdDirectPrivate(x,\"queue\");if(!C)return x.@pull(x).@then(function({done:K,value:N}){return K\?{done:!0,value:[],size:0}:{value:[N],size:1,done:!1}});const E=C.content;var _=C.size,w=E.toArray(!1),I=w.length;if(I>0){var A=@newArrayWithSize(I);if(@isReadableByteStreamController(x)){{const K=w[0];if(!(@ArrayBuffer.@isView(K)||K instanceof @ArrayBuffer))@putByValDirect(A,0,new @Uint8Array(K.buffer,K.byteOffset,K.byteLength));else @putByValDirect(A,0,K)}for(var F=1;F<I;F++){const K=w[F];if(!(@ArrayBuffer.@isView(K)||K instanceof @ArrayBuffer))@putByValDirect(A,F,new @Uint8Array(K.buffer,K.byteOffset,K.byteLength));else @putByValDirect(A,F,K)}}else{@putByValDirect(A,0,w[0].value);for(var F=1;F<I;F++)@putByValDirect(A,F,w[F].value)}if(@resetQueue(@getByIdDirectPrivate(x,\"queue\")),@getByIdDirectPrivate(x,\"closeRequested\"))@readableStreamClose(@getByIdDirectPrivate(x,\"controlledReadableStream\"));else if(@isReadableStreamDefaultController(x))@readableStreamDefaultControllerCallPullIfNeeded(x);else if(@isReadableByteStreamController(x))@readableByteStreamControllerCallPullIfNeeded(x);return{value:A,size:_,done:!1}}var G=(K)=>{if(K.done)return{value:[],size:0,done:!0};var N=@getByIdDirectPrivate(H,\"readableStreamController\"),Q=@getByIdDirectPrivate(N,\"queue\"),S=[K.value].concat(Q.content.toArray(!1)),T=S.length;if(@isReadableByteStreamController(N))for(var d=0;d<T;d++){const U=S[d];if(!(@ArrayBuffer.@isView(U)||U instanceof @ArrayBuffer)){const{buffer:W,byteOffset:B,byteLength:j}=U;@putByValDirect(S,d,new @Uint8Array(W,B,j))}}else for(var d=1;d<T;d++)@putByValDirect(S,d,S[d].value);var D=Q.size;if(@resetQueue(Q),@getByIdDirectPrivate(N,\"closeRequested\"))@readableStreamClose(@getByIdDirectPrivate(N,\"controlledReadableStream\"));else if(@isReadableStreamDefaultController(N))@readableStreamDefaultControllerCallPullIfNeeded(N);else if(@isReadableByteStreamController(N))@readableByteStreamControllerCallPullIfNeeded(N);return{value:S,size:D,done:!1}},J=x.@pull(x);if(J&&@isPromise(J))return J.@then(G);return G(J)})\n";
...
const char* const s_streamInternalsCreateFIFOCode = "(function (){\"use strict\";var v=@Array.prototype.slice;class x{constructor(){this._head=0,this._tail=0,this._capacityMask=3,this._list=@newArrayWithSize(4)}_head;_tail;_capacityMask;_list;size(){if(this._head===this._tail)return 0;if(this._head<this._tail)return this._tail-this._head;else return this._capacityMask+1-(this._head-this._tail)}isEmpty(){return this.size()==0}isNotEmpty(){return this.size()>0}shift(){var{_head:w,_tail:z,_list:g,_capacityMask:A}=this;if(w===z)return @undefined;var k=g[w];if(@putByValDirect(g,w,@undefined),w=this._head=w+1&A,w<2&&z>1e4&&z<=g.length>>>2)this._shrinkArray();return k}peek(){if(this._head===this._tail)return @undefined;return this._list[this._head]}push(w){var z=this._tail;if(@putByValDirect(this._list,z,w),this._tail=z+1&this._capacityMask,this._tail===this._head)this._growArray()}toArray(w){var z=this._list,g=@toLength(z.length);if(w||this._head>this._tail){var A=@toLength(this._head),k=@toLength(this._tail),B=@toLength(g-A+k),E=@newArrayWithSize(B),F=0;for(var G=A;G<g;G++)@putByValDirect(E,F++,z[G]);for(var G=0;G<k;G++)@putByValDirect(E,F++,z[G]);return E}else return v.@call(z,this._head,this._tail)}clear(){this._head=0,this._tail=0,this._list.fill(@undefined)}_growArray(){if(this._head)this._list=this.toArray(!0),this._head=0;this._tail=@toLength(this._list.length),this._list.length<<=1,this._capacityMask=this._capacityMask<<1|1}shrinkArray(){this._list.length>>>=1,this._capacityMask>>>=1}}return new x})\n";
...
const int s_importMetaObjectLoadCJS2ESMCodeLength = 1395;
static const JSC::Intrinsic s_importMetaObjectLoadCJS2ESMCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_importMetaObjectLoadCJS2ESMCode = "(function (_){\"use strict\";var V=@Loader,T=@createFIFO(),h=_;while(h){var w=V.registry.@get(h);if(!w||!w.state||w.state<=@ModuleFetch)@fulfillModuleSync(h),w=V.registry.@get(h);var U=@getPromiseInternalField(w.fetch,@promiseFieldReactionsOrResult),x=V.parseModule(h,U),W=w.module;if(x&&@isPromise(x)){var z=@getPromiseInternalField(x,@promiseFieldReactionsOrResult),B=@getPromiseInternalField(x,@promiseFieldFlags),D=B&@promiseStateMask;if(D===@promiseStatePending||z&&@isPromise(z))@throwTypeError(`require() async module \"${h}\" is unsupported. use \"await import()\" instead.`);else if(D===@promiseStateRejected){if(!z\?.message)@throwTypeError(`${z+\"\"\?z:\"An error occurred\"} occurred while parsing module \\\"${h}\\\"`);throw z}w.module=W=z}else if(x&&!W)w.module=W=x;@setStateToMax(w,@ModuleLink);var X=W.dependenciesMap,F=V.requestedModules(W),L=@newArrayWithSize(F.length);for(var G=0,H=F.length;G<H;++G){var I=F[G],Y=I[0]===\"/\"\?I:V.resolve(I,h),J=V.ensureRegistered(Y);if(J.state<@ModuleLink)T.push(Y);@putByValDirect(L,G,J),X.@set(I,J)}w.dependencies=L,w.instantiate=@Promise.resolve(w),w.satisfy=@Promise.resolve(w),h=T.shift();while(h&&(V.registry.@get(h)\?.state\?\?@ModuleFetch)>=@ModuleLink)h=T.shift()}var Q=V.linkAndEvaluateModule(_,@undefined);if(Q&&@isPromise(Q))@throwTypeError(`require() async module \\\"${_}\\\" is unsupported. use \"await import()\" instead.`);return V.registry.@get(_)})\n";
...
const int s_importMetaObjectInternalRequireCodeLength = 735;
static const JSC::Intrinsic s_importMetaObjectInternalRequireCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_importMetaObjectInternalRequireCode = "(function (_){\"use strict\";var M=@requireMap.@get(_);const F=_.substring(_.length-5);if(M)return M.exports;if(F===\".json\"){var b=globalThis[Symbol.for(\"_fs\")]||=@Bun.fs(),g=JSON.parse(b.readFileSync(_,\"utf8\"));return @requireMap.@set(_,@createCommonJSModule(_,g)),g}else if(F===\".node\"){const n=@createCommonJSModule(_,{});return process.dlopen(n,_),@requireMap.@set(_,n),n.exports}else if(F===\".toml\"){var b=globalThis[Symbol.for(\"_fs\")]||=@Bun.fs(),g=@Bun.TOML.parse(b.readFileSync(_,\"utf8\"));return @requireMap.@set(_,@createCommonJSModule(_,g)),g}else{var g=@requireESM(_);const J=@requireMap.@get(_);if(J)return J.exports;if(g\?.default\?.[@commonJSSymbol]===0)g=g.default;return @requireMap.@set(_,@createCommonJSModule(_,g)),g}})\n";
...
const int s_importMetaObjectCreateRequireCacheCodeLength = 853;
static const JSC::Intrinsic s_importMetaObjectCreateRequireCacheCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_importMetaObjectCreateRequireCacheCode = "(function (){\"use strict\";var _=new Map,t={};return new Proxy(t,{get(c,f){const h=@requireMap.@get(f);if(h)return h;const u=@Loader.registry.@get(f);if(u&&u.evaluated){const L=@Loader.getModuleNamespaceObject(u.module),b=L[@commonJSSymbol]===0||L.default\?.[@commonJSSymbol]\?L.default:L,g=@createCommonJSModule(f,b);return @requireMap.@set(f,g),g}return t[f]},set(c,f,h){return @requireMap.@set(f,h),!0},has(c,f){return @requireMap.@has(f)||@Loader.registry.@has(f)},deleteProperty(c,f){return _.@delete(f),@requireMap.@delete(f),@Loader.registry.@delete(f),!0},ownKeys(c){var f=[...@requireMap.@keys()];const h=[...@Loader.registry.@keys()];for(let u of h)if(!f.includes(u))@arrayPush(f,u);return f},getPrototypeOf(c){return null},getOwnPropertyDescriptor(c,f){if(@requireMap.@has(f)||@Loader.registry.@has(f))return{configurable:!0,enumerable:!0}}})})\n";
...
const char* const s_readableStreamPipeThroughCode = "(function (_,c){\"use strict\";const j=_,k=j[\"readable\"];if(!@isReadableStream(k))throw @makeTypeError(\"readable should be ReadableStream\");const d=j[\"writable\"],q=@getInternalWritableStream(d);if(!@isWritableStream(q))throw @makeTypeError(\"writable should be WritableStream\");let x=!1,y=!1,u=!1,h;if(!@isUndefinedOrNull(c)){if(!@isObject(c))throw @makeTypeError(\"options must be an object\");if(y=!!c[\"preventAbort\"],u=!!c[\"preventCancel\"],x=!!c[\"preventClose\"],h=c[\"signal\"],h!==@undefined&&!@isAbortSignal(h))throw @makeTypeError(\"options.signal must be AbortSignal\")}if(!@isReadableStream(this))throw @makeThisTypeError(\"ReadableStream\",\"pipeThrough\");if(@isReadableStreamLocked(this))throw @makeTypeError(\"ReadableStream is locked\");if(@isWritableStreamLocked(q))throw @makeTypeError(\"WritableStream is locked\");return @readableStreamPipeToWritableStream(this,q,x,y,u,h),k})\n";
...
const char* const s_readableStreamPipeToCode = "(function (m){\"use strict\";if(!@isReadableStream(this))return @Promise.@reject(@makeThisTypeError(\"ReadableStream\",\"pipeTo\"));if(@isReadableStreamLocked(this))return @Promise.@reject(@makeTypeError(\"ReadableStream is locked\"));let u=@argument(1),_=!1,j=!1,R=!1,E;if(!@isUndefinedOrNull(u)){if(!@isObject(u))return @Promise.@reject(@makeTypeError(\"options must be an object\"));try{j=!!u[\"preventAbort\"],R=!!u[\"preventCancel\"],_=!!u[\"preventClose\"],E=u[\"signal\"]}catch(b){return @Promise.@reject(b)}if(E!==@undefined&&!@isAbortSignal(E))return @Promise.@reject(@makeTypeError(\"options.signal must be AbortSignal\"))}const S=@getInternalWritableStream(m);if(!@isWritableStream(S))return @Promise.@reject(@makeTypeError(\"ReadableStream pipeTo requires a WritableStream\"));if(@isWritableStreamLocked(S))return @Promise.@reject(@makeTypeError(\"WritableStream is locked\"));return @readableStreamPipeToWritableStream(this,S,_,j,R,E)})\n";
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerRespondInReadableStateCode = "(function (f,g,_){\"use strict\";if(_.bytesFilled+g>_.byteLength)@throwRangeError(\"bytesWritten value is too great\");if(@assert(@getByIdDirectPrivate(f,\"pendingPullIntos\").isEmpty()||@getByIdDirectPrivate(f,\"pendingPullIntos\").peek()===_),@readableByteStreamControllerInvalidateBYOBRequest(f),_.bytesFilled+=g,_.bytesFilled<_.elementSize)return;@readableByteStreamControllerShiftPendingDescriptor(f);const w=_.bytesFilled%_.elementSize;if(w>0){const R=_.byteOffset+_.bytesFilled,h=@cloneArrayBuffer(_.buffer,R-w,w);@readableByteStreamControllerEnqueueChunk(f,h,0,h.byteLength)}_.buffer=@transferBufferToCurrentRealm(_.buffer),_.bytesFilled-=w,@readableByteStreamControllerCommitDescriptor(@getByIdDirectPrivate(f,\"controlledReadableStream\"),_),@readableByteStreamControllerProcessPullDescriptors(f)})\n";
...
const char* const s_eventSourceGetEventSourceCode = "(function (){\"use strict\";class j extends EventTarget{#A;#V;#W;#X;#Y;#B=!1;#Z=null;#F=\"\";#L=\"\";#U=\"\";#M=!0;#$=0;#G=0;#O=0;#z=null;static#w(X){X.#K()}static#J(X,w){const Y=X.data,A=Y.#U\?`Last-Event-ID: ${Y.#U}\\r\\n`:\"\",B=`GET ${w.pathname}${w.search} HTTP/1.1\\r\\nHost: bun\\r\\nContent-type: text/event-stream\\r\\nContent-length: 0\\r\\n${A}\\r\\n`,F=X.write(B);if(F!==B.length)Y.#L=B.substring(F)}static#Q(X,w,Y){for(;;){if(Y>=w.length)return;let A=-1,B=w.indexOf(\"\\r\\n\",Y);const F=B+2;if(B>0)if(X.#$===0){const V=parseInt(w.substring(Y,B),16);if(V===0){X.#V=2,X.#Z\?.end();return}A=F+V}else A=w.length;else{if(X.#F.length===0){X.#F+=w.substring(Y);return}A=w.length}let G=w.substring(F,A);Y=A+2;let J=0,W=G.indexOf(\"\\n\\n\");if(W==-1){X.#F+=w.substring(F);return}if(X.#F.length)X.#F+=G,G=X.#F,X.#F=\"\";let K=!0;while(K){const V=G.substring(J,W);let L,M=\"\",O,Z=0,Q=-1;for(;;){let U=V.indexOf(\"\\n\",Z);if(U===-1){if(Z>=V.length)break;U=V.length}const H=V.substring(Z,U);if(H.startsWith(\"data:\"))if(M.length)M+=`\\n${H.substring(5).trim()}`;else M=H.substring(5).trim();else if(H.startsWith(\"event:\"))L=H.substring(6).trim();else if(H.startsWith(\"id:\"))O=H.substring(3).trim();else if(H.startsWith(\"retry:\")){if(Q=parseInt(H.substring(6).trim(),10),@isNaN(Q))Q=-1}Z=U+1}if(X.#U=O||\"\",Q>=0)X.#O=Q;if(M||O||L)X.dispatchEvent(new MessageEvent(L||\"message\",{data:M||\"\",origin:X.#A.origin,source:X,lastEventId:O}));if(G.length===W+2){K=!1;break}const z=G.indexOf(\"\\n\\n\",W+1);if(z===-1)break;J=W,W=z}}}static#H={open(X){const w=X.data;if(w.#Z=X,!w.#B)j.#J(X,w.#A)},handshake(X,w,Y){const A=X.data;if(w)j.#J(X,A.#A);else A.#V=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:Y})),X.end()},data(X,w){const Y=X.data;switch(Y.#V){case 0:{let A=w.toString();const B=A.indexOf(\"\\r\\n\\r\\n\");if(B===-1){Y.#F+=A;return}if(Y.#F.length)Y.#F+=A,A=Y.#F,Y.#F=\"\";const F=A.substring(0,B),G=F.indexOf(\"\\r\\n\");if(G===-1){Y.#V=2,Y.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Invalid HTTP request\")})),X.end();return}const J=F.substring(0,G);if(J!==\"HTTP/1.1 200 OK\"){Y.#V=2,Y.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(J)})),X.end();return}let W=G+1,K=!1,V=-1;for(;;){let M=F.indexOf(\"\\r\\n\",W);if(M===-1){if(W>=F.length){if(!K)Y.#V=2,Y.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's response has no MIME type and \"text/event-stream\" is required. Aborting the connection.`)})),X.end();return}M=F.length}const O=F.substring(W+1,M),Z=O.indexOf(\":\"),Q=O.substring(0,Z),z=Q.localeCompare(\"content-type\",@undefined,{sensitivity:\"accent\"})===0;if(W=M+1,z)if(O.endsWith(\" text/event-stream\"))K=!0;else{Y.#V=2,Y.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's response has a MIME type that is not \"text/event-stream\". Aborting the connection.`)})),X.end();return}else if(Q.localeCompare(\"content-length\",@undefined,{sensitivity:\"accent\"})===0){if(V=parseInt(O.substring(Z+1).trim(),10),@isNaN(V)||V<=0){Y.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's Content-Length is invalid. Aborting the connection.`)})),X.end();return}if(K)break}else if(Q.localeCompare(\"transfer-encoding\",@undefined,{sensitivity:\"accent\"})===0){if(O.substring(Z+1).trim()!==\"chunked\"){Y.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's Transfer-Encoding is invalid. Aborting the connection.`)})),X.end();return}if(V=0,K)break}}Y.#$=V,Y.#V=1,Y.dispatchEvent(new Event(\"open\"));const L=A.substring(B+4);if(j.#Q(Y,L,0),Y.#$>0){if(Y.#G+=L.length,Y.#G>=Y.#$)Y.#V=2,X.end()}return}case 1:if(j.#Q(Y,w.toString(),2),Y.#$>0){if(Y.#G+=w.byteLength,Y.#G>=Y.#$)Y.#V=2,X.end()}return;default:break}},drain(X){const w=X.data;if(w.#V===0){const Y=w.#F;if(Y.length){const A=X.write(Y);if(A!==Y.length)X.data.#L=Y.substring(A);else X.data.#L=\"\"}}},close:j.#j,end(X){j.#j(X).dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Connection closed by server\")}))},timeout(X){j.#j(X).dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Timeout\")}))},binaryType:\"buffer\"};static#j(X){const w=X.data;if(w.#Z=null,w.#G=0,w.#V=2,w.#M){if(w.#z)clearTimeout(w.#z);w.#z=setTimeout(j.#w,w.#O,w)}return w}constructor(X,w=@undefined){super();const Y=new URL(X);this.#B=Y.protocol===\"https:\",this.#A=Y,this.#V=2,process.nextTick(j.#w,this)}ref(){this.#z\?.ref(),this.#Z\?.ref()}unref(){this.#z\?.unref(),this.#Z\?.unref()}#K(){if(this.#V!==2)return;const X=this.#A,w=this.#B;this.#V=0,@Bun.connect({data:this,socket:j.#H,hostname:X.hostname,port:parseInt(X.port||(w\?\"443\":\"80\"),10),tls:w\?{requestCert:!0,rejectUnauthorized:!1}:!1}).catch((Y)=>{if(super.dispatchEvent(new ErrorEvent(\"error\",{error:Y})),this.#M){if(this.#z)this.#z.unref\?.();this.#z=setTimeout(j.#w,1000,this)}})}get url(){return this.#A.href}get readyState(){return this.#V}close(){this.#M=!1,this.#V=2,this.#Z\?.unref(),this.#Z\?.end()}get onopen(){return this.#Y}get onerror(){return this.#W}get onmessage(){return this.#X}set onopen(X){if(this.#Y)super.removeEventListener(\"close\",this.#Y);super.addEventListener(\"open\",X),this.#Y=X}set onerror(X){if(this.#W)super.removeEventListener(\"error\",this.#W);super.addEventListener(\"error\",X),this.#W=X}set onmessage(X){if(this.#X)super.removeEventListener(\"message\",this.#X);super.addEventListener(\"message\",X),this.#X=X}}return Object.defineProperty(j.prototype,\"CONNECTING\",{enumerable:!0,value:0}),Object.defineProperty(j.prototype,\"OPEN\",{enumerable:!0,value:1}),Object.defineProperty(j.prototype,\"CLOSED\",{enumerable:!0,value:2}),j[Symbol.for(\"CommonJS\")]=0,j})\n";
