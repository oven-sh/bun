...
const JSC::ConstructAbility s_consoleObjectCreateConsoleConstructorCodeConstructAbility = JSC::ConstructAbility::CannotConstruct;
const JSC::ConstructorKind s_consoleObjectCreateConsoleConstructorCodeConstructorKind = JSC::ConstructorKind::None;
...
const int s_consoleObjectCreateConsoleConstructorCodeLength = 18551;
...
const int s_importMetaObjectInternalRequireCodeLength = 1058;
...
// from
const JSC::ConstructAbility s_jsBufferConstructorFromCodeConstructAbility = JSC::ConstructAbility::CanConstruct;
...
const int s_processObjectInternalsInitializeNextTickQueueCodeLength = 3648;
...
// mainModule
const JSC::ConstructAbility s_processObjectInternalsMainModuleCodeConstructAbility = JSC::ConstructAbility::CannotConstruct;
const JSC::ConstructorKind s_processObjectInternalsMainModuleCodeConstructorKind = JSC::ConstructorKind::None;
const JSC::ImplementationVisibility s_processObjectInternalsMainModuleCodeImplementationVisibility = JSC::ImplementationVisibility::Public;
const int s_processObjectInternalsMainModuleCodeLength = 68;
static const JSC::Intrinsic s_processObjectInternalsMainModuleCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_processObjectInternalsMainModuleCode = "(function () {\"use strict\";\n  return @requireMap.@get(Bun.main);\n})\n";
...
const int s_readableStreamInternalsCreateTextStreamCodeLength = 2045;
