...
const char* const s_processObjectInternalsGetStdioWriteStreamCode = "(function (A,M){\"use strict\";var X={path:\"node:process\",require:M},N=(Z)=>X.require(Z);function O(Z){var{Duplex:T,eos:x,destroy:Y}=N(\"node:stream\"),G=class j extends T{#$;#B;#j=!0;#z=!0;#G;#H;#J;#K;#L;#M;get isTTY(){return this.#M\?\?=N(\"node:tty\").isatty(Z)}get fd(){return Z}constructor(U){super({readable:!0,writable:!0});this.#G=`/dev/fd/${U}`}#N(U){const L=this.#H;if(this.#H=null,L)L(U);else if(U)this.destroy(U);else if(!this.#j&&!this.#z)this.destroy()}_destroy(U,L){if(!U&&this.#H!==null){var V=class J extends Error{code;name;constructor(H=\"The operation was aborted\",P=void 0){if(P!==void 0&&typeof P!==\"object\")throw new Error(`Invalid AbortError options:\\n\\n${JSON.stringify(P,null,2)}`);super(H,P);this.code=\"ABORT_ERR\",this.name=\"AbortError\"}};U=new V}if(this.#J=null,this.#K=null,this.#H===null)L(U);else{if(this.#H=L,this.#$)Y(this.#$,U);if(this.#B)Y(this.#B,U)}}_write(U,L,V){if(!this.#$){var{createWriteStream:J}=N(\"node:fs\"),H=this.#$=J(this.#G);H.on(\"finish\",()=>{if(this.#K){const P=this.#K;this.#K=null,P()}}),H.on(\"drain\",()=>{if(this.#J){const P=this.#J;this.#J=null,P()}}),x(H,(P)=>{if(this.#z=!1,P)Y(H,P);this.#N(P)})}if(H.write(U,L))V();else this.#J=V}_final(U){this.#$&&this.#$.end(),this.#K=U}#O(){var{createReadStream:U}=N(\"node:fs\"),L=this.#B=U(this.#G);return L.on(\"readable\",()=>{if(this.#L){const V=this.#L;this.#L=null,V()}else this.read()}),L.on(\"end\",()=>{this.push(null)}),x(L,(V)=>{if(this.#j=!1,V)Y(L,V);this.#N(V)}),L}_read(){var U=this.#B;if(!U)U=this.#O();while(!0){const L=U.read();if(L===null||!this.push(L))return}}};return new G(Z)}var{EventEmitter:z}=N(\"node:events\");function B(Z){if(!Z)return!0;var T=Z.toLowerCase();return T===\"utf8\"||T===\"utf-8\"||T===\"buffer\"||T===\"binary\"}var Q,K=class Z extends z{#$;#B;#j;#z;bytesWritten=0;setDefaultEncoding(T){if(this.#B||!B(T))return this.#J(),this.#B.setDefaultEncoding(T)}#G(){switch(this.#$){case 1:{var T=@Bun.stdout.writer({highWaterMark:0});return T.unref(),T}case 2:{var T=@Bun.stderr.writer({highWaterMark:0});return T.unref(),T}default:throw new Error(\"Unsupported writer\")}}#H(){return this.#j\?\?=this.#G()}constructor(T){super();this.#$=T}get fd(){return this.#$}get isTTY(){return this.#z\?\?=N(\"node:tty\").isatty(this.#$)}cursorTo(T,x,Y){return(Q\?\?=N(\"readline\")).cursorTo(this,T,x,Y)}moveCursor(T,x,Y){return(Q\?\?=N(\"readline\")).moveCursor(this,T,x,Y)}clearLine(T,x){return(Q\?\?=N(\"readline\")).clearLine(this,T,x)}clearScreenDown(T){return(Q\?\?=N(\"readline\")).clearScreenDown(this,T)}ref(){this.#H().ref()}unref(){this.#H().unref()}on(T,x){if(T===\"close\"||T===\"finish\")return this.#J(),this.#B.on(T,x);if(T===\"drain\")return super.on(\"drain\",x);if(T===\"error\")return super.on(\"error\",x);return super.on(T,x)}get _writableState(){return this.#J(),this.#B._writableState}get _readableState(){return this.#J(),this.#B._readableState}pipe(T){return this.#J(),this.#B.pipe(T)}unpipe(T){return this.#J(),this.#B.unpipe(T)}#J(){if(this.#B)return;this.#B=O(this.#$);const T=this.eventNames();for(let x of T)this.#B.on(x,(...Y)=>{this.emit(x,...Y)})}#K(T){var x=this.#H();const Y=x.write(T);this.bytesWritten+=Y;const G=x.flush(!1);return!!(Y||G)}#L(T,x){if(!B(x))return this.#J(),this.#B.write(T,x);return this.#K(T)}#M(T,x){if(x)this.emit(\"error\",x);try{T(x\?x:null)}catch(Y){this.emit(\"error\",Y)}}#N(T,x,Y){if(!B(x))return this.#J(),this.#B.write(T,x,Y);var G=this.#H();const j=G.write(T),U=G.flush(!0);if(U\?.then)return U.then(()=>{this.#M(Y),this.emit(\"drain\")},(L)=>this.#M(Y,L)),!1;return queueMicrotask(()=>{this.#M(Y)}),!!(j||U)}write(T,x,Y){const G=this._write(T,x,Y);if(G)this.emit(\"drain\");return G}get hasColors(){return @Bun.tty[this.#$].hasColors}_write(T,x,Y){var G=this.#B;if(G)return G.write(T,x,Y);switch(arguments.length){case 0:{var j=new Error(\"Invalid arguments\");throw j.code=\"ERR_INVALID_ARG_TYPE\",j}case 1:return this.#K(T);case 2:if(typeof x===\"function\")return this.#N(T,\"\",x);else if(typeof x===\"string\")return this.#L(T,x);default:{if(typeof x!==\"undefined\"&&typeof x!==\"string\"||typeof Y!==\"undefined\"&&typeof Y!==\"function\"){var j=new Error(\"Invalid arguments\");throw j.code=\"ERR_INVALID_ARG_TYPE\",j}if(typeof Y===\"undefined\")return this.#L(T,x);return this.#N(T,x,Y)}}}destroy(){return this}end(){return this}};return new K(A)})\n";
...
const int s_moduleRequireCodeLength = 927;
static const JSC::Intrinsic s_moduleRequireCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_moduleRequireCode = "(function (M){\"use strict\";const _=@requireMap.@get(M)||@requireMap.@get(M=@resolveSync(M,this.path,!1));if(_)return @evaluateCommonJSModule(_),_.exports;if(M.endsWith(\".json\")||M.endsWith(\".toml\")||M.endsWith(\".node\"))return @internalRequire(M);let h=@Loader.registry.@get(M);if(h\?.evaluated&&(h.state\?\?0)>=@ModuleReady){const l=h.module,y=@Loader.getModuleNamespaceObject(l),S=y\?.[@commonJSSymbol]===0||y\?.default\?.[@commonJSSymbol]===0\?y.default:y;return @requireMap.@set(M,@createCommonJSModule(M,S,!0)),S}const t=@createCommonJSModule(M,{},!1);@requireMap.@set(M,t);var L=this.@require(M,t);if(L===-1){try{L=@requireESM(M)}catch(l){throw @requireMap.@delete(M),l}if(h=@Loader.registry.@get(M),h\?.evaluated&&(h.state\?\?0)>=@ModuleReady){const l=@Loader.getModuleNamespaceObject(h.module);return t.exports=l\?.[@commonJSSymbol]===0||l\?.default\?.[@commonJSSymbol]===0\?l.default:l}}return @evaluateCommonJSModule(t),t.exports})\n";
...
const char* const s_readableStreamInternalsCreateReadableStreamControllerCode = "(function (f,w,v){\"use strict\";const A=w.type,C=@toString(A);if(C===\"bytes\"){if(v.highWaterMark===@undefined)v.highWaterMark=0;if(v.size!==@undefined)@throwRangeError(\"Strategy for a ReadableByteStreamController cannot have a size\");@putByIdDirectPrivate(f,\"readableStreamController\",new @ReadableByteStreamController(f,w,v.highWaterMark,@isReadableStream))}else if(C===\"direct\"){var b=v\?.highWaterMark;@initializeArrayBufferStream.@call(f,w,b)}else if(A===@undefined){if(v.highWaterMark===@undefined)v.highWaterMark=1;@setupReadableStreamDefaultController(f,w,v.size,v.highWaterMark,w.start,w.pull,w.cancel)}else @throwRangeError(\"Invalid type for underlying source\")})\n";
...
const char* const s_readableStreamInternalsReadableStreamPipeToWritableStreamCode = "(function (f,T,w,x,_,z){\"use strict\";if(@assert(@isReadableStream(f)),@assert(@isWritableStream(T)),@assert(!@isReadableStreamLocked(f)),@assert(!@isWritableStreamLocked(T)),@assert(z===@undefined||@isAbortSignal(z)),@getByIdDirectPrivate(f,\"underlyingByteSource\")!==@undefined)return @Promise.@reject(\"Piping to a readable bytestream is not supported\");let D={source:f,destination:T,preventAbort:x,preventCancel:_,preventClose:w,signal:z};if(D.reader=@acquireReadableStreamDefaultReader(f),D.writer=@acquireWritableStreamDefaultWriter(T),@putByIdDirectPrivate(f,\"disturbed\",!0),D.finalized=!1,D.shuttingDown=!1,D.promiseCapability=@newPromiseCapability(@Promise),D.pendingReadPromiseCapability=@newPromiseCapability(@Promise),D.pendingReadPromiseCapability.@resolve.@call(),D.pendingWritePromise=@Promise.@resolve(),z!==@undefined){const B=(F)=>{if(D.finalized)return;@pipeToShutdownWithAction(D,()=>{const G=!D.preventAbort&&@getByIdDirectPrivate(D.destination,\"state\")===\"writable\"\?@writableStreamAbort(D.destination,F):@Promise.@resolve(),I=!D.preventCancel&&@getByIdDirectPrivate(D.source,\"state\")===@streamReadable\?@readableStreamCancel(D.source,F):@Promise.@resolve();let J=@newPromiseCapability(@Promise),K=!0,L=()=>{if(K){K=!1;return}J.@resolve.@call()},k=(q)=>{J.@reject.@call(@undefined,q)};return G.@then(L,k),I.@then(L,k),J.@promise},F)};if(@whenSignalAborted(z,B))return D.promiseCapability.@promise}return @pipeToErrorsMustBePropagatedForward(D),@pipeToErrorsMustBePropagatedBackward(D),@pipeToClosingMustBePropagatedForward(D),@pipeToClosingMustBePropagatedBackward(D),@pipeToLoop(D),D.promiseCapability.@promise})\n";
...
const char* const s_readableStreamInternalsReadDirectStreamCode = "(function (_,f,j){\"use strict\";@putByIdDirectPrivate(_,\"underlyingSource\",@undefined),@putByIdDirectPrivate(_,\"start\",@undefined);function v(x,z){if(z&&j\?.cancel){try{var A=j.cancel(z);@markPromiseAsHandled(A)}catch(B){}j=@undefined}if(x){if(@putByIdDirectPrivate(x,\"readableStreamController\",@undefined),@putByIdDirectPrivate(x,\"reader\",@undefined),z)@putByIdDirectPrivate(x,\"state\",@streamErrored),@putByIdDirectPrivate(x,\"storedError\",z);else @putByIdDirectPrivate(x,\"state\",@streamClosed);x=@undefined}}if(!j.pull){v();return}if(!@isCallable(j.pull)){v(),@throwTypeError(\"pull is not a function\");return}@putByIdDirectPrivate(_,\"readableStreamController\",f);const q=@getByIdDirectPrivate(_,\"highWaterMark\");f.start({highWaterMark:!q||q<64\?64:q}),@startDirectStream.@call(f,_,j.pull,v),@putByIdDirectPrivate(_,\"reader\",{});var w=j.pull(f);if(f=@undefined,w&&@isPromise(w))return w.@then(()=>{})})\n";
...
const char* const s_readableStreamInternalsReadStreamIntoSinkCode = "(async function (P,x,z){\"use strict\";var A=!1,c=!1;try{var G=P.getReader(),f=G.readMany();if(f&&@isPromise(f))f=await f;if(f.done)return A=!0,x.end();var H=f.value.length;const K=@getByIdDirectPrivate(P,\"highWaterMark\");if(z)@startDirectStream.@call(x,P,@undefined,()=>!c&&@markPromiseAsHandled(P.cancel()));x.start({highWaterMark:K||0});for(var J=0,q=f.value,E=f.value.length;J<E;J++)x.write(q[J]);var _=@getByIdDirectPrivate(P,\"state\");if(_===@streamClosed)return A=!0,x.end();while(!0){var{value:B,done:F}=await G.read();if(F)return A=!0,x.end();x.write(B)}}catch(K){c=!0;try{G=@undefined;const I=P.cancel(K);@markPromiseAsHandled(I)}catch(I){}if(x&&!A){A=!0;try{x.close(K)}catch(I){throw new globalThis.AggregateError([K,I])}}throw K}finally{if(G){try{G.releaseLock()}catch(I){}G=@undefined}x=@undefined;var _=@getByIdDirectPrivate(P,\"state\");if(P){var D=@getByIdDirectPrivate(P,\"readableStreamController\");if(D){if(@getByIdDirectPrivate(D,\"underlyingSource\"))@putByIdDirectPrivate(D,\"underlyingSource\",@undefined);if(@getByIdDirectPrivate(D,\"controlledReadableStream\"))@putByIdDirectPrivate(D,\"controlledReadableStream\",@undefined);if(@putByIdDirectPrivate(P,\"readableStreamController\",null),@getByIdDirectPrivate(P,\"underlyingSource\"))@putByIdDirectPrivate(P,\"underlyingSource\",@undefined);D=@undefined}if(!c&&_!==@streamClosed&&_!==@streamErrored)@readableStreamClose(P);P=@undefined}}})\n";
...
const char* const s_readableStreamInternalsLazyLoadStreamCode = "(function (X,I){\"use strict\";var J=@getByIdDirectPrivate(X,\"bunNativeType\"),K=@getByIdDirectPrivate(X,\"bunNativePtr\"),L=@lazyStreamPrototypeMap.@get(J);if(L===@undefined){let m=function(F){var{c:p,v:z}=this;this.c=@undefined,this.v=@undefined,f(F,p,z)},P=function(F){try{F.close()}catch(p){globalThis.reportError(p)}},_=function(F,p,z,A){A[0]=!1;var G;try{G=b(F,z,A)}catch(H){return p.error(H)}return f(G,p,z)};var j=m,W=P,y=_,[b,q,M,B,Q,Y,Z]=@lazyLoad(J),U=[!1],f;f=function F(p,z,A){if(p&&@isPromise(p))return p.then(m.bind({c:z,v:A}),(G)=>z.error(G));else if(typeof p===\"number\")if(A&&A.byteLength===p&&A.buffer===z.byobRequest\?.view\?.buffer)z.byobRequest.respondWithNewView(A);else z.byobRequest.respond(p);else if(p.constructor===@Uint8Array)z.enqueue(p);if(U[0]||p===!1)@enqueueJob(P,z),U[0]=!1};const E=Q\?new FinalizationRegistry(Q):null;L=class F{constructor(p,z,A){if(this.#f=p,this.#b={},this.pull=this.#j.bind(this),this.cancel=this.#m.bind(this),this.autoAllocateChunkSize=z,A!==@undefined)this.start=(G)=>{G.enqueue(A)};if(E)E.register(this,p,this.#b)}#b;pull;cancel;start;#f;type=\"bytes\";autoAllocateChunkSize=0;static startSync=q;#j(p){var z=this.#f;if(!z){p.close();return}_(z,p,p.byobRequest.view,U)}#m(p){var z=this.#f;E&&E.unregister(this.#b),Y&&Y(z,!1),M(z,p)}static deinit=Q;static drain=Z},@lazyStreamPrototypeMap.@set(J,L)}const x=L.startSync(K,I);var N;const{drain:D,deinit:O}=L;if(D)N=D(K);if(x===0){if(Q&&K&&@enqueueJob(Q,K),(N\?.byteLength\?\?0)>0)return{start(m){m.enqueue(N),m.close()},type:\"bytes\"};return{start(m){m.close()},type:\"bytes\"}}return new L(K,x,N)})\n";
...
const char* const s_readableStreamInternalsReadableStreamToArrayBufferDirectCode = "(function (O,x){\"use strict\";var B=new @Bun.ArrayBufferSink;@putByIdDirectPrivate(O,\"underlyingSource\",@undefined);var C=@getByIdDirectPrivate(O,\"highWaterMark\");B.start(C\?{highWaterMark:C}:{});var j=@newPromiseCapability(@Promise),D=!1,_=x.pull,F=x.close,q={start(){},close(G){if(!D){if(D=!0,F)F();@fulfillPromise(j.@promise,B.end())}},end(){if(!D){if(D=!0,F)F();@fulfillPromise(j.@promise,B.end())}},flush(){return 0},write:B.write.bind(B)},z=!1;try{const G=_(q);if(G&&@isObject(G)&&@isPromise(G))return async function(A,v,w){while(!D)await w(A);return await v}(q,promise,_);return j.@promise}catch(G){return z=!0,@readableStreamError(O,G),@Promise.@reject(G)}finally{if(!z&&O)@readableStreamClose(O);q=F=B=_=O=@undefined}})\n";
...
const char* const s_readableStreamInternalsReadableStreamDefineLazyIteratorsCode = "(function (g){\"use strict\";var i=globalThis.Symbol.asyncIterator,q=async function*z(B,D){var F=B.getReader(),G;try{while(!0){var h,k;const j=F.readMany();if(@isPromise(j))({done:h,value:k}=await j);else({done:h,value:k}=j);if(h)return;yield*k}}catch(j){G=j}finally{if(F.releaseLock(),!D)B.cancel(G);if(G)throw G}},w=function z(){return q(this,!1)},x=function z({preventCancel:B=!1}={preventCancel:!1}){return q(this,B)};return @Object.@defineProperty(g,i,{value:w}),@Object.@defineProperty(g,\"values\",{value:x}),g})\n";
...
const char* const s_streamInternalsCreateFIFOCode = "(function (){\"use strict\";var v=@Array.prototype.slice;class b{constructor(){this._head=0,this._tail=0,this._capacityMask=3,this._list=@newArrayWithSize(4)}_head;_tail;_capacityMask;_list;size(){if(this._head===this._tail)return 0;if(this._head<this._tail)return this._tail-this._head;else return this._capacityMask+1-(this._head-this._tail)}isEmpty(){return this.size()==0}isNotEmpty(){return this.size()>0}shift(){var{_head:g,_tail:w,_list:k,_capacityMask:z}=this;if(g===w)return @undefined;var A=k[g];if(@putByValDirect(k,g,@undefined),g=this._head=g+1&z,g<2&&w>1e4&&w<=k.length>>>2)this._shrinkArray();return A}peek(){if(this._head===this._tail)return @undefined;return this._list[this._head]}push(g){var w=this._tail;if(@putByValDirect(this._list,w,g),this._tail=w+1&this._capacityMask,this._tail===this._head)this._growArray()}toArray(g){var w=this._list,k=@toLength(w.length);if(g||this._head>this._tail){var z=@toLength(this._head),A=@toLength(this._tail),B=@toLength(k-z+A),E=@newArrayWithSize(B),F=0;for(var G=z;G<k;G++)@putByValDirect(E,F++,w[G]);for(var G=0;G<A;G++)@putByValDirect(E,F++,w[G]);return E}else return v.@call(w,this._head,this._tail)}clear(){this._head=0,this._tail=0,this._list.fill(@undefined)}_growArray(){if(this._head)this._list=this.toArray(!0),this._head=0;this._tail=@toLength(this._list.length),this._list.length<<=1,this._capacityMask=this._capacityMask<<1|1}shrinkArray(){this._list.length>>>=1,this._capacityMask>>>=1}}return new b})\n";
...
const char* const s_importMetaObjectLoadCJS2ESMCode = "(function (D){\"use strict\";var J=@Loader,B=@createFIFO(),G=D;while(G){var H=J.registry.@get(G);if((H\?.state\?\?0)<=@ModuleFetch)@fulfillModuleSync(G),H=J.registry.@get(G);var I=@getPromiseInternalField(H.fetch,@promiseFieldReactionsOrResult),L=J.parseModule(G,I),Q=H.module;if(L&&@isPromise(L)){var T=@getPromiseInternalField(L,@promiseFieldReactionsOrResult),U=@getPromiseInternalField(L,@promiseFieldFlags),_=U&@promiseStateMask;if(_===@promiseStatePending||T&&@isPromise(T))@throwTypeError(`require() async module \"${G}\" is unsupported. use \"await import()\" instead.`);else if(_===@promiseStateRejected){if(!T\?.message)@throwTypeError(`${T+\"\"\?T:\"An error occurred\"} occurred while parsing module \\\"${G}\\\"`);throw T}H.module=Q=T}else if(L&&!Q)H.module=Q=L;@setStateToMax(H,@ModuleLink);var w=Q.dependenciesMap,x=J.requestedModules(Q),F=@newArrayWithSize(x.length);for(var V=0,W=x.length;V<W;++V){var z=x[V],X=z[0]===\"/\"\?z:J.resolve(z,G),Y=J.ensureRegistered(X);if(Y.state<@ModuleLink)B.push(X);@putByValDirect(F,V,Y),w.@set(z,Y)}H.dependencies=F,H.instantiate=@Promise.resolve(H),H.satisfy=@Promise.resolve(H),G=B.shift();while(G&&(J.registry.@get(G)\?.state\?\?@ModuleFetch)>=@ModuleLink)G=B.shift()}var Z=J.linkAndEvaluateModule(D,@undefined);if(Z&&@isPromise(Z))@throwTypeError(`require() async module \\\"${D}\\\" is unsupported. use \"await import()\" instead.`);return J.registry.@get(D)})\n";
...
const char* const s_importMetaObjectInternalRequireCode = "(function (b){\"use strict\";var j=@requireMap.@get(b);const q=b.substring(b.length-5);if(j)return j.exports;if(q===\".json\"){var k=globalThis[Symbol.for(\"_fs\")]||=@Bun.fs(),v=JSON.parse(k.readFileSync(b,\"utf8\"));return @requireMap.@set(b,@createCommonJSModule(b,v,!0)),v}else if(q===\".node\"){const g=@createCommonJSModule(b,{},!0);return process.dlopen(g,b),@requireMap.@set(b,g),g.exports}else if(q===\".toml\"){var k=globalThis[Symbol.for(\"_fs\")]||=@Bun.fs(),v=@Bun.TOML.parse(k.readFileSync(b,\"utf8\"));return @requireMap.@set(b,@createCommonJSModule(b,v,!0)),v}else{var v=@requireESM(b);const n=@requireMap.@get(b);if(n)return n.exports;var _=v\?.default;if(_\?.[@commonJSSymbol]===0)v=_;return @requireMap.@set(b,@createCommonJSModule(b,v,!0)),v}})\n";
...
const char* const s_importMetaObjectCreateRequireCacheCode = "(function (){\"use strict\";var f=new Map,t={};return new Proxy(t,{get(_,h){const L=@requireMap.@get(h);if(L)return L;const u=@Loader.registry.@get(h);if(u\?.evaluated){const b=@Loader.getModuleNamespaceObject(u.module),c=b[@commonJSSymbol]===0||b.default\?.[@commonJSSymbol]\?b.default:b,g=@createCommonJSModule(h,c,!0);return @requireMap.@set(h,g),g}return t[h]},set(_,h,L){return @requireMap.@set(h,L),!0},has(_,h){return @requireMap.@has(h)||@Loader.registry.@has(h)},deleteProperty(_,h){return f.@delete(h),@requireMap.@delete(h),@Loader.registry.@delete(h),!0},ownKeys(_){var h=[...@requireMap.@keys()];const L=[...@Loader.registry.@keys()];for(let u of L)if(!h.includes(u))@arrayPush(h,u);return h},getPrototypeOf(_){return null},getOwnPropertyDescriptor(_,h){if(@requireMap.@has(h)||@Loader.registry.@has(h))return{configurable:!0,enumerable:!0}}})})\n";
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerPullCode = "(function (d){\"use strict\";const _=@getByIdDirectPrivate(d,\"controlledReadableStream\");if(@assert(@readableStreamHasDefaultReader(_)),@getByIdDirectPrivate(d,\"queue\").content\?.isNotEmpty()){const R=@getByIdDirectPrivate(d,\"queue\").content.shift();@getByIdDirectPrivate(d,\"queue\").size-=R.byteLength,@readableByteStreamControllerHandleQueueDrain(d);let F;try{F=new @Uint8Array(R.buffer,R.byteOffset,R.byteLength)}catch(P){return @Promise.@reject(P)}return @createFulfilledPromise({value:F,done:!1})}if(@getByIdDirectPrivate(d,\"autoAllocateChunkSize\")!==@undefined){let R;try{R=@createUninitializedArrayBuffer(@getByIdDirectPrivate(d,\"autoAllocateChunkSize\"))}catch(P){return @Promise.@reject(P)}const F={buffer:R,byteOffset:0,byteLength:@getByIdDirectPrivate(d,\"autoAllocateChunkSize\"),bytesFilled:0,elementSize:1,ctor:@Uint8Array,readerType:\"default\"};@getByIdDirectPrivate(d,\"pendingPullIntos\").push(F)}const h=@readableStreamAddReadRequest(_);return @readableByteStreamControllerCallPullIfNeeded(d),h})\n";
...
const char* const s_eventSourceGetEventSourceCode = "(function (){\"use strict\";class w extends EventTarget{#$;#j;#w;#A;#B;#F=!1;#G=null;#J=\"\";#K=\"\";#L=\"\";#M=!0;#O=0;#Q=0;#U=0;#V=null;static#W(V){V.#H()}static#X(V,J){const A=V.data,B=A.#L\?`Last-Event-ID: ${A.#L}\\r\\n`:\"\",W=`GET ${J.pathname}${J.search} HTTP/1.1\\r\\nHost: bun\\r\\nContent-type: text/event-stream\\r\\nContent-length: 0\\r\\n${B}\\r\\n`,K=V.write(W);if(K!==W.length)A.#K=W.substring(K)}static#Y(V,J,A){for(;;){if(A>=J.length)return;let B=-1,W=J.indexOf(\"\\r\\n\",A);const K=W+2;if(W>0)if(V.#O===0){const Y=parseInt(J.substring(A,W),16);if(Y===0){V.#j=2,V.#G\?.end();return}B=K+Y}else B=J.length;else{if(V.#J.length===0){V.#J+=J.substring(A);return}B=J.length}let L=J.substring(K,B);A=B+2;let X=0,F=L.indexOf(\"\\n\\n\");if(F==-1){V.#J+=J.substring(K);return}if(V.#J.length)V.#J+=L,L=V.#J,V.#J=\"\";let G=!0;while(G){const Y=L.substring(X,F);let M,O=\"\",Q,Z=0,z=-1;for(;;){let H=Y.indexOf(\"\\n\",Z);if(H===-1){if(Z>=Y.length)break;H=Y.length}const U=Y.substring(Z,H);if(U.startsWith(\"data:\"))if(O.length)O+=`\\n${U.substring(5).trim()}`;else O=U.substring(5).trim();else if(U.startsWith(\"event:\"))M=U.substring(6).trim();else if(U.startsWith(\"id:\"))Q=U.substring(3).trim();else if(U.startsWith(\"retry:\")){if(z=parseInt(U.substring(6).trim(),10),@isNaN(z))z=-1}Z=H+1}if(V.#L=Q||\"\",z>=0)V.#U=z;if(O||Q||M)V.dispatchEvent(new MessageEvent(M||\"message\",{data:O||\"\",origin:V.#$.origin,source:V,lastEventId:Q}));if(L.length===F+2){G=!1;break}const j=L.indexOf(\"\\n\\n\",F+1);if(j===-1)break;X=F,F=j}}}static#Z={open(V){const J=V.data;if(J.#G=V,!J.#F)w.#X(V,J.#$)},handshake(V,J,A){const B=V.data;if(J)w.#X(V,B.#$);else B.#j=2,B.dispatchEvent(new ErrorEvent(\"error\",{error:A})),V.end()},data(V,J){const A=V.data;switch(A.#j){case 0:{let B=J.toString();const W=B.indexOf(\"\\r\\n\\r\\n\");if(W===-1){A.#J+=B;return}if(A.#J.length)A.#J+=B,B=A.#J,A.#J=\"\";const K=B.substring(0,W),L=K.indexOf(\"\\r\\n\");if(L===-1){A.#j=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Invalid HTTP request\")})),V.end();return}const X=K.substring(0,L);if(X!==\"HTTP/1.1 200 OK\"){A.#j=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(X)})),V.end();return}let F=L+1,G=!1,Y=-1;for(;;){let O=K.indexOf(\"\\r\\n\",F);if(O===-1){if(F>=K.length){if(!G)A.#j=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's response has no MIME type and \"text/event-stream\" is required. Aborting the connection.`)})),V.end();return}O=K.length}const Q=K.substring(F+1,O),Z=Q.indexOf(\":\"),z=Q.substring(0,Z),j=z.localeCompare(\"content-type\",@undefined,{sensitivity:\"accent\"})===0;if(F=O+1,j)if(Q.endsWith(\" text/event-stream\"))G=!0;else{A.#j=2,A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's response has a MIME type that is not \"text/event-stream\". Aborting the connection.`)})),V.end();return}else if(z.localeCompare(\"content-length\",@undefined,{sensitivity:\"accent\"})===0){if(Y=parseInt(Q.substring(Z+1).trim(),10),@isNaN(Y)||Y<=0){A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's Content-Length is invalid. Aborting the connection.`)})),V.end();return}if(G)break}else if(z.localeCompare(\"transfer-encoding\",@undefined,{sensitivity:\"accent\"})===0){if(Q.substring(Z+1).trim()!==\"chunked\"){A.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's Transfer-Encoding is invalid. Aborting the connection.`)})),V.end();return}if(Y=0,G)break}}A.#O=Y,A.#j=1,A.dispatchEvent(new Event(\"open\"));const M=B.substring(W+4);if(w.#Y(A,M,0),A.#O>0){if(A.#Q+=M.length,A.#Q>=A.#O)A.#j=2,V.end()}return}case 1:if(w.#Y(A,J.toString(),2),A.#O>0){if(A.#Q+=J.byteLength,A.#Q>=A.#O)A.#j=2,V.end()}return;default:break}},drain(V){const J=V.data;if(J.#j===0){const A=J.#J;if(A.length){const B=V.write(A);if(B!==A.length)V.data.#K=A.substring(B);else V.data.#K=\"\"}}},close:w.#z,end(V){w.#z(V).dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Connection closed by server\")}))},timeout(V){w.#z(V).dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Timeout\")}))},binaryType:\"buffer\"};static#z(V){const J=V.data;if(J.#G=null,J.#Q=0,J.#j=2,J.#M){if(J.#V)clearTimeout(J.#V);J.#V=setTimeout(w.#W,J.#U,J)}return J}constructor(V,J=@undefined){super();const A=new URL(V);this.#F=A.protocol===\"https:\",this.#$=A,this.#j=2,process.nextTick(w.#W,this)}ref(){this.#V\?.ref(),this.#G\?.ref()}unref(){this.#V\?.unref(),this.#G\?.unref()}#H(){if(this.#j!==2)return;const V=this.#$,J=this.#F;this.#j=0,@Bun.connect({data:this,socket:w.#Z,hostname:V.hostname,port:parseInt(V.port||(J\?\"443\":\"80\"),10),tls:J\?{requestCert:!0,rejectUnauthorized:!1}:!1}).catch((A)=>{if(super.dispatchEvent(new ErrorEvent(\"error\",{error:A})),this.#M){if(this.#V)this.#V.unref\?.();this.#V=setTimeout(w.#W,1000,this)}})}get url(){return this.#$.href}get readyState(){return this.#j}close(){this.#M=!1,this.#j=2,this.#G\?.unref(),this.#G\?.end()}get onopen(){return this.#B}get onerror(){return this.#w}get onmessage(){return this.#A}set onopen(V){if(this.#B)super.removeEventListener(\"close\",this.#B);super.addEventListener(\"open\",V),this.#B=V}set onerror(V){if(this.#w)super.removeEventListener(\"error\",this.#w);super.addEventListener(\"error\",V),this.#w=V}set onmessage(V){if(this.#A)super.removeEventListener(\"message\",this.#A);super.addEventListener(\"message\",V),this.#A=V}}return Object.defineProperty(w.prototype,\"CONNECTING\",{enumerable:!0,value:0}),Object.defineProperty(w.prototype,\"OPEN\",{enumerable:!0,value:1}),Object.defineProperty(w.prototype,\"CLOSED\",{enumerable:!0,value:2}),w[Symbol.for(\"CommonJS\")]=0,w})\n";
