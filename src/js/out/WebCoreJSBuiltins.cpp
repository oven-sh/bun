...
=======
const char* const s_writableStreamInternalsWritableStreamDefaultWriterEnsureReadyPromiseRejectedCode = "(function (c,h){\"use strict\";let g=@getByIdDirectPrivate(c,\"readyPromise\"),n=g.@promise;if((@getPromiseInternalField(n,@promiseFieldFlags)&@promiseStateMask)!==@promiseStatePending)g=@newPromiseCapability(@Promise),n=g.@promise,@putByIdDirectPrivate(c,\"readyPromise\",g);g.@reject.@call(@undefined,h),@markPromiseAsHandled(n)})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_writableStreamInternalsSetUpWritableStreamDefaultControllerFromUnderlyingSinkCode = "(function (v,p,P,_,j){\"use strict\";const q=new @WritableStreamDefaultController;let x=()=>{},B=()=>{return @Promise.@resolve()},C=()=>{return @Promise.@resolve()},f=()=>{return @Promise.@resolve()};if(\"start\"in P){const E=P[\"start\"];x=()=>@promiseInvokeOrNoopMethodNoCatch(p,E,[q])}if(\"write\"in P){const E=P[\"write\"];B=(F)=>@promiseInvokeOrNoopMethod(p,E,[F,q])}if(\"close\"in P){const E=P[\"close\"];C=()=>@promiseInvokeOrNoopMethod(p,E,[])}if(\"abort\"in P){const E=P[\"abort\"];f=(F)=>@promiseInvokeOrNoopMethod(p,E,[F])}@setUpWritableStreamDefaultController(v,q,x,B,C,f,_,j)})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_transformStreamInternalsCreateTransformStreamCode = "(function (q,v,x,B,_,E,j){\"use strict\";if(B===@undefined)B=1;if(_===@undefined)_=()=>1;if(E===@undefined)E=0;if(j===@undefined)j=()=>1;@assert(B>=0),@assert(E>=0);const F={};@putByIdDirectPrivate(F,\"TransformStream\",!0);const G=new @TransformStream(F),I=@newPromiseCapability(@Promise);@initializeTransformStream(G,I.@promise,B,_,E,j);const D=new @TransformStreamDefaultController;return @setUpTransformStreamDefaultController(G,D,v,x),q().@then(()=>{I.@resolve.@call()},(c)=>{I.@reject.@call(@undefined,c)}),G})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_transformStreamInternalsTransformStreamDefaultSinkWriteAlgorithmCode = "(function (d,f){\"use strict\";const j=@getByIdDirectPrivate(d,\"internalWritable\");@assert(@getByIdDirectPrivate(j,\"state\")===\"writable\");const q=@getByIdDirectPrivate(d,\"controller\");if(@getByIdDirectPrivate(d,\"backpressure\")){const z=@newPromiseCapability(@Promise),_=@getByIdDirectPrivate(d,\"backpressureChangePromise\");return @assert(_!==@undefined),_.@promise.@then(()=>{const v=@getByIdDirectPrivate(j,\"state\");if(v===\"erroring\"){z.@reject.@call(@undefined,@getByIdDirectPrivate(j,\"storedError\"));return}@assert(v===\"writable\"),@transformStreamDefaultControllerPerformTransform(q,f).@then(()=>{z.@resolve()},(x)=>{z.@reject.@call(@undefined,x)})},(v)=>{z.@reject.@call(@undefined,v)}),z.@promise}return @transformStreamDefaultControllerPerformTransform(q,f)})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_transformStreamInternalsTransformStreamDefaultSinkCloseAlgorithmCode = "(function (_){\"use strict\";const j=@getByIdDirectPrivate(_,\"readable\"),k=@getByIdDirectPrivate(_,\"controller\"),I=@getByIdDirectPrivate(j,\"readableStreamController\"),u=@getByIdDirectPrivate(k,\"flushAlgorithm\");@assert(u!==@undefined);const v=@getByIdDirectPrivate(k,\"flushAlgorithm\").@call();@transformStreamDefaultControllerClearAlgorithms(k);const q=@newPromiseCapability(@Promise);return v.@then(()=>{if(@getByIdDirectPrivate(j,\"state\")===@streamErrored){q.@reject.@call(@undefined,@getByIdDirectPrivate(j,\"storedError\"));return}if(@readableStreamDefaultControllerCanCloseOrEnqueue(I))@readableStreamDefaultControllerClose(I);q.@resolve()},(f)=>{@transformStreamError(@getByIdDirectPrivate(k,\"stream\"),f),q.@reject.@call(@undefined,@getByIdDirectPrivate(j,\"storedError\"))}),q.@promise})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_jsBufferPrototypeReadIntBECode = "(function (d,c){\"use strict\";const r=this.@dataView||=new DataView(this.buffer,this.byteOffset,this.byteLength);switch(c){case 1:return r.getInt8(d);case 2:return r.getInt16(d,!1);case 3:{const u=r.getUint16(d+1,!1)+r.getUint8(d)*65536;return u|(u&8388608)*510}case 4:return r.getInt32(d,!1);case 5:{const u=r.getUint8(d);return(u|(u&128)*33554430)*4294967296+r.getUint32(d+1,!1)}case 6:{const u=r.getUint16(d,!1);return(u|(u&32768)*131070)*4294967296+r.getUint32(d+2,!1)}}@throwRangeError(\"byteLength must be >= 1 and <= 6\")})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_readableStreamInternalsSetupReadableStreamDefaultControllerCode = "(function (f,_,b,q,j,w,v){\"use strict\";const x=new @ReadableStreamDefaultController(f,_,b,q,@isReadableStream),B=()=>@promiseInvokeOrNoopMethod(_,w,[x]),C=(D)=>@promiseInvokeOrNoopMethod(_,v,[D]);@putByIdDirectPrivate(x,\"pullAlgorithm\",B),@putByIdDirectPrivate(x,\"cancelAlgorithm\",C),@putByIdDirectPrivate(x,\"pull\",@readableStreamDefaultControllerPull),@putByIdDirectPrivate(x,\"cancel\",@readableStreamDefaultControllerCancel),@putByIdDirectPrivate(f,\"readableStreamController\",x),@readableStreamDefaultControllerStart(x)})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_readableStreamInternalsReadableStreamPipeToWritableStreamCode = "(function (_,G,f,D,x,F){\"use strict\";if(@assert(@isReadableStream(_)),@assert(@isWritableStream(G)),@assert(!@isReadableStreamLocked(_)),@assert(!@isWritableStreamLocked(G)),@assert(F===@undefined||@isAbortSignal(F)),@getByIdDirectPrivate(_,\"underlyingByteSource\")!==@undefined)return @Promise.@reject(\"Piping to a readable bytestream is not supported\");let H={source:_,destination:G,preventAbort:D,preventCancel:x,preventClose:f,signal:F};if(H.reader=@acquireReadableStreamDefaultReader(_),H.writer=@acquireWritableStreamDefaultWriter(G),@putByIdDirectPrivate(_,\"disturbed\",!0),H.finalized=!1,H.shuttingDown=!1,H.promiseCapability=@newPromiseCapability(@Promise),H.pendingReadPromiseCapability=@newPromiseCapability(@Promise),H.pendingReadPromiseCapability.@resolve.@call(),H.pendingWritePromise=@Promise.@resolve(),F!==@undefined){const I=(J)=>{if(H.finalized)return;@pipeToShutdownWithAction(H,()=>{const K=!H.preventAbort&&@getByIdDirectPrivate(H.destination,\"state\")===\"writable\"\?@writableStreamAbort(H.destination,J):@Promise.@resolve(),T=!H.preventCancel&&@getByIdDirectPrivate(H.source,\"state\")===@streamReadable\?@readableStreamCancel(H.source,J):@Promise.@resolve();let z=@newPromiseCapability(@Promise),B=!0,k=()=>{if(B){B=!1;return}z.@resolve.@call()},q=(w)=>{z.@reject.@call(@undefined,w)};return K.@then(k,q),T.@then(k,q),z.@promise},J)};if(@whenSignalAborted(F,I))return H.promiseCapability.@promise}return @pipeToErrorsMustBePropagatedForward(H),@pipeToErrorsMustBePropagatedBackward(H),@pipeToClosingMustBePropagatedForward(H),@pipeToClosingMustBePropagatedBackward(H),@pipeToLoop(H),H.promiseCapability.@promise})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_readableStreamInternalsPipeToShutdownWithActionCode = "(function (_,b){\"use strict\";if(_.shuttingDown)return;_.shuttingDown=!0;const d=arguments.length>2,g=arguments[2],h=()=>{b().@then(()=>{if(d)@pipeToFinalize(_,g);else @pipeToFinalize(_)},(m)=>{@pipeToFinalize(_,m)})};if(@getByIdDirectPrivate(_.destination,\"state\")===\"writable\"&&!@writableStreamCloseQueuedOrInFlight(_.destination)){_.pendingReadPromiseCapability.@promise.@then(()=>{_.pendingWritePromise.@then(h,h)},(j)=>@pipeToFinalize(_,j));return}h()})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
const char* const s_readableStreamInternalsAssignToStreamCode = "(function (h,b){\"use strict\";var _=@getByIdDirectPrivate(h,\"underlyingSource\");if(_)try{return @readDirectStream(h,b,_)}catch(f){throw f}finally{_=@undefined,h=@undefined,b=@undefined}return @readStreamIntoSink(h,b,!0)})\n";
...
=======
const char* const s_readableStreamInternalsCreateTextStreamCode = "(function (j){\"use strict\";var _,q=[],w=!1,v=!1,z=\"\",x=@toLength(0),A=@newPromiseCapability(@Promise),C=!1;return _={start(){},write(E){if(typeof E===\"string\"){var F=@toLength(E.length);if(F>0)z+=E,w=!0,x+=F;return F}if(!E||!(@ArrayBuffer.@isView(E)||E instanceof @ArrayBuffer))@throwTypeError(\"Expected text, ArrayBuffer or ArrayBufferView\");const G=@toLength(E.byteLength);if(G>0)if(v=!0,z.length>0)@arrayPush(q,z,E),z=\"\";else @arrayPush(q,E);return x+=G,G},flush(){return 0},end(){if(C)return\"\";return _.fulfill()},fulfill(){C=!0;const E=_.finishInternal();return @fulfillPromise(A.@promise,E),E},finishInternal(){if(!w&&!v)return\"\";if(w&&!v)return z;if(v&&!w)return new globalThis.TextDecoder().decode(@Bun.concatArrayBuffers(q));var E=new @Bun.ArrayBufferSink;E.start({highWaterMark:x,asUint8Array:!0});for(let F of q)E.write(F);if(q.length=0,z.length>0)E.write(z),z=\"\";return new globalThis.TextDecoder().decode(E.end())},close(){try{if(!C)C=!0,_.fulfill()}catch(E){}}},[_,A]})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_readableStreamInternalsLazyLoadStreamCode = "(function (f,B){\"use strict\";var D=@getByIdDirectPrivate(f,\"bunNativeType\"),E=@getByIdDirectPrivate(f,\"bunNativePtr\"),y=@lazyStreamPrototypeMap.@get(D);if(y===@undefined){let b=function(Z){var{c:_,v:p}=this;this.c=@undefined,this.v=@undefined,L(Z,_,p)},U=function(Z){try{Z.close()}catch(_){globalThis.reportError(_)}},Y=function(Z,_,p,W){W[0]=!1;var z;try{z=j(Z,p,W)}catch(A){return _.error(A)}return L(z,_,p)};var Q=b,X=U,P=Y,[j,F,G,H,I,m,J]=@lazyLoad(D),K=[!1],L;L=function Z(_,p,W){if(_&&@isPromise(_))return _.then(b.bind({c:p,v:W}),(z)=>p.error(z));else if(typeof _===\"number\")if(W&&W.byteLength===_&&W.buffer===p.byobRequest\?.view\?.buffer)p.byobRequest.respondWithNewView(W);else p.byobRequest.respond(_);else if(_.constructor===@Uint8Array)p.enqueue(_);if(K[0]||_===!1)@enqueueJob(U,p),K[0]=!1};const x=I\?new FinalizationRegistry(I):null;y=class Z{constructor(_,p,W){if(this.#f=_,this.#b={},this.pull=this.#j.bind(this),this.cancel=this.#m.bind(this),this.autoAllocateChunkSize=p,W!==@undefined)this.start=(z)=>{z.enqueue(W)};if(x)x.register(this,_,this.#b)}#b;pull;cancel;start;#f;type=\"bytes\";autoAllocateChunkSize=0;static startSync=F;#j(_){var p=this.#f;if(!p){_.close();return}Y(p,_,_.byobRequest.view,K)}#m(_){var p=this.#f;x&&x.unregister(this.#b),m&&m(p,!1),G(p,_)}static deinit=I;static drain=J},@lazyStreamPrototypeMap.@set(D,y)}const M=y.startSync(E,B);var q;const{drain:N,deinit:O}=y;if(N)q=N(E);if(M===0){if(I&&E&&@enqueueJob(I,E),(q\?.byteLength\?\?0)>0)return{start(b){b.enqueue(q),b.close()},type:\"bytes\"};return{start(b){b.close()},type:\"bytes\"}}return new y(E,M,q)})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_readableStreamInternalsReadableStreamToTextDirectCode = "(async function (f,k){\"use strict\";const h=@initializeTextStream.@call(f,k,@undefined);var p=f.getReader();while(@getByIdDirectPrivate(f,\"state\")===@streamReadable){var j=await p.read();if(j.done)break}try{p.releaseLock()}catch(_){}return p=@undefined,f=@undefined,h.@promise})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_readableStreamInternalsReadableStreamDefineLazyIteratorsCode = "(function (i){\"use strict\";var j=globalThis.Symbol.asyncIterator,q=async function*B(g,D){var F=g.getReader(),G;try{while(!0){var z,h;const x=F.readMany();if(@isPromise(x))({done:z,value:h}=await x);else({done:z,value:h}=x);if(z)return;yield*h}}catch(x){G=x}finally{if(F.releaseLock(),!D)g.cancel(G);if(G)throw G}},w=function B(){return q(this,!1)},k=function B({preventCancel:g=!1}={preventCancel:!1}){return q(this,g)};return @Object.@defineProperty(i,j,{value:w}),@Object.@defineProperty(i,\"values\",{value:k}),i})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_readableStreamDefaultReaderReadManyCode = "(function (){\"use strict\";if(!@isReadableStreamDefaultReader(this))@throwTypeError(\"ReadableStreamDefaultReader.readMany() should not be called directly\");const N=@getByIdDirectPrivate(this,\"ownerReadableStream\");if(!N)@throwTypeError(\"readMany() called on a reader owned by no readable stream\");const k=@getByIdDirectPrivate(N,\"state\");if(@putByIdDirectPrivate(N,\"disturbed\",!0),k===@streamClosed)return{value:[],size:0,done:!0};else if(k===@streamErrored)throw @getByIdDirectPrivate(N,\"storedError\");var F=@getByIdDirectPrivate(N,\"readableStreamController\"),x=@getByIdDirectPrivate(F,\"queue\");if(!x)return F.@pull(F).@then(function({done:S,value:T}){return S\?{done:!0,value:[],size:0}:{value:[T],size:1,done:!1}});const C=x.content;var d=x.size,_=C.toArray(!1),G=_.length;if(G>0){var D=@newArrayWithSize(G);if(@isReadableByteStreamController(F)){{const S=_[0];if(!(@ArrayBuffer.@isView(S)||S instanceof @ArrayBuffer))@putByValDirect(D,0,new @Uint8Array(S.buffer,S.byteOffset,S.byteLength));else @putByValDirect(D,0,S)}for(var H=1;H<G;H++){const S=_[H];if(!(@ArrayBuffer.@isView(S)||S instanceof @ArrayBuffer))@putByValDirect(D,H,new @Uint8Array(S.buffer,S.byteOffset,S.byteLength));else @putByValDirect(D,H,S)}}else{@putByValDirect(D,0,_[0].value);for(var H=1;H<G;H++)@putByValDirect(D,H,_[H].value)}if(@resetQueue(@getByIdDirectPrivate(F,\"queue\")),@getByIdDirectPrivate(F,\"closeRequested\"))@readableStreamClose(@getByIdDirectPrivate(F,\"controlledReadableStream\"));else if(@isReadableStreamDefaultController(F))@readableStreamDefaultControllerCallPullIfNeeded(F);else if(@isReadableByteStreamController(F))@readableByteStreamControllerCallPullIfNeeded(F);return{value:D,size:d,done:!1}}var J=(S)=>{if(S.done)return{value:[],size:0,done:!0};var T=@getByIdDirectPrivate(N,\"readableStreamController\"),U=@getByIdDirectPrivate(T,\"queue\"),W=[S.value].concat(U.content.toArray(!1)),j=W.length;if(@isReadableByteStreamController(T))for(var I=0;I<j;I++){const B=W[I];if(!(@ArrayBuffer.@isView(B)||B instanceof @ArrayBuffer)){const{buffer:K,byteOffset:w,byteLength:E}=B;@putByValDirect(W,I,new @Uint8Array(K,w,E))}}else for(var I=1;I<j;I++)@putByValDirect(W,I,W[I].value);var A=U.size;if(@resetQueue(U),@getByIdDirectPrivate(T,\"closeRequested\"))@readableStreamClose(@getByIdDirectPrivate(T,\"controlledReadableStream\"));else if(@isReadableStreamDefaultController(T))@readableStreamDefaultControllerCallPullIfNeeded(T);else if(@isReadableByteStreamController(T))@readableByteStreamControllerCallPullIfNeeded(T);return{value:W,size:A,done:!1}},Q=F.@pull(F);if(Q&&@isPromise(Q))return Q.@then(J);return J(Q)})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_streamInternalsPromiseInvokeOrNoopCode = "(function (d,l,m){\"use strict\";try{return @promiseInvokeOrNoopNoCatch(d,l,m)}catch(n){return @Promise.@reject(n)}})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_streamInternalsPromiseInvokeOrFallbackOrNoopCode = "(function (n,_,p,l,u){\"use strict\";try{const v=n[_];if(v===@undefined)return @promiseInvokeOrNoopNoCatch(n,l,u);return @shieldingPromiseResolve(v.@apply(n,p))}catch(v){return @Promise.@reject(v)}})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_importMetaObjectLoadCJS2ESMCode = "(function (x){\"use strict\";var B=@Loader,F=@createFIFO(),G=x;while(G){var w=B.registry.@get(G);if((w\?.state\?\?0)<=@ModuleFetch)@fulfillModuleSync(G),w=B.registry.@get(G);var U=@getPromiseInternalField(w.fetch,@promiseFieldReactionsOrResult),D=B.parseModule(G,U),V=w.module;if(D&&@isPromise(D)){var W=@getPromiseInternalField(D,@promiseFieldReactionsOrResult),X=@getPromiseInternalField(D,@promiseFieldFlags),Q=X&@promiseStateMask;if(Q===@promiseStatePending||W&&@isPromise(W))@throwTypeError(`require() async module \"${G}\" is unsupported. use \"await import()\" instead.`);else if(Q===@promiseStateRejected){if(!W\?.message)@throwTypeError(`${W+\"\"\?W:\"An error occurred\"} occurred while parsing module \\\"${G}\\\"`);throw W}w.module=V=W}else if(D&&!V)w.module=V=D;@setStateToMax(w,@ModuleLink);var _=V.dependenciesMap,z=B.requestedModules(V),T=@newArrayWithSize(z.length);for(var H=0,Y=z.length;H<Y;++H){var J=z[H],Z=J[0]===\"/\"\?J:B.resolve(J,G),I=B.ensureRegistered(Z);if(I.state<@ModuleLink)F.push(Z);@putByValDirect(T,H,I),_.@set(J,I)}w.dependencies=T,w.instantiate=@Promise.resolve(w),w.satisfy=@Promise.resolve(w),G=F.shift();while(G&&(B.registry.@get(G)\?.state\?\?@ModuleFetch)>=@ModuleLink)G=F.shift()}var L=B.linkAndEvaluateModule(x,@undefined);if(L&&@isPromise(L))@throwTypeError(`require() async module \\\"${x}\\\" is unsupported. use \"await import()\" instead.`);return B.registry.@get(x)})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_importMetaObjectCreateRequireCacheCode = "(function (){\"use strict\";var f=new Map,b={};return new Proxy(b,{get(_,h){const t=@requireMap.@get(h);if(t)return t;const c=@Loader.registry.@get(h);if(c\?.evaluated){const u=@Loader.getModuleNamespaceObject(c.module),g=u[@commonJSSymbol]===0||u.default\?.[@commonJSSymbol]\?u.default:u,L=@createCommonJSModule(h,g,!0);return @requireMap.@set(h,L),L}return b[h]},set(_,h,t){return @requireMap.@set(h,t),!0},has(_,h){return @requireMap.@has(h)||@Loader.registry.@has(h)},deleteProperty(_,h){return f.@delete(h),@requireMap.@delete(h),@Loader.registry.@delete(h),!0},ownKeys(_){var h=[...@requireMap.@keys()];const t=[...@Loader.registry.@keys()];for(let c of t)if(!h.includes(c))@arrayPush(h,c);return h},getPrototypeOf(_){return null},getOwnPropertyDescriptor(_,h){if(@requireMap.@has(h)||@Loader.registry.@has(h))return{configurable:!0,enumerable:!0}}})})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_readableStreamInitializeReadableStreamCode = "(function (_,I){\"use strict\";if(_===@undefined)_={@bunNativeType:0,@bunNativePtr:0,@lazy:!1};if(I===@undefined)I={};if(!@isObject(_))@throwTypeError(\"ReadableStream constructor takes an object as first argument\");if(I!==@undefined&&!@isObject(I))@throwTypeError(\"ReadableStream constructor takes an object as second argument, if any\");@putByIdDirectPrivate(this,\"state\",@streamReadable),@putByIdDirectPrivate(this,\"reader\",@undefined),@putByIdDirectPrivate(this,\"storedError\",@undefined),@putByIdDirectPrivate(this,\"disturbed\",!1),@putByIdDirectPrivate(this,\"readableStreamController\",null),@putByIdDirectPrivate(this,\"bunNativeType\",@getByIdDirectPrivate(_,\"bunNativeType\")\?\?0),@putByIdDirectPrivate(this,\"bunNativePtr\",@getByIdDirectPrivate(_,\"bunNativePtr\")\?\?0);const m=_.type===\"direct\",v=!!_.@lazy,f=m||v;if(@getByIdDirectPrivate(_,\"pull\")!==@undefined&&!f){const B=@getByIdDirectPrivate(I,\"size\"),b=@getByIdDirectPrivate(I,\"highWaterMark\");return @putByIdDirectPrivate(this,\"highWaterMark\",b),@putByIdDirectPrivate(this,\"underlyingSource\",@undefined),@setupReadableStreamDefaultController(this,_,B,b!==@undefined\?b:1,@getByIdDirectPrivate(_,\"start\"),@getByIdDirectPrivate(_,\"pull\"),@getByIdDirectPrivate(_,\"cancel\")),this}if(m)@putByIdDirectPrivate(this,\"underlyingSource\",_),@putByIdDirectPrivate(this,\"highWaterMark\",@getByIdDirectPrivate(I,\"highWaterMark\")),@putByIdDirectPrivate(this,\"start\",()=>@createReadableStreamController(this,_,I));else if(f){const B=_.autoAllocateChunkSize;@putByIdDirectPrivate(this,\"highWaterMark\",@undefined),@putByIdDirectPrivate(this,\"underlyingSource\",@undefined),@putByIdDirectPrivate(this,\"highWaterMark\",B||@getByIdDirectPrivate(I,\"highWaterMark\")),@putByIdDirectPrivate(this,\"start\",()=>{const b=@lazyLoadStream(this,B);if(b)@createReadableStreamController(this,b,I)})}else @putByIdDirectPrivate(this,\"underlyingSource\",@undefined),@putByIdDirectPrivate(this,\"highWaterMark\",@getByIdDirectPrivate(I,\"highWaterMark\")),@putByIdDirectPrivate(this,\"start\",@undefined),@createReadableStreamController(this,_,I);return this})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_readableStreamPipeThroughCode = "(function (y,h){\"use strict\";const j=y,k=j[\"readable\"];if(!@isReadableStream(k))throw @makeTypeError(\"readable should be ReadableStream\");const q=j[\"writable\"],_=@getInternalWritableStream(q);if(!@isWritableStream(_))throw @makeTypeError(\"writable should be WritableStream\");let u=!1,d=!1,c=!1,x;if(!@isUndefinedOrNull(h)){if(!@isObject(h))throw @makeTypeError(\"options must be an object\");if(d=!!h[\"preventAbort\"],c=!!h[\"preventCancel\"],u=!!h[\"preventClose\"],x=h[\"signal\"],x!==@undefined&&!@isAbortSignal(x))throw @makeTypeError(\"options.signal must be AbortSignal\")}if(!@isReadableStream(this))throw @makeThisTypeError(\"ReadableStream\",\"pipeThrough\");if(@isReadableStreamLocked(this))throw @makeTypeError(\"ReadableStream is locked\");if(@isWritableStreamLocked(_))throw @makeTypeError(\"WritableStream is locked\");return @readableStreamPipeToWritableStream(this,_,u,d,c,x),k})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerCloseCode = "(function (d){\"use strict\";if(@assert(!@getByIdDirectPrivate(d,\"closeRequested\")),@assert(@getByIdDirectPrivate(@getByIdDirectPrivate(d,\"controlledReadableStream\"),\"state\")===@streamReadable),@getByIdDirectPrivate(d,\"queue\").size>0){@putByIdDirectPrivate(d,\"closeRequested\",!0);return}var u=@getByIdDirectPrivate(d,\"pendingPullIntos\")\?.peek();if(u){if(u.bytesFilled>0){const a=@makeTypeError(\"Close requested while there remain pending bytes\");throw @readableByteStreamControllerError(d,a),a}}@readableStreamClose(@getByIdDirectPrivate(d,\"controlledReadableStream\"))})\n";
...
=======
const char* const s_readableByteStreamInternalsReadableByteStreamControllerFillDescriptorFromQueueCode = "(function (_,H){\"use strict\";const q=H.bytesFilled-H.bytesFilled%H.elementSize,j=@getByIdDirectPrivate(_,\"queue\").size<H.byteLength-H.bytesFilled\?@getByIdDirectPrivate(_,\"queue\").size:H.byteLength-H.bytesFilled,k=H.bytesFilled+j,G=k-k%H.elementSize;let v=j,J=!1;if(G>q)v=G-H.bytesFilled,J=!0;while(v>0){let w=@getByIdDirectPrivate(_,\"queue\").content.peek();const E=v<w.byteLength\?v:w.byteLength,z=H.byteOffset+H.bytesFilled;if(new @Uint8Array(H.buffer).set(new @Uint8Array(w.buffer,w.byteOffset,E),z),w.byteLength===E)@getByIdDirectPrivate(_,\"queue\").content.shift();else w.byteOffset+=E,w.byteLength-=E;@getByIdDirectPrivate(_,\"queue\").size-=E,@assert(@getByIdDirectPrivate(_,\"pendingPullIntos\").isEmpty()||@getByIdDirectPrivate(_,\"pendingPullIntos\").peek()===H),@readableByteStreamControllerInvalidateBYOBRequest(_),H.bytesFilled+=E,v-=E}if(!J)@assert(@getByIdDirectPrivate(_,\"queue\").size===0),@assert(H.bytesFilled>0),@assert(H.bytesFilled<H.elementSize);return J})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
const char* const s_readableByteStreamInternalsReadableByteStreamControllerCommitDescriptorCode = "(function (_,g){\"use strict\";@assert(@getByIdDirectPrivate(_,\"state\")!==@streamErrored);let b=!1;if(@getByIdDirectPrivate(_,\"state\")===@streamClosed)@assert(!g.bytesFilled),b=!0;let h=@readableByteStreamControllerConvertDescriptor(g);if(g.readerType===\"default\")@readableStreamFulfillReadRequest(_,h,b);else @assert(g.readerType===\"byob\"),@readableStreamFulfillReadIntoRequest(_,h,b)})\n";
...
=======
const char* const s_readableByteStreamInternalsReadableByteStreamControllerPullIntoCode = "(function (_,N){\"use strict\";const d=@getByIdDirectPrivate(_,\"controlledReadableStream\");let k=1;if(N.BYTES_PER_ELEMENT!==@undefined)k=N.BYTES_PER_ELEMENT;const E=N.constructor,b={buffer:N.buffer,byteOffset:N.byteOffset,byteLength:N.byteLength,bytesFilled:0,elementSize:k,ctor:E,readerType:\"byob\"};var A=@getByIdDirectPrivate(_,\"pendingPullIntos\");if(A\?.isNotEmpty())return b.buffer=@transferBufferToCurrentRealm(b.buffer),A.push(b),@readableStreamAddReadIntoRequest(d);if(@getByIdDirectPrivate(d,\"state\")===@streamClosed){const R=new E(b.buffer,b.byteOffset,0);return @createFulfilledPromise({value:R,done:!0})}if(@getByIdDirectPrivate(_,\"queue\").size>0){if(@readableByteStreamControllerFillDescriptorFromQueue(_,b)){const R=@readableByteStreamControllerConvertDescriptor(b);return @readableByteStreamControllerHandleQueueDrain(_),@createFulfilledPromise({value:R,done:!1})}if(@getByIdDirectPrivate(_,\"closeRequested\")){const R=@makeTypeError(\"Closing stream has been requested\");return @readableByteStreamControllerError(_,R),@Promise.@reject(R)}}b.buffer=@transferBufferToCurrentRealm(b.buffer),@getByIdDirectPrivate(_,\"pendingPullIntos\").push(b);const L=@readableStreamAddReadIntoRequest(d);return @readableByteStreamControllerCallPullIfNeeded(_),L})\n";
>>>>>>> 83598b18c (WebKit instructions)
...
=======
const char* const s_eventSourceGetEventSourceCode = "(function (){\"use strict\";class B extends EventTarget{#$;#j;#w;#A;#B;#F=!1;#G=null;#J=\"\";#K=\"\";#L=\"\";#M=!0;#O=0;#Q=0;#U=0;#V=null;static#W(M){M.#H()}static#X(M,Q){const F=M.data,O=F.#L\?`Last-Event-ID: ${F.#L}\\r\\n`:\"\",U=`GET ${Q.pathname}${Q.search} HTTP/1.1\\r\\nHost: bun\\r\\nContent-type: text/event-stream\\r\\nContent-length: 0\\r\\n${O}\\r\\n`,V=M.write(U);if(V!==U.length)F.#K=U.substring(V)}static#Y(M,Q,F){for(;;){if(F>=Q.length)return;let O=-1,U=Q.indexOf(\"\\r\\n\",F);const V=U+2;if(U>0)if(M.#O===0){const Y=parseInt(Q.substring(F,U),16);if(Y===0){M.#j=2,M.#G\?.end();return}O=V+Y}else O=Q.length;else{if(M.#J.length===0){M.#J+=Q.substring(F);return}O=Q.length}let W=Q.substring(V,O);F=O+2;let X=0,G=W.indexOf(\"\\n\\n\");if(G==-1){M.#J+=Q.substring(V);return}if(M.#J.length)M.#J+=W,W=M.#J,M.#J=\"\";let J=!0;while(J){const Y=W.substring(X,G);let K,Z=\"\",z,w=0,L=-1;for(;;){let H=Y.indexOf(\"\\n\",w);if(H===-1){if(w>=Y.length)break;H=Y.length}const A=Y.substring(w,H);if(A.startsWith(\"data:\"))if(Z.length)Z+=`\\n${A.substring(5).trim()}`;else Z=A.substring(5).trim();else if(A.startsWith(\"event:\"))K=A.substring(6).trim();else if(A.startsWith(\"id:\"))z=A.substring(3).trim();else if(A.startsWith(\"retry:\")){if(L=parseInt(A.substring(6).trim(),10),@isNaN(L))L=-1}w=H+1}if(M.#L=z||\"\",L>=0)M.#U=L;if(Z||z||K)M.dispatchEvent(new MessageEvent(K||\"message\",{data:Z||\"\",origin:M.#$.origin,source:M,lastEventId:z}));if(W.length===G+2){J=!1;break}const j=W.indexOf(\"\\n\\n\",G+1);if(j===-1)break;X=G,G=j}}}static#Z={open(M){const Q=M.data;if(Q.#G=M,!Q.#F)B.#X(M,Q.#$)},handshake(M,Q,F){const O=M.data;if(Q)B.#X(M,O.#$);else O.#j=2,O.dispatchEvent(new ErrorEvent(\"error\",{error:F})),M.end()},data(M,Q){const F=M.data;switch(F.#j){case 0:{let O=Q.toString();const U=O.indexOf(\"\\r\\n\\r\\n\");if(U===-1){F.#J+=O;return}if(F.#J.length)F.#J+=O,O=F.#J,F.#J=\"\";const V=O.substring(0,U),W=V.indexOf(\"\\r\\n\");if(W===-1){F.#j=2,F.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Invalid HTTP request\")})),M.end();return}const X=V.substring(0,W);if(X!==\"HTTP/1.1 200 OK\"){F.#j=2,F.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(X)})),M.end();return}let G=W+1,J=!1,Y=-1;for(;;){let Z=V.indexOf(\"\\r\\n\",G);if(Z===-1){if(G>=V.length){if(!J)F.#j=2,F.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's response has no MIME type and \"text/event-stream\" is required. Aborting the connection.`)})),M.end();return}Z=V.length}const z=V.substring(G+1,Z),w=z.indexOf(\":\"),L=z.substring(0,w),j=L.localeCompare(\"content-type\",@undefined,{sensitivity:\"accent\"})===0;if(G=Z+1,j)if(z.endsWith(\" text/event-stream\"))J=!0;else{F.#j=2,F.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's response has a MIME type that is not \"text/event-stream\". Aborting the connection.`)})),M.end();return}else if(L.localeCompare(\"content-length\",@undefined,{sensitivity:\"accent\"})===0){if(Y=parseInt(z.substring(w+1).trim(),10),@isNaN(Y)||Y<=0){F.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's Content-Length is invalid. Aborting the connection.`)})),M.end();return}if(J)break}else if(L.localeCompare(\"transfer-encoding\",@undefined,{sensitivity:\"accent\"})===0){if(z.substring(w+1).trim()!==\"chunked\"){F.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's Transfer-Encoding is invalid. Aborting the connection.`)})),M.end();return}if(Y=0,J)break}}F.#O=Y,F.#j=1,F.dispatchEvent(new Event(\"open\"));const K=O.substring(U+4);if(B.#Y(F,K,0),F.#O>0){if(F.#Q+=K.length,F.#Q>=F.#O)F.#j=2,M.end()}return}case 1:if(B.#Y(F,Q.toString(),2),F.#O>0){if(F.#Q+=Q.byteLength,F.#Q>=F.#O)F.#j=2,M.end()}return;default:break}},drain(M){const Q=M.data;if(Q.#j===0){const F=Q.#J;if(F.length){const O=M.write(F);if(O!==F.length)M.data.#K=F.substring(O);else M.data.#K=\"\"}}},close:B.#z,end(M){B.#z(M).dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Connection closed by server\")}))},timeout(M){B.#z(M).dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Timeout\")}))},binaryType:\"buffer\"};static#z(M){const Q=M.data;if(Q.#G=null,Q.#Q=0,Q.#j=2,Q.#M){if(Q.#V)clearTimeout(Q.#V);Q.#V=setTimeout(B.#W,Q.#U,Q)}return Q}constructor(M,Q=@undefined){super();const F=new URL(M);this.#F=F.protocol===\"https:\",this.#$=F,this.#j=2,process.nextTick(B.#W,this)}ref(){this.#V\?.ref(),this.#G\?.ref()}unref(){this.#V\?.unref(),this.#G\?.unref()}#H(){if(this.#j!==2)return;const M=this.#$,Q=this.#F;this.#j=0,@Bun.connect({data:this,socket:B.#Z,hostname:M.hostname,port:parseInt(M.port||(Q\?\"443\":\"80\"),10),tls:Q\?{requestCert:!0,rejectUnauthorized:!1}:!1}).catch((F)=>{if(super.dispatchEvent(new ErrorEvent(\"error\",{error:F})),this.#M){if(this.#V)this.#V.unref\?.();this.#V=setTimeout(B.#W,1000,this)}})}get url(){return this.#$.href}get readyState(){return this.#j}close(){this.#M=!1,this.#j=2,this.#G\?.unref(),this.#G\?.end()}get onopen(){return this.#B}get onerror(){return this.#w}get onmessage(){return this.#A}set onopen(M){if(this.#B)super.removeEventListener(\"close\",this.#B);super.addEventListener(\"open\",M),this.#B=M}set onerror(M){if(this.#w)super.removeEventListener(\"error\",this.#w);super.addEventListener(\"error\",M),this.#w=M}set onmessage(M){if(this.#A)super.removeEventListener(\"message\",this.#A);super.addEventListener(\"message\",M),this.#A=M}}return Object.defineProperty(B.prototype,\"CONNECTING\",{enumerable:!0,value:0}),Object.defineProperty(B.prototype,\"OPEN\",{enumerable:!0,value:1}),Object.defineProperty(B.prototype,\"CLOSED\",{enumerable:!0,value:2}),B[Symbol.for(\"CommonJS\")]=0,B})\n";
>>>>>>> 83598b18c (WebKit instructions)
