...
=======
const char* const s_writableStreamInternalsCreateInternalWritableStreamFromUnderlyingSinkCode = "(function (f,o){\"use strict\";const w={};if(f===@undefined)f={};if(o===@undefined)o={};if(!@isObject(f))@throwTypeError(\"WritableStream constructor takes an object as first argument\");if(\"type\"in f)@throwRangeError(\"Invalid type is specified\");const C=@extractSizeAlgorithm(o),E=@extractHighWaterMark(o,1),_={};if(\"start\"in f){if(_[\"start\"]=f[\"start\"],typeof _[\"start\"]!==\"function\")@throwTypeError(\"underlyingSink.start should be a function\")}if(\"write\"in f){if(_[\"write\"]=f[\"write\"],typeof _[\"write\"]!==\"function\")@throwTypeError(\"underlyingSink.write should be a function\")}if(\"close\"in f){if(_[\"close\"]=f[\"close\"],typeof _[\"close\"]!==\"function\")@throwTypeError(\"underlyingSink.close should be a function\")}if(\"abort\"in f){if(_[\"abort\"]=f[\"abort\"],typeof _[\"abort\"]!==\"function\")@throwTypeError(\"underlyingSink.abort should be a function\")}return @initializeWritableStreamSlots(w,f),@setUpWritableStreamDefaultControllerFromUnderlyingSink(w,f,_,E,C),w})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
=======
const char* const s_writableStreamInternalsSetUpWritableStreamDefaultControllerCode = "(function (_,U,B,v,P,d,f,j){\"use strict\";@assert(@isWritableStream(_)),@assert(@getByIdDirectPrivate(_,\"controller\")===@undefined),@putByIdDirectPrivate(U,\"stream\",_),@putByIdDirectPrivate(_,\"controller\",U),@resetQueue(@getByIdDirectPrivate(U,\"queue\")),@putByIdDirectPrivate(U,\"started\",-1),@putByIdDirectPrivate(U,\"startAlgorithm\",B),@putByIdDirectPrivate(U,\"strategySizeAlgorithm\",j),@putByIdDirectPrivate(U,\"strategyHWM\",f),@putByIdDirectPrivate(U,\"writeAlgorithm\",v),@putByIdDirectPrivate(U,\"closeAlgorithm\",P),@putByIdDirectPrivate(U,\"abortAlgorithm\",d);const q=@writableStreamDefaultControllerGetBackpressure(U);@writableStreamUpdateBackpressure(_,q),@writableStreamDefaultControllerStart(U)})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
const char* const s_transformStreamInternalsTransformStreamSetBackpressureCode = "(function (f,_){\"use strict\";@assert(@getByIdDirectPrivate(f,\"backpressure\")!==_);const d=@getByIdDirectPrivate(f,\"backpressureChangePromise\");if(d!==@undefined)d.@resolve.@call();@putByIdDirectPrivate(f,\"backpressureChangePromise\",@newPromiseCapability(@Promise)),@putByIdDirectPrivate(f,\"backpressure\",_)})\n";
...
>>>>>>> 175d327a (finish up)
=======
const char* const s_processObjectInternalsGetStdinStreamCode = "(function (j,J,z){\"use strict\";var L={path:\"node:process\",require:J},M=(T)=>L.require(T),{Duplex:N,eos:G,destroy:P}=M(\"node:stream\"),Q=class T extends N{#Y;#$;#j;#z=!0;#G=!1;#H=!0;#I;#J;#K;get isTTY(){return M(\"tty\").isatty(j)}get fd(){return j}constructor(){super({readable:!0,writable:!0})}#L(Y){const K=this.#J;if(this.#J=null,K)K(Y);else if(Y)this.destroy(Y);else if(!this.#z&&!this.#H)this.destroy()}_destroy(Y,K){if(!Y&&this.#J!==null){var H=class I extends Error{constructor(U=\"The operation was aborted\",V=void 0){if(V!==void 0&&typeof V!==\"object\")throw new Error(`Invalid AbortError options:\\n\\n${JSON.stringify(V,null,2)}`);super(U,V);this.code=\"ABORT_ERR\",this.name=\"AbortError\"}};Y=new H}if(this.#J===null)K(Y);else if(this.#J=K,this.#j)P(this.#j,Y)}setRawMode(Y){}on(Y,K){if(Y===\"readable\")this.ref(),this.#G=!0;return super.on(Y,K)}pause(){return this.unref(),super.pause()}resume(){return this.ref(),super.resume()}ref(){this.#Y\?\?=z.stdin.stream().getReader(),this.#$\?\?=setInterval(()=>{},1<<30)}unref(){if(this.#$)clearInterval(this.#$),this.#$=null}async#M(){try{var Y,K;const H=this.#Y.readMany();if(!H\?.then)({done:Y,value:K}=H);else({done:Y,value:K}=await H);if(!Y){this.push(K[0]);const I=K.length;for(let U=1;U<I;U++)this.push(K[U])}else this.push(null),this.pause(),this.#z=!1,this.#L()}catch(H){this.#z=!1,this.#L(H)}}_read(Y){if(this.#G)this.unref(),this.#G=!1;this.#M()}#N(){var{createWriteStream:Y}=M(\"node:fs\"),K=this.#j=Y(\"/dev/fd/0\");return K.on(\"finish\",()=>{if(this.#I){const H=this.#I;this.#I=null,H()}}),K.on(\"drain\",()=>{if(this.#K){const H=this.#K;this.#K=null,H()}}),G(K,(H)=>{if(this.#H=!1,H)P(K,H);this.#L(H)}),K}_write(Y,K,H){var I=this.#j;if(!I)I=this.#N();if(I.write(Y,K))H();else this.#K=H}_final(Y){this.#j.end(),this.#I=(...K)=>Y(...K)}};return new Q})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
>>>>>>> 175d327a (finish up)
=======
const char* const s_transformStreamInitializeTransformStreamCode = "(function (){\"use strict\";let _=arguments[0];if(@isObject(_)&&@getByIdDirectPrivate(_,\"TransformStream\"))return this;let u=arguments[1],E=arguments[2];if(_===@undefined)_=null;if(E===@undefined)E={};if(u===@undefined)u={};let j={};if(_!==null){if(\"start\"in _){if(j[\"start\"]=_[\"start\"],typeof j[\"start\"]!==\"function\")@throwTypeError(\"transformer.start should be a function\")}if(\"transform\"in _){if(j[\"transform\"]=_[\"transform\"],typeof j[\"transform\"]!==\"function\")@throwTypeError(\"transformer.transform should be a function\")}if(\"flush\"in _){if(j[\"flush\"]=_[\"flush\"],typeof j[\"flush\"]!==\"function\")@throwTypeError(\"transformer.flush should be a function\")}if(\"readableType\"in _)@throwRangeError(\"TransformStream transformer has a readableType\");if(\"writableType\"in _)@throwRangeError(\"TransformStream transformer has a writableType\")}const F=@extractHighWaterMark(E,0),q=@extractSizeAlgorithm(E),G=@extractHighWaterMark(u,1),v=@extractSizeAlgorithm(u),I=@newPromiseCapability(@Promise);if(@initializeTransformStream(this,I.@promise,G,v,F,q),@setUpTransformStreamDefaultControllerFromTransformer(this,_,j),(\"start\"in j)){const x=@getByIdDirectPrivate(this,\"controller\");(()=>@promiseInvokeOrNoopMethodNoCatch(_,j[\"start\"],[x]))().@then(()=>{I.@resolve.@call()},(B)=>{I.@reject.@call(@undefined,B)})}else I.@resolve.@call();return this})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
>>>>>>> bb697687 (stuff)
=======
const char* const s_jsBufferPrototypeSliceCode = "(function (i,k){\"use strict\";var{buffer:m,byteOffset:q,byteLength:c}=this;function w(z,v){if(z=@trunc(z),z===0||@isNaN(z))return 0;else if(z<0)return z+=v,z>0\?z:0;else return z<v\?z:v}var p=w(i,c),x=k!==@undefined\?w(k,c):c;return new @Buffer(m,q+p,x>p\?x-p:0)})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
>>>>>>> 175d327a (finish up)
=======
const char* const s_consoleObjectAsyncIteratorCode = "(function (){\"use strict\";const j=async function*A(){var F=@Bun.stdin.stream().getReader(),G=new globalThis.TextDecoder(\"utf-8\",{fatal:!1}),q,H=@Bun.indexOfLine;try{while(!0){var J,K,w;const L=F.readMany();if(@isPromise(L))({done:J,value:K}=await L);else({done:J,value:K}=L);if(J){if(w)yield G.decode(w);return}var _;for(let M of K){if(_=M,w)_=@Buffer.concat([w,M]),w=null;var z=0,B=H(_,z);while(B!==-1)yield G.decode(_.subarray(z,B)),z=B+1,B=H(_,z);w=_.subarray(z)}}}catch(L){q=L}finally{if(F.releaseLock(),q)throw q}},m=globalThis.Symbol.asyncIterator;return this[m]=j,j()})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
const char* const s_readableStreamInternalsPrivateInitializeReadableStreamDefaultControllerCode = "(function (d,_,b,P){\"use strict\";if(!@isReadableStream(d))@throwTypeError(\"ReadableStreamDefaultController needs a ReadableStream\");if(@getByIdDirectPrivate(d,\"readableStreamController\")!==null)@throwTypeError(\"ReadableStream already has a controller\");return @putByIdDirectPrivate(this,\"controlledReadableStream\",d),@putByIdDirectPrivate(this,\"underlyingSource\",_),@putByIdDirectPrivate(this,\"queue\",@newQueue()),@putByIdDirectPrivate(this,\"started\",-1),@putByIdDirectPrivate(this,\"closeRequested\",!1),@putByIdDirectPrivate(this,\"pullAgain\",!1),@putByIdDirectPrivate(this,\"pulling\",!1),@putByIdDirectPrivate(this,\"strategy\",@validateAndNormalizeQueuingStrategy(b,P)),this})\n";
...
>>>>>>> 175d327a (finish up)
=======
const char* const s_readableStreamInternalsReadableStreamPipeToCode = "(function (c,h){\"use strict\";@assert(@isReadableStream(c));const y=new @ReadableStreamDefaultReader(c);@getByIdDirectPrivate(y,\"closedPromiseCapability\").@promise.@then(()=>{},(g)=>{h.error(g)});function _(){@readableStreamDefaultReaderRead(y).@then(function(g){if(g.done){h.close();return}try{h.enqueue(g.value)}catch(S){h.error(\"ReadableStream chunk enqueueing in the sink failed\");return}_()},function(g){h.error(g)})}_()})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
>>>>>>> 175d327a (finish up)
=======
const char* const s_readableStreamInternalsSetupReadableStreamDefaultControllerCode = "(function (_,w,q,v,x,B,f){\"use strict\";const C=new @ReadableStreamDefaultController(_,w,q,v,@isReadableStream),D=()=>@promiseInvokeOrNoopMethod(w,B,[C]),b=(j)=>@promiseInvokeOrNoopMethod(w,f,[j]);@putByIdDirectPrivate(C,\"pullAlgorithm\",D),@putByIdDirectPrivate(C,\"cancelAlgorithm\",b),@putByIdDirectPrivate(C,\"pull\",@readableStreamDefaultControllerPull),@putByIdDirectPrivate(C,\"cancel\",@readableStreamDefaultControllerCancel),@putByIdDirectPrivate(_,\"readableStreamController\",C),@readableStreamDefaultControllerStart(C)})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
>>>>>>> f0a3559e (add a workaround for eventstream headers)
=======
const char* const s_readableStreamInternalsCreateReadableStreamControllerCode = "(function (C,b,f){\"use strict\";const j=b.type,_=@toString(j);if(_===\"bytes\"){if(f.highWaterMark===@undefined)f.highWaterMark=0;if(f.size!==@undefined)@throwRangeError(\"Strategy for a ReadableByteStreamController cannot have a size\");@putByIdDirectPrivate(C,\"readableStreamController\",new @ReadableByteStreamController(C,b,f.highWaterMark,@isReadableStream))}else if(_===\"direct\"){var A=f\?.highWaterMark;@initializeArrayBufferStream.@call(C,b,A)}else if(j===@undefined){if(f.highWaterMark===@undefined)f.highWaterMark=1;@setupReadableStreamDefaultController(C,b,f.size,f.highWaterMark,b.start,b.pull,b.cancel)}else @throwRangeError(\"Invalid type for underlying source\")})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
=======
const char* const s_readableStreamInternalsReadableStreamDefaultControllerEnqueueCode = "(function (D,E){\"use strict\";const _=@getByIdDirectPrivate(D,\"controlledReadableStream\");if(@assert(@readableStreamDefaultControllerCanCloseOrEnqueue(D)),@isReadableStreamLocked(_)&&@getByIdDirectPrivate(@getByIdDirectPrivate(_,\"reader\"),\"readRequests\")\?.isNotEmpty()){@readableStreamFulfillReadRequest(_,E,!1),@readableStreamDefaultControllerCallPullIfNeeded(D);return}try{let d=1;if(@getByIdDirectPrivate(D,\"strategy\").size!==@undefined)d=@getByIdDirectPrivate(D,\"strategy\").size(E);@enqueueValueWithSize(@getByIdDirectPrivate(D,\"queue\"),E,d)}catch(d){throw @readableStreamDefaultControllerError(D,d),d}@readableStreamDefaultControllerCallPullIfNeeded(D)})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
>>>>>>> 175d327a (finish up)
=======
const char* const s_readableStreamInternalsLazyLoadStreamCode = "(function (W,I){\"use strict\";var L=@getByIdDirectPrivate(W,\"bunNativeType\"),J=@getByIdDirectPrivate(W,\"bunNativePtr\"),K=@lazyStreamPrototypeMap.@get(L);if(K===@undefined){let Y=function(p){var{c:z,v:f}=this;this.c=@undefined,this.v=@undefined,O(p,z,f)},Z=function(p){try{p.close()}catch(z){globalThis.reportError(z)}},_=function(p,z,f,x){x[0]=!1;var A;try{A=b(p,f,x)}catch(H){return z.error(H)}return O(A,z,f)};var F=Y,X=Z,U=_,[b,m,q,B,j,M,N]=@lazyLoad(L),D=[!1],O;O=function p(z,f,x){if(z&&@isPromise(z))return z.then(Y.bind({c:f,v:x}),(A)=>f.error(A));else if(typeof z===\"number\")if(x&&x.byteLength===z&&x.buffer===f.byobRequest\?.view\?.buffer)f.byobRequest.respondWithNewView(x);else f.byobRequest.respond(z);else if(z.constructor===@Uint8Array)f.enqueue(z);if(D[0]||z===!1)@enqueueJob(Z,f),D[0]=!1};const G=j\?new FinalizationRegistry(j):null;K=class p{constructor(z,f,x){if(this.#f=z,this.#b={},this.pull=this.#j.bind(this),this.cancel=this.#m.bind(this),this.autoAllocateChunkSize=f,x!==@undefined)this.start=(A)=>{A.enqueue(x)};if(G)G.register(this,z,this.#b)}#b;pull;cancel;start;#f;type=\"bytes\";autoAllocateChunkSize=0;static startSync=m;#j(z){var f=this.#f;if(!f){z.close();return}_(f,z,z.byobRequest.view,D)}#m(z){var f=this.#f;G&&G.unregister(this.#b),M&&M(f,!1),q(f,z)}static deinit=j;static drain=N},@lazyStreamPrototypeMap.@set(L,K)}const P=K.startSync(J,I);var Q;const{drain:E,deinit:y}=K;if(E)Q=E(J);if(P===0){if(j&&J&&@enqueueJob(j,J),(Q\?.byteLength\?\?0)>0)return{start(Y){Y.enqueue(Q),Y.close()},type:\"bytes\"};return{start(Y){Y.close()},type:\"bytes\"}}return new K(J,P,Q)})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
>>>>>>> 175d327a (finish up)
=======
const char* const s_readableStreamInternalsReadableStreamDefineLazyIteratorsCode = "(function (k){\"use strict\";var z=globalThis.Symbol.asyncIterator,D=async function*F(h,j){var q=h.getReader(),B;try{while(!0){var G,w;const x=q.readMany();if(@isPromise(x))({done:G,value:w}=await x);else({done:G,value:w}=x);if(G)return;yield*w}}catch(x){B=x}finally{if(q.releaseLock(),!j)h.cancel(B);if(B)throw B}},g=function F(){return D(this,!1)},i=function F({preventCancel:h=!1}={preventCancel:!1}){return D(this,h)};return @Object.@defineProperty(k,z,{value:g}),@Object.@defineProperty(k,\"values\",{value:i}),k})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
>>>>>>> 175d327a (finish up)
=======
const char* const s_readableStreamDefaultReaderReadManyCode = "(function (){\"use strict\";if(!@isReadableStreamDefaultReader(this))@throwTypeError(\"ReadableStreamDefaultReader.readMany() should not be called directly\");const w=@getByIdDirectPrivate(this,\"ownerReadableStream\");if(!w)@throwTypeError(\"readMany() called on a reader owned by no readable stream\");const A=@getByIdDirectPrivate(w,\"state\");if(@putByIdDirectPrivate(w,\"disturbed\",!0),A===@streamClosed)return{value:[],size:0,done:!0};else if(A===@streamErrored)throw @getByIdDirectPrivate(w,\"storedError\");var C=@getByIdDirectPrivate(w,\"readableStreamController\"),x=@getByIdDirectPrivate(C,\"queue\");if(!x)return C.@pull(C).@then(function({done:B,value:S}){return B\?{done:!0,value:[],size:0}:{value:[S],size:1,done:!1}});const H=x.content;var J=x.size,E=H.toArray(!1),K=E.length;if(K>0){var d=@newArrayWithSize(K);if(@isReadableByteStreamController(C)){{const B=E[0];if(!(@ArrayBuffer.@isView(B)||B instanceof @ArrayBuffer))@putByValDirect(d,0,new @Uint8Array(B.buffer,B.byteOffset,B.byteLength));else @putByValDirect(d,0,B)}for(var N=1;N<K;N++){const B=E[N];if(!(@ArrayBuffer.@isView(B)||B instanceof @ArrayBuffer))@putByValDirect(d,N,new @Uint8Array(B.buffer,B.byteOffset,B.byteLength));else @putByValDirect(d,N,B)}}else{@putByValDirect(d,0,E[0].value);for(var N=1;N<K;N++)@putByValDirect(d,N,E[N].value)}if(@resetQueue(@getByIdDirectPrivate(C,\"queue\")),@getByIdDirectPrivate(C,\"closeRequested\"))@readableStreamClose(@getByIdDirectPrivate(C,\"controlledReadableStream\"));else if(@isReadableStreamDefaultController(C))@readableStreamDefaultControllerCallPullIfNeeded(C);else if(@isReadableByteStreamController(C))@readableByteStreamControllerCallPullIfNeeded(C);return{value:d,size:J,done:!1}}var O=(B)=>{if(B.done)return{value:[],size:0,done:!0};var S=@getByIdDirectPrivate(w,\"readableStreamController\"),F=@getByIdDirectPrivate(S,\"queue\"),T=[B.value].concat(F.content.toArray(!1)),I=T.length;if(@isReadableByteStreamController(S))for(var U=0;U<I;U++){const _=T[U];if(!(@ArrayBuffer.@isView(_)||_ instanceof @ArrayBuffer)){const{buffer:k,byteOffset:D,byteLength:G}=_;@putByValDirect(T,U,new @Uint8Array(k,D,G))}}else for(var U=1;U<I;U++)@putByValDirect(T,U,T[U].value);var j=F.size;if(@resetQueue(F),@getByIdDirectPrivate(S,\"closeRequested\"))@readableStreamClose(@getByIdDirectPrivate(S,\"controlledReadableStream\"));else if(@isReadableStreamDefaultController(S))@readableStreamDefaultControllerCallPullIfNeeded(S);else if(@isReadableByteStreamController(S))@readableByteStreamControllerCallPullIfNeeded(S);return{value:T,size:j,done:!1}},Q=C.@pull(C);if(Q&&@isPromise(Q))return Q.@then(O);return O(Q)})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
const char* const s_streamInternalsPromiseInvokeOrNoopCode = "(function (n,l,d){\"use strict\";try{return @promiseInvokeOrNoopNoCatch(n,l,d)}catch(m){return @Promise.@reject(m)}})\n";
...
>>>>>>> bb697687 (stuff)
=======
const char* const s_importMetaObjectInternalRequireCode = "(function (_){\"use strict\";var k=@requireMap.@get(_);const n=_.substring(_.length-5);if(k)return k.exports;if(n===\".json\"){var g=globalThis[Symbol.for(\"_fs\")]||=@Bun.fs(),q=JSON.parse(g.readFileSync(_,\"utf8\"));return @requireMap.@set(_,@createCommonJSModule(_,q,!0)),q}else if(n===\".node\"){const b=@createCommonJSModule(_,{},!0);return process.dlopen(b,_),@requireMap.@set(_,b),b.exports}else if(n===\".toml\"){var g=globalThis[Symbol.for(\"_fs\")]||=@Bun.fs(),q=@Bun.TOML.parse(g.readFileSync(_,\"utf8\"));return @requireMap.@set(_,@createCommonJSModule(_,q,!0)),q}else{var q=@requireESM(_);const j=@requireMap.@get(_);if(j)return j.exports;var v=q\?.default;if(v\?.[@commonJSSymbol]===0)q=v;return @requireMap.@set(_,@createCommonJSModule(_,q,!0)),q}})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
>>>>>>> 175d327a (finish up)
=======
const char* const s_readableStreamConsumeReadableStreamCode = "(function (_,w,D){\"use strict\";const x=globalThis.Symbol.for(\"Bun.consumeReadableStreamPrototype\");var H=globalThis[x];if(!H)H=globalThis[x]=[];var G=H[w];if(G===@undefined){var[I,J,K,F,L,N]=globalThis[globalThis.Symbol.for(\"Bun.lazy\")](w);G=class A{handleError;handleClosed;processResult;constructor(B,k){this.#_=k,this.#F=B,this.#$=!1,this.handleError=this._handleError.bind(this),this.handleClosed=this._handleClosed.bind(this),this.processResult=this._processResult.bind(this),B.closed.then(this.handleClosed,this.handleError)}_handleClosed(){if(this.#$)return;this.#$=!0;var B=this.#_;this.#_=0,F(B),N(B)}_handleError(B){if(this.#$)return;this.#$=!0;var k=this.#_;this.#_=0,J(k,B),N(k)}#_;#$=!1;#F;_handleReadMany({value:B,done:k,size:q}){if(k){this.handleClosed();return}if(this.#$)return;K(this.#_,B,k,q)}read(){if(!this.#_)return @throwTypeError(\"ReadableStreamSink is already closed\");return this.processResult(this.#F.read())}_processResult(B){if(B&&@isPromise(B)){if(@getPromiseInternalField(B,@promiseFieldFlags)&@promiseStateFulfilled){const q=@getPromiseInternalField(B,@promiseFieldReactionsOrResult);if(q)B=q}}if(B&&@isPromise(B))return B.then(this.processResult,this.handleError),null;if(B.done)return this.handleClosed(),0;else if(B.value)return B.value;else return-1}readMany(){if(!this.#_)return @throwTypeError(\"ReadableStreamSink is already closed\");return this.processResult(this.#F.readMany())}};const j=w+1;if(H.length<j)H.length=j;@putByValDirect(H,w,G)}if(@isReadableStreamLocked(D))@throwTypeError(\"Cannot start reading from a locked stream\");return new G(D.getReader(),_)})\n";
>>>>>>> ebaff277 (revert EventStream manually)
...
>>>>>>> 175d327a (finish up)
=======
const char* const s_eventSourceGetEventSourceCode = "(function (){\"use strict\";class Q extends EventTarget{#$;#j;#w;#A;#B;#F=!1;#G=null;#J=\"\";#K=\"\";#L=\"\";#M=!0;#O=0;#Q=0;#U=0;#V=null;static#W(U){U.#H()}static#X(U,V){const W=U.data,X=W.#L\?`Last-Event-ID: ${W.#L}\\r\\n`:\"\",Y=`GET ${V.pathname}${V.search} HTTP/1.1\\r\\nHost: bun\\r\\nContent-type: text/event-stream\\r\\nContent-length: 0\\r\\n${X}\\r\\n`,Z=U.write(Y);if(Z!==Y.length)W.#K=Y.substring(Z)}static#Y(U,V,W){for(;;){if(W>=V.length)return;let X=-1,Y=V.indexOf(\"\\r\\n\",W);const Z=Y+2;if(Y>0)if(U.#O===0){const L=parseInt(V.substring(W,Y),16);if(L===0){U.#j=2,U.#G\?.end();return}X=Z+L}else X=V.length;else{if(U.#J.length===0){U.#J+=V.substring(W);return}X=V.length}let G=V.substring(Z,X);W=X+2;let K=0,j=G.indexOf(\"\\n\\n\");if(j==-1){U.#J+=V.substring(Z);return}if(U.#J.length)U.#J+=G,G=U.#J,U.#J=\"\";let B=!0;while(B){const L=G.substring(K,j);let z,M=\"\",F,H=0,A=-1;for(;;){let J=L.indexOf(\"\\n\",H);if(J===-1){if(H>=L.length)break;J=L.length}const O=L.substring(H,J);if(O.startsWith(\"data:\"))if(M.length)M+=`\\n${O.substring(5).trim()}`;else M=O.substring(5).trim();else if(O.startsWith(\"event:\"))z=O.substring(6).trim();else if(O.startsWith(\"id:\"))F=O.substring(3).trim();else if(O.startsWith(\"retry:\")){if(A=parseInt(O.substring(6).trim(),10),@isNaN(A))A=-1}H=J+1}if(U.#L=F||\"\",A>=0)U.#U=A;if(M||F||z)U.dispatchEvent(new MessageEvent(z||\"message\",{data:M||\"\",origin:U.#$.origin,source:U,lastEventId:F}));if(G.length===j+2){B=!1;break}const w=G.indexOf(\"\\n\\n\",j+1);if(w===-1)break;K=j,j=w}}}static#Z={open(U){const V=U.data;if(V.#G=U,!V.#F)Q.#X(U,V.#$)},handshake(U,V,W){const X=U.data;if(V)Q.#X(U,X.#$);else X.#j=2,X.dispatchEvent(new ErrorEvent(\"error\",{error:W})),U.end()},data(U,V){const W=U.data;switch(W.#j){case 0:{let X=V.toString();const Y=X.indexOf(\"\\r\\n\\r\\n\");if(Y===-1){W.#J+=X;return}if(W.#J.length)W.#J+=X,X=W.#J,W.#J=\"\";const Z=X.substring(0,Y),G=Z.indexOf(\"\\r\\n\");if(G===-1){W.#j=2,W.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Invalid HTTP request\")})),U.end();return}const K=Z.substring(0,G);if(K!==\"HTTP/1.1 200 OK\"){W.#j=2,W.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(K)})),U.end();return}let j=G+1,B=!1,L=-1;for(;;){let M=Z.indexOf(\"\\r\\n\",j);if(M===-1){if(j>=Z.length){if(!B)W.#j=2,W.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's response has no MIME type and \"text/event-stream\" is required. Aborting the connection.`)})),U.end();return}M=Z.length}const F=Z.substring(j+1,M),H=F.indexOf(\":\"),A=F.substring(0,H),w=A.localeCompare(\"content-type\",@undefined,{sensitivity:\"accent\"})===0;if(j=M+1,w)if(F.endsWith(\" text/event-stream\"))B=!0;else{W.#j=2,W.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's response has a MIME type that is not \"text/event-stream\". Aborting the connection.`)})),U.end();return}else if(A.localeCompare(\"content-length\",@undefined,{sensitivity:\"accent\"})===0){if(L=parseInt(F.substring(H+1).trim(),10),@isNaN(L)||L<=0){W.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's Content-Length is invalid. Aborting the connection.`)})),U.end();return}if(B)break}else if(A.localeCompare(\"transfer-encoding\",@undefined,{sensitivity:\"accent\"})===0){if(F.substring(H+1).trim()!==\"chunked\"){W.dispatchEvent(new ErrorEvent(\"error\",{error:new Error(`EventSource's Transfer-Encoding is invalid. Aborting the connection.`)})),U.end();return}if(L=0,B)break}}W.#O=L,W.#j=1,W.dispatchEvent(new Event(\"open\"));const z=X.substring(Y+4);if(Q.#Y(W,z,0),W.#O>0){if(W.#Q+=z.length,W.#Q>=W.#O)W.#j=2,U.end()}return}case 1:if(Q.#Y(W,V.toString(),2),W.#O>0){if(W.#Q+=V.byteLength,W.#Q>=W.#O)W.#j=2,U.end()}return;default:break}},drain(U){const V=U.data;if(V.#j===0){const W=V.#J;if(W.length){const X=U.write(W);if(X!==W.length)U.data.#K=W.substring(X);else U.data.#K=\"\"}}},close:Q.#z,end(U){Q.#z(U).dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Connection closed by server\")}))},timeout(U){Q.#z(U).dispatchEvent(new ErrorEvent(\"error\",{error:new Error(\"Timeout\")}))},binaryType:\"buffer\"};static#z(U){const V=U.data;if(V.#G=null,V.#Q=0,V.#j=2,V.#M){if(V.#V)clearTimeout(V.#V);V.#V=setTimeout(Q.#W,V.#U,V)}return V}constructor(U,V=@undefined){super();const W=new URL(U);this.#F=W.protocol===\"https:\",this.#$=W,this.#j=2,process.nextTick(Q.#W,this)}ref(){this.#V\?.ref(),this.#G\?.ref()}unref(){this.#V\?.unref(),this.#G\?.unref()}#H(){if(this.#j!==2)return;const U=this.#$,V=this.#F;this.#j=0,@Bun.connect({data:this,socket:Q.#Z,hostname:U.hostname,port:parseInt(U.port||(V\?\"443\":\"80\"),10),tls:V\?{requestCert:!0,rejectUnauthorized:!1}:!1}).catch((W)=>{if(super.dispatchEvent(new ErrorEvent(\"error\",{error:W})),this.#M){if(this.#V)this.#V.unref\?.();this.#V=setTimeout(Q.#W,1000,this)}})}get url(){return this.#$.href}get readyState(){return this.#j}close(){this.#M=!1,this.#j=2,this.#G\?.unref(),this.#G\?.end()}get onopen(){return this.#B}get onerror(){return this.#w}get onmessage(){return this.#A}set onopen(U){if(this.#B)super.removeEventListener(\"close\",this.#B);super.addEventListener(\"open\",U),this.#B=U}set onerror(U){if(this.#w)super.removeEventListener(\"error\",this.#w);super.addEventListener(\"error\",U),this.#w=U}set onmessage(U){if(this.#A)super.removeEventListener(\"message\",this.#A);super.addEventListener(\"message\",U),this.#A=U}}return Object.defineProperty(Q.prototype,\"CONNECTING\",{enumerable:!0,value:0}),Object.defineProperty(Q.prototype,\"OPEN\",{enumerable:!0,value:1}),Object.defineProperty(Q.prototype,\"CLOSED\",{enumerable:!0,value:2}),Q[Symbol.for(\"CommonJS\")]=0,Q})\n";
>>>>>>> ebaff277 (revert EventStream manually)
