...
const int s_transformStreamInternalsTransformStreamDefaultSinkCloseAlgorithmCodeLength = 1003;
...
const int s_processObjectInternalsGetStdinStreamCodeLength = 1385;
...
const int s_moduleMainCodeLength = 62;
...
const int s_jsBufferPrototypeInspectCodeLength = 69;
...
const int s_readableByteStreamControllerEnqueueCodeLength = 564;
static const JSC::Intrinsic s_readableByteStreamControllerEnqueueCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableByteStreamControllerEnqueueCode = "(function (chunk){\"use strict\";if(!@isReadableByteStreamController(this))throw @makeThisTypeError(\"ReadableByteStreamController\",\"enqueue\");if(@getByIdDirectPrivate(this,\"closeRequested\"))@throwTypeError(\"ReadableByteStreamController is requested to close\");if(@getByIdDirectPrivate(@getByIdDirectPrivate(this,\"controlledReadableStream\"),\"state\")!==4)@throwTypeError(\"ReadableStream is not readable\");if(!@isObject(chunk)||!@ArrayBuffer.@isView(chunk))@throwTypeError(\"Provided chunk is not a TypedArray\");return @readableByteStreamControllerEnqueue(this,chunk)})\n";
...
const int s_readableByteStreamControllerErrorCodeLength = 330;
static const JSC::Intrinsic s_readableByteStreamControllerErrorCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableByteStreamControllerErrorCode = "(function (error){\"use strict\";if(!@isReadableByteStreamController(this))throw @makeThisTypeError(\"ReadableByteStreamController\",\"error\");if(@getByIdDirectPrivate(@getByIdDirectPrivate(this,\"controlledReadableStream\"),\"state\")!==4)@throwTypeError(\"ReadableStream is not readable\");@readableByteStreamControllerError(this,error)})\n";
...
const int s_readableByteStreamControllerCloseCodeLength = 419;
static const JSC::Intrinsic s_readableByteStreamControllerCloseCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableByteStreamControllerCloseCode = "(function (){\"use strict\";if(!@isReadableByteStreamController(this))throw @makeThisTypeError(\"ReadableByteStreamController\",\"close\");if(@getByIdDirectPrivate(this,\"closeRequested\"))@throwTypeError(\"Close has already been requested\");if(@getByIdDirectPrivate(@getByIdDirectPrivate(this,\"controlledReadableStream\"),\"state\")!==4)@throwTypeError(\"ReadableStream is not readable\");@readableByteStreamControllerClose(this)})\n";
...
const int s_consoleObjectAsyncIteratorCodeLength = 1018;
static const JSC::Intrinsic s_consoleObjectAsyncIteratorCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_consoleObjectAsyncIteratorCode = "(function (){\"use strict\";const stream=Bun.stdin.stream();var decoder=new TextDecoder(\"utf-8\",{fatal:!1}),deferredError,indexOf=Bun.indexOfLine;async function*ConsoleAsyncIterator(){var reader=stream.getReader();try{while(!0){var done,value,pendingChunk;const firstResult=reader.readMany();if(@isPromise(firstResult))({done,value}=await firstResult);else({done,value}=firstResult);if(done){if(pendingChunk)yield decoder.decode(pendingChunk);console.log(\"done\?\");return}var actualChunk;for(let chunk of value){if(actualChunk=chunk,pendingChunk)actualChunk=@Buffer.concat([pendingChunk,chunk]),pendingChunk=null;var last=0,i=indexOf(actualChunk,last);while(i!==-1)yield decoder.decode(actualChunk.subarray(last,i)),last=i+1,i=indexOf(actualChunk,last);pendingChunk=actualChunk.subarray(last)}}}catch(e){deferredError=e}finally{if(console.log(\"finally\"),reader.releaseLock(),deferredError)throw deferredError}}const symbol=globalThis.Symbol.asyncIterator;return this[symbol]=ConsoleAsyncIterator,ConsoleAsyncIterator()})\n";
...
const int s_consoleObjectWriteCodeLength = 391;
...
const int s_readableStreamInternalsReadableStreamReaderGenericInitializeCodeLength = 558;
static const JSC::Intrinsic s_readableStreamInternalsReadableStreamReaderGenericInitializeCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsReadableStreamReaderGenericInitializeCode = "(function (reader,stream){\"use strict\";if(@putByIdDirectPrivate(reader,\"ownerReadableStream\",stream),@putByIdDirectPrivate(stream,\"reader\",reader),@getByIdDirectPrivate(stream,\"state\")===4)@putByIdDirectPrivate(reader,\"closedPromiseCapability\",@newPromiseCapability(@Promise));else if(@getByIdDirectPrivate(stream,\"state\")===1)@putByIdDirectPrivate(reader,\"closedPromiseCapability\",{promise:@Promise.@resolve()});else @putByIdDirectPrivate(reader,\"closedPromiseCapability\",{promise:@newHandledRejectedPromise(@getByIdDirectPrivate(stream,\"storedError\"))})})\n";
...
const int s_readableStreamInternalsPipeToErrorsMustBePropagatedForwardCodeLength = 526;
...
const int s_readableStreamInternalsPipeToClosingMustBePropagatedForwardCodeLength = 470;
...
const int s_readableStreamInternalsReadDirectStreamCodeLength = 1256;
...
const int s_readableStreamInternalsOnPullDirectStreamCodeLength = 1342;
...
const int s_readableStreamInternalsCreateTextStreamCodeLength = 1477;
...
const int s_readableStreamInternalsInitializeArrayBufferStreamCodeLength = 792;
...
const int s_readableStreamInternalsReadableStreamDefaultControllerGetDesiredSizeCodeLength = 316;
...
const int s_readableStreamInternalsReadableStreamReaderGenericReleaseCodeLength = 693;
static const JSC::Intrinsic s_readableStreamInternalsReadableStreamReaderGenericReleaseCodeIntrinsic = JSC::NoIntrinsic;
const char* const s_readableStreamInternalsReadableStreamReaderGenericReleaseCode = "(function (reader){\"use strict\";if(@getByIdDirectPrivate(@getByIdDirectPrivate(reader,\"ownerReadableStream\"),\"state\")===4)@getByIdDirectPrivate(reader,\"closedPromiseCapability\").reject.@call(@undefined,@makeTypeError(\"releasing lock of reader whose stream is still in readable state\"));else @putByIdDirectPrivate(reader,\"closedPromiseCapability\",{promise:@newHandledRejectedPromise(@makeTypeError(\"reader released lock\"))});const promise=@getByIdDirectPrivate(reader,\"closedPromiseCapability\").promise;@markPromiseAsHandled(promise),@putByIdDirectPrivate(@getByIdDirectPrivate(reader,\"ownerReadableStream\"),\"reader\",@undefined),@putByIdDirectPrivate(reader,\"ownerReadableStream\",@undefined)})\n";
...
const int s_readableStreamInternalsReadableStreamDefaultControllerCanCloseOrEnqueueCodeLength = 193;
...
const char* const s_readableStreamInternalsReadableStreamDefaultControllerCanCloseOrEnqueueCode = "(function (controller){\"use strict\";return!@getByIdDirectPrivate(controller,\"closeRequested\")&&@getByIdDirectPrivate(@getByIdDirectPrivate(controller,\"controlledReadableStream\"),\"state\")===4})\n";
...
const int s_readableStreamInternalsReadableStreamToArrayBufferDirectCodeLength = 1078;
...
const int s_readableStreamInternalsReadableStreamToTextDirectCodeLength = 374;
...
const int s_readableStreamInternalsReadableStreamToArrayDirectCodeLength = 470;
...
const int s_importMetaObjectInternalRequireCodeLength = 854;
...
const int s_importMetaObjectMainCodeLength = 74;
...
const int s_readableStreamReadableStreamToArrayBufferCodeLength = 352;
...
const int s_readableStreamReadableStreamToFormDataCodeLength = 141;
...
const int s_readableStreamReadableStreamToJSONCodeLength = 103;
...
const int s_readableStreamReadableStreamToBlobCodeLength = 125;
...
const int s_readableByteStreamInternalsPrivateInitializeReadableByteStreamControllerCodeLength = 1882;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerGetDesiredSizeCodeLength = 305;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerShouldCallPullCodeLength = 695;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerCallPullIfNeededCodeLength = 734;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerRespondInternalCodeLength = 522;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerCommitDescriptorCodeLength = 370;
...
const int s_readableByteStreamInternalsReadableStreamBYOBReaderReadCodeLength = 371;
...
const int s_readableByteStreamInternalsReadableByteStreamControllerPullIntoCodeLength = 1647;
...
const int s_eventSourceGetEventSourceCodeLength = 8457;
