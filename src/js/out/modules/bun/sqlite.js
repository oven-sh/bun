// src/js/bun/sqlite.js
var symbolFor = Symbol.for;
var lazy = globalThis[symbolFor("Bun.lazy")];
  ...
  constructor(filenameGiven, options) {
    if (typeof filenameGiven === "undefined") {
      ...
      if (isTypedArray(filenameGiven)) {
        this.#handle = Database.deserialize(filenameGiven, typeof options === "object" && options ? !!options.readonly : ((options | 0) & constants.SQLITE_OPEN_READONLY) != 0);
...
var wrapTransaction = (fn, db, { begin, commit, rollback, savepoint, release, rollbackTo }) => function transaction(...args) {
