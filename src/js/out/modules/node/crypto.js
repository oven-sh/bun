...
var require_safe_buffer = __commonJS({
  "node_modules/safe-buffer/index.js"(exports, module) {
    ...
    SafeBuffer.alloc = function(size, fill, encoding) {
      ...
      return fill !== undefined ? typeof encoding == "string" ? buf.fill(fill, encoding) : buf.fill(fill) : buf.fill(0), buf;
    };
...
var require_hash_base = __commonJS({
  "node_modules/hash-base/index.js"(exports, module) {
    var Buffer2 = require_safe_buffer().Buffer, Transform = __require("readable-stream").Transform, inherits = require_inherits_browser();
    function throwIfNotStringOrBuffer(val, prefix) {
      if (!Buffer2.isBuffer(val) && typeof val != "string")
        throw new TypeError(prefix + " must be a string or a buffer");
    }
    function HashBase(blockSize) {
      Transform.call(this), this._block = Buffer2.allocUnsafe(blockSize), this._blockSize = blockSize, this._blockOffset = 0, this._length = [0, 0, 0, 0], this._finalized = false;
    }
    ...
    HashBase.prototype.digest = function(encoding) {
      ...
      encoding !== undefined && (digest = digest.toString(encoding)), this._block.fill(0), this._blockOffset = 0;
      for (var i = 0;i < 4; ++i)
        this._length[i] = 0;
      return digest;
    };
...
var require_ripemd160 = __commonJS({
  "node_modules/ripemd160/index.js"(exports, module) {
    var Buffer2 = __require("buffer").Buffer, inherits = require_inherits_browser(), HashBase = require_hash_base(), ARRAY16 = new Array(16), zl = [
      0,
      1,
      2,
      3,
...
var require_sha512 = __commonJS({
  "node_modules/sha.js/sha512.js"(exports, module) {
    ...
    Sha512.prototype._update = function(M) {
      ...
      for (;i < 160; i += 2) {
        var xh = W2[i - 30], xl = W2[i - 15 * 2 + 1], gamma0 = Gamma0(xh, xl), gamma0l = Gamma0l(xl, xh);
        xh = W2[i - 2 * 2], xl = W2[i - 2 * 2 + 1];
        var gamma1 = Gamma1(xh, xl), gamma1l = Gamma1l(xl, xh), Wi7h = W2[i - 7 * 2], Wi7l = W2[i - 7 * 2 + 1], Wi16h = W2[i - 16 * 2], Wi16l = W2[i - 16 * 2 + 1], Wil = gamma0l + Wi7l | 0, Wih = gamma0 + Wi7h + getCarry(Wil, gamma0l) | 0;
...
var require_cipher_base = __commonJS({
  "node_modules/cipher-base/index.js"(exports, module) {
    var Buffer2 = require_safe_buffer().Buffer, Transform = stream_exports.Transform, StringDecoder = __require("string_decoder").StringDecoder, inherits = require_inherits_browser();
    function CipherBase(hashMode) {
      Transform.call(this), this.hashMode = typeof hashMode == "string", this.hashMode ? this[hashMode] = this._finalOrDigest : this.final = this._finalOrDigest, this._final && (this.__final = this._final, this._final = null), this._decoder = null, this._encoding = null;
    }
...
var require_async = __commonJS({
  "node_modules/pbkdf2/lib/async.js"(exports, module) {
    ...
    module.exports = function(password, salt, iterations, keylen, digest, callback) {
      typeof digest == "function" && (callback = digest, digest = undefined), digest = digest || "sha1";
...
var require_utils = __commonJS({
  "node_modules/des.js/lib/des/utils.js"(exports) {
    ...
    exports.substitute = function(inL, inR) {
      ...
      for (var i = 0;i < 4; i++) {
        var b = inR >>> 18 - i * 6 & 63, sb = sTable[4 * 64 + i * 64 + b];
        out <<= 4, out |= sb;
      }
      return out >>> 0;
    };
...
var require_authCipher = __commonJS({
  "node_modules/browserify-aes/authCipher.js"(exports, module) {
    ...
    function StreamCipher(mode, key, iv, decrypt) {
      ...
      this._ghash = new GHASH(ck), iv = calcIv(this, iv, ck), this._prev = Buffer2.from(iv), this._cache = Buffer2.allocUnsafe(0), this._secCache = Buffer2.allocUnsafe(0), this._decrypt = decrypt, this._alen = 0, this._len = 0, this._mode = mode, this._authTag = null, this._called = false;
    }
...
var require_encrypter = __commonJS({
  "node_modules/browserify-aes/encrypter.js"(exports) {
    ...
    function Cipher(mode, key, iv) {
      Transform.call(this), this._cache = new Splitter, this._cipher = new aes.AES(key), this._prev = Buffer2.from(iv), this._mode = mode, this._autopadding = true;
    }
...
var require_decrypter = __commonJS({
  "node_modules/browserify-aes/decrypter.js"(exports) {
    ...
    function Decipher(mode, key, iv) {
      Transform.call(this), this._cache = new Splitter, this._last = undefined, this._cipher = new aes.AES(key), this._prev = Buffer2.from(iv), this._mode = mode, this._autopadding = true;
    }
    ...
    function createDecipheriv(suite, password, iv) {
      ...
      if (typeof password == "string" && (password = Buffer2.from(password)), password.length !== config.key / 8)
        throw new TypeError("invalid key length " + password.length);
      return config.type === "stream" ? new StreamCipher(config.module, password, iv, true) : config.type === "auth" ? new AuthCipher(config.module, password, iv, true) : new Decipher(config.module, password, iv);
    }
...
var require_bn = __commonJS({
  "node_modules/diffie-hellman/node_modules/bn.js/lib/bn.js"(exports, module) {
    (function(module2, exports2) {
      ...
      var Buffer2;
      try {
        typeof window < "u" && typeof window.Buffer < "u" ? Buffer2 = window.Buffer : Buffer2 = __require("buffer").Buffer;
      } catch {
      }
      BN.isBN = function(num) {
        return num instanceof BN ? true : num !== null && typeof num == "object" && num.constructor.wordSize === BN.wordSize && Array.isArray(num.words);
      ...
      BN.prototype.toString = function(base, padding) {
        ...
        return this.length === 2 ? ret += this.words[1] * 67108864 : this.length === 3 && this.words[2] === 1 ? ret += 4503599627370496 + this.words[1] * 67108864 : this.length > 2 && assert(false, "Number can only safely store up to 53 bits"), this.negative !== 0 ? -ret : ret;
      ...
      MPrime.prototype._tmp = function() {
        ...
        return cmp === 0 ? (r.words[0] = 0, r.length = 1) : cmp > 0 ? r.isub(this.p) : r.strip !== undefined ? r.strip() : r._strip(), r;
  ...
  "node_modules/miller-rabin/lib/mr.js"(exports, module) {
    ...
    MillerRabin.prototype.test = function(n, k, cb) {
      ...
      for (var n1 = n.subn(1), s = 0;!n1.testn(s); s++)
        ;
      for (var d = n.shrn(s), rn1 = n1.toRed(red), prime = true;k > 0; k--) {
...
var require_dh = __commonJS({
  "node_modules/diffie-hellman/lib/dh.js"(exports, module) {
    ...
    function DH(prime, generator, malleable) {
      this.setGenerator(generator), this.__prime = new BN(prime), this._prime = BN.mont(this.__prime), this._primeLen = prime.length, this._pub = undefined, this._priv = undefined, this._primeCode = undefined, malleable ? (this.setPublicKey = setPublicKey, this.setPrivateKey = setPrivateKey) : this._primeCode = 8;
    }
...
var require_browser7 = __commonJS({
  "node_modules/diffie-hellman/browser.js"(exports) {
    ...
    function createDiffieHellman(prime, enc, generator, genc) {
      return Buffer.isBuffer(enc) || ENCODINGS[enc] === undefined ? createDiffieHellman(prime, "binary", enc, generator) : (enc = enc || "binary", genc = genc || "binary", generator = generator || new Buffer([2]), Buffer.isBuffer(generator) || (generator = new Buffer(generator, genc)), typeof prime == "number" ? new DH(generatePrime(prime, generator), generator, true) : (Buffer.isBuffer(prime) || (prime = new Buffer(prime, enc)), new DH(prime, generator, true)));
    }
    ...
    BaseCurve.prototype._wnafMulAdd = function(defW, points, coeffs, len, jacobianResult) {
      ...
      for (i = max;i >= 0; i--) {
        for (var k = 0;i >= 0; ) {
          var zero = true;
          for (j = 0;j < len; j++)
            tmp[j] = naf[j][i] | 0, tmp[j] !== 0 && (zero = false);
          if (!zero)
            break;
          k++, i--;
        }
  ...
  "node_modules/elliptic/lib/elliptic/curve/short.js"(exports, module) {
    ...
    ShortCurve.prototype._endoWnafMulAdd = function(points, coeffs, jacobianResult) {
      for (var npoints = this._endoWnafT1, ncoeffs = this._endoWnafT2, i = 0;i < points.length; i++) {
        ...
        split.k1.negative && (split.k1.ineg(), p = p.neg(true)), split.k2.negative && (split.k2.ineg(), beta = beta.neg(true)), npoints[i * 2] = p, npoints[i * 2 + 1] = beta, ncoeffs[i * 2] = split.k1, ncoeffs[i * 2 + 1] = split.k2;
      }
...
var require_edwards = __commonJS({
  "node_modules/elliptic/lib/elliptic/curve/edwards.js"(exports, module) {
    ...
    Point.prototype.normalize = function() {
      ...
      return this.x = this.x.redMul(zi), this.y = this.y.redMul(zi), this.t && (this.t = this.t.redMul(zi)), this.z = this.curve.one, this.zOne = true, this;
    };
...
var require_utils4 = __commonJS({
  "node_modules/hash.js/lib/hash/utils.js"(exports) {
    ...
    function isSurrogatePair(msg, i) {
      return (msg.charCodeAt(i) & 64512) !== 55296 || i < 0 || i + 1 >= msg.length ? false : (msg.charCodeAt(i + 1) & 64512) === 56320;
    }
    function toArray(msg, enc) {
      if (Array.isArray(msg))
        return msg.slice();
  ...
  "node_modules/elliptic/lib/elliptic/ec/signature.js"(exports, module) {
    ...
    function Signature(options, enc) {
      if (options instanceof Signature)
        return options;
      this._importDER(options, enc) || (assert(options.r && options.s, "Signature without r or s"), this.r = new BN(options.r, 16), this.s = new BN(options.s, 16), options.recoveryParam === undefined ? this.recoveryParam = null : this.recoveryParam = options.recoveryParam);
    }
    ...
    function getLength(buf, p) {
      ...
      return val <= 127 ? false : (p.place = off, val);
    }
    ...
    Signature.prototype._importDER = function(data, enc) {
      ...
      if (len === false || len + p.place !== data.length || data[p.place++] !== 2)
        return false;
      ...
      if (slen === false || data.length !== slen + p.place)
        return false;
...
var require_ec = __commonJS({
  "node_modules/elliptic/lib/elliptic/ec/index.js"(exports, module) {
    ...
    EC.prototype.verify = function(msg, signature, key, enc) {
      ...
      return this.curve._maxwellTrick ? (p = this.g.jmulAdd(u1, key.getPublic(), u2), p.isInfinity() ? false : p.eqXToP(r)) : (p = this.g.mulAdd(u1, key.getPublic(), u2), p.isInfinity() ? false : p.getX().umod(this.n).cmp(r) === 0);
    };
...
var require_safer = __commonJS({
  "node_modules/safer-buffer/safer.js"(exports, module) {
    var buffer = __require("buffer"), Buffer2 = buffer.Buffer, safer = {}, key;
    for (key in buffer)
...
var require_buffer = __commonJS({
  "node_modules/asn1.js/lib/asn1/base/buffer.js"(exports) {
    ...
    EncoderBuffer.isEncoderBuffer = function(data) {
      return data instanceof EncoderBuffer ? true : typeof data == "object" && data.constructor.name === "EncoderBuffer" && typeof data.length == "number" && typeof data.join == "function";
    };
...
var require_node = __commonJS({
  "node_modules/asn1.js/lib/asn1/base/node.js"(exports, module) {
    ...
    function Node(enc, parent, name) {
      let state = {};
      this._baseState = state, state.name = name, state.enc = enc, state.parent = parent || null, state.children = null, state.tag = null, state.args = null, state.reverseArgs = null, state.choice = null, state.optional = false, state.any = false, state.obj = false, state.use = null, state.useDecoder = null, state.key = null, state.default = null, state.explicit = null, state.implicit = null, state.contains = null, state.parent || (state.children = [], this._wrap());
    }
    module.exports = Node;
    var stateProps = [
      "enc",
    ...
    Node.prototype.obj = function() {
      let state = this._baseState, args = Array.prototype.slice.call(arguments);
      return state.obj = true, args.length !== 0 && this._useArgs(args), this;
    };
    ...
    Node.prototype._decode = function(input, options) {
      ...
      let result = state.default, present = true, prevKey = null;
    ...
    Node.prototype._decodeChoice = function(input, options) {
      let state = this._baseState, result = null, match = false;
    ...
    Node.prototype._encode = function(data, reporter, parent) {
      ...
      if (result !== undefined && !this._skipDefault(result, reporter, parent))
        return result;
    };
    Node.prototype._encodeValue = function(data, reporter, parent) {
      ...
      if (this.reporter = reporter, state.optional && data === undefined)
        if (state.default !== null)
          ...
          return;
      let content = null, primitive = false;
      if (state.any)
        ...
        state.use !== null ? result = this._getUse(state.use, parent)._encode(data, reporter) : (content = this._encodePrimitive(state.tag, data), primitive = true);
...
var require_der2 = __commonJS({
  "node_modules/asn1.js/lib/asn1/encoders/der.js"(exports, module) {
    ...
    DERNode.prototype._skipDefault = function(dataBuffer, reporter, parent) {
      ...
      if (state.defaultBuffer === undefined && (state.defaultBuffer = this._encodeValue(state.default, reporter, parent).join()), data.length !== state.defaultBuffer.length)
        return false;
  ...
  "node_modules/asn1.js/lib/asn1/decoders/der.js"(exports, module) {
    ...
    DERNode.prototype._decodeObjid = function(buffer, values, relative) {
      ...
      if (relative ? result = identifiers : result = [first, second].concat(identifiers.slice(1)), values) {
        ...
        tmp === undefined && (tmp = values[result.join(".")]), tmp !== undefined && (result = tmp);
      }
      return result;
    };
...
var require_sign = __commonJS({
  "node_modules/browserify-sign/browser/sign.js"(exports, module) {
    ...
    function dsaSign(hash, priv, algo) {
      for (var x = priv.params.priv_key, p = priv.params.p, q = priv.params.q, g = priv.params.g, r = new BN(0), k, H = bits2int(hash, q).mod(q), s = false, kv = getKey(x, q, hash, algo);s === false; )
        k = makeKey(q, kv, algo), r = makeR(g, k, p, q), s = k.invm(q).imul(H.add(x.mul(r))).mod(q), s.cmpn(0) === 0 && (s = false, r = new BN(0));
      return toDER(r, s);
    }
    function toDER(r, s) {
...
var require_browser8 = __commonJS({
  "node_modules/browserify-sign/browser/index.js"(exports, module) {
    var Buffer2 = require_safe_buffer().Buffer, createHash = require_browser2(), stream = __require("readable-stream"), inherits = require_inherits_browser(), sign = require_sign(), verify = require_verify(), algorithms = require_algorithms();
  ...
  "node_modules/randomfill/browser.js"(exports) {
    ...
    function randomFillSync(buf, offset, size) {
      if (typeof offset > "u" && (offset = 0), !Buffer2.isBuffer(buf) && !(buf instanceof global.Uint8Array))
        throw new TypeError('"buf" argument must be a Buffer or Uint8Array');
      return assertOffset(offset, buf.length), size === undefined && (size = buf.length - offset), assertSize(size, offset, buf.length), actualFill(buf, offset, size);
    }
  }
});
...
var timingSafeEqual = "timingSafeEqual" in crypto ? (a, b) => {
...
var scryptSync = "scryptSync" in crypto ? (password, salt, keylen, options) => {
...
var scrypt = "scryptSync" in crypto ? function(password, salt, keylen, options, callback) {
  if (typeof options == "function" && (callback = options, options = undefined), typeof callback != "function") {
...
var crypto_default = crypto_exports;
...
//# debugId=E4988CE5634235AA64756e2164756e21
