...
var W = function(s, r) {
  return A(s, false, true).resolve(r);
};
var X = function(s, r) {
  return s ? A(s, false, true).resolveObject(r) : r;
};
var { URL: F, URLSearchParams: M, [Symbol.for("Bun.lazy")]: S } = globalThis;
var tt = /^([a-z0-9.+-]+:)/i;
var st = /:[0-9]*$/;
var ht = /^(\/\/?(?!\/)[^\?\s]*)(\?[^\s]*)?$/;
var et = [
...
var J = ["/", "?", "#"];
var ot = 255;
var K = /^[+a-z0-9A-Z_-]{0,63}$/;
var at = /^([+a-z0-9A-Z_-]{0,63})(.*)$/;
var nt = { javascript: true, "javascript:": true };
...
m.prototype.parse = function(s, r, t) {
  ...
  if (t || c || h.match(/^\/\/[^@\/]+@[^@\/]+/)) {
    var j = h.substr(0, 2) === "//";
    j && !(c && N[c]) && (h = h.substr(2), this.slashes = true);
  }
  if (!N[c] && (j || c && !R[c])) {
...
m.prototype.resolve = function(s) {
  return this.resolveObject(A(s, false, true)).format();
};
...
//# debugId=24D51152BC9A2B3964756e2164756e21
