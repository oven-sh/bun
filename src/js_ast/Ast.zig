//! AST container struct for JavaScript/TypeScript code
const std = @import("std");
const bun = @import("root").bun;

/// AST container for a JavaScript/TypeScript file or module
const Ast = @This();
...
pub const NamedImports = std.ArrayHashMapUnmanaged(Ref, NamedImport, Ref.ArrayHashCtx, true);
pub const NamedExports = bun.StringArrayHashMapUnmanaged(NamedExport);
pub const ConstValuesMap = std.ArrayHashMapUnmanaged(Ref, Expr, Ref.ArrayHashCtx, false);
pub const TsEnumsMap = std.ArrayHashMapUnmanaged(Ref, bun.StringHashMapUnmanaged(InlinedEnumValue), Ref.ArrayHashCtx, false);
