//! Binding base types
//! Contains the base Binding struct which forms the foundation for variable bindings

/// Binding represents a variable binding in JavaScript.
/// It's used on the left side of variable declarations.
