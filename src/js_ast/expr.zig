//! Expr struct definition for JavaScript AST
//! Defines the base Expr struct and related functionality
...
const PrimitiveType = js_ast.PrimitiveType;
...
const stringToEquivalentNumberValue = js_ast.stringToEquivalentNumberValue;
