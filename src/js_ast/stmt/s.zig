/// Purpose: Implements all statement node types in the S namespace
...
pub const Try = struct {
    ...
    catch_: ?js_ast.Catch = null,
    finally: ?js_ast.Finally = null,
};
...
pub const Import = struct {
    ...
    pub fn importRecordTag(import: *const Import) ?js_ast.ImportRecord.Tag {
...
const ExprNodeIndex = Expr;
const Stmt = js_ast.Stmt;
const StmtNodeIndex = Stmt;
const BindingNodeIndex = js_ast.Binding;
