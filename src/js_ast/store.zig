//! Memory allocation mechanism for AST nodes
//! Provides specialized memory allocation strategy similar to an arena
//! for efficient allocation of expression and statement nodes.
...
pub fn NewStore(comptime types: []const type, comptime count: usize) type {
    ...
    return struct {
        ...
        pub fn deinit(store: *Store) void {
            ...
            bun.assert(&prealloc.first_block == store.firstBlock());
        ...
        fn supportsType(comptime T: type) bool {
