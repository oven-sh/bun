//! JSON-only subset of `js_lexer` — the runtime-options JSON specialization,
//! co-located with the canonical const-options lexer at the crate root.
//!
//! The ~10 lexer entry-points JSON actually exercises are inlined here
...
//!
//! The crate root remains the canonical lexer; this module is a
//! sliced re-port of it.
    ...
    'bump: 'a,
{
    ...
    #[inline]
    pub fn log_ptr(&self) -> *mut bun_ast::Log {
        self.log
    }
