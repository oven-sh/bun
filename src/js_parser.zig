...
pub fn NewParser_(
    ...
    return struct {
        ...
        pub const parseSuffix = @import("ast/parseSuffix.zig").ParseSuffix(parser_feature__typescript, parser_feature__jsx, parser_feature__scan_only).parseSuffix;
        ...
        pub const parsePrefix = @import("ast/parsePrefix.zig").ParsePrefix(parser_feature__typescript, parser_feature__jsx, parser_feature__scan_only).parsePrefix;
        ...
        pub const visitExprInOut = @import("ast/visitExpr.zig").VisitExpr(parser_feature__typescript, parser_feature__jsx, parser_feature__scan_only).visitExprInOut;
