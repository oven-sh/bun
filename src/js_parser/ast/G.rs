...
//   confidence: medium
//   todos:      8
//   notes:      AST arena crate — '<ast> lifetimes cascade from LIFETIMES.tsv (Property.class_static_block); Flags::Property/Function path & ExprData variant names need Phase B fixup; string fields use StoreStr.
// ──────────────────────────────────────────────────────────────────────────
