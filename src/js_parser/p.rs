...
pub(crate) trait ParserLike<'a> {
    ...
    fn store_name_in_ref(&mut self, name: &'a [u8]) -> Result<Ref, crate::js_parser::Error>;
}
...
impl<'a, const TYPESCRIPT: bool, const SCAN_ONLY: bool> P<'a, TYPESCRIPT, SCAN_ONLY> {
    ...
    ) -> Result<&'b [u8], crate::js_parser::Error> {
    ...
    pub fn prepare_for_visit_pass(&mut self) -> Result<(), crate::js_parser::Error> {
        {
    ...
    pub fn push_scope_for_parse_pass(
        ...
        KIND: js_ast::scope::Kind,
        loc: bun_ast::Loc,
    ) -> Result<usize, crate::js_parser::Error> {
    ...
    #[cold]
    #[inline(never)]
    pub fn forbid_lexical_decl(&mut self, loc: bun_ast::Loc) -> Result<(), crate::js_parser::Error> {
        self.log().add_error(
            Some(self.source),
            loc,
    ...
    ) -> Result<Stmt, crate::js_parser::Error> {
        let is_macro =
    ...
    pub fn create_default_name(
        &mut self,
        loc: bun_ast::Loc,
    ) -> Result<js_ast::LocRef, crate::js_parser::Error> {
        let identifier: &'a [u8] = {
    ...
    pub fn new_symbol(
        ...
        identifier: &'a [u8],
    ) -> Result<Ref, crate::js_parser::Error> {
    ...
    pub fn store_name_in_ref(&mut self, name: &'a [u8]) -> Result<Ref, crate::js_parser::Error> {
        if Self::TRACK_SYMBOL_USAGE_DURING_PARSE_PASS {
            if let Some(uses) = &mut self.parse_pass_symbol_uses {
    ...
    pub fn jsx_strings_to_member_expression(
        ...
        loc: bun_ast::Loc,
        parts: &[&'a [u8]],
    ) -> Result<Expr, crate::js_parser::Error> {
...
impl<'a, const TYPESCRIPT: bool, const SCAN_ONLY: bool> P<'a, TYPESCRIPT, SCAN_ONLY> {
    pub fn to_ast(
        ...
        wrap_mode: WrapMode,
        hashbang: &'a [u8],
    ) -> Result<Box<js_ast::Ast<'a>>, crate::js_parser::Error> {
    ...
    pub fn compute_ts_enums_map(
        &self,
        _arena: &'a Bump,
    ) -> Result<bun_ast::ast_result::TsEnumsMap, crate::js_parser::Error> {
...
impl LowerUsingDeclarationsContext {
    pub fn init<'a, const T: bool, const S_: bool>(
        p: &mut P<'a, T, S_>,
    ) -> Result<Self, crate::js_parser::Error> {
        Ok(Self {
