...
impl<'a, const TYPESCRIPT: bool, const SCAN_ONLY: bool> P<'a, TYPESCRIPT, SCAN_ONLY> {
            ...
            js_ast::StmtOrExpr::Stmt(s2) => {
                ...
                match s2_data {
                    ...
                    StmtData::SClass(mut class_ref) => {
                        ...
                        let class_stmts =
                            p.lower_class(js_ast::StmtOrExpr::Stmt(s2_copy), body_scope);
    ...
    fn s_class(
        ...
        let (_, body_scope) = p.visit_class(stmt.loc, &mut data.class, Ref::NONE, false);
        ...
        let lowered = p.lower_class(js_ast::StmtOrExpr::Stmt(*stmt), body_scope);
