...
pub const API = struct {
    ...
    pub const BrotliEncoder = @import("./bun.js/api/compress.zig").BrotliEncoder;
    pub const BrotliDecoder = @import("./bun.js/api/compress.zig").BrotliDecoder;
    pub const DeflateEncoder = @import("./bun.js/api/compress.zig").DeflateEncoder;
    pub const DeflateDecoder = @import("./bun.js/api/compress.zig").DeflateDecoder;
};
