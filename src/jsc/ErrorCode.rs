...
impl ErrorCode {
    ...
    pub const WORKER_MESSAGING_ERRORED: ErrorCode = ErrorCode(320);
    /// `ERR_WORKER_MESSAGING_FAILED` (instanceof Error)
    pub const WORKER_MESSAGING_FAILED: ErrorCode = ErrorCode(321);
    /// `ERR_WORKER_MESSAGING_SAME_THREAD` (instanceof Error)
    pub const WORKER_MESSAGING_SAME_THREAD: ErrorCode = ErrorCode(322);
    /// `ERR_WORKER_MESSAGING_TIMEOUT` (instanceof Error)
    pub const WORKER_MESSAGING_TIMEOUT: ErrorCode = ErrorCode(323);
