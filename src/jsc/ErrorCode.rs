...
impl ErrorCode {
    ...
    pub const ERR_CHILD_PROCESS_STDIO_MAXBUFFER: ErrorCode = ErrorCode::CHILD_PROCESS_STDIO_MAXBUFFER;
    ...
    pub const ERR_CRYPTO_CUSTOM_ENGINE_NOT_SUPPORTED: ErrorCode = ErrorCode::CRYPTO_CUSTOM_ENGINE_NOT_SUPPORTED;
    pub const ERR_CRYPTO_ECDH_INVALID_FORMAT: ErrorCode = ErrorCode::CRYPTO_ECDH_INVALID_FORMAT;
    pub const ERR_CRYPTO_ECDH_INVALID_PUBLIC_KEY: ErrorCode = ErrorCode::CRYPTO_ECDH_INVALID_PUBLIC_KEY;
    ...
    pub const ERR_CRYPTO_INCOMPATIBLE_KEY_OPTIONS: ErrorCode = ErrorCode::CRYPTO_INCOMPATIBLE_KEY_OPTIONS;
    ...
    pub const ERR_CRYPTO_INVALID_KEY_OBJECT_TYPE: ErrorCode = ErrorCode::CRYPTO_INVALID_KEY_OBJECT_TYPE;
    ...
    pub const ERR_CRYPTO_JWK_UNSUPPORTED_KEY_TYPE: ErrorCode = ErrorCode::CRYPTO_JWK_UNSUPPORTED_KEY_TYPE;
    pub const ERR_CRYPTO_OPERATION_FAILED: ErrorCode = ErrorCode::CRYPTO_OPERATION_FAILED;
    pub const ERR_CRYPTO_SCRYPT_INVALID_PARAMETER: ErrorCode = ErrorCode::CRYPTO_SCRYPT_INVALID_PARAMETER;
    pub const ERR_CRYPTO_SIGN_KEY_REQUIRED: ErrorCode = ErrorCode::CRYPTO_SIGN_KEY_REQUIRED;
    pub const ERR_CRYPTO_TIMING_SAFE_EQUAL_LENGTH: ErrorCode = ErrorCode::CRYPTO_TIMING_SAFE_EQUAL_LENGTH;
    ...
    pub const ERR_ENCODING_INVALID_ENCODED_DATA: ErrorCode = ErrorCode::ENCODING_INVALID_ENCODED_DATA;
    ...
    pub const ERR_EXECUTION_ENVIRONMENT_NOT_AVAILABLE: ErrorCode = ErrorCode::EXECUTION_ENVIRONMENT_NOT_AVAILABLE;
    pub const ERR_FEATURE_UNAVAILABLE_ON_PLATFORM: ErrorCode = ErrorCode::FEATURE_UNAVAILABLE_ON_PLATFORM;
    ...
    pub const ERR_HTTP2_INFO_STATUS_NOT_ALLOWED: ErrorCode = ErrorCode::HTTP2_INFO_STATUS_NOT_ALLOWED;
    ...
    pub const ERR_HTTP2_MAX_PENDING_SETTINGS_ACK: ErrorCode = ErrorCode::HTTP2_MAX_PENDING_SETTINGS_ACK;
    ...
    pub const ERR_HTTP2_PSEUDOHEADER_NOT_ALLOWED: ErrorCode = ErrorCode::HTTP2_PSEUDOHEADER_NOT_ALLOWED;
    ...
    pub const ERR_HTTP2_TOO_MANY_CUSTOM_SETTINGS: ErrorCode = ErrorCode::HTTP2_TOO_MANY_CUSTOM_SETTINGS;
    pub const ERR_HTTP2_TOO_MANY_INVALID_FRAMES: ErrorCode = ErrorCode::HTTP2_TOO_MANY_INVALID_FRAMES;
    ...
    pub const ERR_INVALID_OBJECT_DEFINE_PROPERTY: ErrorCode = ErrorCode::INVALID_OBJECT_DEFINE_PROPERTY;
    ...
    pub const ERR_MESSAGE_TARGET_CONTEXT_UNAVAILABLE: ErrorCode = ErrorCode::MESSAGE_TARGET_CONTEXT_UNAVAILABLE;
    ...
    pub const ERR_PARSE_ARGS_INVALID_OPTION_VALUE: ErrorCode = ErrorCode::PARSE_ARGS_INVALID_OPTION_VALUE;
    pub const ERR_PARSE_ARGS_UNEXPECTED_POSITIONAL: ErrorCode = ErrorCode::PARSE_ARGS_UNEXPECTED_POSITIONAL;
    pub const ERR_PARSE_ARGS_UNKNOWN_OPTION: ErrorCode = ErrorCode::PARSE_ARGS_UNKNOWN_OPTION;
    pub const ERR_POSTGRES_AUTHENTICATION_FAILED_PBKDF2: ErrorCode = ErrorCode::POSTGRES_AUTHENTICATION_FAILED_PBKDF2;
    ...
    pub const ERR_POSTGRES_INVALID_BACKEND_KEY_DATA: ErrorCode = ErrorCode::POSTGRES_INVALID_BACKEND_KEY_DATA;
    pub const ERR_POSTGRES_INVALID_BINARY_DATA: ErrorCode = ErrorCode::POSTGRES_INVALID_BINARY_DATA;
    pub const ERR_POSTGRES_INVALID_BYTE_SEQUENCE_FOR_ENCODING: ErrorCode = ErrorCode::POSTGRES_INVALID_BYTE_SEQUENCE_FOR_ENCODING;
    pub const ERR_POSTGRES_INVALID_BYTE_SEQUENCE: ErrorCode = ErrorCode::POSTGRES_INVALID_BYTE_SEQUENCE;
    pub const ERR_POSTGRES_INVALID_CHARACTER: ErrorCode = ErrorCode::POSTGRES_INVALID_CHARACTER;
    pub const ERR_POSTGRES_INVALID_MESSAGE_LENGTH: ErrorCode = ErrorCode::POSTGRES_INVALID_MESSAGE_LENGTH;
    pub const ERR_POSTGRES_INVALID_MESSAGE: ErrorCode = ErrorCode::POSTGRES_INVALID_MESSAGE;
    pub const ERR_POSTGRES_INVALID_QUERY_BINDING: ErrorCode = ErrorCode::POSTGRES_INVALID_QUERY_BINDING;
    pub const ERR_POSTGRES_INVALID_SERVER_KEY: ErrorCode = ErrorCode::POSTGRES_INVALID_SERVER_KEY;
    pub const ERR_POSTGRES_INVALID_SERVER_SIGNATURE: ErrorCode = ErrorCode::POSTGRES_INVALID_SERVER_SIGNATURE;
    pub const ERR_POSTGRES_INVALID_TRANSACTION_STATE: ErrorCode = ErrorCode::POSTGRES_INVALID_TRANSACTION_STATE;
    pub const ERR_POSTGRES_LIFETIME_TIMEOUT: ErrorCode = ErrorCode::POSTGRES_LIFETIME_TIMEOUT;
    pub const ERR_POSTGRES_MULTIDIMENSIONAL_ARRAY_NOT_SUPPORTED_YET: ErrorCode = ErrorCode::POSTGRES_MULTIDIMENSIONAL_ARRAY_NOT_SUPPORTED_YET;
    pub const ERR_POSTGRES_NOT_TAGGED_CALL: ErrorCode = ErrorCode::POSTGRES_NOT_TAGGED_CALL;
    pub const ERR_POSTGRES_NULLS_IN_ARRAY_NOT_SUPPORTED_YET: ErrorCode = ErrorCode::POSTGRES_NULLS_IN_ARRAY_NOT_SUPPORTED_YET;
    ...
    pub const ERR_POSTGRES_SASL_SIGNATURE_INVALID_BASE64: ErrorCode = ErrorCode::POSTGRES_SASL_SIGNATURE_INVALID_BASE64;
    pub const ERR_POSTGRES_SASL_SIGNATURE_MISMATCH: ErrorCode = ErrorCode::POSTGRES_SASL_SIGNATURE_MISMATCH;
    ...
    pub const ERR_POSTGRES_UNKNOWN_AUTHENTICATION_METHOD: ErrorCode = ErrorCode::POSTGRES_UNKNOWN_AUTHENTICATION_METHOD;
    ...
    pub const ERR_POSTGRES_UNSUPPORTED_ARRAY_FORMAT: ErrorCode = ErrorCode::POSTGRES_UNSUPPORTED_ARRAY_FORMAT;
    pub const ERR_POSTGRES_UNSUPPORTED_AUTHENTICATION_METHOD: ErrorCode = ErrorCode::POSTGRES_UNSUPPORTED_AUTHENTICATION_METHOD;
    pub const ERR_POSTGRES_UNSUPPORTED_BYTEA_FORMAT: ErrorCode = ErrorCode::POSTGRES_UNSUPPORTED_BYTEA_FORMAT;
    pub const ERR_POSTGRES_UNSUPPORTED_INTEGER_SIZE: ErrorCode = ErrorCode::POSTGRES_UNSUPPORTED_INTEGER_SIZE;
    pub const ERR_POSTGRES_UNSUPPORTED_NUMERIC_FORMAT: ErrorCode = ErrorCode::POSTGRES_UNSUPPORTED_NUMERIC_FORMAT;
    ...
    pub const ERR_SOCKET_CLOSED_BEFORE_CONNECTION: ErrorCode = ErrorCode::SOCKET_CLOSED_BEFORE_CONNECTION;
    ...
    pub const ERR_STREAM_UNSHIFT_AFTER_END_EVENT: ErrorCode = ErrorCode::STREAM_UNSHIFT_AFTER_END_EVENT;
    ...
    pub const ERR_TLS_PROTOCOL_VERSION_CONFLICT: ErrorCode = ErrorCode::TLS_PROTOCOL_VERSION_CONFLICT;
    pub const ERR_TLS_PSK_SET_IDENTITY_HINT_FAILED: ErrorCode = ErrorCode::TLS_PSK_SET_IDENTITY_HINT_FAILED;
    ...
    pub const ERR_TLS_ALPN_CALLBACK_WITH_PROTOCOLS: ErrorCode = ErrorCode::TLS_ALPN_CALLBACK_WITH_PROTOCOLS;
    ...
    pub const ERR_UNCAUGHT_EXCEPTION_CAPTURE_ALREADY_SET: ErrorCode = ErrorCode::UNCAUGHT_EXCEPTION_CAPTURE_ALREADY_SET;
    ...
    pub const ERR_VM_MODULE_CANNOT_CREATE_CACHED_DATA: ErrorCode = ErrorCode::VM_MODULE_CANNOT_CREATE_CACHED_DATA;
    ...
    pub const ERR_VM_MODULE_CACHED_DATA_REJECTED: ErrorCode = ErrorCode::VM_MODULE_CACHED_DATA_REJECTED;
    pub const ERR_VM_DYNAMIC_IMPORT_CALLBACK_MISSING: ErrorCode = ErrorCode::VM_DYNAMIC_IMPORT_CALLBACK_MISSING;
    ...
    pub const ERR_SECRETS_INTERACTION_NOT_ALLOWED: ErrorCode = ErrorCode::SECRETS_INTERACTION_NOT_ALLOWED;
...
impl ErrorCode {
    ...
    pub fn code_str(self) -> &'static str {
        CODE_STR.get(self.0 as usize).copied().unwrap_or("ERR_UNKNOWN")
    }
