...
// The Rust sibling is generated by the same codegen (ResolvedSourceTag.rs) and
// include!()'d by `crate::resolved_source_tag`, keeping it in lock-step with the
// C `uint32_t tag` field in src/jsc/bindings/headers-handwritten.h.
