...
/// Version 28: Standard decorator lowering moves every field of a decorated
/// class, names its temporaries uniquely, and requires `bun:wrap` in
/// CommonJS-wrapped modules.
