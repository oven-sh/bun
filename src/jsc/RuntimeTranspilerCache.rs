...
/// Version 24: `prefer_installed` aliases keep the user-written specifier in
/// printed output (e.g. `next/dist/compiled/undici` is no longer rewritten to
/// `undici`), so entries written by older versions are stale (#36098).
