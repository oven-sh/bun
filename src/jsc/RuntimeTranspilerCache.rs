...
/// Version 24: `undefined`/`NaN`/`Infinity` print as `void 0`/`0/0`/`1/0` when
/// the file declares a local binding of the same name; unshadowed `Infinity` no
/// longer prints as `1 / 0`.
