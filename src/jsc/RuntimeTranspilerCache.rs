...
/// Version 34: The runtime linker no longer rewrites `require()` records through a plugin
/// `onResolve`. Older entries hold the rewritten `namespace:path` string, which the
/// resolver cannot resolve (#43025).
