...
/// Version 28: An assignment target is never replaced by a constant: a define
/// with a constant value keeps the identifier (#21210), and `"str".length` is
/// not folded there. Older entries can hold the invalid output (`0 = 1`).
