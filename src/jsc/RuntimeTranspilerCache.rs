...
/// Version 28: Import attributes are printed as written on every import and
/// re-export, and ModuleInfo derives FetchParameters from the `type` attribute
/// of `export * from` / `export {} from` records too.
