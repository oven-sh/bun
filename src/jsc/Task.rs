...
//! 1. Add a tag constant to `bun_loop::task_tag` (the canonical list).
...
pub use bun_loop::{Task, TaskTag, Taskable, task_tag};
...
pub fn report_error_or_terminate(
    ...
    let _ = crate::vm::VirtualMachine::report_uncaught_exception(
        global,
