...
impl VirtualMachine {
    ...
    /// Whether anything outstanding (active I/O, queued tasks, pending refs,
    /// immediates) could still settle a promise. Unlike
    /// [`Self::is_event_loop_alive`], a prior unhandled error does not count
    /// as "nothing left"; that counter encodes exit semantics.
