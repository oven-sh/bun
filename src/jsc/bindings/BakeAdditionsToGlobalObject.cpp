...
extern "C" SYSV_ABI EncodedJSValue Bake__createDevServerFrameworkRequestArgsObject(JSC::JSGlobalObject* globalObject, EncodedJSValue routerTypeMain, EncodedJSValue routeModules, EncodedJSValue clientEntryUrl, EncodedJSValue styles, EncodedJSValue params)
{
    ...
    auto* object = JSFinalObject::create(vm, bunGlobal->bakeAdditions().m_DevServerFrameworkRequestArgsClassStructure.get(bunGlobal));
...
extern "C" SYSV_ABI JSC::EncodedJSValue Bake__getAsyncLocalStorage(JSC::JSGlobalObject* globalObject)
{
    ...
    auto value = bunGlobal->bakeAdditions().getAsyncLocalStorage(bunGlobal);
...
{
    auto* bunGlobal = static_cast<Bun::GlobalObject*>(globalObject);
    return JSValue::encode(bunGlobal->bakeAdditions().ensureAsyncLocalStorageInstanceJSFunction(globalObject));
}

extern "C" SYSV_ABI JSC::EncodedJSValue Bake__getSSRResponseConstructor(JSC::JSGlobalObject* globalObject)
{
    auto* bunGlobal = static_cast<Bun::GlobalObject*>(globalObject);
    return JSValue::encode(bunGlobal->bakeAdditions().JSBakeResponseConstructor(globalObject));
}

BUN_DEFINE_HOST_FUNCTION(jsFunctionBakeGetAsyncLocalStorage, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callframe))
{
    auto* bunGlobal = static_cast<Bun::GlobalObject*>(globalObject);
    return JSValue::encode(bunGlobal->bakeAdditions().getAsyncLocalStorage(bunGlobal));
}
...
BUN_DEFINE_HOST_FUNCTION(jsFunctionBakeEnsureAsyncLocalStorage, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callframe))
{
    ...
    bunGlobal->bakeAdditions().ensureAsyncLocalStorageInstance(bunGlobal, callframe->argument(0));
...
{
    auto* bunGlobal = static_cast<Bun::GlobalObject*>(globalObject);
    auto value = bunGlobal->bakeAdditions().getBundleNewRouteJSFunction(bunGlobal);
    return JSValue::encode(value);
}
...
{
    auto* bunGlobal = static_cast<Bun::GlobalObject*>(globalObject);
    auto value = bunGlobal->bakeAdditions().getNewRouteParamsJSFunction(bunGlobal);
    return JSValue::encode(value);
}
