...
public:
    ...
    void doConnect(WebCore::ScriptExecutionContext& context)
    {
        ...
        if (this->unrefOnDisconnect) {
            Bun__eventLoop__incrementRefConcurrently(static_cast<Rust::GlobalObject*>(globalObject)->bunVM(), 1);
        }
        ...
        this->receiveMessagesOnInspectorThread(context, static_cast<Rust::GlobalObject*>(globalObject), false);
    }
    ...
    void disconnect()
    {
        ...
        ScriptExecutionContext::ensureOnContextThread(scriptExecutionContextIdentifier, [connection = this](ScriptExecutionContext& context) {
            ...
            if (connection->unrefOnDisconnect) {
                ...
                Bun__eventLoop__incrementRefConcurrently(static_cast<Rust::GlobalObject*>(context.jsGlobalObject())->bunVM(), -1);
            }
        });
    }
    ...
    void receiveMessagesOnInspectorThread(ScriptExecutionContext& context, Rust::GlobalObject* globalObject, bool connectIfNeeded)
    {
    ...
    void receiveMessagesOnDebuggerThread(ScriptExecutionContext& context, Rust::GlobalObject* debuggerGlobalObject)
    {
    ...
    void sendMessageToDebuggerThread(WTF::String&& inputMessage)
    {
        ...
        if (this->debuggerThreadMessageScheduledCount++ == 0) {
            debuggerScriptExecutionContext->postTaskConcurrently([connection = this](ScriptExecutionContext& context) {
                connection->receiveMessagesOnDebuggerThread(context, static_cast<Rust::GlobalObject*>(context.jsGlobalObject()));
            });
        }
    }
    ...
    void sendMessageToInspectorFromDebuggerThread(Vector<WTF::String, 12>&& inputMessages)
    {
        ...
        if (this->jsThreadMessageScheduledCount++ == 0) {
            ScriptExecutionContext::postTaskTo(scriptExecutionContextIdentifier, [connection = this](ScriptExecutionContext& context) {
                connection->receiveMessagesOnInspectorThread(context, static_cast<Rust::GlobalObject*>(context.jsGlobalObject()), true);
            });
        }
    }
...
extern "C" unsigned int Bun__createJSDebugger(Rust::GlobalObject* globalObject)
{
    {
        Locker<Lock> locker(inspectorConnectionsLock);
...
{
    auto* debuggerGlobalObject = dynamicDowncast<Rust::GlobalObject>(globalObject);
...
extern "C" void Bun__startJSDebuggerThread(Rust::GlobalObject* debuggerGlobalObject, ScriptExecutionContextIdentifier scriptId, BunString* portOrPathString, int isAutomatic, bool isUrlServer)
{
