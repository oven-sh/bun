...
void GlobalObject::finishCreation(VM& vm)
{
    ...
    m_streamsRuntime.initLater(
        [](const JSC::LazyProperty<JSC::JSGlobalObject, WebCore::JSStreamsRuntime>::Initializer& init) {
            init.set(WebCore::JSStreamsRuntime::create(init.vm, static_cast<Bun::GlobalObject*>(init.owner)));
        });
...
extern "C" [[ZIG_EXPORT(check_slow)]] void Bun__performTask(Bun::GlobalObject* globalObject, WebCore::EventLoopTask* task)
{
...
extern "C" void Bun__InspectorConnection__disconnectAllOnExit(Bun::GlobalObject*);
