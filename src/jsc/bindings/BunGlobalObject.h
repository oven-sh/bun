...
#if OS(WINDOWS)
#include <uv.h>
extern "C" uv_loop_t* Bun__BunGlobalObject__uvLoop(void* /* BunVM */);
#endif
...
public:
    ...
    {
        return Bun__BunGlobalObject__uvLoop(m_bunVM);
    }
#endif
...
#include "BunGeneratedClasses+lazyStructureHeader.h"
