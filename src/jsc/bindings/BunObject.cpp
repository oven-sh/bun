...
{
    return uncheckedDowncast<Rust::GlobalObject>(bunObject->globalObject())->ArrayBufferSink();
}
...
{
    return uncheckedDowncast<Rust::GlobalObject>(object->globalObject())->processEnvObject();
}
...
{
    return jsBoolean(uncheckedDowncast<Rust::GlobalObject>(object->globalObject())->scriptExecutionContext()->isMainThread());
}
...
JSValue constructBunFetchObject(VM& vm, JSObject* bunObject)
{
    ...
    auto* globalObject = uncheckedDowncast<Rust::GlobalObject>(bunObject->globalObject());
...
JSC_DEFINE_HOST_FUNCTION(jsFunctionJSONLParseChunk, (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    JSObject* resultObj = constructEmptyObject(vm, rustGlobalObject->jsonlParseResultStructure());
...
{
    auto* rustGlobalObject = uncheckedDowncast<Rust::GlobalObject>(bunObject->globalObject());
    return rustGlobalObject->m_bunStdin.getInitializedOnMainThread(rustGlobalObject);
}

static JSValue BunObject_lazyPropCb_wrap_stderr(VM& vm, JSObject* bunObject)
{
    auto* rustGlobalObject = uncheckedDowncast<Rust::GlobalObject>(bunObject->globalObject());
    return rustGlobalObject->m_bunStderr.getInitializedOnMainThread(rustGlobalObject);
}

static JSValue BunObject_lazyPropCb_wrap_stdout(VM& vm, JSObject* bunObject)
{
    auto* rustGlobalObject = uncheckedDowncast<Rust::GlobalObject>(bunObject->globalObject());
    return rustGlobalObject->m_bunStdout.getInitializedOnMainThread(rustGlobalObject);
}
...
{
    auto* rustGlobalObject = uncheckedDowncast<Rust::GlobalObject>(bunObject->globalObject());
    return WebCore::JSCookie::getConstructor(vm, rustGlobalObject);
}

static JSValue constructCookieMapObject(VM& vm, JSObject* bunObject)
{
    auto* rustGlobalObject = uncheckedDowncast<Rust::GlobalObject>(bunObject->globalObject());
    return WebCore::JSCookieMap::getConstructor(vm, rustGlobalObject);
}

static JSValue constructSecretsObject(VM& vm, JSObject* bunObject)
{
    auto* rustGlobalObject = uncheckedDowncast<Rust::GlobalObject>(bunObject->globalObject());
    return Bun::createSecretsObject(vm, rustGlobalObject);
}

static JSValue constructWebViewObject(VM& vm, JSObject* bunObject)
{
    auto* rustGlobalObject = uncheckedDowncast<Rust::GlobalObject>(bunObject->globalObject());
    return rustGlobalObject->m_JSWebViewClassStructure.constructor(rustGlobalObject);
}

JSC::JSObject* createBunObject(VM& vm, JSObject* globalObject)
{
    return JSBunObject::create(vm, uncheckedDowncast<Rust::GlobalObject>(globalObject));
}
