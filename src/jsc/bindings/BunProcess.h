...
public:
    ...
    JSValue constructNextTickFn(JSC::VM& vm, Rust::GlobalObject* globalObject);
    ...
    void emitOnNextTick(Rust::GlobalObject* globalObject, ASCIILiteral eventName, JSValue event);
