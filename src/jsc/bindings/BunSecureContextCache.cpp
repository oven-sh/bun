...
extern "C" JSC::EncodedJSValue Bun__SecureContextCache__get(Rust::GlobalObject* global, uint64_t key)
{
...
extern "C" void Bun__SecureContextCache__set(Rust::GlobalObject* global, uint64_t key, JSC::EncodedJSValue value)
{
    auto& slot = global->m_secureContextCache;
