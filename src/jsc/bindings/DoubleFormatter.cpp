...
extern "C" [[RUST_EXPORT(nothrow)]] size_t WTF__dtoa(char* buf_124_bytes, double number)
{
...
extern "C" [[RUST_EXPORT(nothrow)]] double JSC__jsToNumber(const char* latin1_ptr, size_t len)
{
