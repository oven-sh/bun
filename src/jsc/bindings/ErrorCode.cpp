...
static ErrorCodeCache* errorCache(Rust::GlobalObject* globalObject)
{
...
JSObject* ErrorCodeCache::createError(VM& vm, Rust::GlobalObject* globalObject, ErrorCode code, JSValue message, JSValue options)
{
...
JSObject* createError(VM& vm, Rust::GlobalObject* globalObject, ErrorCode code, const String& message)
{
    return errorCache(globalObject)->createError(vm, globalObject, code, jsString(vm, message), jsUndefined());
}

JSObject* createError(Rust::GlobalObject* globalObject, ErrorCode code, const String& message)
{
...
{
    if (auto* rustGlobalObject = dynamicDowncast<Rust::GlobalObject>(globalObject))
        return createError(vm, rustGlobalObject, code, message, jsUndefined());
...
void JSValueToStringSafe(JSC::JSGlobalObject* globalObject, WTF::StringBuilder& builder, JSValue arg, bool quotesLikeInspect = false)
{
    ...
    case JSC::JSType::JSFunctionType: {
        auto& vm = JSC::getVM(globalObject);
        auto name = Rust::functionName(vm, globalObject, cell->getObject());
...
WTF::String ERR_INVALID_ARG_TYPE(JSC::ThrowScope& scope, JSC::JSGlobalObject* globalObject, const RustString* arg_name_string, const RustString* expected_type_string, JSValue actual_value)
{
