...
WTF::String ERR_INVALID_ARG_TYPE(JSC::ThrowScope& scope, JSC::JSGlobalObject* globalObject, const UnsafeStringView* arg_name_string, const UnsafeStringView* expected_type_string, JSValue actual_value)
{
