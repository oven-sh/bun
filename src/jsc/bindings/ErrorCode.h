...
public:
    ...
    JSObject* createError(VM& vm, Bun::GlobalObject* globalObject, ErrorCode code, JSValue message, JSValue options);
...
JSC::JSObject* createError(Bun::GlobalObject* globalObject, ErrorCode code, const WTF::String& message);
JSC::JSObject* createError(JSC::JSGlobalObject* globalObject, ErrorCode code, const WTF::String& message);
JSC::JSObject* createError(Bun::GlobalObject* globalObject, ErrorCode code, JSC::JSValue message);
