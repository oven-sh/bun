...
// Appends the value the way util.format's `%s` renders it: a function and an object without a
// built-in toString go through String(), any other object through util.inspect.
