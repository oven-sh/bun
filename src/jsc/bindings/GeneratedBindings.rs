...
//   confidence: high
//   todos:      0
//   notes:      generated by bindgen codegen; teach generator to emit .rs in Phase B. Only `bindgen_test` hand-ported so far — add further modules as downstream callers need them.
// ──────────────────────────────────────────────────────────────────────────
