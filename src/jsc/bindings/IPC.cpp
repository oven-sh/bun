...
extern "C" [[RUST_EXPORT(zero_is_throw)]] JSC::EncodedJSValue IPCSerialize(Bun::GlobalObject* global, JSC::EncodedJSValue message, JSC::EncodedJSValue handle)
{
...
extern "C" [[RUST_EXPORT(zero_is_throw)]] JSC::EncodedJSValue IPCParse(Bun::GlobalObject* global, JSC::EncodedJSValue target, JSC::EncodedJSValue serialized, JSC::EncodedJSValue fd)
{
    auto& vm = JSC::getVM(global);
    auto scope = DECLARE_THROW_SCOPE(vm);
