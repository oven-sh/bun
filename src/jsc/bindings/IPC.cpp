...
extern "C" [[ZIG_EXPORT(zero_is_throw, reenters_js)]] JSC::EncodedJSValue IPCSerialize(Zig::GlobalObject* global, JSC::EncodedJSValue message, JSC::EncodedJSValue handle, JSC::EncodedJSValue options)
{
