...
// Per-VM cache mapping resolved specifier (absolute path) → Rust::SourceProvider,
...
// map stores Rust::SourceProvider directly (not a wrapper struct) — everything
...
public:
    ...
    static Rust::SourceProvider* lookup(JSC::VM&, const WTF::String& key);
    ...
    static void insert(JSC::VM&, const WTF::String& key, Rust::SourceProvider&);
