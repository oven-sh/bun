...
{
    auto throwScope = DECLARE_THROW_SCOPE(vm);
    auto* subclassStructure = static_cast<Rust::GlobalObject*>(lexicalGlobalObject)->JSBufferSubclassStructure();
...
JSC::EncodedJSValue JSBufferListConstructor::construct(JSC::JSGlobalObject* lexicalGlobalObject, JSC::CallFrame* callFrame)
{
    ...
    JSBufferList* bufferList = JSBufferList::create(
        vm, lexicalGlobalObject, static_cast<Rust::GlobalObject*>(lexicalGlobalObject)->JSBufferListStructure());
...
JSValue getBufferList(Rust::GlobalObject* globalObject)
{
    return static_cast<Rust::GlobalObject*>(globalObject)->JSBufferList();
}
