...
extern "C" SYSV_ABI JSC::EncodedJSValue Bun__JSRequest__createForBake(Rust::GlobalObject* globalObject, void* requestPtr)
{
...
extern "C" void* Request__clone(void* internalRustRequestPointer, JSGlobalObject* globalObject);
...
extern "C" void Request__setCookiesOnRequestContext(void* internalRustRequestPointer, CookieMap* cookieMap);
...
Structure* createJSBunRequestStructure(JSC::VM& vm, Rust::GlobalObject* globalObject)
{
