...
void onAssign(Bun::GlobalObject* globalObject, JSC::PropertyName propertyName, JSC::JSValue value)
{
...
extern "C" uint32_t JSCommonJSExtensions__appendFunction(Bun::GlobalObject* globalObject, JSC::JSValue value)
{
...
extern "C" void JSCommonJSExtensions__setFunction(Bun::GlobalObject* globalObject, uint32_t index, JSC::JSValue value)
{
    JSCommonJSExtensions* extensions = globalObject->lazyRequireExtensionsObject();
    extensions->m_registeredFunctions[index].set(globalObject->vm(), globalObject, value);
}

extern "C" uint32_t JSCommonJSExtensions__swapRemove(Bun::GlobalObject* globalObject, uint32_t index)
{
    JSCommonJSExtensions* extensions = globalObject->lazyRequireExtensionsObject();
