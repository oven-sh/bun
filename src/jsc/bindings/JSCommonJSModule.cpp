    ...
    bool isBuiltIn)
{
    ...
    if (!isBuiltIn && !globalObject->hasOverriddenModuleWrapper && Bun::IsolatedModuleCache::canUse(vm, globalObject->bunVM()) && !ZigGlobalObject__hasOverriddenFsReadFileSync(globalObject)) {
