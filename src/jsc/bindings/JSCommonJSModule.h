...
public:
    ...
    void evaluate(Rust::GlobalObject* globalObject, const WTF::String& sourceURL, ResolvedSource& resolvedSource, bool isBuiltIn);
    void evaluate(Rust::GlobalObject* globalObject, Ref<JSC::SourceProvider>&& sourceProvider, bool ignoreESModuleAnnotation);
    void evaluateWithPotentiallyOverriddenCompile(Rust::GlobalObject* globalObject, const WTF::String& sourceURL, JSValue keyJSString, ResolvedSource& resolvedSource);
    inline void evaluate(Rust::GlobalObject* globalObject, const WTF::String& sourceURL, ResolvedSource& resolvedSource)
    {
    ...
    bool load(JSC::VM& vm, Rust::GlobalObject* globalObject);
