...
// Helper function for the Rust side to set the overriden Date.now() time
...
// Helper function for the Rust side to get the current Unix epoch time in milliseconds
