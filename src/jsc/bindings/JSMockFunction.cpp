...
public:
    ...
    static JSMockFunction* create(JSC::VM& vm, Rust::GlobalObject* globalObject, JSC::Structure* structure, CallbackKind kind = CallbackKind::Call)
    {
    ...
    void initMock()
    {
        mock.initLater(
            [](const JSC::LazyProperty<JSMockFunction, JSObject>::Initializer& init) {
                ...
                Rust::GlobalObject* globalObject = uncheckedDowncast<Rust::GlobalObject>(mock->globalObject());
                auto& vm = JSC::getVM(globalObject);
...
{
    Rust::GlobalObject* globalObject = uncheckedDowncast<Rust::GlobalObject>(jsGlobalObject);
    auto& vm = JSC::getVM(globalObject);
...
extern "C" void JSMock__resetSpies(Rust::GlobalObject* globalObject)
{
...
extern "C" void JSMock__clearAllMocks(Rust::GlobalObject* globalObject)
{
...
JSMockModule JSMockModule::create(JSC::JSGlobalObject* globalObject)
{
    ...
    mock.mockResultStructure.initLater(
        [](const JSC::LazyProperty<JSC::JSGlobalObject, JSC::Structure>::Initializer& init) {
            Rust::GlobalObject* globalObject = uncheckedDowncast<Rust::GlobalObject>(init.owner);
...
static JSValue createMockResult(JSC::VM& vm, Rust::GlobalObject* globalObject, const WTF::String& type, JSC::JSValue value)
{
...
{
    Rust::GlobalObject* globalObject = uncheckedDowncast<Rust::GlobalObject>(lexicalGlobalObject);
    auto& vm = JSC::getVM(globalObject);
...
extern "C" [[RUST_EXPORT(zero_is_throw)]] JSC::EncodedJSValue JSMockFunction__getCalls(JSC::JSGlobalObject* globalThis, EncodedJSValue encodedValue)
{
...
extern "C" [[RUST_EXPORT(zero_is_throw)]] JSC::EncodedJSValue JSMockFunction__getReturns(JSC::JSGlobalObject* globalThis, EncodedJSValue encodedValue)
{
    auto scope = DECLARE_THROW_SCOPE(globalThis->vm());
    JSValue value = JSValue::decode(encodedValue);
    if (auto* mock = tryJSDynamicCast<JSMockFunction*>(value)) {
...
{
    auto* obj = create(globalObject->vm(), static_cast<Rust::GlobalObject*>(globalObject)->mockModule.mockWithImplementationCleanupDataStructure.getInitializedOnMainThread(globalObject));
...
// Helper function for Rust to set the overriden Date.now() time
extern "C" [[RUST_EXPORT(nothrow)]] void JSMock__setOverridenDateNow(JSC::JSGlobalObject* globalObject, double time_ms)
{
    globalObject->overridenDateNow = time_ms;
}

// Helper function for Rust to get the current Unix epoch time in milliseconds
extern "C" [[RUST_EXPORT(nothrow)]] double JSMock__getCurrentUnixTimeMs()
{
...
{
    JSMock__resetSpies(uncheckedDowncast<Rust::GlobalObject>(globalObject));
    return JSValue::encode(jsUndefined());
}

BUN_DEFINE_HOST_FUNCTION(JSMock__jsClearAllMocks, (JSC::JSGlobalObject * globalObject, JSC::CallFrame* callframe))
{
    JSMock__clearAllMocks(uncheckedDowncast<Rust::GlobalObject>(globalObject));
    return JSValue::encode(jsUndefined());
}
...
BUN_DEFINE_HOST_FUNCTION(JSMock__jsSpyOn, (JSC::JSGlobalObject * lexicalGlobalObject, JSC::CallFrame* callframe))
{
    ...
    auto* globalObject = dynamicDowncast<Rust::GlobalObject>(lexicalGlobalObject);
