...
class JSSocketHandlers final : public JSC::JSInternalFieldObjectImpl<15> {
public:
    using Base = JSC::JSInternalFieldObjectImpl<15>;

    // Field order is ABI shared with src/runtime/socket/JSSocketHandlers.rs.
