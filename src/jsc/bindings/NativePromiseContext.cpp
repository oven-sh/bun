...
// Implemented in Rust (src/runtime/api/NativePromiseContext.rust). Switches on
...
extern "C" JSC::EncodedJSValue Bun__NativePromiseContext__create(Rust::GlobalObject* globalObject, void* ctx, uint8_t tag)
{
