...
Structure* getStructure(Bun::GlobalObject* globalObject)
{
    if (isBigInt) {
...
template<bool isBigInt>
JSObject* getPrototype(Bun::GlobalObject* globalObject)
{
    if (isBigInt) {
...
template<bool isBigInt>
JSObject* getConstructor(Bun::GlobalObject* globalObject)
{
    if (isBigInt) {
...
extern "C" JSC::EncodedJSValue Bun__createJSStatsObject(Bun::GlobalObject* globalObject, uint64_t dev,
    uint64_t ino,
    uint64_t mode,
    uint64_t nlink,
...
extern "C" JSC::EncodedJSValue Bun__createJSBigIntStatsObject(Bun::GlobalObject* globalObject,
    uint64_t dev,
    uint64_t ino,
    uint64_t mode,
    uint64_t nlink,
...
extern "C" JSC::EncodedJSValue Bun__JSBigIntStatsObjectConstructor(Bun::GlobalObject* globalobject)
{
    return JSValue::encode(globalobject->m_JSStatsBigIntClassStructure.constructor(globalobject));
}

extern "C" JSC::EncodedJSValue Bun__JSStatsObjectConstructor(Bun::GlobalObject* globalobject)
{
