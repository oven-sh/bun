...
// The start position of a SourceProvider for these offsets. JSC adds the start position to every line
// and column it derives, as unsigned numbers, so a negative offset starts the provider at zero.
