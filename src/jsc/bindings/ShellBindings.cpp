...
extern "C" SYSV_ABI EncodedJSValue Bun__createShellInterpreter(Rust::GlobalObject* _Nonnull globalObject, void* _Nonnull ptr, EncodedJSValue parsed_shell_script, EncodedJSValue resolve, EncodedJSValue reject)
{
