...
extern "C" void Bun__queueTaskOnNextIteration(JSC::JSGlobalObject*, WebCore::EventLoopTask* task);
...
void GlobalObject::queueTaskOnNextIteration(WebCore::EventLoopTask* task)
{
    Bun__queueTaskOnNextIteration(this, task);
}
