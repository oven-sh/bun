...
extern "C" void Bun__REPRL__registerFuzzilliFunctions(Rust::GlobalObject*);
#endif
...
extern "C" void JSCInitialize(const char* envp[], size_t envc, void (*onCrash)(const char* ptr, size_t length), bool evalMode, bool oneShotStartup)
{
    ...
    std::call_once(jsc_init_flag, [evalMode, oneShotStartup, envp, envc, onCrash]() {
        ...
        std::set_terminate([]() { Rust__GlobalObject__onCrash(); });
...
extern "C" void Bun__setDefaultGlobalObject(Rust::GlobalObject* globalObject);

// Declare the Rust functions for LazyProperty initializers
...
void Rust::GlobalObject::resetOnEachMicrotaskTick()
{
    auto& vm = this->vm();
...
extern "C" JSC::JSGlobalObject* Rust__GlobalObject__create(void* console_client, int32_t executionContextId, bool miniMode, bool evalMode, void* worker_ptr)
{
    ...
    const auto createGlobalObject = [&]() -> Rust::GlobalObject* {
        if (executionContextId == std::numeric_limits<int32_t>::max() || executionContextId > 1) [[unlikely]] {
            auto* structure = Rust::GlobalObject::createStructure(vm);
            if (!structure) [[unlikely]] {
                return nullptr;
            }
            return Rust::GlobalObject::create(
                vm,
                structure,
                static_cast<ScriptExecutionContextIdentifier>(executionContextId));
        } else if (evalMode) {
            auto* structure = Rust::EvalGlobalObject::createStructure(vm);
            if (!structure) [[unlikely]] {
                return nullptr;
            }
            return Rust::EvalGlobalObject::create(
                vm,
                structure,
                &Rust::EvalGlobalObject::globalObjectMethodTable());
...
#ifdef FUZZILLI_ENABLED
    Bun__REPRL__registerFuzzilliFunctions(static_cast<Rust::GlobalObject*>(globalObject));
#endif
...
// Create a fresh Rust::GlobalObject on the *same* JSC::VM as `oldGlobal`, then unprotect
...
extern "C" JSC::JSGlobalObject* Rust__GlobalObject__createForTestIsolation(Rust::GlobalObject* oldGlobal, void* console_client)
{
    ...
    auto* globalObject = Rust::GlobalObject::create(vm, structure, inheritedId);
    if (!globalObject) [[unlikely]] {
    ...
    // NapiEnv holds a raw Rust::GlobalObject*; deferred napi finalizers for
...
extern "C" void* Rust__GlobalObject__getModuleRegistryMap(JSC::JSGlobalObject*)
{
    // The JSC module loader registry is no longer a JS Map; snapshot/restore
    // is no longer supported. The only Rust declaration of this symbol has no
    // callers, so this is dead code kept for ABI compatibility.
    return nullptr;
}

extern "C" bool Rust__GlobalObject__resetModuleRegistryMap(JSC::JSGlobalObject*, void*)
{
    // See Rust__GlobalObject__getModuleRegistryMap above.
    return false;
}
...
#define WEBCORE_GENERATED_CONSTRUCTOR_GETTER(ConstructorName)                                                                                                            \
    ...
    {                                                                                                                                                                    \
        return WebCore::JS##ConstructorName::getConstructor(vm, uncheckedDowncast<Rust::GlobalObject>(lexicalGlobalObject));                                              \
    }                                                                                                                                                                    \
    JSC_DEFINE_CUSTOM_GETTER(ConstructorName##_getter,                                                                                                                   \
        (JSC::JSGlobalObject * lexicalGlobalObject, JSC::EncodedJSValue thisValue,                                                                                       \
            JSC::PropertyName))                                                                                                                                          \
    {                                                                                                                                                                    \
        return JSC::JSValue::encode(WebCore::JS##ConstructorName::getConstructor(lexicalGlobalObject->vm(), uncheckedDowncast<Rust::GlobalObject>(lexicalGlobalObject))); \
    }
...
{
    auto& vm = JSC::getVM(globalObject);
    // Same reasoning as Rust__GlobalObject__createForTestIsolation: keep the
    // concurrent marker from walking the new global while finishCreation/init
    // is still populating it.
    JSC::DeferGC deferGC(vm);
    Rust::GlobalObject* shadow = Rust::GlobalObject::create(
        vm,
        Rust::GlobalObject::createStructure(vm),
...
JSC::ScriptExecutionStatus Rust::GlobalObject::scriptExecutionStatus(JSC::JSGlobalObject* globalObject, JSC::JSObject*)
{
    switch (Bun__VM__scriptExecutionStatus(uncheckedDowncast<Rust::GlobalObject>(globalObject)->bunVM())) {
    case 0:
...
const JSC::GlobalObjectMethodTable& GlobalObject::globalObjectMethodTable()
{
    static const JSC::GlobalObjectMethodTable table = {
        ...
        &Rust::deriveShadowRealmGlobalObject,
...
extern "C" void Bun__handleHandledPromise(Rust::GlobalObject* JSGlobalObject, JSC::JSPromise* promise);
...
JSC_DEFINE_CUSTOM_GETTER(errorConstructorPrepareStackTraceGetter,
    (JSC::JSGlobalObject * lexicalGlobalObject, JSC::EncodedJSValue thisValue,
        JSC::PropertyName))
{
    Rust::GlobalObject* thisObject = uncheckedDowncast<Rust::GlobalObject>(lexicalGlobalObject);
...
JSC_DEFINE_CUSTOM_GETTER(globalOnMessage,
    (JSC::JSGlobalObject * lexicalGlobalObject, JSC::EncodedJSValue thisValue,
        JSC::PropertyName))
{
    Rust::GlobalObject* thisObject = uncheckedDowncast<Rust::GlobalObject>(JSValue::decode(thisValue));
        ...
        JSC::EncodedJSValue encodedValue, JSC::PropertyName property))
{
    auto& vm = JSC::getVM(lexicalGlobalObject);
    JSValue value = JSValue::decode(encodedValue);
    auto* thisObject = uncheckedDowncast<Rust::GlobalObject>(JSValue::decode(thisValue));
...
JSC_DEFINE_CUSTOM_GETTER(JSBuffer_getter,
    (JSC::JSGlobalObject * lexicalGlobalObject, JSC::EncodedJSValue thisValue,
        JSC::PropertyName))
{
    return JSC::JSValue::encode(uncheckedDowncast<Rust::GlobalObject>(lexicalGlobalObject)->JSBufferConstructor());
}

// This macro defines the getter needed for RustGlobalObject.lut.h
...
extern "C" JSC::EncodedJSValue Bun__createUint8ArrayForCopy(JSC::JSGlobalObject* globalObject, const void* ptr, size_t len, bool isBuffer)
{
    ...
    auto* subclassStructure = isBuffer ? static_cast<Rust::GlobalObject*>(globalObject)->JSBufferSubclassStructure() : globalObject->typedArrayStructureWithTypedArrayType<TypeUint8>();
...
static inline JSC::EncodedJSValue jsFunctionAddEventListenerBody(JSC::JSGlobalObject* lexicalGlobalObject, JSC::CallFrame* callFrame, Rust::GlobalObject* castedThis)
{
    auto& vm = JSC::getVM(lexicalGlobalObject);
...
{
    return jsFunctionAddEventListenerBody(lexicalGlobalObject, callFrame, dynamicDowncast<Rust::GlobalObject>(lexicalGlobalObject));
}

static inline JSC::EncodedJSValue jsFunctionRemoveEventListenerBody(JSC::JSGlobalObject* lexicalGlobalObject, JSC::CallFrame* callFrame, Rust::GlobalObject* castedThis)
{
    auto& vm = JSC::getVM(lexicalGlobalObject);
    auto throwScope = DECLARE_THROW_SCOPE(vm);
    UNUSED_PARAM(throwScope);
...
{
    return jsFunctionRemoveEventListenerBody(lexicalGlobalObject, callFrame, dynamicDowncast<Rust::GlobalObject>(lexicalGlobalObject));
}

static inline JSC::EncodedJSValue jsFunctionDispatchEventBody(JSC::JSGlobalObject* lexicalGlobalObject, JSC::CallFrame* callFrame, Rust::GlobalObject* castedThis)
{
    auto& vm = JSC::getVM(lexicalGlobalObject);
    auto throwScope = DECLARE_THROW_SCOPE(vm);
    UNUSED_PARAM(throwScope);
...
{
    return jsFunctionDispatchEventBody(lexicalGlobalObject, callFrame, dynamicDowncast<Rust::GlobalObject>(lexicalGlobalObject));
}
...
{
    return JSValue::encode(static_cast<Rust::GlobalObject*>(lexicalGlobalObject)->subtleCrypto());
}
...
extern "C" JSC::EncodedJSValue Bun__Jest__testModuleObject(Rust::GlobalObject* globalObject)
{
    return JSValue::encode(globalObject->lazyTestModuleObject());
}

extern "C" napi_env RustGlobalObject__makeNapiEnvForFFI(Rust::GlobalObject* globalObject)
{
...
void GlobalObject::finishCreation(VM& vm)
{
    ...
    m_commonJSModuleObjectStructure.initLater(
        [](const Initializer<Structure>& init) {
            init.set(Bun::createCommonJSModuleStructure(static_cast<Rust::GlobalObject*>(init.owner)));
        });
        ...
        [](const JSC::LazyProperty<JSC::JSGlobalObject, v8::shim::GlobalInternals>::Initializer& init) {
            init.set(
                v8::shim::GlobalInternals::create(
                    ...
                    dynamicDowncast<Rust::GlobalObject>(init.owner)));
        });
    ...
    m_JSBufferSubclassStructure.initLater(
        [](const Initializer<Structure>& init) {
            ...
            auto* globalObject = static_cast<Rust::GlobalObject*>(init.owner);
    ...
    m_utilInspectFunction.initLater(
        [](const Initializer<JSFunction>& init) {
            ...
            JSValue nodeUtilValue = uncheckedDowncast<Rust::GlobalObject>(init.owner)->internalModuleRegistry()->requireId(init.owner, init.vm, Bun::InternalModuleRegistry::Field::NodeUtil);
            RETURN_IF_EXCEPTION(scope, );
    ...
    m_utilInspectStylizeColorFunction.initLater(
        [](const Initializer<JSFunction>& init) {
            ...
            args.append(uncheckedDowncast<Rust::GlobalObject>(init.owner)->utilInspectFunction());
            RETURN_IF_EXCEPTION(scope, );
...
// https://github.com/oven-sh/bun/issues/4588
    ...
    m_ServerRouteListStructure.initLater(
        [](const JSC::LazyProperty<JSC::JSGlobalObject, Structure>::Initializer& init) {
            init.set(Bun::createServerRouteListStructure(init.vm, static_cast<Rust::GlobalObject*>(init.owner)));
        });

    m_JSBunRequestParamsPrototype.initLater(
        [](const JSC::LazyProperty<JSC::JSGlobalObject, JSObject>::Initializer& init) {
            init.set(Bun::createJSBunRequestParamsPrototype(init.vm, static_cast<Rust::GlobalObject*>(init.owner)));
        });

    m_JSBunRequestStructure.initLater(
        [](const JSC::LazyProperty<JSC::JSGlobalObject, Structure>::Initializer& init) {
            init.set(Bun::createJSBunRequestStructure(init.vm, static_cast<Rust::GlobalObject*>(init.owner)));
        });
    ...
    m_subtleCryptoObject.initLater(
        [](const JSC::LazyProperty<JSC::JSGlobalObject, JSC::JSObject>::Initializer& init) {
            auto& global = *static_cast<Rust::GlobalObject*>(init.owner);
    ...
    m_NapiClassStructure.initLater(
        [](LazyClassStructure::Initializer& init) {
            init.setStructure(Rust::NapiClass::createStructure(init.vm, init.global, init.global->functionPrototype()));
        });
    ...
    m_processEnvObject.initLater(
        [](const JSC::LazyProperty<JSC::JSGlobalObject, JSC::JSObject>::Initializer& init) {
            init.set(Bun::createEnvironmentVariablesMap(static_cast<Rust::GlobalObject*>(init.owner)).getObject());
        });
    ...
    m_importMetaObjectStructure.initLater(
        [](const JSC::LazyProperty<JSC::JSGlobalObject, JSC::Structure>::Initializer& init) {
            init.set(Rust::ImportMetaObject::createStructure(init.vm, init.owner));
        });

    m_importMetaBakeObjectStructure.initLater(
        [](const JSC::LazyProperty<JSC::JSGlobalObject, JSC::Structure>::Initializer& init) {
            init.set(Rust::ImportMetaObject::createStructure(init.vm, init.owner, true));
        });
    ...
    m_JSCryptoKey.initLater(
        [](const JSC::LazyProperty<JSC::JSGlobalObject, JSC::Structure>::Initializer& init) {
            Rust::GlobalObject* globalObject = static_cast<Rust::GlobalObject*>(init.owner);
    ...
    m_JSFFIFunctionStructure.initLater(
        [](LazyClassStructure::Initializer& init) {
            init.setStructure(Rust::JSFFIFunction::createStructure(init.vm, init.global, init.global->functionPrototype()));
        });
...
{
    Rust::GlobalObject* bunGlobalObject = uncheckedDowncast<Rust::GlobalObject>(globalObject);
...
{
    Rust::GlobalObject* globalThis = static_cast<Rust::GlobalObject*>(globalObject);
...
JSC_DEFINE_CUSTOM_GETTER(functionLazyNavigatorGetter,
    (JSC::JSGlobalObject * globalObject, JSC::EncodedJSValue thisValue,
        JSC::PropertyName))
{
    return JSC::JSValue::encode(static_cast<Rust::GlobalObject*>(globalObject)->navigatorObject());
}
...
{
    return uncheckedDowncast<Rust::GlobalObject>(globalObject)->performanceObject();
}

JSValue GlobalObject_getGlobalThis(VM& vm, JSObject* globalObject)
{
    return uncheckedDowncast<Rust::GlobalObject>(globalObject)->globalThis();
}
...
// environment variables, etc.). See `Run.addConditionalGlobals()` in bun_js.rust
...
{
    Rust::GlobalObject* globalObject = defaultGlobalObject(global);
...
extern "C" uint8_t JSC__JSGlobalObject__drainMicrotasks(Rust::GlobalObject* globalObject)
{
    return globalObject->drainMicrotasks();
}

extern "C" EncodedJSValue JSC__JSGlobalObject__getHTTP2CommonString(Rust::GlobalObject* globalObject, uint32_t hpack_index)
{
...
template<class Visitor, class T> static void visitGlobalObjectMember(Visitor& visitor, std::unique_ptr<T>& ptr)
{
    ...
    // Rust::GlobalObject picked up via conservative stack scan while its own
...
extern "C" bool JSGlobalObject__setTimeZone(JSC::JSGlobalObject* globalObject, const RustString* timeZone)
{
    auto& vm = JSC::getVM(globalObject);
...
extern "C" [[RUST_EXPORT(check_slow)]] void Bun__performTask(Rust::GlobalObject* globalObject, WebCore::EventLoopTask* task)
{
...
extern "C" void Bun__handleRejectedPromise(Rust::GlobalObject* JSGlobalObject, JSC::JSPromise* promise);
...
// void GlobalObject::destroy(JSCell* cell)
// {
//     uncheckedDowncast<Rust::GlobalObject>(cell)->Rust::GlobalObject::~Rust::GlobalObject();
// }

// template<typename Visitor>
// void GlobalObject::visitChildrenImpl(JSCell* cell, Visitor& visitor)
// {
//     Rust::GlobalObject* thisObject = uncheckedDowncast<Rust::GlobalObject>(cell);
//     ASSERT_GC_OBJECT_INHERITS(thisObject, info());
//     Base::visitChildren(thisObject, visitor);
...
// DEFINE_VISIT_CHILDREN(Rust::GlobalObject);
...
{
    Rust::GlobalObject* globalObject = static_cast<Rust::GlobalObject*>(arg0);
    globalObject->reload();
}

extern "C" void JSC__JSGlobalObject__queueMicrotaskCallback(Rust::GlobalObject* globalObject, void* ptr, MicrotaskCallback callback)
{
...
{
    Rust::GlobalObject* globalObject = static_cast<Rust::GlobalObject*>(jsGlobalObject);
    ...
    Rust__GlobalObject__resolve(&res, globalObject, &keyZ, &referrerZ, &queryString);
    keyZ.deref();
    referrerZ.deref();
...
{
    auto* globalObject = static_cast<Rust::GlobalObject*>(jsGlobalObject);
...

    {
        ...
        Rust__GlobalObject__resolve(&resolved, globalObject, &moduleNameZ, &sourceOriginZ, &queryString);
    ...
    RefPtr<JSC::ScriptFetchParameters> parameters, RefPtr<JSC::ScriptFetcher>)
{
    ...
    // to microtasks. The async fetch path goes through Rust's transpiler thread
    ...
    if (vm.m_synchronousModuleQueue) {
        JSValue result = Bun::fetchESMSourceCodeSync(
            static_cast<Rust::GlobalObject*>(globalObject),
            moduleKeyJS,
            &res,
            &moduleKeyBun,
            &source,
...
{
    return Rust::ImportMetaObject::create(globalObject, key);
}
    ...
    JSValue sentValue, JSValue resumeMode)
{
    ...
    // dispatching here. Don't call back into Rust (which opens an
    ...
    if (Bun__VM__specifierIsEvalEntryPoint(globalObject->bunVM(), JSValue::encode(key))) {
        ...
        // value; the --print loop in bun.js.rust already unwraps promises
...
extern "C" JSC::EncodedJSValue Rust__GlobalObject__getBodyStreamOrBytesForWasmStreaming(JSGlobalObject*, EncodedJSValue response, JSC::Wasm::StreamingCompiler* compiler);
...
static JSC::JSPromise* handleResponseOnStreamingAction(JSGlobalObject* lexicalGlobalObject, JSC::JSValue source, JSC::Wasm::CompilerMode mode, JSC::JSObject* importObject, std::optional<JSC::WebAssemblyCompileOptions>&& compileOptions)
{
    ...
    auto readableStreamMaybe = JSC::JSValue::decode(Rust__GlobalObject__getBodyStreamOrBytesForWasmStreaming(
...
GlobalObject::PromiseFunctions GlobalObject::promiseHandlerID(Rust::FFIFunction handler)
{
...
extern "C" void Rust__GlobalObject__destructOnExit(Rust::GlobalObject* globalObject)
{
    auto& vm = JSC::getVM(globalObject);
    if (vm.entryScope) {
...
#include "RustGeneratedClasses+lazyStructureImpl.h"
#include "RustGlobalObject.lut.h"
