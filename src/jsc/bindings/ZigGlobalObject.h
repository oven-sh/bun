...
public:
    ...
    Structure* JSFetchConnectionStatsStructure() const { return m_JSFetchConnectionStatsStructure.getInitializedOnMainThread(this); }
...
#define FOR_EACH_GLOBALOBJECT_GC_MEMBER(V)                                                                   \
    ...
    V(private, LazyPropertyOfGlobalObject<Structure>, m_JSFetchConnectionStatsStructure)                     \
