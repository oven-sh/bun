...
SourceProvider::~SourceProvider()
{
    ...
    if (m_resolvedSource.module_info != nullptr) {
        rust__ModuleInfoDeserialized__deinit(static_cast<bun_ModuleInfoDeserialized*>(m_resolvedSource.module_info));
        m_resolvedSource.module_info = nullptr;
    }
    // The Rust/Rust side hands these as +1 (RuntimeTranspilerStore::run_from_js_thread:
...
extern "C" BunString RustSourceProvider__getSourceSlice(SourceProvider* provider)
{
