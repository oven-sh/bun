...
// Note: keep this in sync with Expect.Flags implementation in rust (at expect.rust)
...
static void handlePromise(PromiseType* promise, JSC::JSGlobalObject* globalObject, JSC::EncodedJSValue ctx, Rust::FFIFunction resolverFunction, Rust::FFIFunction rejecterFunction)
{

    auto globalThis = static_cast<Rust::GlobalObject*>(globalObject);
...
std::optional<bool> specialObjectsDequal(JSC::JSGlobalObject* globalObject, MarkedArgumentBuffer& gcBuffer, Vector<std::pair<JSC::JSValue, JSC::JSValue>, 16>& stack, ThrowScope& scope, JSCell* _Nonnull c1, JSCell* _Nonnull c2)
{
    ...
    // NOTE: globalThis from JS is a JSGlobalProxy (GlobalProxyType) wrapping Rust::GlobalObject (GlobalObjectType)
...
void WebCore__FetchHeaders__append(WebCore::FetchHeaders* headers, const RustString* arg1, const RustString* arg2,
    JSC::JSGlobalObject* lexicalGlobalObject)
{
    auto throwScope = DECLARE_THROW_SCOPE(lexicalGlobalObject->vm());
    WebCore::propagateException(*lexicalGlobalObject, throwScope, headers->append(Rust::toString(*arg1), Rust::toString(*arg2)));
...
JSC::EncodedJSValue WebCore__FetchHeaders__clone(WebCore::FetchHeaders* headers, JSC::JSGlobalObject* arg1)
{
    ...
    Rust::GlobalObject* globalObject = static_cast<Rust::GlobalObject*>(arg1);
...
typedef struct RustSliceString {
    const unsigned char* ptr;
    size_t len;
} RustSliceString;

typedef struct PicoHTTPHeader {
    RustSliceString name;
    RustSliceString value;
} PicoHTTPHeader;
...
WebCore::FetchHeaders* WebCore__FetchHeaders__createValueNotJS(JSC::JSGlobalObject* arg0, StringPointer* arg1, StringPointer* arg2, const RustString* arg3, uint32_t count)
{
    ...
    for (uint32_t i = 0; i < count; i++) {
        WTF::String name = Rust::toStringCopy(buf, arg1[i]);
        WTF::String value = Rust::toStringCopy(buf, arg2[i]);
...
JSC::EncodedJSValue WebCore__FetchHeaders__createValue(JSC::JSGlobalObject* arg0, StringPointer* arg1, StringPointer* arg2, const RustString* arg3, uint32_t count)
{
    auto throwScope = DECLARE_THROW_SCOPE(arg0->vm());
    Vector<KeyValuePair<String, String>> pairs;
    pairs.reserveCapacity(count);
    ...
    JSValue value = WebCore::toJSNewlyCreated(arg0, static_cast<Rust::GlobalObject*>(arg0), WTF::move(headers));
...
void WebCore__FetchHeaders__get_(WebCore::FetchHeaders* headers, const RustString* arg1, RustString* arg2, JSC::JSGlobalObject* global)
{
    auto throwScope = DECLARE_THROW_SCOPE(global->vm());
    auto result = headers->get(Rust::toString(*arg1));
    if (result.hasException())
        WebCore::propagateException(*global, throwScope, result.releaseException());
    else
        *arg2 = Rust::toRustString(result.releaseReturnValue());
}
bool WebCore__FetchHeaders__has(WebCore::FetchHeaders* headers, const RustString* arg1, JSC::JSGlobalObject* global)
{
    auto throwScope = DECLARE_THROW_SCOPE(global->vm());
    auto result = headers->has(Rust::toString(*arg1));
    if (result.hasException()) {
        WebCore::propagateException(*global, throwScope, result.releaseException());
        return false;
    } else
...
extern "C" void WebCore__FetchHeaders__put(WebCore::FetchHeaders* headers, HTTPHeaderName name, const RustString* arg2, JSC::JSGlobalObject* global)
{
    auto throwScope = DECLARE_THROW_SCOPE(global->vm());
    throwScope.assertNoException(); // can't throw an exception when there's already one.
    WebCore::propagateException(*global, throwScope, headers->set(name, Rust::toStringCopy(*arg2)));
}
void WebCore__FetchHeaders__remove(WebCore::FetchHeaders* headers, const RustString* arg1, JSC::JSGlobalObject* global)
{
    auto throwScope = DECLARE_THROW_SCOPE(global->vm());
    WebCore::propagateException(*global, throwScope,
        headers->remove(Rust::toString(*arg1)));
}
...
void WebCore__FetchHeaders__fastGet_(WebCore::FetchHeaders* headers, unsigned char headerName, RustString* arg2)
{
...
[[RUST_EXPORT(nothrow)]] void WebCore__DOMURL__href_(WebCore::DOMURL* domURL, RustString* arg1)
{
    const WTF::URL& href = domURL->href();
    *arg1 = Rust::toRustString(href.string());
}
[[RUST_EXPORT(nothrow)]] void WebCore__DOMURL__pathname_(WebCore::DOMURL* domURL, RustString* arg1)
{
    const WTF::URL& href = domURL->href();
    const WTF::StringView& pathname = href.path();
    *arg1 = Rust::toRustString(pathname);
}
...
extern "C" JSC::EncodedJSValue RustString__toJSONObject(const RustString* strPtr, JSC::JSGlobalObject* globalObject)
{
    ASSERT_NO_PENDING_EXCEPTION(globalObject);
    auto str = Rust::toString(*strPtr);
...
// native code at the top of the event loop (e.g. runFromJSThread in node_fs.rust)
...
double JSC__JSValue__getLengthIfPropertyExistsInternal(JSC::EncodedJSValue value, JSC::JSGlobalObject* globalObject)
{
    ...
    default: {
        ...
        if (auto* object = dynamicDowncast<JSObject>(cell)) {
            auto scope = DECLARE_THROW_SCOPE(globalObject->vm());
            scope.release(); // rust binding handles exceptions
...
void JSC__JSObject__putRecord(JSC::JSObject* object, JSC::JSGlobalObject* global, RustString* key, RustString* values, size_t valuesLen)
{
    auto scope = DECLARE_THROW_SCOPE(global->vm());
    auto ident = Identifier::fromString(global->vm(), Rust::toStringCopy(*key));
    ...
    if (valuesLen == 1) {
        descriptor.setValue(JSC::jsString(global->vm(), Rust::toStringCopy(values[0])));
    } else {
        ...
        for (size_t i = 0; i < valuesLen; ++i) {
            strings.append(JSC::jsString(global->vm(), Rust::toStringCopy(values[i])));
        }
...
void JSC__JSValue__putRecord(JSC::EncodedJSValue objectValue, JSC::JSGlobalObject* global, RustString* key,
    RustString* values, size_t valuesLen)
{
    JSC::JSValue objValue = JSC::JSValue::decode(objectValue);
    JSC::JSObject* object = objValue.asCell()->getObject();
    auto scope = DECLARE_THROW_SCOPE(global->vm());
    auto ident = Rust::toIdentifier(*key, global);
    JSC::PropertyDescriptor descriptor;
    ...
    if (valuesLen == 1) {
        descriptor.setValue(JSC::jsString(global->vm(), Rust::toString(values[0])));
    } else {
        ...
        MarkedArgumentBuffer strings;
        for (size_t i = 0; i < valuesLen; ++i) {
            strings.append(JSC::jsString(global->vm(), Rust::toString(values[i])));
        }
...
bool JSC__JSFunction__getSourceCode(JSC::EncodedJSValue JSValue0, RustString* outSourceCode)
{
    JSC::JSValue value = JSC::JSValue::decode(JSValue0);
    if (JSC::JSFunction* func = dynamicDowncast<JSC::JSFunction>(value)) {
        ...
        if (sourceCode != nullptr) { // native functions have no source code
            *outSourceCode = Rust::toRustString(sourceCode->view());
            return true;
        }
        return false;
    }
...
void JSC__JSValue___then(JSC::EncodedJSValue JSValue0, JSC::JSGlobalObject* arg1, JSC::EncodedJSValue arg2, Rust::FFIFunction ArgFn3, Rust::FFIFunction ArgFn4)
{
...
JSC::EncodedJSValue JSC__JSGlobalObject__getCachedObject(JSC::JSGlobalObject* globalObject, const RustString* arg1)
{
    auto& vm = JSC::getVM(globalObject);
    auto scope = DECLARE_THROW_SCOPE(vm);
    WTF::String string = Rust::toString(*arg1);
...
JSC::EncodedJSValue JSC__JSGlobalObject__putCachedObject(JSC::JSGlobalObject* globalObject, const RustString* arg1, JSC::EncodedJSValue JSValue2)
{
    auto& vm = JSC::getVM(globalObject);
    WTF::String string = Rust::toString(*arg1);
    auto symbol = vm.privateSymbolRegistry().symbolForKey(string);
...
void JSC__JSGlobalObject__deleteModuleRegistryEntry(JSC::JSGlobalObject* global, RustString* arg1)
{
    const JSC::Identifier identifier = Rust::toIdentifier(*arg1, global);
...
JSC::EncodedJSValue JSC__JSObject__getDirect(JSC::JSObject* arg0, JSC::JSGlobalObject* arg1,
    const RustString* arg2)
{
    return JSC::JSValue::encode(arg0->getDirect(arg1->vm(), Rust::toIdentifier(*arg2, arg1)));
}
void JSC__JSObject__putDirect(JSC::JSObject* arg0, JSC::JSGlobalObject* arg1, const RustString* key,
    JSC::EncodedJSValue value)
{
    auto prop = Rust::toIdentifier(*key, arg1);
...
void JSC__JSString__toRustString(JSC::JSString* arg0, JSC::JSGlobalObject* arg1, RustString* arg2)
{
    auto value = arg0->value(arg1);
    *arg2 = Rust::toRustString(value.data.impl());
...
[[RUST_EXPORT(zero_is_throw)]] JSC::EncodedJSValue ReadableStream__empty(Rust::GlobalObject* globalObject)
{
    auto& vm = JSC::getVM(globalObject);
    auto scope = DECLARE_THROW_SCOPE(vm);
    auto clientData = WebCore::clientData(vm);
...
[[RUST_EXPORT(zero_is_throw)]] JSC::EncodedJSValue ReadableStream__used(Rust::GlobalObject* globalObject)
{
    auto& vm = JSC::getVM(globalObject);
    auto scope = DECLARE_THROW_SCOPE(vm);
    auto clientData = WebCore::clientData(vm);
...
JSC::EncodedJSValue JSC__JSValue__createRangeError(const RustString* message, const RustString* arg1,
    JSC::JSGlobalObject* globalObject)
{
    auto& vm = JSC::getVM(globalObject);
    RustString code = *arg1;
    JSC::JSObject* rangeError = Rust::getRangeErrorInstance(message, globalObject).asCell()->getObject();

    if (code.len > 0) {
        auto clientData = WebCore::clientData(vm);
        JSC::JSValue codeValue = Rust::toJSString(code, globalObject);
...
JSC::EncodedJSValue JSC__JSValue__createTypeError(const RustString* message, const RustString* arg1,
    JSC::JSGlobalObject* globalObject)
{
    auto& vm = JSC::getVM(globalObject);
    RustString code = *arg1;
    JSC::JSObject* typeError = Rust::getTypeErrorInstance(message, globalObject).asCell()->getObject();
...
JSC::EncodedJSValue JSC__JSValue__fromEntries(JSC::JSGlobalObject* globalObject, RustString* keys,
    RustString* values, size_t initialCapacity, bool clone)
{
    auto& vm = JSC::getVM(globalObject);
    auto scope = DECLARE_THROW_SCOPE(vm);
    ...
    if (!clone) {
        for (size_t i = 0; i < initialCapacity; ++i) {
            object->putDirect(
                vm, JSC::PropertyName(JSC::Identifier::fromString(vm, Rust::toString(keys[i]))),
                Rust::toJSStringGC(values[i], globalObject), 0);
            RETURN_IF_EXCEPTION(scope, {});
        }
    } else {
        for (size_t i = 0; i < initialCapacity; ++i) {
            object->putDirect(vm, JSC::PropertyName(Rust::toIdentifier(keys[i], globalObject)),
                Rust::toJSStringGC(values[i], globalObject), 0);
            RETURN_IF_EXCEPTION(scope, {});
        }
    }
...
JSC::EncodedJSValue JSC__JSGlobalObject__createAggregateError(JSC::JSGlobalObject* globalObject,
    ...
    const RustString* arg3)
{
    auto& vm = JSC::getVM(globalObject);
    auto scope = DECLARE_THROW_SCOPE(vm);

    WTF::String message = Rust::toString(*arg3);
...
JSC::EncodedJSValue RustString__toAtomicValue(const RustString* arg0, JSC::JSGlobalObject* arg1)
{
    if (arg0->len == 0) {
    ...
    return JSC::JSValue::encode(JSC::jsString(arg1->vm(), makeAtomString(Rust::toStringCopy(*arg0))));
}

JSC::EncodedJSValue RustString__to16BitValue(const RustString* arg0, JSC::JSGlobalObject* arg1)
{
    auto str = WTF::String::fromUTF8(std::span { arg0->ptr, arg0->len });
    return JSC::JSValue::encode(JSC::jsString(arg1->vm(), str));
}

JSC::EncodedJSValue RustString__toExternalU16(const uint16_t* arg0, size_t len, JSC::JSGlobalObject* global)
{
    if (len == 0) {
...
[[RUST_EXPORT(nothrow)]] JSC::EncodedJSValue RustString__toExternalValue(const RustString* arg0, JSC::JSGlobalObject* arg1)
{
    RustString str = *arg0;
    if (str.len == 0) {
        return JSC::JSValue::encode(JSC::jsEmptyString(arg1->vm()));
    }
    if (Rust::isTaggedUTF16Ptr(str.ptr)) {
        auto ref = String(ExternalStringImpl::create({ reinterpret_cast<const char16_t*>(Rust::untag(str.ptr)), str.len }, Rust::untagVoid(str.ptr), free_global_string));
        return JSC::JSValue::encode(JSC::jsString(arg1->vm(), WTF::move(ref)));
    } else {
        auto ref = String(ExternalStringImpl::create({ Rust::untag(str.ptr), str.len }, Rust::untagVoid(str.ptr), free_global_string));
        return JSC::JSValue::encode(JSC::jsString(arg1->vm(), WTF::move(ref)));
    }
}
...
JSC::EncodedJSValue RustString__toValueGC(const RustString* arg0, JSC::JSGlobalObject* arg1)
{
    return JSC::JSValue::encode(JSC::jsString(arg1->vm(), Rust::toStringCopy(*arg0)));
}

void JSC__JSValue__toRustString(JSC::EncodedJSValue JSValue0, RustString* arg1, JSC::JSGlobalObject* arg2)
{
    JSC::JSValue value = JSC::JSValue::decode(JSValue0);
    ...
    if (str->is8Bit()) {
        ...
        arg1->ptr = Rust::taggedUTF16Ptr(str->span16().data());
    }

    arg1->len = str->length();
}

JSC::EncodedJSValue RustString__external(const RustString* arg0, JSC::JSGlobalObject* arg1, void* arg2, void (*ArgFn3)(void* arg0, void* arg1, size_t arg2))
{
    RustString str
        = *arg0;
    if (Rust::isTaggedUTF16Ptr(str.ptr)) {
        return JSC::JSValue::encode(JSC::jsString(arg1->vm(), WTF::String(ExternalStringImpl::create({ reinterpret_cast<const char16_t*>(Rust::untag(str.ptr)), str.len }, arg2, ArgFn3))));
    } else {
        return JSC::JSValue::encode(JSC::jsString(arg1->vm(), WTF::String(ExternalStringImpl::create({ reinterpret_cast<const Latin1Character*>(Rust::untag(str.ptr)), str.len }, arg2, ArgFn3))));
    }
}

JSC::EncodedJSValue RustString__toExternalValueWithCallback(const RustString* arg0, JSC::JSGlobalObject* arg1, void (*ArgFn2)(void* arg2, void* arg0, size_t arg1))
{

    RustString str
        = *arg0;
    if (Rust::isTaggedUTF16Ptr(str.ptr)) {
        return JSC::JSValue::encode(JSC::jsOwnedString(arg1->vm(), WTF::String(ExternalStringImpl::create({ reinterpret_cast<const char16_t*>(Rust::untag(str.ptr)), str.len }, nullptr, ArgFn2))));
    } else {
        return JSC::JSValue::encode(JSC::jsOwnedString(arg1->vm(), WTF::String(ExternalStringImpl::create({ reinterpret_cast<const Latin1Character*>(Rust::untag(str.ptr)), str.len }, nullptr, ArgFn2))));
    }
}

JSC::EncodedJSValue RustString__toErrorInstance(const RustString* str, JSC::JSGlobalObject* globalObject)
{
    return JSC::JSValue::encode(Rust::getErrorInstance(str, globalObject));
}

JSC::EncodedJSValue RustString__toTypeErrorInstance(const RustString* str, JSC::JSGlobalObject* globalObject)
{
    return JSC::JSValue::encode(Rust::getTypeErrorInstance(str, globalObject));
}

JSC::EncodedJSValue RustString__toDOMExceptionInstance(const RustString* str, JSC::JSGlobalObject* globalObject, WebCore::ExceptionCode code)
{
    return JSValue::encode(createDOMException(globalObject, code, toStringCopy(*str)));
}

JSC::EncodedJSValue RustString__toSyntaxErrorInstance(const RustString* str, JSC::JSGlobalObject* globalObject)
{
    return JSC::JSValue::encode(Rust::getSyntaxErrorInstance(str, globalObject));
}

JSC::EncodedJSValue RustString__toRangeErrorInstance(const RustString* str, JSC::JSGlobalObject* globalObject)
{
    return JSC::JSValue::encode(Rust::getRangeErrorInstance(str, globalObject));
}
...
[[RUST_EXPORT(check_slow)]] void JSC__JSPromise__reject(JSC::JSPromise* arg0, JSC::JSGlobalObject* globalObject, JSC::EncodedJSValue JSValue2)
{
...
[[RUST_EXPORT(check_slow)]] void JSC__JSPromise__rejectAsHandled(JSC::JSPromise* arg0, JSC::JSGlobalObject* arg1, JSC::EncodedJSValue JSValue2)
{
    ASSERT_WITH_MESSAGE(arg0->inherits<JSC::JSPromise>(), "Argument is not a promise");
    ASSERT_WITH_MESSAGE(arg0->status() == JSC::JSPromise::Status::Pending, "Promise is already resolved or rejected");
...
[[RUST_EXPORT(check_slow)]] void JSC__JSPromise__resolve(JSC::JSPromise* arg0, JSC::JSGlobalObject* arg1, JSC::EncodedJSValue JSValue2)
{
    ...
    JSC::EncodedJSValue encoedValue, bool handled)
{
    ...
    if (!(flags & JSC::JSPromise::isFirstResolvingFunctionCalledFlag)) {
        ...
        auto* globalObject = uncheckedDowncast<Rust::GlobalObject>(promise->globalObject());
...
[[RUST_EXPORT(nothrow)]] JSC::EncodedJSValue JSC__JSPromise__result(JSC::JSPromise* promise, JSC::VM* arg1)
{
    auto& vm = *arg1;
...
[[RUST_EXPORT(nothrow)]] uint32_t JSC__JSPromise__status(const JSC::JSPromise* arg0)
{
    switch (arg0->status()) {
...
[[RUST_EXPORT(nothrow)]] bool JSC__JSPromise__isHandled(const JSC::JSPromise* arg0)
{
    return arg0->isHandled();
}
[[RUST_EXPORT(nothrow)]] void JSC__JSPromise__setHandled(JSC::JSPromise* promise)
{
...
{
    return uncheckedDowncast<Rust::GlobalObject>(arg0)->handleRejectedPromises();
}
...
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isAnyInt(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isAnyInt();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isBigInt(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isBigInt();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isBigInt32(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isBigInt32();
}

void JSC__JSValue__put(JSC::EncodedJSValue JSValue0, JSC::JSGlobalObject* arg1, const RustString* arg2, JSC::EncodedJSValue JSValue3)
{
    JSC::JSObject* object = JSC::JSValue::decode(JSValue0).asCell()->getObject();
    object->putDirect(arg1->vm(), Rust::toIdentifier(*arg2, arg1), JSC::JSValue::decode(JSValue3));
}
...
extern "C" [[RUST_EXPORT(check_slow)]] void JSC__JSValue__putMayBeIndex(JSC::EncodedJSValue target, JSC::JSGlobalObject* globalObject, const BunString* key, JSC::EncodedJSValue value)
{
    auto& vm = JSC::getVM(globalObject);
...
extern "C" bool JSC__JSValue__deleteProperty(JSC::EncodedJSValue target, JSC::JSGlobalObject* globalObject, const RustString* key)
{
    ...
    bool result = object->deleteProperty(globalObject, Rust::toIdentifier(*key, globalObject));
    RETURN_IF_EXCEPTION(scope, false);
    return result;
}
...
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isCell(JSC::EncodedJSValue JSValue0) { return JSC::JSValue::decode(JSValue0).isCell(); }
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isCustomGetterSetter(JSC::EncodedJSValue JSValue0)
{
...
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isCallable(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isCallable();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isGetterSetter(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isGetterSetter();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isHeapBigInt(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isHeapBigInt();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isInt32(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isInt32();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isInt32AsAnyInt(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isInt32AsAnyInt();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isNull(JSC::EncodedJSValue JSValue0) { return JSC::JSValue::decode(JSValue0).isNull(); }
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isNumber(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isNumber();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isObject(JSC::EncodedJSValue JSValue0)
{
    return JSValue0 != 0 && JSC::JSValue::decode(JSValue0).isObject();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isPrimitive(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isPrimitive();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isSymbol(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isSymbol();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isUInt32AsAnyInt(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isUInt32AsAnyInt();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isUndefined(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isUndefined();
}
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isUndefinedOrNull(JSC::EncodedJSValue JSValue0)
{
    return JSC::JSValue::decode(JSValue0).isUndefinedOrNull();
}

[[RUST_EXPORT(nothrow)]] JSC::EncodedJSValue JSC__JSValue__jsEmptyString(JSC::JSGlobalObject* arg0)
{
    return JSC::JSValue::encode(JSC::jsEmptyString(arg0->vm()));
}
[[RUST_EXPORT(nothrow)]] JSC::EncodedJSValue JSC__JSValue__jsNumberFromChar(unsigned char arg0)
{
...
[[RUST_EXPORT(nothrow)]] JSC::EncodedJSValue JSC__JSValue__jsNumberFromU16(uint16_t arg0)
{
    return JSC::JSValue::encode(JSC::jsNumber(arg0));
}
...
[[RUST_EXPORT(nothrow)]] int64_t JSC__JSValue__toInt64(JSC::EncodedJSValue val)
{
...
JSC::EncodedJSValue JSC__JSValue__createObject2(JSC::JSGlobalObject* globalObject, const RustString* arg1,
    const RustString* arg2, JSC::EncodedJSValue JSValue3,
    JSC::EncodedJSValue JSValue4)
{
    auto& vm = JSC::getVM(globalObject);
    auto scope = DECLARE_THROW_SCOPE(vm);
    JSC::JSObject* object = JSC::constructEmptyObject(globalObject);
    auto key1 = Rust::toIdentifier(*arg1, globalObject);
    ...
    auto key2 = Rust::toIdentifier(*arg2, globalObject);
...
[[RUST_EXPORT(zero_is_throw)]] JSC::EncodedJSValue JSC__JSValue__getIfPropertyExistsImpl(JSC::EncodedJSValue JSValue0,
    JSC::JSGlobalObject* globalObject,
...
void JSC__JSValue__getSymbolDescription(JSC::EncodedJSValue symbolValue_, JSC::JSGlobalObject* arg1, RustString* arg2)

{
    ...
    if (!result.isEmpty()) {
        *arg2 = Rust::toRustString(result);
    } else {
        *arg2 = RustStringEmpty;
    }
}

JSC::EncodedJSValue JSC__JSValue__symbolFor(JSC::JSGlobalObject* globalObject, RustString* arg2)
{

    auto& vm = JSC::getVM(globalObject);
    WTF::String string = Rust::toString(*arg2);
    return JSC::JSValue::encode(JSC::Symbol::create(vm, vm.symbolRegistry().symbolForKey(string)));
}

bool JSC__JSValue__symbolKeyFor(JSC::EncodedJSValue symbolValue_, JSC::JSGlobalObject* arg1, RustString* arg2)
{
    JSC::JSValue symbolValue = JSC::JSValue::decode(symbolValue_);
    JSC::VM& vm = arg1->vm();
    ...
    *arg2 = Rust::toRustString(JSC::jsString(vm, String { uid }), arg1);
    return true;
}
...
[[RUST_EXPORT(check_slow)]] int32_t JSC__JSValue__coerceToInt32(JSC::EncodedJSValue JSValue0, JSC::JSGlobalObject* arg1)
{
    JSC::JSValue value = JSC::JSValue::decode(JSValue0);
...
[[RUST_EXPORT(check_slow)]] int64_t JSC__JSValue__coerceToInt64(JSC::EncodedJSValue JSValue0, JSC::JSGlobalObject* arg1)
{
    JSValue value = JSValue::decode(JSValue0);
    if (value.isCell() && value.isHeapBigInt()) {
...
[[RUST_EXPORT(null_is_throw)]] JSC::JSString* JSC__JSValue__toStringOrNull(JSC::EncodedJSValue JSValue0, JSC::JSGlobalObject* arg1)
{
    JSC::JSValue value = JSC::JSValue::decode(JSValue0);
    return value.toStringOrNull(arg1);
}

[[RUST_EXPORT(check_slow)]] bool JSC__JSValue__toMatch(JSC::EncodedJSValue regexValue, JSC::JSGlobalObject* global, JSC::EncodedJSValue value)
{
...
void JSC__JSValue__getClassName(JSC::EncodedJSValue JSValue0, JSC::JSGlobalObject* arg1, RustString* arg2)
{
    JSValue value = JSValue::decode(JSValue0);
    JSC::JSCell* cell = value.asCell();
    ...
    if (calculated.length() > 0) {
        *arg2 = Rust::toRustString(calculated);
        return;
    }

    *arg2 = Rust::toRustString(view);
}
...
void JSC__JSValue__getNameProperty(JSC::EncodedJSValue JSValue0, JSC::JSGlobalObject* arg1, RustString* arg2)
{
    JSC::JSObject* obj = JSC::JSValue::decode(JSValue0).getObject();
    JSC::VM& vm = arg1->vm();
    auto scope = DECLARE_THROW_SCOPE(vm);
    ...
    if (JSC::JSFunction* function = dynamicDowncast<JSC::JSFunction>(obj)) {
        ...
        if (!actualName.isEmpty() || function->isHostOrBuiltinFunction()) {
            *arg2 = Rust::toRustString(actualName);
            return;
        }
    ...
    if (JSC::InternalFunction* function = dynamicDowncast<JSC::InternalFunction>(obj)) {
        *arg2 = Rust::toRustString(function->name());
        return;
    }
...
[[RUST_EXPORT(check_slow)]] void JSC__JSValue__getName(JSC::EncodedJSValue JSValue0, JSC::JSGlobalObject* globalObject, BunString* arg2)
{
    JSC::JSValue value = JSC::JSValue::decode(JSValue0);
    if (!value.isObject()) {
        *arg2 = BunStringEmpty;
...
// new, more ergonomic binding for interacting with the lock from Rust
...
// This enum must match the rust enum in src/jsc/bindings/JSValue.rust JSValue.BuiltinName
...
static void JSC__JSValue__forEachPropertyImpl(JSC::EncodedJSValue JSValue0, JSC::JSGlobalObject* globalObject, void* arg2, void (*iter)(JSC::JSGlobalObject* arg0, void* ctx, RustString* arg2, JSC::EncodedJSValue JSValue3, bool isSymbol, bool isPrivateSymbol))
{
    ASSERT_NO_PENDING_EXCEPTION(globalObject);
    JSC::JSValue value = JSC::JSValue::decode(JSValue0);
    JSC::JSObject* object = value.getObject();
...
restart:
    if (fast) {
        ...
        structure->forEachProperty(vm, [&](const PropertyTableEntry& entry) -> bool {
            ...
            RustString key = toRustString(prop);
...

    {
        ...
        while (iterating && !(iterating == globalObject->objectPrototype() || iterating == globalObject->functionPrototype() || (iterating->inherits<JSGlobalProxy>() && uncheckedDowncast<JSGlobalProxy>(iterating)->target() != globalObject)) && prototypeCount++ < 5) {
            ...
            for (auto& property : properties) {
                ...
                RustString key = toRustString(property.isSymbol() && !property.isPrivateName() ? property.impl() : property.string());
...
[[RUST_EXPORT(check_slow)]] void JSC__JSValue__forEachProperty(JSC::EncodedJSValue JSValue0, JSC::JSGlobalObject* globalObject, void* arg2, void (*iter)([[RUST_NONNULL]] JSC::JSGlobalObject* arg0, void* ctx, [[RUST_NONNULL]] RustString* arg2, JSC::EncodedJSValue JSValue3, bool isSymbol, bool isPrivateSymbol))
{
    JSC__JSValue__forEachPropertyImpl<false>(JSValue0, globalObject, arg2, iter);
}

extern "C" void JSC__JSValue__forEachPropertyNonIndexed(JSC::EncodedJSValue JSValue0, JSC::JSGlobalObject* globalObject, void* arg2, void (*iter)(JSC::JSGlobalObject* arg0, void* ctx, RustString* arg2, JSC::EncodedJSValue JSValue3, bool isSymbol, bool isPrivateSymbol))
{
    JSC__JSValue__forEachPropertyImpl<true>(JSValue0, globalObject, arg2, iter);
}

extern "C" [[RUST_EXPORT(nothrow)]] bool JSC__isBigIntInUInt64Range(JSC::EncodedJSValue value, uint64_t max, uint64_t min)
{
...
extern "C" [[RUST_EXPORT(nothrow)]] bool JSC__isBigIntInInt64Range(JSC::EncodedJSValue value, int64_t max, int64_t min)
{
    JSValue jsValue = JSValue::decode(value);
    if (!jsValue.isHeapBigInt())
        return false;
...
[[RUST_EXPORT(check_slow)]] void JSC__JSValue__forEachPropertyOrdered(JSC::EncodedJSValue JSValue0, JSC::JSGlobalObject* globalObject, void* arg2, void (*iter)([[RUST_NONNULL]] JSC::JSGlobalObject* arg0, void* ctx, [[RUST_NONNULL]] RustString* arg2, JSC::EncodedJSValue JSValue3, bool isSymbol, bool isPrivateSymbol))

{
    ...
    for (auto property : vector) {
        ...
        RustString key = toRustString(name);
...
[[RUST_EXPORT(nothrow)]] bool JSC__JSValue__isConstructor(JSC::EncodedJSValue JSValue0)
{
    JSValue value = JSValue::decode(JSValue0);
    return value.isConstructor();
}
...
extern "C" [[RUST_EXPORT(check_slow)]] double Bun__parseDate(JSC::JSGlobalObject* globalObject, BunString* str)
{
    auto& vm = JSC::getVM(globalObject);
    return vm.dateCache.parseDate(globalObject, vm, str->toWTFString());
}

extern "C" [[RUST_EXPORT(check_slow)]] double Bun__gregorianDateTimeToMS(JSC::JSGlobalObject* globalObject, int year, int month, int day, int hour, int minute, int second, int millisecond, bool localTime)
{
    auto& vm = JSC::getVM(globalObject);
...
extern "C" [[RUST_EXPORT(nothrow)]] void Bun__msToGregorianDateTime(JSC::JSGlobalObject* globalObject, double ms, bool localTime,
...
CPP_DECL void WebCore__DOMFormData__appendBlob(WebCore::DOMFormData* arg0, JSC::JSGlobalObject* arg1, RustString* arg2, void* blobValueInner, RustString* fileName)
{
...
extern "C" void DOMFormData__toQueryString(
    ...
    void* ctx,
    void (*callback)(void* ctx, RustString* encoded))
{
    auto str = formData->toURLEncodedString();
    RustString encoded = toRustString(str);
...
CPP_DECL [[RUST_EXPORT(nothrow)]] JSC::EncodedJSValue JSC__JSMap__create(JSC::JSGlobalObject* arg0)
{
...
CPP_DECL [[RUST_EXPORT(zero_is_throw)]] JSC::EncodedJSValue JSC__JSMap__get(JSC::JSMap* map, JSC::JSGlobalObject* arg1, JSC::EncodedJSValue JSValue2)
{
    auto& vm = JSC::getVM(arg1);
...
CPP_DECL [[RUST_EXPORT(check_slow)]] bool JSC__JSMap__has(JSC::JSMap* map, JSC::JSGlobalObject* arg1, JSC::EncodedJSValue JSValue2)
{
    const JSC::JSValue value = JSC::JSValue::decode(JSValue2);
    return map->has(arg1, value);
}

CPP_DECL [[RUST_EXPORT(check_slow)]] bool JSC__JSMap__remove(JSC::JSMap* map, JSC::JSGlobalObject* arg1, JSC::EncodedJSValue JSValue2)
{
    const JSC::JSValue value = JSC::JSValue::decode(JSValue2);
    return map->remove(arg1, value);
}

CPP_DECL [[RUST_EXPORT(check_slow)]] void JSC__JSMap__clear(JSC::JSMap* map, JSC::JSGlobalObject* arg1)
{
    map->clear(arg1);
}

CPP_DECL [[RUST_EXPORT(check_slow)]] void JSC__JSMap__set(JSC::JSMap* map, JSC::JSGlobalObject* arg1, JSC::EncodedJSValue JSValue2, JSC::EncodedJSValue JSValue3)
{
    map->set(arg1, JSC::JSValue::decode(JSValue2), JSC::JSValue::decode(JSValue3));
}

CPP_DECL [[RUST_EXPORT(check_slow)]] uint32_t JSC__JSMap__size(JSC::JSMap* map, JSC::JSGlobalObject* arg1)
{
    return map->size();
}
...
{
    return JSValue::encode(static_cast<Rust::GlobalObject*>(globalObject)->JSExpectPrototype());
}

extern "C" EncodedJSValue ExpectStatic__getPrototype(JSC::JSGlobalObject* globalObject)
{
    return JSValue::encode(static_cast<Rust::GlobalObject*>(globalObject)->JSExpectStaticPrototype());
}

extern "C" EncodedJSValue JSFunction__createFromRust(
...
CPP_DECL [[RUST_EXPORT(nothrow)]] bool JSC__CustomGetterSetter__isGetterNull(JSC::CustomGetterSetter* gettersetter)
{
    return gettersetter->getter() == nullptr;
}

CPP_DECL [[RUST_EXPORT(nothrow)]] bool JSC__CustomGetterSetter__isSetterNull(JSC::CustomGetterSetter* gettersetter)
{
...
CPP_DECL [[RUST_EXPORT(nothrow)]] void JSC__SourceProvider__deref(JSC::SourceProvider* provider)
{
    provider->deref();
}
...
CPP_DECL void Bun__CallFrame__getCallerSrcLoc(JSC::CallFrame* callFrame, JSC::JSGlobalObject* globalObject, BunString* outSourceURL, unsigned int* outLine, unsigned int* outColumn)
{
    ...
    JSC::StackVisitor::visit(callFrame, vm, [&](JSC::StackVisitor& visitor) -> WTF::IterationStatus {
        ...
        if (visitor->hasLineAndColumnInfo()) {
            ...
            sourceURL = Rust::sourceURL(visitor);
...
extern "C" [[RUST_EXPORT(nothrow)]] bool Bun__RETURN_IF_EXCEPTION(JSC::JSGlobalObject* globalObject)
{
    auto scope = DECLARE_THROW_SCOPE(globalObject->vm());
...
CPP_DECL [[RUST_EXPORT(zero_is_throw)]] JSC::EncodedJSValue Bun__JSValue__bind(JSC::EncodedJSValue functionToBindEncoded, JSC::JSGlobalObject* globalObject, JSC::EncodedJSValue bindThisArgEncoded, const BunString* name, double length, JSC::EncodedJSValue* args, size_t args_len)
{
    auto scope = DECLARE_THROW_SCOPE(globalObject->vm());
...
CPP_DECL [[RUST_EXPORT(check_slow)]] void Bun__JSValue__setPrototypeDirect(JSC::EncodedJSValue valueEncoded, JSC::EncodedJSValue prototypeEncoded, JSC::JSGlobalObject* globalObject)
{
    auto scope = DECLARE_THROW_SCOPE(globalObject->vm());
...
CPP_DECL [[RUST_EXPORT(nothrow)]] unsigned int Bun__CallFrame__getLineNumber(JSC::CallFrame* callFrame, JSC::JSGlobalObject* globalObject)
{
    auto& vm = JSC::getVM(globalObject);
    JSC::LineColumn lineColumn;
    String sourceURL;
    ...
    JSC::StackVisitor::visit(callFrame, vm, [&](JSC::StackVisitor& visitor) -> WTF::IterationStatus {
        ...
        if (visitor->hasLineAndColumnInfo()) {
            String currentSourceURL = Rust::sourceURL(visitor);
    ...
    JSC::EncodedJSValue* exception)
{
    ...
    // Note: _ is now set in Rust code (repl.rust) after extracting the value from
    ...
    bool colors)
{
    ...
    auto* bunGlobal = uncheckedDowncast<Rust::GlobalObject>(globalObject);
