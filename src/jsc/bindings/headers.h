...
ZIG_DECL void Bun__WebSocketClient__terminateImmediately(WebSocketClient* arg0);
...
ZIG_DECL void Bun__WebSocketClientTLS__terminateImmediately(WebSocketClientTLS* arg0);
