...
static void free_global_string(void* str, void* ptr, unsigned len)
{
    ...
    RustString__freeGlobal(reinterpret_cast<const unsigned char*>(ptr), len);
}

// Switching to AtomString doesn't yield a perf benefit because we're recreating it each time.
static const WTF::String toString(RustString str)
{
...
static WTF::AtomString toAtomString(RustString str)
{
...
static const WTF::String toString(RustString str, StringPointer ptr)
{
...
static const WTF::String toStringCopy(RustString str, StringPointer ptr)
{
    if (str.len == 0 || str.ptr == nullptr || ptr.len == 0) {
        return WTF::String();
    }
...
static const WTF::String toStringCopy(RustString str)
{
    if (str.len == 0 || str.ptr == nullptr) {
        return WTF::String();
    }
...
static void appendToBuilder(RustString str, WTF::StringBuilder& builder)
{
    if (str.len == 0 || str.ptr == nullptr) {
        return;
    }
...
static WTF::String toStringNotConst(RustString str) { return toString(str); }

static const JSC::JSString* toJSString(RustString str, JSC::JSGlobalObject* global)
{
    return JSC::jsOwnedString(global->vm(), toString(str));
}

static JSC::JSString* toJSStringGC(RustString str, JSC::JSGlobalObject* global)
{
    return JSC::jsString(global->vm(), toStringCopy(str));
}

static const RustString RustStringEmpty = RustString { (unsigned char*)"", 0 };
static const unsigned char __dot_char = '.';
static const RustString RustStringCwd = RustString { &__dot_char, 1 };
static const BunString BunStringCwd = BunString { BunStringTag::StaticRustString, RustStringCwd };
...
static RustString toRustString(WTF::String* str)
{
    return str->isEmpty()
        ? RustStringEmpty
        : RustString { str->is8Bit() ? str->span8().data() : taggedUTF16Ptr(str->span16().data()),
              str->length() };
}

static RustString toRustString(WTF::StringImpl& str)
{
    return str.isEmpty()
        ? RustStringEmpty
        : RustString { str.is8Bit() ? str.span8().data() : taggedUTF16Ptr(str.span16().data()),
...
// Overload for `StringImpl*` so callers like `toRustString(string.impl())` resolve here
...
static RustString toRustString(const WTF::StringImpl* str)
{
...
static RustString toRustString(WTF::StringView& str)
{
    return str.isEmpty()
        ? RustStringEmpty
        : RustString { str.is8Bit() ? str.span8().data() : taggedUTF16Ptr(str.span16().data()),
...
static RustString toRustString(const WTF::StringView& str)
{
    return str.isEmpty()
        ? RustStringEmpty
        : RustString { str.is8Bit() ? str.span8().data() : taggedUTF16Ptr(str.span16().data()),
...
static RustString toRustString(JSC::JSString& str, JSC::JSGlobalObject* global)
{
    if (str.isSubstring()) {
        return toRustString(str.view(global));
    }

    return toRustString(str.value(global));
}
...
static RustString toRustString(JSC::Identifier& str, JSC::JSGlobalObject* global)
{
    return toRustString(str.string());
}
...
static WTF::StringView toStringView(RustString str)
{
    return WTF::StringView(std::span { untag(str.ptr), str.len });
}

static void throwException(JSC::ThrowScope& scope, RustErrorType err, JSC::JSGlobalObject* global)
{
    scope.throwException(global,
        JSC::Exception::create(global->vm(), JSC::JSValue::decode(err.value)));
}

static RustString toRustString(JSC::JSValue val, JSC::JSGlobalObject* global)
{
    ...
    return toRustString(view);
}

static const WTF::String toStringStatic(RustString str)
{
    if (str.len == 0 || str.ptr == nullptr) {
        return WTF::String();
    }
...
static JSC::JSValue getErrorInstance(const RustString* str, JSC::JSGlobalObject* globalObject)
{
...
static JSC::JSValue getTypeErrorInstance(const RustString* str, JSC::JSGlobalObject* globalObject)
{
...
static JSC::JSValue getSyntaxErrorInstance(const RustString* str, JSC::JSGlobalObject* globalObject)
{
...
static JSC::JSValue getRangeErrorInstance(const RustString* str, JSC::JSGlobalObject* globalObject)
{
...
static const JSC::Identifier toIdentifier(RustString str, JSC::JSGlobalObject* global)
{
    if (str.len == 0 || str.ptr == nullptr) {
        return global->vm().propertyNames->emptyIdentifier;
    }
    WTF::String wtfstr = Rust::isTaggedExternalPtr(str.ptr) ? toString(str) : Rust::toStringCopy(str);
