...
3. Update `src/symbols.txt` (macOS) and `src/linker.lds` (Linux and FreeBSD). `test/internal/source-lints/posix-export-lists.test.ts` checks that the two lists agree.
