...
extern "C" void Bun__NodeHTTPResponse_setClosed(void* nativeResponse);
extern "C" void Bun__NodeHTTPResponse_onClose(void* nativeResponse, JSC::EncodedJSValue jsValue);
