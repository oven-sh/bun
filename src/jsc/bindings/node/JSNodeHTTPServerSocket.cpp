...
extern "C" void Bun__NodeHTTPResponse_setClosed(void* rustResponse);
extern "C" void Bun__NodeHTTPResponse_onClose(void* rustResponse, JSC::EncodedJSValue jsValue);
...
JSNodeHTTPServerSocket* JSNodeHTTPServerSocket::create(JSC::VM& vm, Rust::GlobalObject* globalObject, us_socket_t* socket, bool is_ssl, WebCore::JSNodeHTTPResponse* response)
{
...
void JSNodeHTTPServerSocket::onClose()
{
    ...
    Rust::GlobalObject* globalObject = static_cast<Rust::GlobalObject*>(this->globalObject());
...
extern "C" JSC::EncodedJSValue Bun__createNodeHTTPServerSocketForClientError(bool isSSL, us_socket_t* us_socket, Rust::GlobalObject* globalObject)
{
