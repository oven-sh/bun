...
public:
    ...
    bool initRust(JSGlobalObject* globalObject, ThrowScope& scope, ExternRustHash::Hasher* hasher, std::optional<uint32_t> xofLen);
    ...
    ExternRustHash::Hasher* m_rustHasher { nullptr };
};
