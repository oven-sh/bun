...
JSC_DEFINE_HOST_FUNCTION(jsCertExportChallenge, (JSC::JSGlobalObject * lexicalGlobalObject, JSC::CallFrame* callFrame))
{
    ...
    auto* bufferResult = JSC::JSUint8Array::create(lexicalGlobalObject, static_cast<Bun::GlobalObject*>(lexicalGlobalObject)->JSBufferSubclassStructure(), WTF::move(result), 0, cert.len);
    RETURN_IF_EXCEPTION(scope, {});
...
JSValue createNodeCryptoBinding(Bun::GlobalObject* globalObject)
{
