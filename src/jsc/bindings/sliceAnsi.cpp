...
// GraphemeWidthState mirror of visible.rs's GraphemeState because these are
...
// ============================================================================
// Grapheme-aware Visible Width (mirrors visible.rs GraphemeState; see above)
// ============================================================================
...
struct GraphemeWidthState {
    ...
    uint8_t width() const
    {
        ...
        if (regionalIndicator)
            return 1; // Single (unpaired) regional indicator is width 1 — matches visible.rs
        ...
        // Match visible.rs GraphemeState.width() exactly: return accumulated width
