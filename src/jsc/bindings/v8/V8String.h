...
private:
    // Out-of-line target of V8's inline templated NewFromUtf8Literal overload
    // in v8-primitive.h. Private to match V8's declaration, which affects the
    // mangled name on MSVC.
