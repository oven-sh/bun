...
public:
    ...
    static GlobalInternals* create(JSC::VM& vm, JSC::Structure* structure, Bun::GlobalObject* globalObject);
...
private:
    ...
    GlobalInternals(JSC::VM& vm, JSC::Structure* structure, Bun::GlobalObject* globalObject)
        : Base(vm, structure)
