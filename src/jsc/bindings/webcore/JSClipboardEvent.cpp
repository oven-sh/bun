...
{
    return WebCore::subspaceForImpl<JSClipboardEvent, UseCustomHeapCellType::No>(vm, BUN_SUBSPACE_SLOTS(m_clientSubspaceForClipboardEvent, m_subspaceForClipboardEvent));
}
