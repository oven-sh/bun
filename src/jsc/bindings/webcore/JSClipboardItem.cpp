...
{
    return WebCore::subspaceForImpl<JSClipboardItem, UseCustomHeapCellType::No>(vm, BUN_SUBSPACE_SLOTS(m_clientSubspaceForClipboardItem, m_subspaceForClipboardItem));
}
