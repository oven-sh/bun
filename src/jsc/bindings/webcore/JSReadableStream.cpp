...
JSC_DEFINE_HOST_FUNCTION(jsReadableStreamProtoFuncText, (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    return BunGlobalObject__readableStreamToText(defaultGlobalObject(globalObject), JSValue::encode(thisObject));
}
...
JSC_DEFINE_HOST_FUNCTION(jsReadableStreamProtoFuncBytes, (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    return BunGlobalObject__readableStreamToBytes(defaultGlobalObject(globalObject), JSValue::encode(thisObject));
}
...
JSC_DEFINE_HOST_FUNCTION(jsReadableStreamProtoFuncJSON, (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    return BunGlobalObject__readableStreamToJSON(defaultGlobalObject(globalObject), JSValue::encode(thisObject));
}
...
JSC_DEFINE_HOST_FUNCTION(jsReadableStreamProtoFuncBlob, (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    return BunGlobalObject__readableStreamToBlob(defaultGlobalObject(globalObject), JSValue::encode(thisObject));
}
