...
template<> CryptoAlgorithmAeadParams convertDictionary<CryptoAlgorithmAeadParams>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    CryptoAlgorithmAeadParams result;
    JSValue nameValue;
    ...
    if (!nameValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "name"_s, "AeadParams"_s, "DOMString"_s);
        return {};
    }
    ...
    if (!ivValue.isUndefined()) {
        ...
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "iv"_s, "AeadParams"_s, "(ArrayBufferView or ArrayBuffer)"_s);
        return {};
    }
