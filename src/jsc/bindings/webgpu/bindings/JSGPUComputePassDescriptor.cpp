...
static_assert(std::is_aggregate_v<GPUComputePassDescriptor>);
static_assert(IsIncreasing<
      0
    , offsetof(GPUComputePassDescriptor, timestampWrites)
>);

IGNORE_WARNINGS_END

template<> ConversionResult<IDLDictionary<GPUComputePassDescriptor>> convertDictionary<GPUComputePassDescriptor>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
