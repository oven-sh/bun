...
static_assert(std::is_aggregate_v<GPUComputePassTimestampWrites>);
static_assert(IsIncreasing<
      0
    , offsetof(GPUComputePassTimestampWrites, querySet)
    , offsetof(GPUComputePassTimestampWrites, beginningOfPassWriteIndex)
    , offsetof(GPUComputePassTimestampWrites, endOfPassWriteIndex)
>);
