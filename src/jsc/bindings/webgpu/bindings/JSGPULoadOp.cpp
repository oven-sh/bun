...
template<> JSString* convertEnumerationToJS(JSGlobalObject& lexicalGlobalObject, GPULoadOp enumerationValue)
{
...
{
    static constexpr SortedArrayMap enumerationMapping { WTF::toArray<std::pair<ComparableASCIILiteral, GPULoadOp>>({
        { "clear"_s, GPULoadOp::Clear },
        { "load"_s, GPULoadOp::Load },
    }) };
