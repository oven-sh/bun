...
#include "config.h"
#include "JSGPUObjectDescriptorBase.h"
...
static_assert(std::is_aggregate_v<GPUObjectDescriptorBase>);
static_assert(IsIncreasing<
      0
    , offsetof(GPUObjectDescriptorBase, label)
>);

IGNORE_WARNINGS_END

template<> ConversionResult<IDLDictionary<GPUObjectDescriptorBase>> convertDictionary<GPUObjectDescriptorBase>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
