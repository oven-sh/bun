...
static_assert(std::is_aggregate_v<GPUQueueDescriptor>);
...
template<> ConversionResult<IDLDictionary<GPUQueueDescriptor>> convertDictionary<GPUQueueDescriptor>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
