        ...
        match ext.tag {
            ...
            4 => {
                ...
                if !arr.data.is_null() {
                    ...
                    // Zig `BindgenArray` reuses the allocation in-place when
                    // `ZigType == ExternType`. This path copies-then-frees the
                    // source buffer instead; profile if it shows up on a hot path.
