...
pub mod resolved_source_tag {
    ...
    static INTERNAL_MODULE_TAG: phf::Map<&'static [u8], ResolvedSourceTag> = phf::phf_map! {
        ...
        b"bun:guard" => ResolvedSourceTag(513),
        b"bun:sql" => ResolvedSourceTag(514),
        b"bun:sqlite" => ResolvedSourceTag(515),
        b"internal:abort_listener" => ResolvedSourceTag(516),
        b"internal:assert/assertion_error" => ResolvedSourceTag(517),
        b"internal:assert/calltracker" => ResolvedSourceTag(518),
        b"internal:assert/myers_diff" => ResolvedSourceTag(519),
        b"internal:assert/utils" => ResolvedSourceTag(520),
        b"internal:buffer" => ResolvedSourceTag(521),
        b"internal:cluster/child" => ResolvedSourceTag(522),
        b"internal:cluster/isPrimary" => ResolvedSourceTag(523),
        b"internal:cluster/primary" => ResolvedSourceTag(524),
        b"internal:cluster/RoundRobinHandle" => ResolvedSourceTag(525),
        b"internal:cluster/Worker" => ResolvedSourceTag(526),
        b"internal:crypto/x509" => ResolvedSourceTag(527),
        b"internal:debugger" => ResolvedSourceTag(528),
        b"internal:errors" => ResolvedSourceTag(529),
        b"internal:fifo" => ResolvedSourceTag(530),
        b"internal:fixed_queue" => ResolvedSourceTag(531),
        b"internal:freelist" => ResolvedSourceTag(532),
        b"internal:fs/cp-sync" => ResolvedSourceTag(533),
        b"internal:fs/cp" => ResolvedSourceTag(534),
        b"internal:fs/glob" => ResolvedSourceTag(535),
        b"internal:fs/streams" => ResolvedSourceTag(536),
        b"internal:html" => ResolvedSourceTag(537),
        b"internal:http" => ResolvedSourceTag(538),
        b"internal:http/FakeSocket" => ResolvedSourceTag(539),
        b"internal:linkedlist" => ResolvedSourceTag(540),
        b"internal:net/isIP" => ResolvedSourceTag(541),
        b"internal:perf_hooks/monitorEventLoopDelay" => ResolvedSourceTag(542),
        b"internal:primordials" => ResolvedSourceTag(543),
        b"internal:promisify" => ResolvedSourceTag(544),
        b"internal:shared" => ResolvedSourceTag(545),
        b"internal:sql/errors" => ResolvedSourceTag(546),
        b"internal:sql/mysql" => ResolvedSourceTag(547),
        b"internal:sql/postgres" => ResolvedSourceTag(548),
        b"internal:sql/query" => ResolvedSourceTag(549),
        b"internal:sql/shared" => ResolvedSourceTag(550),
        b"internal:sql/sqlite" => ResolvedSourceTag(551),
        b"internal:stream/promises" => ResolvedSourceTag(552),
        b"internal:stream" => ResolvedSourceTag(553),
        b"internal:streams/add-abort-signal" => ResolvedSourceTag(554),
        b"internal:streams/compose" => ResolvedSourceTag(555),
        b"internal:streams/destroy" => ResolvedSourceTag(556),
        b"internal:streams/duplex" => ResolvedSourceTag(557),
        b"internal:streams/duplexify" => ResolvedSourceTag(558),
        b"internal:streams/duplexpair" => ResolvedSourceTag(559),
        b"internal:streams/end-of-stream" => ResolvedSourceTag(560),
        b"internal:streams/from" => ResolvedSourceTag(561),
        b"internal:streams/lazy_transform" => ResolvedSourceTag(562),
        b"internal:streams/legacy" => ResolvedSourceTag(563),
        b"internal:streams/native-readable" => ResolvedSourceTag(564),
        b"internal:streams/operators" => ResolvedSourceTag(565),
        b"internal:streams/passthrough" => ResolvedSourceTag(566),
        b"internal:streams/pipeline" => ResolvedSourceTag(567),
        b"internal:streams/readable" => ResolvedSourceTag(568),
        b"internal:streams/state" => ResolvedSourceTag(569),
        b"internal:streams/transform" => ResolvedSourceTag(570),
        b"internal:streams/utils" => ResolvedSourceTag(571),
        b"internal:streams/writable" => ResolvedSourceTag(572),
        b"internal:timers" => ResolvedSourceTag(573),
        b"internal:tls" => ResolvedSourceTag(574),
        b"internal:tty" => ResolvedSourceTag(575),
        b"internal:url" => ResolvedSourceTag(576),
        b"internal:util/colors" => ResolvedSourceTag(577),
        b"internal:util/deprecate" => ResolvedSourceTag(578),
        b"internal:util/inspect" => ResolvedSourceTag(579),
        b"internal:util/mime" => ResolvedSourceTag(580),
        b"internal:validators" => ResolvedSourceTag(581),
        b"internal:webstreams_adapters" => ResolvedSourceTag(582),
        ...
        b"node:_http2_upgrade" => ResolvedSourceTag(589),
        b"node:_stream_duplex" => ResolvedSourceTag(590),
        b"node:_stream_passthrough" => ResolvedSourceTag(591),
        b"node:_stream_readable" => ResolvedSourceTag(592),
        b"node:_stream_transform" => ResolvedSourceTag(593),
        b"node:_stream_wrap" => ResolvedSourceTag(594),
        b"node:_stream_writable" => ResolvedSourceTag(595),
        b"node:_tls_common" => ResolvedSourceTag(596),
        b"node:assert/strict" => ResolvedSourceTag(597),
        b"node:assert" => ResolvedSourceTag(598),
        b"node:async_hooks" => ResolvedSourceTag(599),
        b"node:child_process" => ResolvedSourceTag(600),
        b"node:cluster" => ResolvedSourceTag(601),
        b"node:console" => ResolvedSourceTag(602),
        b"node:crypto" => ResolvedSourceTag(603),
        b"node:dgram" => ResolvedSourceTag(604),
        b"node:diagnostics_channel" => ResolvedSourceTag(605),
        b"node:dns/promises" => ResolvedSourceTag(606),
        b"node:dns" => ResolvedSourceTag(607),
        b"node:domain" => ResolvedSourceTag(608),
        b"node:events" => ResolvedSourceTag(609),
        b"node:fs/promises" => ResolvedSourceTag(610),
        b"node:fs" => ResolvedSourceTag(611),
        b"node:http" => ResolvedSourceTag(612),
        b"node:http2" => ResolvedSourceTag(613),
        b"node:https" => ResolvedSourceTag(614),
        b"node:inspector/promises" => ResolvedSourceTag(615),
        b"node:inspector" => ResolvedSourceTag(616),
        b"node:net" => ResolvedSourceTag(617),
        b"node:os" => ResolvedSourceTag(618),
        b"node:path/posix" => ResolvedSourceTag(619),
        b"node:path" => ResolvedSourceTag(620),
        b"node:path/win32" => ResolvedSourceTag(621),
        b"node:perf_hooks" => ResolvedSourceTag(622),
        b"node:punycode" => ResolvedSourceTag(623),
        b"node:querystring" => ResolvedSourceTag(624),
        b"node:readline/promises" => ResolvedSourceTag(625),
        b"node:readline" => ResolvedSourceTag(626),
        b"node:repl" => ResolvedSourceTag(627),
        b"node:stream/consumers" => ResolvedSourceTag(628),
        b"node:stream/promises" => ResolvedSourceTag(629),
        b"node:stream" => ResolvedSourceTag(630),
        b"node:stream/web" => ResolvedSourceTag(631),
        b"node:test" => ResolvedSourceTag(632),
        b"node:timers/promises" => ResolvedSourceTag(633),
        b"node:timers" => ResolvedSourceTag(634),
        b"node:tls" => ResolvedSourceTag(635),
        b"node:trace_events" => ResolvedSourceTag(636),
        b"node:tty" => ResolvedSourceTag(637),
        b"node:url" => ResolvedSourceTag(638),
        b"node:util" => ResolvedSourceTag(639),
        b"node:v8" => ResolvedSourceTag(640),
        b"node:vm" => ResolvedSourceTag(641),
        b"node:wasi" => ResolvedSourceTag(642),
        b"node:worker_threads" => ResolvedSourceTag(643),
        b"node:zlib" => ResolvedSourceTag(644),
        b"isomorphic-fetch" => ResolvedSourceTag(645),
        b"node-fetch" => ResolvedSourceTag(646),
        b"undici" => ResolvedSourceTag(647),
        b"vercel_fetch" => ResolvedSourceTag(648),
        ...
        b"node:buffer" => ResolvedSourceTag(654),
        b"node:constants" => ResolvedSourceTag(655),
        b"node:string_decoder" => ResolvedSourceTag(656),
        b"node:util/types" => ResolvedSourceTag(657),
        b"utf-8-validate" => ResolvedSourceTag(658),
        b"abort-controller" => ResolvedSourceTag(659),
        b"node:module" => ResolvedSourceTag(660),
        b"node:process" => ResolvedSourceTag(661),
        b"bun" => ResolvedSourceTag(662),
    };
}
