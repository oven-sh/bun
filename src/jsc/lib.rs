...
pub mod resolved_source_tag {
    ...
    static INTERNAL_MODULE_TAG: phf::Map<&'static [u8], ResolvedSourceTag> = phf::phf_map! {
        ...
        b"internal:fs/watchfile" => ResolvedSourceTag(536),
        ...
        b"node:_http2_upgrade" => ResolvedSourceTag(583),
        b"node:_http_agent" => ResolvedSourceTag(584),
        b"node:_http_client" => ResolvedSourceTag(585),
        b"node:_http_common" => ResolvedSourceTag(586),
        b"node:_http_incoming" => ResolvedSourceTag(587),
        b"node:_http_outgoing" => ResolvedSourceTag(588),
        b"node:_http_server" => ResolvedSourceTag(589),
