...
//!
//! this file is loaded as `pub mod timer;` from `mod.rs` (js2native codegen
//! reaches `bun_jsc::timer::timer::internal_bindings::*` via the generated
//! thunks in `bun_runtime::generated_js2native`). The canonical struct
//! definitions (`All`,
...
impl DateHeaderTimer {
    ...
    pub(super) unsafe fn enable(&mut self, vm: *mut VirtualMachine, now: &Timespec) {
        ...
        if elapsed >= 1000 {
            ...
            // aliases (raw-ptr-per-field re-entry pattern).
