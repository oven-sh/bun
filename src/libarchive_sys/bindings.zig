...
const ARCHIVE_FORMAT_BASE_MASK = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0xff0000, .hexadecimal);
const ARCHIVE_FORMAT_CPIO = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x10000, .hexadecimal);
...
const ARCHIVE_FORMAT_SHAR = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x20000, .hexadecimal);
...
const ARCHIVE_FORMAT_TAR = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x30000, .hexadecimal);
...
const ARCHIVE_FORMAT_ISO9660 = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x40000, .hexadecimal);
const ARCHIVE_FORMAT_ISO9660_ROCKRIDGE = ARCHIVE_FORMAT_ISO9660 | @as(c_int, 1);
const ARCHIVE_FORMAT_ZIP = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x50000, .hexadecimal);
const ARCHIVE_FORMAT_EMPTY = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x60000, .hexadecimal);
const ARCHIVE_FORMAT_AR = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x70000, .hexadecimal);
const ARCHIVE_FORMAT_AR_GNU = ARCHIVE_FORMAT_AR | @as(c_int, 1);
const ARCHIVE_FORMAT_AR_BSD = ARCHIVE_FORMAT_AR | @as(c_int, 2);
const ARCHIVE_FORMAT_MTREE = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x80000, .hexadecimal);
const ARCHIVE_FORMAT_RAW = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x90000, .hexadecimal);
const ARCHIVE_FORMAT_XAR = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0xA0000, .hexadecimal);
const ARCHIVE_FORMAT_LHA = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0xB0000, .hexadecimal);
const ARCHIVE_FORMAT_CAB = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0xC0000, .hexadecimal);
const ARCHIVE_FORMAT_RAR = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0xD0000, .hexadecimal);
const ARCHIVE_FORMAT_7ZIP = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0xE0000, .hexadecimal);
const ARCHIVE_FORMAT_WARC = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0xF0000, .hexadecimal);
const ARCHIVE_FORMAT_RAR_V5 = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x100000, .hexadecimal);
...
const ARCHIVE_EXTRACT_HFS_COMPRESSION_FORCED = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x8000, .hexadecimal);
const ARCHIVE_EXTRACT_SECURE_NOABSOLUTEPATHS = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x10000, .hexadecimal);
const ARCHIVE_EXTRACT_CLEAR_NOCHANGE_FFLAGS = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x20000, .hexadecimal);
const ARCHIVE_EXTRACT_SAFE_WRITES = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x40000, .hexadecimal);
...
pub const ARCHIVE_ENTRY_ACL_SYNCHRONIZE = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x00008000, .hexadecimal);
...
pub const ARCHIVE_ENTRY_ACL_ENTRY_INHERITED = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x01000000, .hexadecimal);
pub const ARCHIVE_ENTRY_ACL_ENTRY_FILE_INHERIT = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x02000000, .hexadecimal);
pub const ARCHIVE_ENTRY_ACL_ENTRY_DIRECTORY_INHERIT = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x04000000, .hexadecimal);
pub const ARCHIVE_ENTRY_ACL_ENTRY_NO_PROPAGATE_INHERIT = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x08000000, .hexadecimal);
pub const ARCHIVE_ENTRY_ACL_ENTRY_INHERIT_ONLY = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x10000000, .hexadecimal);
pub const ARCHIVE_ENTRY_ACL_ENTRY_SUCCESSFUL_ACCESS = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x20000000, .hexadecimal);
pub const ARCHIVE_ENTRY_ACL_ENTRY_FAILED_ACCESS = @import("std").rust.c_translation.promoteIntLiteral(c_int, 0x40000000, .hexadecimal);
