...
pub(crate) type mi_deferred_free_fun = extern "C" fn(bool, c_ulonglong, *mut c_void);
...
pub(crate) type mi_error_fun = extern "C" fn(c_int, *mut c_void);
...
pub(crate) type ArenaID = *mut c_void;
...
pub(crate) type mi_arena_id_t = *mut c_void;
