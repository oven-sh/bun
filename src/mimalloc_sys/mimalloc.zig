...
pub extern fn mi_prof_enable(sample_rate_bytes: usize) void;
pub extern fn mi_prof_reset() void;
pub extern fn mi_prof_dump_buf(buf: ?*anyopaque, cap: usize) usize;
pub extern fn mi_heap_snapshot_to_file(path: [*:0]const u8, flags: c_uint) c_int;
