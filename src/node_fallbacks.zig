...
const assert_code: string = ("./node-fallbacks/out/assert.js");
const buffer_code: string = ("./node-fallbacks/out/buffer.js");
const console_code: string = ("./node-fallbacks/out/console.js");
const constants_code: string = ("./node-fallbacks/out/constants.js");
const crypto_code: string = ("./node-fallbacks/out/crypto.js");
const domain_code: string = ("./node-fallbacks/out/domain.js");
const events_code: string = ("./node-fallbacks/out/events.js");
const http_code: string = ("./node-fallbacks/out/http.js");
const https_code: string = ("./node-fallbacks/out/https.js");
const net_code: string = ("./node-fallbacks/out/net.js");
const os_code: string = ("./node-fallbacks/out/os.js");
const path_code: string = ("./node-fallbacks/out/path.js");
const process_code: string = ("./node-fallbacks/out/process.js");
const punycode_code: string = ("./node-fallbacks/out/punycode.js");
const querystring_code: string = ("./node-fallbacks/out/querystring.js");
const stream_code: string = ("./node-fallbacks/out/stream.js");
const string_decoder_code: string = ("./node-fallbacks/out/string_decoder.js");
const sys_code: string = ("./node-fallbacks/out/sys.js");
const timers_code: string = ("./node-fallbacks/out/timers.js");
const tty_code: string = ("./node-fallbacks/out/tty.js");
const url_code: string = ("./node-fallbacks/out/url.js");
const util_code: string = ("./node-fallbacks/out/util.js");
const zlib_code: string = ("./node-fallbacks/out/zlib.js");
const supports_color_code: string = ("./node-fallbacks/out/supports-color.js");

const node_fetch_code: string = ("./node-fallbacks/out/node-fetch.js");
const isomorphic_fetch_code: string = ("./node-fallbacks/out/isomorphic-fetch.js");
const vercel_fetch_code: string = ("./node-fallbacks/out/@vercel_fetch.js");
