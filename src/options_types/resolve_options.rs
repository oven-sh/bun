//! Resolver-input option types — the canonical defs shared by `bun_resolver`
//! and `bun_bundler`. Both crates re-export these so `options::X` /
//! `ropts::X` spellings on either side name the SAME nominal types.
...
pub struct ExternalModules {
    ...
    pub abs_paths: bun_collections::StringSet,
    pub node_modules: bun_collections::StringSet,
}
...
impl Default for ExtensionOrderGroup {
    fn default() -> Self {
        ExtensionOrderGroup {
            default: crate::owned_string_list(crate::bundle_defaults::EXTENSION_ORDER),
            esm: crate::owned_string_list(crate::bundle_defaults::MODULE_EXTENSION_ORDER),
        }
    }
}
    ...
    fn default() -> Self {
        ExtensionOrder {
            ...
            node_modules: ExtensionOrderGroup {
                default: crate::owned_string_list(
                    crate::bundle_defaults::node_modules::EXTENSION_ORDER,
                ),
                esm: crate::owned_string_list(
                    crate::bundle_defaults::node_modules::MODULE_EXTENSION_ORDER,
                ),
            },
            css: crate::owned_string_list(crate::bundle_defaults::CSS_EXTENSION_ORDER),
        }
    }
}
impl ExtensionOrder {
...
pub struct BundleOptions {
    ...
    pub production: bool,
    pub force_node_env: crate::bundle_enums::ForceNodeEnv,
...
impl Default for BundleOptions {
    ...
    fn default() -> Self {
        BundleOptions {
            ...
            main_field_extension_order: crate::owned_string_list(
                crate::bundle_defaults::EXTENSION_ORDER,
            ),
            main_fields: crate::owned_string_list(DEFAULT_MAIN_FIELDS.get(Target::default())),
            ...
            allow_runtime: true,
            production: false,
            force_node_env: crate::bundle_enums::ForceNodeEnv::default(),
        }
    }
}
