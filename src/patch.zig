...
pub const TestingAPIs = struct {
    ...
    pub fn parseApplyArgs(globalThis: *JSC.JSGlobalObject, callframe: *JSC.CallFrame) bun.JSC.Node.Maybe(ApplyArgs, JSC.JSValue) {
        ...
        const dir_fd = if (arguments.nextEat()) |dir_js| brk: {
            var bunstr = dir_js.toBunString(globalThis) catch return .{ .err = .undefined };
            defer bunstr.deref();
        ...
        const patchfile_bunstr = patchfile_js.toBunString(globalThis) catch return .{ .err = .undefined };
