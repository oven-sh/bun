...
use crate::hir::{EvaluationOrder, HirFunction, IdentifierId, InstructionValue, ScopeId};
...
pub fn align_method_call_scopes(func: &mut HirFunction, env: &mut Environment) {
    ...
    let original_range_ids: HashMap<ScopeId, crate::hir::MutableRangeId> = range_updates
        .keys()
        .map(|&root_id| {
