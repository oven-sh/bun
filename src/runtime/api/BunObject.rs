...
pub mod bun_object {
    ...
    export_callbacks! {
        ...
        BunObject_callback_connect => host_fn::wrap_static_method!(api::Listener, connect, false),
        ...
        BunObject_callback_listen => host_fn::wrap_static_method!(api::Listener, listen, false),
        ...
        BunObject_callback_sha => host_fn::wrap_static_method!(Crypto::SHA512_256, hash_, true),
        ...
        BunObject_callback_spawn => host_fn::wrap_static_method!(api::Subprocess, spawn, false),
        BunObject_callback_spawnSync => host_fn::wrap_static_method!(api::Subprocess, spawn_sync, false),
        BunObject_callback_udpSocket => host_fn::wrap_static_method!(api::UDPSocket, udp_socket, false),
