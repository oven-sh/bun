...
pub use bun_options_types::context::BunCAStore;
...
pub static Bun__Node__CAStore_locked: core::sync::atomic::AtomicBool =
    core::sync::atomic::AtomicBool::new(false);
...
pub fn apply_bunfig_ca_store(ctx: &mut bun_options_types::context::ContextData) {
