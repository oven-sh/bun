...
// The CI table in `cli::ci_info_generated` is a hand-port of the generated module
// produced by src/codegen/ci_info.ts (a build.zig-registered module in the Zig build).
