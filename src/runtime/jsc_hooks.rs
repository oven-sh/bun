...
use bun_jsc::virtual_machine::{
    AllowSideEffects, InitOptions, ResolveMode, RuntimeHooks, RuntimeState as OpaqueRuntimeState,
    VirtualMachine,
};
use bun_jsc::{
...
pub(crate) fn close_isolation_handles(vm: &mut VirtualMachine) {
    ...
    loop {
        ...
        match kv.key {
            ...
            IsolationHandle::Server(mut s) => s.stop(crate::server::StopMode::Abrupt),
        }
    }
}
