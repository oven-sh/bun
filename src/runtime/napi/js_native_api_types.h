...
#if defined(NAPI_EXPERIMENTAL) && !defined(NODE_API_EXPERIMENTAL_NO_WARNING) && !defined(NODE_WANT_INTERNALS)
#ifdef _MSC_VER
...
#if !defined(NAPI_EXPERIMENTAL) || (defined(NAPI_EXPERIMENTAL) && (defined(NODE_API_EXPERIMENTAL_NOGC_ENV_OPT_OUT) || defined(NODE_API_EXPERIMENTAL_BASIC_ENV_OPT_OUT)))
typedef struct NapiEnv* node_api_nogc_env;
#else
typedef const struct NapiEnv* node_api_nogc_env;
#endif
