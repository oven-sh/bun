...
export default [
  ...
  define({
    ...
    proto: {
      ...
      // `node:fs`'s callback APIs: identical to the promise-returning sibling
      // above, except the completion callback is the last argument and runs from
      // the event-loop task instead of a promise reaction (so `process.nextTick`
      // scheduled inside it still drains before microtasks, as in node).
      accessCb: { async: true, fn: "accessCb", length: 4 },
      appendFileCb: { async: true, fn: "appendFileCb", length: 5 },
      closeCb: { async: true, fn: "closeCb", length: 2 },
      copyFileCb: { async: true, fn: "copyFileCb", length: 5 },
      existsCb: { async: true, fn: "existsCb", length: 3 },
      chownCb: { async: true, fn: "chownCb", length: 5 },
      chmodCb: { async: true, fn: "chmodCb", length: 4 },
      fchmodCb: { async: true, fn: "fchmodCb", length: 4 },
      fchownCb: { async: true, fn: "fchownCb", length: 5 },
      fstatCb: { async: true, fn: "fstatCb", length: 2 },
      fsyncCb: { async: true, fn: "fsyncCb", length: 3 },
      ftruncateCb: { async: true, fn: "ftruncateCb", length: 2 },
      futimesCb: { async: true, fn: "futimesCb", length: 5 },
      lchmodCb: { async: true, fn: "lchmodCb", length: 4 },
      lchownCb: { async: true, fn: "lchownCb", length: 5 },
      linkCb: { async: true, fn: "linkCb", length: 4 },
      lstatCb: { async: true, fn: "lstatCb", length: 2 },
      mkdirCb: { async: true, fn: "mkdirCb", length: 4 },
      mkdtempCb: { async: true, fn: "mkdtempCb", length: 4 },
      openCb: { async: true, fn: "openCb", length: 5 },
      readCb: { async: true, fn: "readCb", length: 7 },
      writeCb: { async: true, fn: "writeCb", length: 7 },
      readFileCb: { async: true, fn: "readFileCb", length: 4 },
      writeFileCb: { async: true, fn: "writeFileCb", length: 5 },
      readlinkCb: { async: true, fn: "readlinkCb", length: 4 },
      rmCb: { async: true, fn: "rmCb", length: 4 },
      rmdirCb: { async: true, fn: "rmdirCb", length: 4 },
      realpathCb: { async: true, fn: "realpathCb", length: 4 },
      realpathNativeCb: { async: true, fn: "realpathNativeCb", length: 4 },
      renameCb: { async: true, fn: "renameCb", length: 4 },
      statCb: { async: true, fn: "statCb", length: 2 },
      statfsCb: { async: true, fn: "statfsCb", length: 3 },
      symlinkCb: { async: true, fn: "symlinkCb", length: 5 },
      truncateCb: { async: true, fn: "truncateCb", length: 4 },
      unlinkCb: { async: true, fn: "unlinkCb", length: 3 },
      utimesCb: { async: true, fn: "utimesCb", length: 5 },
      lutimesCb: { async: true, fn: "lutimesCb", length: 5 },
      writevCb: { async: true, fn: "writevCb", length: 5 },
      readvCb: { async: true, fn: "readvCb", length: 5 },
      fdatasyncCb: { async: true, fn: "fdatasyncCb", length: 3 },
      readdirCb: { async: true, fn: "readdirCb", length: 4 },
