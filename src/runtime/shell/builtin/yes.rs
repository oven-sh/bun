...
use crate::shell::interpreter::{Builtin, BuiltinImpl};
use crate::shell::{AllocScope, ExitCode, Yield};
...
// TODO(port): these enum/tag types live in crate::shell::interpreter; placeholder imports
// until Phase B wires the real paths.
use crate::shell::interpreter::{BuiltinFd, BuiltinKind, ConcurrentTaskDeinit, OutputNeedsIo};
