...
impl Listener {
    ...
    pub(crate) fn connect_inner(
        ...
        let fd_is_spawned_pipe = opts
            .get_truthy(cx.global(), "fdIsSpawnedPipe")?
...
impl WindowsNamedPipeListeningContext {
    ...
    unsafe fn on_connection(this: *mut Self, (): ()) {
        ...
        let entered = listener.handlers.vm.enter_context(listener.context);
        use crate::socket::windows_named_pipe_context::SocketType as PipeSocketType;
        ...
        let client = WindowsNamedPipeContext::create(
            &listener.handlers.global_object.js_thread(entered.context()),
            socket,
        );
