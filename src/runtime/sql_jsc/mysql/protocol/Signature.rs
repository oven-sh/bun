...
use crate::sql_jsc::mysql::my_sql_statement::Param;
...
impl Signature {
    ...
    pub fn generate(
        ...
        while let Some(value) = iter.next().map_err(AnyMySQLError::from)? {
            ...
            let tag = crate::sql_jsc::mysql::my_sql_value::field_type_from_js(
                global_object,
                value,
                &mut unsigned,
            )
