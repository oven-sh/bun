use crate::node::{AllowFile, BlobOrStringOrBuffer as JSArgument};
...
fn from_js(global: &JSGlobalObject, value: JSValue) -> JsResult<Option<JSArgument>> {
    ...
    if value.is_number() {
        ...
        return JSArgument::from_js_maybe_file(global, str.to_js(), AllowFile::Yes);
    }

    JSArgument::from_js_maybe_file(global, value, AllowFile::No)
}
