...
export default [
  define({
    ...
    proto: {
      ...
      subscribe: { fn: "subscribe", length: 2 },
      duplicate: { fn: "duplicate" },
      psubscribe: { fn: "psubscribe", length: 2 },
    ...
    values: ["onconnect", "onclose", "connectionPromise", "hello", "subscriptionCallbackMap", "patternCallbackMap"],
  }),
];
