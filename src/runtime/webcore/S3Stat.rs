...
use bun_jsc::{CallFrame, JSGlobalObject, JSValue, JsResult, StrJsc as _, bun_string_jsc};
...
impl S3Stat {
    ...
    pub(crate) fn init(
        ...
        let last_modified =
            bun_string_jsc::parse_date(&bun_core::StringView::from_bytes(last_modified), global)?;
