    ...
    impl WriteFileWindows {
        pub fn create_with_ctx(
            ...
            unsafe {
                ...
                wf.io_request.loop_ = (*event_loop).virtual_machine.unwrap().as_ref().event_loop_handle.unwrap();
        ...
        pub fn loop_(&self) -> *mut uv::Loop {
            ...
            unsafe { (*self.event_loop).virtual_machine.unwrap().as_ref().event_loop_handle.unwrap() }
        }
