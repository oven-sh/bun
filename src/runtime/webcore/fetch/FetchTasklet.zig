    ...
    pub fn onReject(this: *FetchTasklet) Body.Value.ValueError {
        ...
        const fetch_error = jsc.SystemError{
            ...
            .message = switch (this.result.fail.?) {
                ...
                error.SocksCredentialsIncomplete => bun.String.static("SOCKS proxy credentials must include both username and password."),
                error.SocksConnectionRefused => bun.String.static("SOCKS proxy refused the connection."),
                error.SocksGeneralFailure => bun.String.static("SOCKS proxy reported a general failure."),
                error.SocksConnectionNotAllowed => bun.String.static("SOCKS proxy reported that the connection is not allowed."),
                ...
                error.SocksTTLExpired => bun.String.static("SOCKS proxy reported that the TTL expired."),
                error.SocksCommandNotSupported => bun.String.static("SOCKS proxy does not support the requested command."),
                error.SocksAddressTypeNotSupported => bun.String.static("SOCKS proxy does not support the requested address type."),
