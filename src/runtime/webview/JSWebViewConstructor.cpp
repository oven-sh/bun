...
JSC_DEFINE_HOST_FUNCTION(constructWebView, (JSGlobalObject * globalObject, CallFrame* callFrame))
{
    ...
    Structure* structure = bunGlobalObject->m_JSWebViewClassStructure.get(bunGlobalObject);
    JSValue newTarget = callFrame->newTarget();
    if (bunGlobalObject->m_JSWebViewClassStructure.constructor(bunGlobalObject) != newTarget) [[unlikely]] {
