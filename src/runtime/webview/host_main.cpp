// WebView host subprocess entry point. Reached via the CLI when
...
// JSC, no VM, no Bun runtime past the env check.
//
...
// ---------------------------------------------------------------------------
// Entry. The CLI calls this before anything else when BUN_INTERNAL_WEBVIEW_HOST
