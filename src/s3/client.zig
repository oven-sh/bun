...
const S3DeleteObjects = @import("./delete_objects.zig");
pub const getS3DeleteObjectsOptionsFromJs = S3DeleteObjects.getS3DeleteObjectsOptionsFromJs;
...
pub fn deleteObjects(
    ...
    const hash_as_hex = std.fmt.bytesToHex(sha_digest[0..bun.sha.SHA256.digest], .lower);
