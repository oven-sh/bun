...
//!
//! Hand-rolled JSON encoders for the shell parser's testing surface.
...
// ───────────────────────────── RedirectFlags ──────────────────────────
// Bitflags struct serialized in field-declaration order.
...
/// `Display` adapter that JSON-formats a `Script` AST.
