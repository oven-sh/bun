...
pub const Report = struct {
    ...
    pub fn linesCoverageFraction(this: *const Report) f64 {
        var intersected = this.executable_lines.clone(bun.default_allocator) catch |oe| bun.outOfMemory(oe);
    ...
    pub const Text = struct {
        ...
        pub fn writeFormat(
            ...
            var executable_lines_that_havent_been_executed = report.lines_which_have_executed.clone(bun.default_allocator) catch |oe| bun.outOfMemory(oe);
    ...
    pub const Lcov = struct {
        pub fn writeFormat(
            ...
            var executable_lines = report.executable_lines.clone(bun.default_allocator) catch |oe| bun.outOfMemory(oe);
...
pub const ByteRangeMapping = struct {
    ...
    pub fn generate(str: bun.String, source_contents_str: bun.String, source_id: i32) callconv(.C) void {
        var _map = map orelse brk: {
            map = bun.jsc.VirtualMachine.get().allocator.create(HashMap) catch |oe| bun.outOfMemory(oe);
        ...
        var entry = _map.getOrPut(hash) catch |oe| bun.outOfMemory(oe);
