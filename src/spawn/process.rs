...
mod spawn_process_body {
    ...
    pub unsafe fn spawn_process(
        ...
        envp: Envp,
    ) -> Result<bun_sys::Result<SpawnProcessResult>, crate::spawn::Error> {
        #[cfg(unix)]
        {
    ...
    ) -> Result<bun_sys::Result<WindowsSpawnResult>, crate::spawn::Error> {
                    ...
                    WindowsStdio::Path(path) => {
                        ...
                        let path_z = match bun_sys::to_posix_path(path) {
                            ...
                            Err(e) => {
                                ...
                                return Err(crate::spawn::Error::Sys(e));
                            }
                        };
    ...
    pub mod sync {
        ...
        fn spawn_windows_without_pipes(
            ...
            argv: *const *const c_char,
            envp: *const *const c_char,
        ) -> core::result::Result<Maybe<Result>, crate::spawn::Error> {
        ...
        pub fn spawn(options: &Options) -> core::result::Result<Maybe<Result>, crate::spawn::Error> {
