...
const PreparedStatementsMap = std.HashMapUnmanaged(u64, *Statement, bun.IdentityContext(u64), 80);
...
pub const SQLQuery = struct {
    pub fn deinit(this: *SQLQuery) void {
        _ = this;
    }
};
...
pub const Statement = struct {
    ...
    pub fn deinit(this: *Statement) void {
