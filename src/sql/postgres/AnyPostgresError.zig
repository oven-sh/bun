...
pub fn postgresErrorToJS(globalObject: *jsc.JSGlobalObject, message: ?[]const u8, err: AnyPostgresError) JSValue {
    const code = switch (err) {
        ...
        error.CopyBothNotImplemented => "ERR_POSTGRES_COPY_BOTH_NOT_IMPLEMENTED",
        error.CopyBufferTooLarge => "ERR_POSTGRES_COPY_BUFFER_TOO_LARGE",
        error.CopyChunkTooLarge => "ERR_POSTGRES_COPY_CHUNK_TOO_LARGE",
        error.CopyWriteFailed => "ERR_POSTGRES_COPY_WRITE_FAILED",
        ...
        error.CopyTimeout => "ERR_POSTGRES_COPY_TIMEOUT",
        ...
        error.UnexpectedCopyData => "ERR_POSTGRES_UNEXPECTED_COPY_DATA",
