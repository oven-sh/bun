...
pub const CopyBothResponse = @import("./protocol/CopyBothResponse.zig");
pub const CopyInResponse = @import("./protocol/CopyInResponse.zig");
pub const CopyOutResponse = @import("./protocol/CopyOutResponse.zig");
