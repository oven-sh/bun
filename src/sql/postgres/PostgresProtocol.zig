...
pub const CopyResponse = @import("./protocol/CopyResponse.zig");
pub const CopyBothResponse = @import("./protocol/CopyBothResponse.zig").CopyBothResponse;
pub const CopyInResponse = @import("./protocol/CopyInResponse.zig").CopyInResponse;
