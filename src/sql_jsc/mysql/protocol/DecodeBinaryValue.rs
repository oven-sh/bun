        ...
        FieldType::MYSQL_TYPE_TIME => {
            match reader.byte()? {
                ...
                l @ (8 | 12) => {
                    ...
                    // MySQL TIME is capped at +/-838:59:59. days is a raw wire u32;
                    // bounding it to 34 keeps days*24 <= 816 so the u32 sum below
                    // cannot wrap, then total_hours > 838 rejects the remainder.
