...
pub fn from_js(arg: JSValue, global_this: &JSGlobalObject) -> JsResult<SignalCode> {
    #[cfg(any())]
    // TODO(b2-blocked): bun_jsc::JSValue::{get_number,is_string,as_string,to_enum,is_empty_or_undefined_or_null}
    ...
    {
        let _ = (arg, global_this);
        todo!("b2-blocked: bun_jsc JSValue/JSGlobalObject methods unavailable")
    }
}
...
//   confidence: high (body gated on bun_jsc stub surface)
