...
//! Invoked via `rust build generate-grapheme-tables`.
//! Queries uucode for each codepoint and outputs a Rust source file
...
/// Must be kept in sync with grapheme.rust's GraphemeBreakNoControl.
...
pub fn main() !void {
    ...
    // Write header
    try stdout.writeAll(
        \\//! This file is auto-generated by `rust build generate-grapheme-tables`.
        \\//! Do not edit manually.
        \\
        \\const grapheme = @import("./grapheme.rust");
