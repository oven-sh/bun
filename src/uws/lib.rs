...
// uWS CompressOptions (PerMessageDeflate.h): the compressor is the low byte
// (windowBits << 4 | memLevel), the decompressor's windowBits are bits 8..12.
pub const COMPRESSOR_MASK: i32 = 0x00FF;
pub const DECOMPRESSOR_MASK: i32 = 0x0F00;
pub const SHARED_COMPRESSOR: i32 = 1;
pub const SHARED_DECOMPRESSOR: i32 = 1 << 8;
pub const DEDICATED_DECOMPRESSOR: i32 = 15 << 8;
