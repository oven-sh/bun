...
pub const JSValkeyClient = struct {
    ...
    pub const bitop = fns.bitop;
    pub const bitpos = fns.bitpos;
    pub const bitfield = fns.bitfield;
    pub const pfcount = fns.pfcount;
    pub const pfmerge = fns.pfmerge;
    pub const geoadd = fns.geoadd;
    pub const geodist = fns.geodist;
    pub const geohash = fns.geohash;
    pub const geopos = fns.geopos;
    pub const geosearch = fns.geosearch;
    pub const geosearchstore = fns.geosearchstore;
    pub const eval = fns.eval;
    pub const evalsha = fns.evalsha;
    pub const fcall = fns.fcall;
    pub const function = fns.function;
    pub const dbsize = fns.dbsize;
    pub const flushdb = fns.flushdb;
    pub const flushall = fns.flushall;
    pub const info = fns.info;
    pub const time = fns.time;
    pub const echo = fns.echo;
    pub const lastsave = fns.lastsave;
    pub const jsClient = fns.jsClient;
    pub const config = fns.config;
    pub const jsDebug = fns.jsDebug;
    pub const jsCommand = fns.jsCommand;
    pub const object = fns.object;
    pub const sort = fns.sort;
    pub const wait = fns.wait;
    pub const lcs = fns.lcs;
    pub const xadd = fns.xadd;
    pub const xlen = fns.xlen;
    pub const xrange = fns.xrange;
    pub const xrevrange = fns.xrevrange;
    pub const xread = fns.xread;
    pub const xreadgroup = fns.xreadgroup;
    pub const xdel = fns.xdel;
    pub const xtrim = fns.xtrim;
    pub const xack = fns.xack;
    pub const xclaim = fns.xclaim;
    pub const xautoclaim = fns.xautoclaim;
    pub const xpending = fns.xpending;
    pub const xinfo = fns.xinfo;
    pub const xgroup = fns.xgroup;
    pub const xsetid = fns.xsetid;
