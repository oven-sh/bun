...
pub const zcount = compile.@"(...strings: string[])"("zcount", "ZCOUNT", .not_subscriber).call;
pub const zlexcount = compile.@"(...strings: string[])"("zlexcount", "ZLEXCOUNT", .not_subscriber).call;
...
pub const zrangebylex = compile.@"(...strings: string[])"("zrangebylex", "ZRANGEBYLEX", .not_subscriber).call;
pub const zrevrangebylex = compile.@"(...strings: string[])"("zrevrangebylex", "ZREVRANGEBYLEX", .not_subscriber).call;
