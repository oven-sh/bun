...
pub const JsValkey = struct {
    ...
    pub const exists = MetFactory.@"(key: RedisKey, value: RedisValue)"("exists", .EXISTS, "key", "field").fxn;
    ...
    pub const smove = MetFactory.@"(key: RedisKey, value: RedisValue, value2: RedisValue)"("smove", .SMOV, "source", "desitnation", "member").fxn;
