...
pub mod ntstatus {
    ...
    pub const INVALID_INFO_CLASS: NTSTATUS = NTSTATUS::INVALID_INFO_CLASS;
    pub const NOT_SUPPORTED: NTSTATUS = NTSTATUS::NOT_SUPPORTED;
    pub const NOT_IMPLEMENTED: NTSTATUS = NTSTATUS::NOT_IMPLEMENTED;
    pub const INVALID_DEVICE_REQUEST: NTSTATUS = NTSTATUS::INVALID_DEVICE_REQUEST;
    pub const ILLEGAL_FUNCTION: NTSTATUS = NTSTATUS::ILLEGAL_FUNCTION;
}
