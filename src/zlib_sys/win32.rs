...
pub use crate::shared::{
    Bytef, DataType, FlushValue, ReturnCode, alloc_func, free_func, internal_state,
    struct_internal_state, struct_z_stream_s, uInt, uLong, uLongf, voidpf, z_alloc_func,
    z_free_func, z_stream, z_stream_s, z_streamp, zStream_struct,
};
