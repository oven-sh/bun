...
//     const items = await c.elems("li");
//     expect(items.length).toBe(3);
//     expect(await items[0].text()).toBe("Item 1");
//     expect(await items[1].text()).toBe("Item 2");
//     expect(await items[2].text()).toBe("Item 3");
//   },
// });
