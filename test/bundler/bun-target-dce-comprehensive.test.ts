...
test("DCE with switch statements and Bun checks", async () => {
  using dir = tempDir("dce-switch", {
    "index.js": `
      const runtime = process.versions.bun ? "bun" : "node";
      
      switch (runtime) {
        case "bun":
          exports.result1 = "is-bun";
          break;
        case "node":
          // This case should be eliminated
          exports.result1 = "is-node";
          break;
        default:
          exports.result1 = "unknown";
      }
      
      // Direct switch on Bun check
      switch (typeof Bun !== "undefined") {
        case true:
          exports.result2 = "has-bun";
          break;
        case false:
          // This should be eliminated
          exports.result2 = "no-bun";
          break;
      }
    `,
  });
  ...
  // Correct cases preserved
  expect(bundled).toContain("is-bun");
  expect(bundled).toContain("has-bun");
  
  // Note: Switch statement optimization is complex and not yet implemented
  // The dead cases are still present in the code
  expect(bundled).toContain("is-node"); // Switch cases aren't eliminated yet
  expect(bundled).toContain("no-bun");   // Switch cases aren't eliminated yet
});