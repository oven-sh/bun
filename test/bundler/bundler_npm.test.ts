  ...
  itBundled("npm/ReactSSR", {
    ...
    snapshotSourceMap: {
      "entry.js.map": {
        ...
        mappings: [
          ["react.development.js:524:'getContextName'", "1:5580:nt"],
    ...
    expectExactFilesize: {
      // +52 bytes vs. before: bundling now preserves the function-body "use strict"
      // directive inside each of React's 4 CJS development-bundle IIFEs (~13 bytes each),
      // matching esbuild. See https://github.com/oven-sh/bun/pull/31807.
      "out/entry.js": 221947,
    },
    run: {
