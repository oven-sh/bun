  ...
  itBundled("npm/ReactSSR", {
    ...
    snapshotSourceMap: {
      "entry.js.map": {
        ...
        mappings: [
          ["react.development.js:524:'getContextName'", "1:5611:nt"],
          ["react.development.js:2495:'actScopeDepth'", "23:4030:ar++"],
          ["react.development.js:696:''Component'", '1:7667:\'Component "%s"'],
          ["entry.tsx:6:'\"Content-Type\"'", '100:18669:"Content-Type"'],
          ["entry.tsx:11:'<html>'", "100:18923:void"],
          ["entry.tsx:23:'await'", "100:19022:await"],
        ],
      },
    },
    expectExactFilesize: {
