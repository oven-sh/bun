...
import { expectBundled } from "./expectBundled.js";
...
describe("bundler", () => {
  ...
  it("TestSimpleCommonJS", () => {
    expectBundled("TestSimpleCommonJS", {
      files: {
        "/entry.js": /* js */ `
  ...
  it("TestNestedCommonJS", () => {
    expectBundled("TestNestedCommonJS", {
      files: {
        "/entry.js": /* js */ `
  ...
  it("TestNewExpressionCommonJS", () => {
    expectBundled("TestNewExpressionCommonJS", {
      files: {
        "/entry.js": /* js */ `
  ...
  it("TestCommonJSFromES6", () => {
    expectBundled("TestCommonJSFromES6", {
      files: {
        "/entry.js": /* js */ `
  ...
  it("TestES6FromCommonJS", () => {
    expectBundled("TestES6FromCommonJS", {
      files: {
        "/entry.js": /* js */ `
          import {foo} from './foo'
          console.log(foo(), bar())
  ...
  it("TestNestedES6FromCommonJS", () => {
    expectBundled("TestNestedES6FromCommonJS", {
      files: {
        "/entry.js": /* js */ `
          import {fn} from './foo'
          (() => {
  ...
  it("TestExportFormsES6", () => {
    expectBundled("TestExportFormsES6", {
      files: {
        "/entry.js": /* js */ `
          export default 123
          export var v = 234
  ...
  it("TestExportFormsIIFE", () => {
    expectBundled("TestExportFormsIIFE", {
      files: {
        "/entry.js": /* js */ `
          export default 123
          export var v = 234
  ...
  it("TestExportFormsWithMinifyIdentifiersAndNoBundle", () => {
    expectBundled("TestExportFormsWithMinifyIdentifiersAndNoBundle", {
      files: {
        "/a.js": `
          export default 123
  ...
  it("TestImportFormsWithMinifyIdentifiersAndNoBundle", () => {
    ...
    expectBundled("TestImportFormsWithMinifyIdentifiersAndNoBundle", {
      files: {
        "/entry.js": /* js */ `
          import './a'
          import {} from './b'
