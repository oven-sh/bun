...
// https://github.com/oven-sh/bun/issues/4424
test.concurrent(`function-level "use strict" is honored in CJS`, async () => {
  expect(await bunRun(path.join(import.meta.dir, "function-use-strict-cjs-fixture.cjs"))).toSpawn();
});

test.concurrent(`function-level "use strict" survives require() of a CJS module`, async () => {
