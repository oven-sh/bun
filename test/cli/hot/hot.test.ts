...
// Each reload of an edited file inserted a new UnlinkedModuleProgramCodeBlock
...
it(
  "should not accumulate stale code blocks when file content changes on every reload",
  async () => {
    const root = join(cwd, "leak-runner.mjs");
