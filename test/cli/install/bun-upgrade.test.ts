          ...
          "assets": [
            {
              ...
              "browser_download_url": `https://github.com/oven-sh/bun/releases/download/bun-v1.1.4/bun-windows-x64.zip`,
            },
            {
              "url": "foo",
              "content_type": "application/zip",
              "name": "bun-windows-x64-baseline.zip",
              "browser_download_url": `https://github.com/oven-sh/bun/releases/download/bun-v1.1.4/bun-windows-x64-baseline.zip`,
            },
            {
              "url": "foo",
              "content_type": "application/zip",
              "name": "bun-linux-x64.zip",
              "browser_download_url": `https://github.com/oven-sh/bun/releases/download/bun-v1.1.4/bun-linux-x64.zip`,
            },
            {
              "url": "foo",
              "content_type": "application/zip",
              "name": "bun-linux-x64-baseline.zip",
              "browser_download_url": `https://github.com/oven-sh/bun/releases/download/bun-v1.1.4/bun-linux-x64-baseline.zip`,
            },
            {
              "url": "foo",
              "content_type": "application/zip",
              "name": "bun-darwin-x64.zip",
              "browser_download_url": `https://github.com/oven-sh/bun/releases/download/bun-v1.1.4/bun-darwin-x64.zip`,
            },
            {
              "url": "foo",
              "content_type": "application/zip",
              "name": "bun-darwin-x64-baseline.zip",
              "browser_download_url": `https://github.com/oven-sh/bun/releases/download/bun-v1.1.4/bun-darwin-x64-baseline.zip`,
            },
            {
              "url": "foo",
              "content_type": "application/zip",
              "name": "bun-darwin-aarch64.zip",
              "browser_download_url": `https://github.com/oven-sh/bun/releases/download/bun-v1.1.4/bun-darwin-aarch64.zip`,
            },
          ],
        }),
      );
