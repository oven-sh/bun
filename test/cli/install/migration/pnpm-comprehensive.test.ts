...
`,
  ...
  test("pnpm with git and link dependencies", async () => {
    const tempDir = tempDirWithFiles("pnpm-git-link", {
      "package.json": JSON.stringify(
        {
          name: "git-link-test",
          version: "1.0.0",
          dependencies: {
            "my-git-package": "github:user/repo#v1.0.0",
            "my-git-ssh": "git+ssh://git@github.com:user/private-repo.git",
            "my-git-https": "git+https://github.com/user/repo.git#feature-branch",
            "my-link": "link:../local-package",
            "my-file": "file:./local-tarball.tgz",
          },
        },
        null,
        2,
      ),
      "local-tarball.tgz": Buffer.from("fake tarball content"),
      "pnpm-lock.yaml": `lockfileVersion: '9.0'
...
importers:
  .:
    dependencies:
      ...
      my-git-https:
        specifier: git+https://github.com/user/repo.git#feature-branch
        version: github.com/user/repo/abc123def456
      my-git-package:
        specifier: github:user/repo#v1.0.0
        version: github.com/user/repo/123456789abc
      my-git-ssh:
        specifier: git+ssh://git@github.com:user/private-repo.git
        version: github.com/user/private-repo/def456abc123
      my-link:
        specifier: link:../local-package
        version: link:../local-package

packages:
  'file:local-tarball.tgz':
    resolution: {integrity: sha512-localtarball==}
    name: local-tarball
    version: 1.0.0

  'github.com/user/repo/123456789abc':
    resolution: {tarball: https://codeload.github.com/user/repo/tar.gz/123456789abc}
    name: my-git-package
    version: 1.0.0
    engines: {node: '>=14'}

  'github.com/user/private-repo/def456abc123':
    resolution: {tarball: https://codeload.github.com/user/private-repo/tar.gz/def456abc123}
    name: my-git-ssh
    version: 2.0.0

  'github.com/user/repo/abc123def456':
    resolution: {tarball: https://codeload.github.com/user/repo/tar.gz/abc123def456}
    name: my-git-https
    version: 3.0.0-beta
...
`,
    ...
    const bunLockContent = fs.readFileSync(join(tempDir, "bun.lock"), "utf8");
    expect(bunLockContent).toMatchSnapshot("git-link-deps");
  });

  test("pnpm with scoped packages and registries", async () => {
    const tempDir = tempDirWithFiles("pnpm-scoped-registries", {
      "package.json": JSON.stringify(
        {
          name: "scoped-test",
          version: "1.0.0",
          dependencies: {
            ...
            "@my-company/private-package": "^1.2.3",
      ...
      ".npmrc": `@my-company:registry=https://npm.my-company.com/
  ...
  .:
    dependencies:
      ...
      '@fortawesome/fontawesome-svg-core':
        specifier: ^6.5.1
        version: /@fortawesome/fontawesome-svg-core@6.5.1
      '@my-company/private-package':
        specifier: ^1.2.3
        version: /@my-company/private-package@1.2.3

packages:
  '@babel/core@7.23.7':
    resolution: {integrity: sha512-babel-core==}
    engines: {node: '>=6.9.0'}

  '@babel/preset-env@7.23.7':
    resolution: {integrity: sha512-babel-preset-env==}
    engines: {node: '>=6.9.0'}
    peerDependencies:
      '@babel/core': ^7.0.0-0

  '@babel/preset-react@7.23.3':
    resolution: {integrity: sha512-babel-preset-react==}
    engines: {node: '>=6.9.0'}
    peerDependencies:
      '@babel/core': ^7.0.0-0

  '/@fortawesome/fontawesome-svg-core@6.5.1':
    resolution: {integrity: sha512-fontawesome==, registry: https://npm.fontawesome.com/, tarball: https://npm.fontawesome.com/@fortawesome/fontawesome-svg-core/-/fontawesome-svg-core-6.5.1.tgz}
    name: '@fortawesome/fontawesome-svg-core'
    version: 6.5.1
    engines: {node: '>=6'}

  '/@my-company/private-package@1.2.3':
    resolution: {integrity: sha512-private-package==, registry: https://npm.my-company.com/, tarball: https://npm.my-company.com/@my-company/private-package/-/private-package-1.2.3.tgz}
  ...
  '@babel/helper-plugin-utils@7.22.5':
    resolution: {integrity: sha512-plugin-utils==}
    engines: {node: '>=6.9.0'}
...
`,
    ...
    const bunLockContent = fs.readFileSync(join(tempDir, "bun.lock"), "utf8");
    expect(bunLockContent).toMatchSnapshot("scoped-registries");
  });

  test("pnpm v8 format", async () => {
    const tempDir = tempDirWithFiles("pnpm-v8", {
      "package.json": JSON.stringify({
        name: "v8-format-test",
        version: "1.0.0",
        dependencies: {
...
packages:
  ...
  /express@4.18.2:
    resolution: {integrity: sha512-expressAAA==}
    engines: {node: '>= 0.10.0'}
    dependencies:
      accepts: 1.3.8
      array-flatten: 1.1.1
...
`,
  ...
  test("pnpm v7 format with multiple registries", async () => {
    const tempDir = tempDirWithFiles("pnpm-v7-multi-registry", {
      "package.json": JSON.stringify(
        {
          name: "v7-format-test",
          version: "1.0.0",
      ...
      "pnpm-lock.yaml": `lockfileVersion: '7.0'
...
packages:
  ...
  jest@29.7.0:
    resolution: {integrity: sha512-jest==}
  ...
  follow-redirects@1.15.4:
    resolution: {integrity: sha512-follow==}
    engines: {node: '>=4.0'}
    dev: false

  form-data@4.0.0:
    resolution: {integrity: sha512-form-data==}
    engines: {node: '>= 6'}
    dependencies:
      asynckit: 0.4.0
  ...
  proxy-from-env@1.1.0:
    resolution: {integrity: sha512-proxy==}
    dev: false

  '@jest/core@29.7.0':
    resolution: {integrity: sha512-jest-core==}
    engines: {node: ^14.15.0 || ^16.10.0 || >=18.0.0}
    dev: true

  '@jest/types@29.6.3':
    resolution: {integrity: sha512-jest-types==}
    engines: {node: ^14.15.0 || ^16.10.0 || >=18.0.0}
    dev: true

  asynckit@0.4.0:
    resolution: {integrity: sha512-asynckit==}
    dev: false

  combined-stream@1.0.8:
    resolution: {integrity: sha512-combined==}
    engines: {node: '>= 0.8'}
    dependencies:
  ...
  delayed-stream@1.0.0:
    resolution: {integrity: sha512-delayed==}
    engines: {node: '>=0.4.0'}
    dev: false
...
`,
    ...
    const bunLockContent = fs.readFileSync(join(tempDir, "bun.lock"), "utf8");
    expect(bunLockContent).toMatchSnapshot("v7-multi-registry");
  });
