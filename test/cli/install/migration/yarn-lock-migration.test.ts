...
`,
  ...
  test("yarn.lock with npm alias to scoped package (#27781)", async () => {
    const tempDir = tempDirWithFiles("yarn-migration-scoped-alias", {
      "package.json": JSON.stringify(
        {
...
"monaco-editor@npm:@codingame/monaco-editor-treemended@>=1.83.3 <1.84.0":
  version "1.83.16"
  resolved "https://registry.yarnpkg.com/@codingame/monaco-editor-treemended/-/monaco-editor-treemended-1.83.16.tgz#abc123"
...
`,
    ...
    // The scoped package name must be preserved with its @scope/ prefix
    expect(bunLockContent).toContain("@codingame/monaco-editor-treemended@1.83.16");
    // Must NOT contain the unscoped (broken) form that drops @codingame/
    expect(bunLockContent).not.toContain('"monaco-editor-treemended@');
  });
});
