...
/**
 * Source of a JS expression that makes a WebAssembly GC struct reference, for a test that needs one in a subprocess.
 * (module (type $s (struct (field (mut i32)))) (func (export "mk") (result (ref null $s)) struct.new_default $s))
 */
export const wasmGCStructRefSource = `new WebAssembly.Instance(new WebAssembly.Module(new Uint8Array([
