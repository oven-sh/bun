...
// behind `#[cfg(test)]` is invisible to every other CI lane.
//
// This does not try to link or run the unit tests (linking needs the C/C++ dep
// archive the main build assembles); `cargo check --tests` is enough to catch
// the class of breakage above and is fast on a warm build tree.
