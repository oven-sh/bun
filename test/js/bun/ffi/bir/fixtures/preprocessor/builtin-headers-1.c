...
#include <stdarg.h>
         ...
         int limits(void) { return (INT_MAX == 2147483647) + (INT_MIN == -2147483647 - 1) + (UINT_MAX == 4294967295u) + (LONG_MAX == (sizeof(long) == 8 ? 9223372036854775807LL : 2147483647LL)) + (CHAR_BIT == 8) + (SCHAR_MIN == -128) + (UCHAR_MAX == 255) + (SHRT_MAX == 32767) + (LLONG_MIN < 0) + (ULLONG_MAX == 18446744073709551615ULL) + (CHAR_MIN < 0); } /* long: any width */
