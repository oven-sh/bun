...
const N_VALID_JSONC: Array<[name: string, source: string, expected: unknown]> = [
  ...
  ["n_number_hex_1_digit.json", "[0x1]", [1]],
  ["n_number_hex_2_digits.json", "[0x42]", [66]],
  ["n_number_minus_space_1.json", "[- 1]", [-1]],
  ["n_number_neg_int_starting_with_zero.json", "[-012]", [-10]],
  ...
  ["n_number_with_leading_zero.json", "[012]", [10]],
