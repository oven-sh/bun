...
describe("Bun.markdown.fromHTML", () => {
  ...
  describe("tree construction", () => {
    const cases: [string, string, string][] = [
      ...
      [
        "cells and rows imply <tr>/<tbody> and close each other",
        "<table><tr><td>1<td>2<tr><td>3</table>",
        "| 1 | 2 |\n| --- | --- |\n| 3 |  |",
      ],
      ["<td> straight inside <table>", "<table><td>x</table>", "x"],
      [
        "text inside <table> is foster-parented before it",
        "<table>oops<tr><td>a</td><td>b</td></tr></table>",
        "oops\n\n| a | b |\n| --- | --- |",
      ],
      [
        "elements inside <table> are foster-parented too",
        "<table><p>para<tr><td>a</td><td>b</td></tr></table>",
        "para\n\n| a | b |\n| --- | --- |",
      ],
      [
        "foster-parented text reopens formatting",
        "<table><b><tr><td>a</td></tr>bold</table>after",
        "**bold**\n\na\n\n**after**",
      ],
      [
        "<table> inside <table> closes the first",
        "<table><tr><td>a<table><tr><td>b</td><td>c</td></tr></table>",
        "a\n\n| b | c |\n| --- | --- |",
      ],
      ["table tags outside a table are ignored", "<p>a<tr><td>b</td></tr>c</p>", "abc"],
      [
        "<col>, <colgroup>, <caption>",
        "<table><caption>cap</caption><colgroup><col></colgroup><tr><th>h</th></tr><tr><td>d</td></tr></table>",
        "cap\n\n| h |\n| --- |\n| d |",
      ],
      [
        "closing a cell drops formatting opened inside it",
        "<table><tr><td><b>x</td><td>y</td></tr></table>z",
        "| **x** | y |\n| --- | --- |\n\nz",
      ],
      ...
      [
        "<a> left open is reopened in later blocks, as in a browser",
        "<ul><li><a href=x>one<li>two</ul><p>after</p>",
        "- [one](x)\n- [two](x)\n\n[after](x)",
      ],
      [
        "identical formatting elements are capped at three (Noah's Ark)",
      ...
      [
        "svg/math integration points carry HTML text",
        "<svg><title>T</title><desc>D</desc></svg>|<math><mi>x</mi></math>",
        "TD|x",
      ],
      ...
      [
        "<body>/<html>/<head> tags mid-document are ignored",
