...
<ListBucketResult xmlns="http://s3.amazonaws.com/doc/2006-03-01/"><Name>awsome-very-dummy-bucket</Name><Prefix></Prefix><KeyCount>3</KeyCount><MaxKeys>1000</MaxKeys><IsTruncated>false</IsTruncated><Contents><Key>01951feb-1db5-7000-aee3-213b4df4015f/file_1.txt</Key><LastModified>2025-02-19T20:34:18.000Z</LastModified><ETag>&quot;9297ab3fbd56b42f6566284119238125&quot;</ETag><Size>9</Size><StorageClass>STANDARD</StorageClass></Contents><Contents><Key>01951feb-1db5-7000-aee3-213b4df4015f/file_2.txt</Key><LastModified>2025-02-19T20:34:18.000Z</LastModified><ETag>&quot;6685cd62b95f2c58818cb20e7292168b&quot;</ETag><Size>9</Size><StorageClass>STANDARD</StorageClass></Contents><Contents><Key>01951feb-1db5-7000-aee3-213b4df4015f/file_3.txt</Key><LastModified>2025-02-19T20:34:18.000Z</LastModified><ETag>&quot;bffd51760cd2c6b531756efac72110c3&quot;</ETag><Size>9</Size><StorageClass>STANDARD</StorageClass></Contents></ListBucketResult>`;
  ...
  it("Should parse IsTruncated when it is the last element and the declaration is long", async () => {
    // `<IsTruncated>true</IsTruncated></ListBucketResult>` is 50 bytes, shorter than
    // the 56 byte declaration, so it used to fall outside the scanned window.
    const body = `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<ListBucketResult xmlns="http://s3.amazonaws.com/doc/2006-03-01/"><Name>my_bucket</Name><Contents><Key>a/k1</Key><Size>3</Size><StorageClass>STANDARD</StorageClass></Contents><KeyCount>1</KeyCount><MaxKeys>1</MaxKeys><NextContinuationToken>ct:a/k1</NextContinuationToken><IsTruncated>true</IsTruncated></ListBucketResult>`;
  ...
  it("Should parse the last Contents when a comment precedes the root element", async () => {
    const comment = `<!-- ${"generated by an S3-compatible object store ".repeat(5)}-->`;
    const contents = ["a/k1", "a/k2"]
      .map(
        key =>
          `<Contents><Key>${key}</Key><LastModified>2026-01-01T00:00:00.000Z</LastModified><ETag>&quot;d41d8cd98f00b204e9800998ecf8427e&quot;</ETag><Size>3</Size><StorageClass>STANDARD</StorageClass></Contents>`,
      )
      .join("");
    const body = `<?xml version="1.0" encoding="UTF-8"?>
${comment}
<ListBucketResult xmlns="http://s3.amazonaws.com/doc/2006-03-01/"><Name>my_bucket</Name><IsTruncated>false</IsTruncated>${contents}</ListBucketResult>`;
  ...
  it("Should ignore elements that appear before the root element", async () => {
    const body = `<?xml version="1.0" encoding="UTF-8"?>
<!-- a > b <Contents><Key>commented-out</Key></Contents> -->
<ListBucketResult xmlns="http://s3.amazonaws.com/doc/2006-03-01/"><Name>my_bucket</Name><Contents><Key>real</Key><Size>3</Size></Contents></ListBucketResult>`;
