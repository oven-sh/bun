...
// In debug builds this hit a "reached unreachable code" assertion; in release
// builds it could corrupt memory or trip the AtomString cross-thread check.
test("S3Client.presign without credentials throws instead of crashing", async () => {
