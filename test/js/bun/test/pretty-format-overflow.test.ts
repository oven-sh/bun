// Test for integer overflow fix in src/runtime/test_runner/pretty_format.rs
// Previously crashed with: panic: integer overflow at writeIndent in pretty_format
