...
test("toBeEven()", () => {
  ...
  expect(new WebAssembly.Global({value:'f32', mutable:true}, 4.30).value).not.toBeEven();
  expect(new WebAssembly.Global({value:'f32', mutable:false}, 4.30).value).not.toBeEven();
  expect(new WebAssembly.Global({value:'f64', mutable:true}, 4.30).value).not.toBeEven();
  expect(new WebAssembly.Global({value:'f64', mutable:false}, 4.30).value).not.toBeEven();
  ...
  // FUTURE: with uintv128: expect(new WebAssembly.Global({value:'v128', mutable:false}, 340282366920938463463374607431768211456n).value).not.toBeEven();
});
...
test("toBeOdd()", () => {
  ...
  expect(new WebAssembly.Global({value:'f32', mutable:true}, 4.30).value).not.toBeOdd();
  expect(new WebAssembly.Global({value:'f32', mutable:false}, 4.30).value).not.toBeOdd();
  expect(new WebAssembly.Global({value:'f64', mutable:true}, 4.30).value).not.toBeOdd();
  expect(new WebAssembly.Global({value:'f64', mutable:false}, 4.30).value).not.toBeOdd();
  // did not seem to support SIMD v128 type yet
