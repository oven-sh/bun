...
// per-allocation cap (the lane the gate and the ASAN CI lanes run), and on
// Linux release builds through a real address-space limit, which makes
// mimalloc itself return null.
