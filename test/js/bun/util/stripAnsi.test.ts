...
describe("Bun.stripANSI", () => {
  ...
  const testCases: string[] = [
    ...
    "\x1b]8;;file:///path/to/file\x1b\\clickable\x1b]8;;\x1b\\",
    ...
    "\x1b[12345mtext", // only first 4 digits consumed
    "\x1b[1234mtext",
    "\x1b[9999;1234mtext",

    // String terminator variations
    "\x1b]0;title\x9ctext", // 0x9C terminator
    "\x1b]2;test\x07more",

    // Mixed sequences
    "\x1b[31m\x1b]0;title\x07\x1b[39mtext",
    "\x1b]8;;\x07\x1b[4mlink\x1b[24m\x1b]8;;\x07",
    ...
    "\x1b[31m\x1b in text\x1b[39m",
    "\x1b]0;\x1b[31mred\x1b[39m\x07text",
    ...
    "\x9b31mtext\x9b39m",
    "\x9b[31mtext", // 0x9B followed by [ is invalid
    "\x9bHtext", // Cursor Home
    "\x9b2Jtext", // Clear Screen

    // OSC sequences with various terminators
    "\x1b]0;Window Title\x1b\\text", // ESC \ terminator
    "\x1b]1;Icon Name\x07text", // BEL terminator
    "\x1b]2;Both\x9ctext", // ST terminator
    ...
    // Save/restore cursor
    "\x1b[stext\x1b[u", // Save and restore cursor
    "\x1b7text\x1b8", // Save and restore cursor (alternate)
    ...
    "\x1b*0text", // DEC special character set
    "\x1b+Btext", // G3 character set

    // Double-width/height sequences
    "\x1b#3text", // Double-height line (top half)
    "\x1b#4text", // Double-height line (bottom half)
    "\x1b#5text", // Single-width line
    "\x1b#6text", // Double-width line
    ...
    "\x1b[99999mtext", // Parameter too long (>4 digits)
    ...
    "\x1b]0;タイトル\x07text", // Japanese in OSC
    "\x1b]2;🚀 rocket\x07text", // Emoji in OSC
    ...
    "\x1b]0;This is a very long window title that exceeds 16 characters\x07text", // Long OSC
