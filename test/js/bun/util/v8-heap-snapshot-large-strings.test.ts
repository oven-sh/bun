...
describe.concurrent("generateHeapSnapshot('v8') large-string truncation", () => {
  test("truncates string node names like V8", async () => {
  ...
  test("handles a large UTF-16 string in the heap", async () => {
  ...
  test("arraybuffer output also truncates string node names", async () => {
    const script = `
