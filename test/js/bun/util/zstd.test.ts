...
import { bunEnv, bunExe, canFaultOnCpuid, isASAN, rss, runWithCpuidFaultAfterWarmup } from "harness";
...
// The child makes CPUID raise SIGSEGV after the first round trip, so a context that still probes
// the CPU kills it. The first context of each kind is allowed to probe.
