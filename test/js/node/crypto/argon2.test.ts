...
// Loosened from the @types/node signatures so the table-driven cases below can
// pass invalid algorithms and parameter objects.
...
describe("crypto.argon2", () => {
  ...
  test("rejects wrong-typed secret/associatedData", () => {
    // Node up to v26.3.0 passes no name to getArrayBufferOrView here and throws
    // ERR_INTERNAL_ASSERTION. Newer Node names the property; match that.
