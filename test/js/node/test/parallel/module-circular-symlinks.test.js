//#FILE: test-module-circular-symlinks.js
//#SHA1: fb1de1e61b1207d2ef63f6367c27fe0ef0e2c75f
//-----------------
"use strict";
...
beforeAll(() => {
  ...
  try {
    ...
    test.skip("insufficient privileges for symlinks");
  }

  fs.writeFileSync(path.join(tmpDir, "index.js"), "module.exports = require('moduleA');", "utf8");
  fs.writeFileSync(path.join(moduleA, "index.js"), "module.exports = {b: require('moduleB')};", "utf8");
  fs.writeFileSync(path.join(moduleB, "index.js"), "module.exports = {a: require('moduleA')};", "utf8");
});
...
test("symlinks are not followed forever", () => {
  // Ensure that the symlinks are not followed forever...
  const obj = require(path.join(tmpDir, "index"));
  expect(obj).toBeDefined();
  expect(obj.b).toBeDefined();
  expect(obj.b.a).toBeDefined();
  expect(obj.b.a.b).toBeUndefined();
});

//<#END_FILE: test-module-circular-symlinks.js
