...
describe('Stream Default High Water Mark', () => {
  ...
  test('Writable stream should have correct highWaterMark', () => {
  ...
  test('Readable stream should have correct highWaterMark', () => {
  ...
  test('Transform stream should have correct highWaterMark for both readable and writable', () => {
