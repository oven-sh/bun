...
const variants = [
  (stream, compressed, trailingData) => { stream.end(compressed); },
  (stream, compressed, trailingData) => { stream.write(compressed); stream.write(trailingData); },
  (stream, compressed, trailingData) => { stream.write(compressed); stream.end(trailingData); },
  (stream, compressed, trailingData) => { stream.write(Buffer.concat([compressed, trailingData])); },
  (stream, compressed, trailingData) => { stream.end(Buffer.concat([compressed, trailingData])); },
];
