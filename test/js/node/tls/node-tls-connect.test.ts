...
// Ed25519 in its signature_algorithms extension, so a handshake against an
// Ed25519 leaf could not complete: the peer certificate came back empty and
// hostname verification failed with "Cert does not contain a DNS name". RSA and
// ECDSA were unaffected and are included so the fix is proven not to regress
// them. https://github.com/oven-sh/bun/issues/32234
