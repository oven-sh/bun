...
// Issue #30632: `new Bun.SQL({ adapter: "mysql", max: N })` must grow the pool
// lazily on demand, not open all N connections up-front. Uses a bare TCP
// listener so the test runs without a live MySQL server.
describe("mysql connection pool grows lazily (#30632)", () => {
