// https://github.com/oven-sh/bun/issues/40102: PostgresRequest.write_bind's
// json/jsonb arm leaked the JSON.stringify result (a +1 WTFStringImpl ref) once
// per JSON parameter bound.
//
