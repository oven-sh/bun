    ...
    describe("Array helpers", () => {
      ...
      test("sql.array without a type infers the element type from the values", async () => {
        ...
        const [row] = await sql`select
          ...
          pg_typeof(${sql.array([9223372036854775807n, -9223372036854775808n])}) as int64_bounds,
          pg_typeof(${sql.array([9223372036854775808n])}) as beyond_int64,
