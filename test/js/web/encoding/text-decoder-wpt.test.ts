...
describe("WPT: single-byte-decoder", () => {
  ...
  const supportedEncodings = [
    "IBM866", "ISO-8859-3", "ISO-8859-6", "ISO-8859-7", "ISO-8859-8",
...
describe("WPT: textdecoder-labels", () => {
  ...
  const encodingLabels: Record<string, string[]> = {
    ...
    "iso-8859-7": ["iso-8859-7", "iso8859-7", "iso_8859-7", "greek", "greek8", "iso-ir-126", "elot_928", "ecma-118", "csisolatingreek"],
    ...
    for (const label of labels) {
      describe(`${label} => ${canonical}`, () => {
        ...
        test("mixed case label", () => {
          const mixedCase = label.split('').map((c, i) => i % 2 ? c.toUpperCase() : c).join('');
