...
test("new File() reports its size to the GC like new Blob() does", () => {
  ...
  // FormData entries carry the File's reported size, as they do for Blobs.
...
describe.concurrent.each([
  ...
  test("reports its size to the GC when constructed", async () => {
