  ...
  server = Bun.serve({
    ...
    routes: {
      ...
      "/status": req => {
        ...
        // null body statuses (204) reject a body in the Response constructor
        const body = u.searchParams.get("body") || null;
        return new Response(body, { status: Number(u.searchParams.get("code")) });
      },
      "/gzip": () =>
