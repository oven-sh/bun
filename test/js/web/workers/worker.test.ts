...
describe("worker_threads", () => {
  ...
  test("worker terminate while setting up thread", async () => {
    ...
    // running code the exit code is 1 instead. this means we can randomly see an exit code of 1 if
    // the main thread happens to run slower than usual and allows the worker to run some code.
    //
