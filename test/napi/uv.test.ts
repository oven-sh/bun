...
import { symbols, test_skipped } from "../../src/buntime/bindings/libuv/generate_uv_posix_stubs_constants";
...
describe.if(!isWindows)("uv stubs", () => {
  ...
  beforeAll(async () => {
    ...
    const libuvDir = path.join(__dirname, "../../src/buntime/bindings/libuv");
