...
const PACKAGES_TO_TEST = [
  ...
  //{ name: "microsoft/TypeScript", committish: "" },
  //{ name: "angular/angular", committish: "" },
  //{ name: "shadcn-ui/ui", committish: "" },
  //{ name: "iptv-org/iptv", committish: "" },
  //{ name: "mui/material-ui", committish: "" },
  //{ name: "ant-design/ant-design", committish: "" },
  //{ name: "puppeteer/puppeteer", committish: "" },
  //{ name: "tailwindlabs/tailwindcss", committish: "" },
  //{ name: "supabase/supabase", committish: "" },
  //{ name: "storybookjs/storybook", committish: "" },
  //{ name: "ChatGPTNextWeb/NextChat", committish: "" },
  //{ name: "mermaid-js/mermaid", committish: "" },
  //{ name: "gothinkster/realworld", committish: "" },
  //{ name: "immich-app/immich", committish: "" },
  //{ name: "google-gemini/gemini-cli", committish: "" },
  //{ name: "clash-verge-rev/clash-verge-rev", committish: "" },
  //{ name: "microsoft/playwright", committish: "" },
  //{ name: "vitejs/vite", committish: "" },
  //{ name: "hoppscotch/hoppscotch", committish: "" },
  //{ name: "coder/code-server", committish: "" },
  //{ name: "nestjs/nest", committish: "" },
  //{ name: "modelcontextprotocol/servers", committish: "" },
  //{ name: "grafana/grafana", committish: "" },
  //{ name: "strapi/strapi", committish: "" },
  //{ name: "apache/superset", committish: "" },
  //{ name: "lobehub/lobe-chat", committish: "" },
  //{ name: "Eugeny/tabby", committish: "" },
  //{ name: "infiniflow/ragflow", committish: "" },
  //{ name: "apache/echarts", committish: "" },
  //{ name: "firecrawl/firecrawl", committish: "" },
  //{ name: "socketio/socket.io", committish: "" },
  //{ name: "facebook/docusaurus", committish: "" },
  //{ name: "reduxjs/redux", committish: "" },
  //{ name: "nuxt/nuxt", committish: "" },
  //{ name: "nocodb/nocodb", committish: "" },
  //{ name: "toeverything/AFFiNE", committish: "" },
  //{ name: "remix-run/react-router", committish: "" },
  //{ name: "pmndrs/zustand", committish: "" },
  //{ name: "withastro/astro", committish: "" },
  //{ name: "appwrite/appwrite", committish: "" },
  //{ name: "ionic-team/ionic-framework", committish: "" },
  //{ name: "vuejs/core", committish: "" },
  //{ name: "laurent22/joplin", committish: "" },
  //{ name: "cline/cline", committish: "" },
  //{ name: "DefinitelyTyped/DefinitelyTyped", committish: "" },
  //{ name: "cypress-io/cypress", committish: "" },
  //{ name: "TanStack/query", committish: "" },
  //{ name: "type-challenges/type-challenges", committish: "" },
  //{ name: "lyswhut/lx-music-desktop", committish: "" },
  //{ name: "slab/quill", committish: "" },
  //{ name: "FlowiseAI/Flowise", committish: "" },
  //{ name: "pixijs/pixijs", committish: "" },
  //{ name: "jestjs/jest", committish: "" },
  //{ name: "vercel/hyper", committish: "" },
  //{ name: "expo/expo", committish: "" },
  //{ name: "prisma/prisma", committish: "" },
  //{ name: "react-hook-form/react-hook-form", committish: "" },
  //{ name: "babel/babel", committish: "" },
  //{ name: "RocketChat/Rocket.Chat", committish: "" },
  //{ name: "streamich/react-use", committish: "" },
  //{ name: "FuelLabs/fuels-ts", committish: "" },
  //{ name: "tldraw/tldraw", committish: "" },
  //{ name: "OpenCut-app/OpenCut", committish: "" },
  //{ name: "AykutSarac/jsoncrack.com", committish: "" },
  //{ name: "styled-components/styled-components", committish: "" },
  //{ name: "hexojs/hexo", committish: "" },
  //{ name: "vuetifyjs/vuetify", committish: "" },
  //{ name: "slidevjs/slidev", committish: "" },
  //{ name: "upscayl/upscayl", committish: "" },
  //{ name: "colinhacks/zod", committish: "" },
  //{ name: "anthropics/claude-code", committish: "" },
  //{ name: "chakra-ui/chakra-ui", committish: "" },
  //{ name: "makeplane/plane", committish: "" },
  //{ name: "DIYgod/RSSHub", committish: "" },
  //{ name: "trpc/trpc", committish: "" },
  //{ name: "siyuan-note/siyuan", committish: "" },
  //{ name: "fastapi/full-stack-fastapi-template", committish: "" },
  //{ name: "calcom/cal.com", committish: "" },
  //{ name: "payloadcms/payload", committish: "" },
  //{ name: "menloresearch/jan", committish: "" },
  //{ name: "appsmithorg/appsmith", committish: "" },
  //{ name: "novuhq/novu", committish: "" },
  //{ name: "ant-design/ant-design-pro", committish: "" },
  //{ name: "Kong/insomnia", committish: "" },
  //{ name: "chatboxai/chatbox", committish: "" },
  //{ name: "NervJS/taro", committish: "" },
  //{ name: "inkonchain/ink-kit", committish: "" },
  //{ name: "twentyhq/twenty", committish: "" },
  //{ name: "chatchat-space/Langchain-Chatchat", committish: "" },
  //{ name: "date-fns/date-fns", committish: "" },
  //{ name: "lerna/lerna", committish: "" },
  //{ name: "typeorm/typeorm", committish: "" },
  //{ name: "outline/outline", committish: "" },
  //{ name: "spacedriveapp/spacedrive", committish: "" },
  //{ name: "nativefier/nativefier", committish: "" },
  //{ name: "RSSNext/Folo", committish: "" },
  //{ name: "reworkd/AgentGPT", committish: "" },
  //{ name: "portainer/portainer", committish: "" },
  //{ name: "CherryHQ/cherry-studio", committish: "" },
  //{ name: "solidjs/solid", committish: "" },
  //{ name: "jaredpalmer/formik", committish: "" },
  //{ name: "mattermost/mattermost", committish: "" },
  //{ name: "mifi/lossless-cut", committish: "" },
  //{ name: "AmruthPillai/Reactive-Resume", committish: "" },
  //{ name: "alan2207/bulletproof-react", committish: "" },
  //{ name: "ueberdosis/tiptap", committish: "" },
  //{ name: "immutable-js/immutable-js", committish: "" },
  //{ name: "refinedev/refine", committish: "" },
  //{ name: "xyflow/xyflow", committish: "" },
  //{ name: "directus/directus", committish: "" },
  //{ name: "pnpm/pnpm", committish: "" },
  //{ name: "mckaywrigley/chatbot-ui", committish: "" },
  //{ name: "vadimdemedes/ink", committish: "" },
  //{ name: "balena-io/etcher", committish: "" },
  //{ name: "TriliumNext/Trilium", committish: "" },
  //{ name: "vercel/swr", committish: "" },
  //{ name: "floating-ui/floating-ui", committish: "" },
  //{ name: "remix-run/remix", committish: "" },
  //{ name: "hasura/graphql-engine", committish: "" },
  //{ name: "shardeum/shardeum", committish: "" },
  //{ name: "backscommittishe/backscommittishe", committish: "" },
  //{ name: "niklasvh/html2canvas", committish: "" },
  //{ name: "ZuodaoTech/everyone-can-use-english", committish: "" },
  //{ name: "ReactiveX/rxjs", committish: "" },
  //{ name: "umami-software/umami", committish: "" },
  //{ name: "ianstormtaylor/slate", committish: "" },
  //{ name: "codex-team/editor.js", committish: "" },
  //{ name: "danny-avila/LibreChat", committish: "" },
  //{ name: "medusajs/medusa", committish: "" },
  //{ name: "drizzle-team/drizzle-orm", committish: "" },
  //{ name: "fabricjs/fabric.js", committish: "" },
  //{ name: "transloadit/uppy", committish: "" },
  //{ name: "sequelize/sequelize", committish: "" },
  //{ name: "motiondivision/motion", committish: "" },
  //{ name: "mantinedev/mantine", committish: "" },
  //{ name: "cheeriojs/cheerio", committish: "" },
  //{ name: "pmndrs/react-three-fiber", committish: "" },
  //{ name: "refined-github/refined-github", committish: "" },
  //{ name: "heyverse/hey", committish: "" },
  //{ name: "continuedev/continue", committish: "" },
  //{ name: "pmndrs/react-spring", committish: "" },
  //{ name: "sst/opencode", committish: "" },
  //{ name: "postcss/postcss", committish: "" },
  //{ name: "statelyai/xstate", committish: "" },
  //{ name: "pear-devs/pear-desktop", committish: "" },
  //{ name: "GitbookIO/gitbook", committish: "" },
  //{ name: "t3-oss/create-t3-app", committish: "" },
  //{ name: "mobxjs/mobx", committish: "" },
  //{ name: "tailwindlabs/headlessui", committish: "" },
  //{ name: "JedWatson/react-select", committish: "" },
  //{ name: "nextauthjs/next-auth", committish: "" },
  //{ name: "jitsi/jitsi-meet", committish: "" },
  //{ name: "the1812/Bilibili-Evolved", committish: "" },
  //{ name: "voideditor/void", committish: "" },
  //{ name: "nrwl/nx", committish: "" },
  //{ name: "TanStack/table", committish: "" },
  //{ name: "Budibase/budibase", committish: "" },
  //{ name: "heroui-inc/heroui", committish: "" },
  //{ name: "angular/angular-cli", committish: "" },
  //{ name: "ItzCrazyKns/Perplexica", committish: "" },
  //{ name: "honojs/hono", committish: "" },
  //{ name: "Lissy93/web-check", committish: "" },
  //{ name: "element-plus/element-plus", committish: "" },
  //{ name: "blakeblackshear/frigate", committish: "" },
  //{ name: "discordjs/discord.js", committish: "" },
  //{ name: "marmelab/react-admin", committish: "" },
  //{ name: "recharts/recharts", committish: "" },
  //{ name: "labring/FastGPT", committish: "" },
  //{ name: "invoke-ai/InvokeAI", committish: "" },
  //{ name: "Dokploy/dokploy", committish: "" },
  //{ name: "ComposioHQ/composio", committish: "" },
  //{ name: "akveo/ngx-admin", committish: "" },
  //{ name: "oldj/SwitchHosts", committish: "" },
  //{ name: "Molunerfinn/PicGo", committish: "" },
  //{ name: "fingerprintjs/fingerprintjs", committish: "" },
  //{ name: "daytonaio/daytona", committish: "" },
  //{ name: "mattermost-community/focalboard", committish: "" },
  //{ name: "NativeScript/NativeScript", committish: "" },
  //{ name: "Redocly/redoc", committish: "" },
  //{ name: "withfig/autocomplete", committish: "" },
  //{ name: "GrapesJS/grapesjs", committish: "" },
  //{ name: "neoclide/coc.nvim", committish: "" },
  //{ name: "homebridge/homebridge", committish: "" },
  //{ name: "angular/components", committish: "" },
  //{ name: "kamranahmedse/driver.js", committish: "" },
  //{ name: "vuejs/devtools-v6", committish: "" },
  //{ name: "sst/sst", committish: "" },
  //{ name: "BabylonJS/Babylon.js", committish: "" },
  //{ name: "nextai-translator/nextai-translator", committish: "" },
  //{ name: "CopilotKit/CopilotKit", committish: "" },
  //{ name: "OI-wiki/OI-wiki", committish: "" },
  //{ name: "responsively-org/responsively-app", committish: "" },
  //{ name: "remotion-dev/remotion", committish: "" },
  //{ name: "react-navigation/react-navigation", committish: "" },
  //{ name: "electron-react-boilerplate/electron-react-boilerplate", committish: "" },
  //{ name: "youzan/vant", committish: "" },
  //{ name: "SigNoz/signoz", committish: "" },
  //{ name: "gitroomhq/postiz-app", committish: "" },
  //{ name: "GoogleChromeLabs/squoosh", committish: "" },
  //{ name: "doczjs/docz", committish: "" },
  //{ name: "usablica/intro.js", committish: "" },
  //{ name: "rahuldkjain/github-profile-readme-generator", committish: "" },
  //{ name: "jquense/yup", committish: "" },
  //{ name: "reduxjs/react-redux", committish: "" },
  //{ name: "hcengineering/platform", committish: "" },
  //{ name: "kriasoft/react-starter-kit", committish: "" },
  //{ name: "conwnet/github1s", committish: "" },
  //{ name: "wg-easy/wg-easy", committish: "" },
  //{ name: "Infisical/infisical", committish: "" },
  //{ name: "felixrieseberg/windows95", committish: "" },
  //{ name: "onlook-dev/onlook", committish: "" },
  //{ name: "actualbudget/actual", committish: "" },
  //{ name: "pubkey/rxdb", committish: "" },
  //{ name: "react-bootstrap/react-bootstrap", committish: "" },
  //{ name: "dubinc/dub", committish: "" },
  //{ name: "t4t5/sweetalert", committish: "" },
  //{ name: "facebook/lexical", committish: "" },
  //{ name: "microsoft/playwright-mcp", committish: "" },
  //{ name: "jhipster/generator-jhipster", committish: "" },
  //{ name: "better-auth/better-auth", committish: "" },
  //{ name: "wechaty/wechaty", committish: "" },
  //{ name: "BuilderIO/gpt-crawler", committish: "" },
  //{ name: "zzzgydi/clash-verge", committish: "" },
  //{ name: "wandb/openui", committish: "" },
  //{ name: "QwikDev/qwik", committish: "" },
  //{ name: "vueuse/vueuse", committish: "" },
  //{ name: "react-dnd/react-dnd", committish: "" },
  //{ name: "basarat/typescript-book", committish: "" },
  //{ name: "palantir/blueprint", committish: "" },
  //{ name: "darkreader/darkreader", committish: "" },
  //{ name: "firecrawl/open-lovable", committish: "" },
  //{ name: "SBoudrias/Inquirer.js", committish: "" },
  //{ name: "nikivdev/myflow", committish: "" },
  //{ name: "eclipse-theia/theia", committish: "" },
  //{ name: "maotoumao/MusicFree", committish: "" },
  //{ name: "beekeeper-studio/beekeeper-studio", committish: "" },
  //{ name: "desktop/desktop", committish: "" },
  //{ name: "elastic/kibana", committish: "" },
  //{ name: "pmndrs/jotai", committish: "" },
  //{ name: "RealKai42/qwerty-learner", committish: "" },
  //{ name: "karakeep-app/karakeep", committish: "" },
  //{ name: "lit/lit", committish: "" },
  //{ name: "GeekyAnts/NativeBase", committish: "" },
  //{ name: "airbnb/visx", committish: "" },
  //{ name: "a2aproject/A2A", committish: "" },
  //{ name: "graphql/graphql-js", committish: "" },
  //{ name: "apify/crawlee", committish: "" },
  //{ name: "bokeh/bokeh", committish: "" },
  //{ name: "wenyan-lang/wenyan", committish: "" },
  //{ name: "teableio/teable", committish: "" },
  //{ name: "musistudio/claude-code-router", committish: "" },
  //{ name: "fullcalendar/fullcalendar", committish: "" },
  //{ name: "louislam/dockge", committish: "" },
  //{ name: "renovatebot/renovate", committish: "" },
  //{ name: "web3/web3.js", committish: "" },
  //{ name: "Lissy93/personal-security-checklist", committish: "" },
  //{ name: "yamadashy/repomix", committish: "" },
  //{ name: "apollographql/apollo-client", committish: "" },
  //{ name: "microsoft/fluentui", committish: "" },
  //{ name: "pavlobu/deskreen", committish: "" },
  //{ name: "aidenybai/react-scan", committish: "" },
  //{ name: "lucide-icons/lucide", committish: "" },
  //{ name: "chartdb/chartdb", committish: "" },
  //{ name: "bytedance/UI-TARS-desktop", committish: "" },
  //{ name: "xtermjs/xterm.js", committish: "" },
  //{ name: "infinitered/ignite", committish: "" },
  //{ name: "railsware/upterm", committish: "" },
  //{ name: "reduxjs/reselect", committish: "" },
  //{ name: "shadcn-ui/taxonomy", committish: "" },
  //{ name: "tensorflow/tfjs", committish: "" },
  //{ name: "eggjs/egg", committish: "" },
  //{ name: "wulkano/Kap", committish: "" },
  //{ name: "subquery/subql", committish: "" },
  //{ name: "activepieces/activepieces", committish: "" },
  //{ name: "vercel/ai", committish: "" },
  //{ name: "rrweb-io/rrweb", committish: "" },
  //{ name: "monkeytypegame/monkeytype", committish: "" },
  //{ name: "browserbase/scommittishehand", committish: "" },
  //{ name: "baidu/amis", committish: "" },
  //{ name: "alibaba/ice", committish: "" },
  //{ name: "whyour/qinglong", committish: "" },
  //{ name: "vercel/ai-chatbot", committish: "" },
  //{ name: "kortix-ai/suna", committish: "" },
  //{ name: "winfunc/opcode", committish: "" },
  //{ name: "adonisjs/core", committish: "" },
  //{ name: "teambit/bit", committish: "" },
  //{ name: "unocss/unocss", committish: "" },
  //{ name: "wangeditor-team/wangEditor", committish: "" },
  //{ name: "compiler-explorer/compiler-explorer", committish: "" },
  //{ name: "coze-dev/coze-studio", committish: "" },
  //{ name: "github/docs", committish: "" },
  //{ name: "conventional-changelog/commitlint", committish: "" },
  //{ name: "radix-ui/primitives", committish: "" },
  //{ name: "transitive-bullshit/agentic", committish: "" },
  //{ name: "dzhng/deep-research", committish: "" },
  //{ name: "ionic-team/ionicons", committish: "" },
  //{ name: "birobirobiro/awesome-shadcn-ui", committish: "" },
  //{ name: "ether/etherpad-lite", committish: "" },
  //{ name: "tusen-ai/naive-ui", committish: "" },
  //{ name: "oblador/react-native-vector-icons", committish: "" },
  //{ name: "reduxjs/redux-thunk", committish: "" },
  //{ name: "nhn/tui.editor", committish: "" },
  //{ name: "mastra-ai/mastra", committish: "" },
  //{ name: "catppuccin/catppuccin", committish: "" },
  //{ name: "motion-canvas/motion-canvas", committish: "" },
  //{ name: "redwoodjs/graphql", committish: "" },
  //{ name: "docmost/docmost", committish: "" },
  //{ name: "justadudewhohacks/face-api.js", committish: "" },
  //{ name: "CopyTranslator/CopyTranslator", committish: "" },
  //{ name: "langfuse/langfuse", committish: "" },
  //{ name: "redis/node-redis", committish: "" },
  //{ name: "aidenybai/million", committish: "" },
  //{ name: "mihomo-party-org/clash-party", committish: "" },
  //{ name: "Tencent/vConsole", committish: "" },
  //{ name: "verdaccio/verdaccio", committish: "" },
  //{ name: "mswjs/msw", committish: "" },
  //{ name: "simstudioai/sim", committish: "" },
  //{ name: "material-components/material-components-web", committish: "" },
  //{ name: "bluesky-social/social-app", committish: "" },
  //{ name: "elizaOS/eliza", committish: "" },
  //{ name: "nocobase/nocobase", committish: "" },
  //{ name: "dyad-sh/dyad", committish: "" },
  //{ name: "resend/react-email", committish: "" },
  //{ name: "bvaughn/react-window", committish: "" },
  //{ name: "learn-anything/learn-anything", committish: "" },
  //{ name: "leon-ai/leon", committish: "" },
  //{ name: "mlc-ai/web-llm", committish: "" },
  //{ name: "graphql/graphiql", committish: "" },
  //{ name: "carloscuesta/gitmoji", committish: "" },
  //{ name: "ustbhuangyi/better-scroll", committish: "" },
  //{ name: "foambubble/foam", committish: "" },
  //{ name: "labring/sealos", committish: "" },
  //{ name: "tremorlabs/tremor-npm", committish: "" },
  //{ name: "umijs/qiankun", committish: "" },
  //{ name: "flatpickr/flatpickr", committish: "" },
  //{ name: "sindresorhus/type-fest", committish: "" },
  //{ name: "vuejs/vitepress", committish: "" },
  //{ name: "linshenkx/prompt-optimizer", committish: "" },
  //{ name: "richards199999/Thinking-Claude", committish: "" },
  //{ name: "nukeop/nuclear", committish: "" },
  //{ name: "video-dev/hls.js", committish: "" },
  //{ name: "diegomura/react-pdf", committish: "" },
  //{ name: "langchain-ai/langchainjs", committish: "" },
  //{ name: "mayooear/ai-pdf-chatbot-langchain", committish: "" },
  //{ name: "sismo-core/sismo-badges", committish: "" },
  //{ name: "typescript-eslint/typescript-eslint", committish: "" },
  //{ name: "amplication/amplication", committish: "" },
  //{ name: "clauderic/dnd-kit", committish: "" },
  //{ name: "tinymce/tinymce", committish: "" },
  //{ name: "umijs/umi", committish: "" },
  //{ name: "stackblitz/bolt.new", committish: "" },
  //{ name: "mediar-ai/screenpipe", committish: "" },
  //{ name: "react-native-maps/react-native-maps", committish: "" },
  //{ name: "sindresorhus/ky", committish: "" },
  //{ name: "alibaba/lowcode-engine", committish: "" },
  //{ name: "humanlayer/12-factor-agents", committish: "" },
  //{ name: "signalapp/Signal-Desktop", committish: "" },
  //{ name: "johannesjo/super-productivity", committish: "" },
  //{ name: "fosrl/pangolin", committish: "" },
  //{ name: "omnivore-app/omnivore", committish: "" },
  //{ name: "steven-tey/novel", committish: "" },
  //{ name: "javascript-obfuscator/javascript-obfuscator", committish: "" },
  //{ name: "infinitered/reactotron", committish: "" },
  //{ name: "rjsf-team/react-jsonschema-form", committish: "" },
  //{ name: "sass/sass", committish: "" },
  //{ name: "udecode/plate", committish: "" },
  //{ name: "linkwarden/linkwarden", committish: "" },
  //{ name: "kubeflow/kubeflow", committish: "" },
  //{ name: "feathersjs/feathers", committish: "" },
  //{ name: "vitest-dev/vitest", committish: "" },
  //{ name: "uuidjs/uuid", committish: "" },
  //{ name: "redis/ioredis", committish: "" },
  //{ name: "apitable/apitable", committish: "" },
  //{ name: "airbnb/react-sketchapp", committish: "" },
  //{ name: "VSCodeVim/Vim", committish: "" },
  //{ name: "jupyterlab/jupyterlab", committish: "" },
  //{ name: "BrainJS/brain.js", committish: "" },
  //{ name: "sindresorhus/got", committish: "" },
  //{ name: "alibaba/hooks", committish: "" },
  //{ name: "nextjs/saas-starter", committish: "" },
  //{ name: "tensorflow/tfjs-models", committish: "" },
  //{ name: "QwenLM/qwen-code", committish: "" },
  //{ name: "cyrildiagne/ar-cutpaste", committish: "" },
  //{ name: "ag-grid/ag-grid", committish: "" },
  //{ name: "formatjs/formatjs", committish: "" },
  //{ name: "ahmedkhaleel2004/gitdiagram", committish: "" },
  //{ name: "caprover/caprover", committish: "" },
  //{ name: "faker-js/faker", committish: "" },
  //{ name: "jimp-dev/jimp", committish: "" },
  //{ name: "hydralauncher/hydra", committish: "" },
  //{ name: "adobe/react-spectrum", committish: "" },
  //{ name: "Tonejs/Tone.js", committish: "" },
  //{ name: "ajv-validator/ajv", committish: "" },
  //{ name: "elysiajs/elysia", committish: "" },
  //{ name: "lyswhut/lx-music-mobile", committish: "" },
  //{ name: "gvergnaud/ts-pattern", committish: "" },
  //{ name: "google/brotli", committish: "" },
  //{ name: "electron-userland/electron-builder", committish: "" },
  //{ name: "reduxjs/redux-devtools", committish: "" },
  //{ name: "botpress/botpress", committish: "" },
  //{ name: "vuejs/pinia", committish: "" },
  //{ name: "vercel/vercel", committish: "" },
  //{ name: "readest/readest", committish: "" },
  //{ name: "ionic-team/capacitor", committish: "" },
  //{ name: "Chocobozzz/PeerTube", committish: "" },
  //{ name: "FaridSafi/react-native-gifted-chat", committish: "" },
  //{ name: "Koenkk/zigbee2mqtt", committish: "" },
  //{ name: "blitz-js/blitz", committish: "" },
  //{ name: "callstack/react-native-paper", committish: "" },
  //{ name: "ConsenSys-archive/truffle", committish: "" },
  //{ name: "yoavbls/pretty-ts-errors", committish: "" },
  //{ name: "Sairyss/domain-driven-hexagon", committish: "" },
  //{ name: "danilowoz/react-content-loader", committish: "" },
  //{ name: "microsoft/data-formulator", committish: "" },
  //{ name: "apollographql/apollo-server", committish: "" },
  //{ name: "plouc/nivo", committish: "" },
  //{ name: "getmaxun/maxun", committish: "" },
  //{ name: "shoelace-style/shoelace", committish: "" },
  //{ name: "fengyuanchen/cropperjs", committish: "" },
  //{ name: "dexie/Dexie.js", committish: "" },
  //{ name: "konvajs/konva", committish: "" },
  //{ name: "formkit/auto-animate", committish: "" },
  //{ name: "vercel/commerce", committish: "" },
  //{ name: "SawyerHood/draw-a-ui", committish: "" },
  //{ name: "QwikDev/partytown", committish: "" },
  //{ name: "visgl/deck.gl", committish: "" },
  //{ name: "CapSoftware/Cap", committish: "" },
  //{ name: "gitpod-io/gitpod", committish: "" },
  //{ name: "denoland/fresh", committish: "" },
  //{ name: "nexe/nexe", committish: "" },
  //{ name: "angular-ui/ui-router", committish: "" },
  //{ name: "BuilderIO/mitosis", committish: "" },
  //{ name: "facebook/flipper", committish: "" },
  //{ name: "ikatyang/emoji-cheat-sheet", committish: "" },
  //{ name: "ourongxing/newsnow", committish: "" },
  //{ name: "chartist-js/chartist", committish: "" },
  //{ name: "glideapps/quicktype", committish: "" },
  //{ name: "fkhadra/react-toastify", committish: "" },
  //{ name: "piotrwitek/react-redux-typescript-guide", committish: "" },
  //{ name: "TibixDev/winboat", committish: "" },
  //{ name: "fuergaosi233/wechat-chatgpt", committish: "" },
  //{ name: "soybeanjs/soybean-admin", committish: "" },
  //{ name: "shuding/nextra", committish: "" },
  //{ name: "schickling/chromeless", committish: "" },
  //{ name: "tamagui/tamagui", committish: "" },
  //{ name: "Tencent/omi", committish: "" },
  //{ name: "mountain-loop/yaak", committish: "" },
  //{ name: "wong2/chatgpt-google-extension", committish: "" },
  //{ name: "google/blockly", committish: "" },
  //{ name: "TypeStrong/ts-node", committish: "" },
  //{ name: "electric-sql/pglite", committish: "" },
  //{ name: "peers/peerjs", committish: "" },
  //{ name: "rt2zz/redux-persist", committish: "" },
  //{ name: "hotwired/stimulus", committish: "" },
  //{ name: "streetwriters/notesnook", committish: "" },
  //{ name: "stenciljs/core", committish: "" },
  //{ name: "MetaMask/metamask-extension", committish: "" },
  //{ name: "kysely-org/kysely", committish: "" },
  //{ name: "crimx/ext-saladict", committish: "" },
  //{ name: "tinacms/tinacms", committish: "" },
  //{ name: "graphile/crystal", committish: "" },
  //{ name: "supermemoryai/supermemory", committish: "" },
  //{ name: "taye/interact.js", committish: "" },
  //{ name: "Unleash/unleash", committish: "" },
  //{ name: "barbajs/barba", committish: "" },
  //{ name: "tradingview/lightweight-charts", committish: "" },
  //{ name: "midday-ai/midday", committish: "" },
  //{ name: "majodev/google-webfonts-helper", committish: "" },
  //{ name: "wasp-lang/open-saas", committish: "" },
  //{ name: "turbolinks/turbolinks", committish: "" },
  //{ name: "triggerdotdev/trigger.dev", committish: "" },
  //{ name: "tensorflow/playground", committish: "" },
  //{ name: "Automattic/wp-calypso", committish: "" },
  //{ name: "vercel/satori", committish: "" },
  //{ name: "aws/aws-cdk", committish: "" },
  //{ name: "PlasmoHQ/plasmo", committish: "" },
  //{ name: "nhn/tui.calendar", committish: "" },
  //{ name: "antvis/G2", committish: "" },
  //{ name: "stan-smith/FossFLOW", committish: "" },
  //{ name: "noodle-run/noodle", committish: "" },
  //{ name: "GoogleChromeLabs/comlink", committish: "" },
  //{ name: "ChromeDevTools/chrome-devtools-mcp", committish: "" },
  //{ name: "react-icons/react-icons", committish: "" },
  //{ name: "highcharts/highcharts", committish: "" },
  //{ name: "shikijs/shiki", committish: "" },
  //{ name: "Canner/WrenAI", committish: "" },
  //{ name: "snabbdom/snabbdom", committish: "" },
  //{ name: "illacloud/illa-builder", committish: "" },
  //{ name: "alibaba/formily", committish: "" },
  //{ name: "element-hq/element-web", committish: "" },
  //{ name: "callstack/linaria", committish: "" },
  ...
  { "name": "hcengineering/platform", "tag": "v0.7.266" },
  ...
  { "name": "wandb/openui", "committish": "f9d8f0e30e1efe2a21bbefffba33bcf6b4e12dc7" },
  ...
  { "name": "bokeh/bokeh", "tag": "branch-3.2-final-commit" },
