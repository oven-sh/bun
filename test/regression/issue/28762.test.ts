...
test("Blob.stream() preserves part boundaries as separate chunks", async () => {
  const part1 = new Uint8Array([
    58, 162, 101, 114, 111, 111, 116, 115, 129, 216, 42, 88, 37, 0, 1, 85, 18, 32, 95, 102, 197, 19, 218, 30, 103,
    78, 133, 139, 57, 105, 28, 11, 0, 246, 124, 167, 41, 140, 239, 220, 248, 168, 136, 35, 196, 72, 236, 184, 232,
    89, 103, 118, 101, 114, 115, 105, 111, 110, 1,
  ]);
  const part2 = new Uint8Array([68]);
  const part3 = new Uint8Array([
    1, 85, 18, 32, 95, 102, 197, 19, 218, 30, 103, 78, 133, 139, 57, 105, 28, 11, 0, 246, 124, 167, 41, 140, 239,
    220, 248, 168, 136, 35, 196, 72, 236, 184, 232, 89,
  ]);
  const part4 = new Uint8Array([
    90, 189, 174, 145, 144, 134, 214, 117, 47, 251, 231, 254, 29, 238, 0, 29, 212, 201, 123, 107, 95, 130, 24, 168,
    207, 139, 134, 177, 187, 88, 167, 36,
  ]);
