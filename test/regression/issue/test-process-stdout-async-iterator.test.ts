...
test.skipIf(isOhos)("process.stdout and process.stderr have Symbol.asyncIterator for Node.js compatibility", () => {
...
test.skipIf(isOhos)("process.stdout and process.stderr async iterators work without throwing", async () => {
...
test.skipIf(isOhos)("tty.WriteStream has Symbol.asyncIterator", () => {
