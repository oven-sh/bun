 ...
 * 
 * {@link https://github.com/DefinitelyTyped/DefinitelyTyped/blob/master/types/websocket/index.d.ts}
 * @see [source](https://developer.mozilla.org/en-US/docs/Web/API/WebSocket)
 */
